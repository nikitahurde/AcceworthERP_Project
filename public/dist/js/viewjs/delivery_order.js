...
//alert(vrno);
  ...
  if(msg=='No Match'){
     ...
     document.getElementById("acccode_err").innerHTML = 'The Custmer code field is required.';
      ...
      $('#tempvrno').val('');
      $('#temptransporter').val('');
       $('#do_excel_code').prop('readonly',true);
   ...
   //  $('#importbtn').prop('disabled',true);
    ...
    $('#accountName').val(msg);
     ...
     $('#getTransCode').val(transcode);
     $('#tempvrno').val(vrno);
     $('#temptransporter').val(Acccode);
     $('#account_code').css('border-color','#d2d6de');
     $('#do_excel_code').prop('readonly',false);
...
$("#do_excel_code").bind('change', function () {
