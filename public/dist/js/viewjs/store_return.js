...
$("#Plant_code").bind('change', function () {
  ...
  if(msg=='No Match'){
   ...
   ///  alert(plntCode);
     ...
     $('#appndplantbtn').append('<button type="button"  data-toggle="modal" data-target="#plant_detail" onclick="storereturn.getplantdata(Plantdetailsurl)" class="btn btn-xs btn-info gly-radius" data-original-title="" title="" style="padding: 0px 5px 0px 5px;"> <i class="fa fa-info" aria-hidden="true" style="font-size: 13px;"></i></button>');
  ...
  if(msg=='No Match'){
    ...
    $('#seriesName').val(msg);
     ...
     $('#appndbtn').append('<button type="button"  data-toggle="modal" data-target="#series_detail" onclick="storereturn.getcode(seriesurl)" class="btn btn-xs btn-info gly-radius" data-original-title="" title="" style="padding: 0px 5px 0px 5px;"> <i class="fa fa-info" aria-hidden="true" style="font-size: 13px;"></i></button>');
