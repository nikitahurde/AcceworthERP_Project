...
$("#acc_code").bind('change', function () {
  ...
  if(msg=='No Match'){
     ...
     document.getElementById("accode_err").innerHTML = '';
      ...
      $('#appndplantbtn').append('<button type="button"  data-toggle="modal" data-target="#plant_detail" onclick="gatepasspurchase.getplantdata(Plantdetailsurl)" class="btn btn-xs btn-info gly-radius" data-original-title="" title="" style="padding: 0px 5px 0px 5px;"> <i class="fa fa-info" aria-hidden="true" style="font-size: 13px;"></i></button>');
...
$("#order_no").bind('change', function () {
  var Ordercode =  $(this).val();
  var xyz = $('#orderList option').filter(function() {

    return this.value == Ordercode;
  ...
  if(msg=='No Match'){
     ...
     document.getElementById("order_err").innerHTML = 'The Order No field is required.';
