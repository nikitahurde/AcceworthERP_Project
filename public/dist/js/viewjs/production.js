...
$("#fg_code").bind('change', function () {
  ...
  if(msg=='No Match'){
     ...
     $('#seriesName').val('');
      ...
      document.getElementById("fg_code_errr").innerHTML = 'The Finishing Goods code field is required.';
      $('#Plant_code').prop('readonly',true);
      $('#account_code').prop('readonly',true);
      $('#due_days').prop('readonly',true);
      $('#getSeriesCode').val('');
                ...
                if (data1.response == 'error') {
                  ...
                  $("#plantcityshow").html(data1.data[0].CITY);
                   ...
                   $("#plantcityshow").html('--');
                    ...
                    if(data1.data[0].PIN_CODE){

                  $("#plantpinshow").html(data1.data[0].PIN_CODE);
                    }else{
