...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Top Debitors
            <small>   Top Debitors Details</small>
          </h1>
          <ol class="breadcrumb">
  ...
  <section class="content">
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">Top Debitors</h2>
...
Processing: true,
             ...
             pageLength:'25',
              ...
              buttons: [
                        {
                        extend: 'excelHtml5',
                        title: 'top_debitors_'+curr_date+'_'+curr_time,
                        footer: true
                      }
                        ],
