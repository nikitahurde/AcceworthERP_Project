    ...
    <section class="content">
          ...
          <div class="col-sm-7">
            ...
            <div class="box box-primary Custom-Box">
              ...
              <?php if($button=='Save') { ?>
               ...
               <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Add Master Approve Index</h2>
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">Update Master Approve Index</h2>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="approve_code" value="{{ $approve_code }}" placeholder="Enter Approve Code" maxlength="10" id="bankCodeSearch">
                    ...
                    <div class="form-group">
                      ...
                      <label>Approve Name : <span class="required-field"></span>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="approve_name" value="{{$approve_name}}" placeholder="Enter Approve Name" maxlength="40">
      ...
      <div class="col-sm-3 hideinmobile">
        ...
        <div class="box-tools pull-right">
          ...
          <a href="{{ url('/finance/view-approve-ind-mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Approve Index</a>
