  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/finance/view-cost-category')}}"> Master Employee Wage Type</a></li>



            <li class="Active"><a href="{{ URL('/finance/view-cost-category')}}">View Employee Wage Type </a></li>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Wage Type </h3>
          ...
          <a href="{{ url('/Master/Employee/Emp-Wage-Type-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Wage Type</a>
      ...
      <div class="modal-footer">
        ...
        <form action="#" method="post">
          @csrf
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_WAGE_TYPE">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="GRADE_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="WAGEIND_CODE">
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER EMPLOYEE WAGE TYPE'+$("#headerexcelDt").val(),
                      filename: 'MASTER_EMPLOYEE_WAGE_TYPE'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Employee/View-Emp-Wage-Type-Mast') }}"
       ...
       columns: [
         ...
         { render: function (data, type, full, meta){
             ...
             var rateCode  = full['RATE_CODE'];
             var rateName  = full['RATE_NAME'];
            

             var rateCodeName = rateName+' ['+rateCode+' ]';
         ...
         { data: "LOGIC",className:"text-right" },
         { data: "STATIC",className:"text-right" },
