  ...
  <section class="content-header">
    ...
    <h1> Master Employee  Wage Type <small>Add Details</small></h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="Active"><a href="{{ URL('/finance/tran-tax-mast')}}">Edit Wage Type </a></li>
      </ol>
      ...
      <div class="col-sm-12">
        ...
        <div class="box box-primary Custom-Box">
          ...
          <div class="box-header with-border" style="text-align: center;">
            ...
            <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Update Employee Wage Type</h2>

            <div class="box-tools pull-right">

              <a href="{{ url('/Master/Employee/View-Emp-Wage-Type-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Employee Wage Type</a>
          ...
          <div class="box-body" style="overflow-x: auto;">
            ...
            <form action="{{ url('/Master/Employee/form-emp-wage-type-update') }}" method="POST">
                    ...
                    <div class="col-md-3 TaxCodeMargin">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input list="grade_list"  id="grade_code" name="grade_code" class="form-control  pull-left" value="{{$gradecode}}" placeholder="Select Grade Code" oninput="gradecode(2)" >
                        ...
                        <small id="gradecodeErr" class="form-text text-muted"> 
                      ...
                      <div class="row" style="margin-top: 3%;">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <small class="HeadTextshow" id="HeadText1"><?php  if($key1->WAGEIND_CODE =='CTC'){echo $key1->WAGEIND_NAME;} ?></small>
                              ...
                              <?php 
                                $dataCountRow=count($wagetype_value); 
                                $dataCountRow1 = $dataCountRow+1;
                                $sr=2; 
                                foreach ($wagetype_value as $row){
                              ?>
                              ...
                              <tr>
                                ...
                                <th class="text-center"><?php echo $sr; ?></th>
                                  ...
                                  <td class="row">
                                    ...
                                    <input type="hidden" name="wagetypeId[]" value="{{$row->ID}}">

                                    <div class="input-group col-sm-12">

                                    <input list="wageindicator_list<?php echo $sr; ?>"  id="wageindicator_code<?php echo $sr; ?>" name="wageindicator_code[]" class="form-control  pull-left" onchange="indicator(<?php echo $sr; ?>)" placeholder="Select Wage Indicator" value="<?php if(isset($row->WAGEIND_CODE)){echo $row->WAGEIND_CODE; } ?>" oninput="wageindicator(<?php echo $sr; ?>)">

                                    <datalist id="wageindicator_list<?php echo $sr; ?>">
                                    ...
                                    <input type="hidden" name="wageIndType[]" id="wageIndType<?php echo $sr; ?>" value="<?php if(isset($row->WAGEIND_TYPE)){echo $row->WAGEIND_TYPE; } ?>">

                                    <small id="wageindicatorErr<?php echo $sr; ?>"></small>

                                    <div class="pull-left showSeletedName" id="wageIndicatorText2"></div>
                                  ...
                                  <td>
                                    ...
                                    <input list="rate_list"  id="rate_code<?php echo $sr; ?>" name="rate_code[]" class="form-control" placeholder="---Select Rate Code---" value="<?php if(isset($row->RATE_CODE)){echo $row->RATE_CODE; } ?>" oninput="ratecode(<?php echo $sr; ?>)">
                                    ...
                                    <input type="hidden" name="rate_name[]" id="rate_name<?php echo $sr; ?>" value="{{$row->RATE_NAME}}">
                                  ...
                                  <td>
                                    ...
                                    <input type="text" name="rate[]" class="form-control  pull-left" id="rate<?php echo $sr; ?>" oninput="removerateval(<?php echo $sr; ?>)"placeholder="Rate" oninput="ratevalidate(<?php echo $sr; ?>)" value="<?php echo $row->RATE; ?>">
                                      <small id="rateErr<?php echo $sr; ?>">
                                      </small>
                                  ...
                                  <td>
                                    ...
                                    <input type="text" name="logic[]" class="form-control  pull-left"  id="logic<?php echo $sr; ?>"  placeholder="Logic" onclick="funSelLogic(<?php echo $sr; ?>)"  autocomplete="off"  value="<?php echo $row->LOGIC; ?>">

                                    <small id="logicErr<?php echo $sr; ?>">
                                    </small>

                                    <input type="hidden" id="lastLogincRow" value="<?php echo $dataCountRow1; ?>">
                                  </td>
                                  ...
                                  <td>
                                    ...
                                    <option value="1" <?php if(isset($row->STATIC) && $row->STATIC == 1 ){echo 'selected'; } ?>>Yes</option>

                                    <option value="0" <?php if(isset($row->STATIC) && $row->STATIC == 0 ){echo 'selected'; } ?>>No</option>
                                  ...
                                  <td>
                                    ...
                                    <select class="form-control" id="monOrYr" name="monOrYr[]" >
                                    <option value="Monthly" <?php if(isset($row->MONTH_OR_YEAR) && $row->MONTH_OR_YEAR == 'Monthly' ){echo 'selected'; } ?>>Monthly</option>

                                    <option value="Quarterly" <?php if(isset($row->MONTH_OR_YEAR) && $row->MONTH_OR_YEAR == 'Quarterly' ){echo 'selected'; } ?>>Quarterly</option>

                                    <option value="Half Year" <?php if(isset($row->MONTH_OR_YEAR) && $row->MONTH_OR_YEAR == 'Half Year' ){echo 'selected'; } ?>>Half Year</option>

                                    <option value="Yearly" <?php if(isset($row->MONTH_OR_YEAR) && $row->MONTH_OR_YEAR == 'Yearly' ){echo 'selected'; } ?>>Yearly</option>
                                ...
                                $dataCount=count($wagetype_value);

                                $dataSr=$dataCount+2;

                                $dataRow=20;

                                $getRow=$dataRow-$dataCount-1;
                                ...
                                <tr>
                                  ...
                                  <th class="text-center"><?php echo $dataSr; ?></th>
                                  <td class="row">
                                      
                                    <div class="input-group col-sm-12">

                                    <input list="wageindicator_list<?php echo $dataSr; ?>"  id="wageindicator_code<?php echo $dataSr; ?>" name="wageindicator_code_new[]" class="form-control  pull-left" value=""onchange="indicator(<?php echo $dataSr; ?>)" placeholder="Select Wage Indicator" disabled oninput="wageindicator(<?php echo $dataSr; ?>)">
                                  ...
                                  <td>
                                    ...
                                    <div class="input-group">
                                    <input list="rate_list"  id="rate_code<?php echo $dataSr; ?>" name="rate_code_new[]" class="form-control" placeholder="---Select Rate Code---" oninput="ratecodenew(<?php echo $dataSr; ?>)">
                                    ...
                                    <datalist id="rate_list">
                                      ...
                                      <option value="{{ $rows->RATE_VALUE }}" ><?php echo $rows->RATE_VALUE; ?> = <?php echo $rows->RATE_NAME ?> </option>

                                      @endforeach

                                    </datalist>

                                    <input type="hidden" name="rate_name_new[]" id="rate_name_new<?php echo $dataSr; ?>" value="">
                                  ...
                                  <td>
                                    ...
                                    <input type="text" name="rate_new[]" class="form-control  pull-left" id="rate<?php echo $dataSr; ?>"value="" oninput="removerateval(<?php echo $dataSr; ?>)"placeholder="Rate" oninput="ratevalidate(<?php echo $dataSr; ?>)" disabled>
                                  ...
                                  <td>
                                    ...
                                    <input type="text" name="logic_new[]" class="form-control  pull-left"  id="logic<?php echo $dataSr; ?>" value="" placeholder="Logic"onclick="funSelLogic(<?php echo $dataSr; ?>)"  oninput="removelogicval(<?php echo $dataSr; ?>)"  disabled>
                                  ...
                                  <td>
                                     <select class="form-control" id="static<?php echo $dataSr; ?>" name="static_new[]">
                                  ...
                                  <td>
                                     <select class="form-control" id="monthOrYr<?php echo $dataSr; ?>" name="monOrYr_new[]">
                        ...
                        <div style="text-align: center;">
                          ...
                          <button type="submit" class="btn btn-primary submitbtnC"  style="margin-left: 10%;" id="submitbtn"><i class="fa fa-floppy-o" aria-hidden="true"></i> &nbsp;&nbsp;Update</button>
...
$(document).ready(function(){
  ...
  var getVal = $('#lastLogincRow').val();

  var nextid = parseInt(getVal)+parseInt(1);
...
$('#rowIdUn').val(srno);
  ...
  var tableData = '<div class="form-check">'+
        ...
        '<label class="form-check-label" for="check1" style="padding-left:10px;">' +wagecode[p]+'</label>'+
        '</div>';
...
function wageindicator(idindicator){

  var indicatorId =   $('#wageindicator_code'+idindicator).val();

  if(indicatorId){

   $('#rateErr'+idindicator).html('');

    $('#rate'+idindicator).prop('disabled', false);

   }else{

    $('#rateErr'+idindicator).html('Required');
   }
}
...
function ratecode(ratecodeId){
  ...
  var xyzInd = $('#rate_list option').filter(function() {
...
function ratecodenew(rate_id){
  console.log('id',rate_id);

  var ratecode =   $('#rate_code'+rate_id).val();
  ...
  if(msgInd=='No Match'){
    ...
    $('#rate_name_new'+rate_id).val('');
    $('#rate_code'+rate_id).val('');
     

  }else{

    $('#rate_name_new'+rate_id).val(msgInd);
...
function indicator(headid){
  ...
  console.log('wageindicator_code',wageindicator_code);
  ...
  $.ajax({
    ...
    if (obj.response == 'error') {
      ...
      if(obj.data==''){
        ...
        $('#wageIndType'+headid).val(obj.data.wageindicator_type);
      }
...
function checkvalidation(){
  ...
  if(gradecode == ''){
    ...
    $('#showAllErrMsg').html('<div class="alert alert-danger alert-dismissible" role="alert"><strong>Error ...!</strong> Grade Code Are Required.<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
     return false;
  }

  for(var q=2;q<=15;q++){

    var headamt = $('#wageindicator_code'+q).val();
      
    var logic =  $('#logic'+q).val();
    ...
    var wageIndi =  $('#wageindicator_code'+q).val();
    
    var wageIndi_err =  $('#wageindicatorErr'+q).html();
    ...
    if(error == 0 || error == 2 || error == 3 ){
      ...
      $('#showAllErrMsg').html('<div class="alert alert-danger alert-dismissible" role="alert"><strong>Error ...!</strong>  Fields Are Required.<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
