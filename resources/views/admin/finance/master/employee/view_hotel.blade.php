...
<style type="text/css">
  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <h1>Master Hotel<small>View Details</small></h1>
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/Master/Hotel/View-Emp-Hotel-Mast')}}">Master Hotel</a></li>

            <li class="Active"><a href="{{ URL('/Master/Hotel/View-Emp-Hotel-Mast')}}">View Hotel </a></li>
          ...
          <div class="col-xs-12">
            ...
            <div class="box box-primary Custom-Box">
              ...
              <div class="box-header with-border" style="text-align: center;">
                ...
                <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Hotel </h3>

                <div class="box-tools pull-right">

                  <a href="{{ url('/Master/Hotel/Emp-Hotel-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Hotel</a>
...
<div class="modal fade" id="hotelDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form action="#" method="post">
         ...
         <input type="hidden" name="AssetViewLink" id="AssetViewLink" value="Master/Hotel/View-Emp-Hotel-Mast">
         
         <input type="hidden" name="tblName" id="tblName" value="MASTER_HOTEL">
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER EMPLOYEE HOTEL'+$("#headerexcelDt").val(),
                      filename: 'MASTER_EMPLOYEE_HOTEL_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Hotel/View-Emp-Hotel-Mast') }}"
       ...
       columns: [
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['HOTEL_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['HOTEL_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['ID']+'" value="'+full['ID']+'"><a href="Edit-Emp-Hotel/'+btoa(full['ID'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getId(\''+full['ID']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
