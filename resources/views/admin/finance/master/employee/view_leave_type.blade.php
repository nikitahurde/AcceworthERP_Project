  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/finance/view-cost-category')}}">Master Employee Leave Type</a></li>



            <li class="Active"><a href="{{ URL('/finance/view-cost-category')}}">View Employee Leave Type </a></li>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Leave Type </h3>
          ...
          <a href="{{ url('/Master/Employee/Emp-leaveType-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Leave Type</a>
...
<div class="modal fade" id="leaveTypeDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-footer">
       <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal" style="margin-right: 23%;">Cancel</button>
          <form action="#" method="post">
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_LEAVETYPE">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            
            <input type="hidden" name="colName" id="colName" value="LEAVE_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="LEAVE_NAME">
    ...
    var t = $("#example").DataTable({
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER EMPLOYEE LEAVE TYPE'+$("#headerexcelDt").val(),
                      filename: 'MASTER_EMPLOYEE_LEAVE_TYPE_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Employee/View-Emp-leaveType-Mast') }}"
       ...
       columns: [
         ...
         { data:"LEAVE_CODE",className:"text-left"},
         { data:"LEAVE_NAME",className:"text-left"},
        
         // { render: function (data, type, full, meta){
             
         //     var leaveCode  = full['LEAVE_CODE'];
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['LEAVE_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['LEAVE_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['LEAVE_CODE']+'" value="'+full['LEAVE_CODE']+'"><a href="Edit-Emp-leaveType-Mast/'+btoa(full['LEAVE_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getId(\''+full['LEAVE_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
...
function funDelData(){
 ...
 $.ajaxSetup({
  ...
  function getId(tblId,rowId)
  {
    ...
    $("#leaveTypeDelete").modal('show');


    $("#leavetype").val(getval);
