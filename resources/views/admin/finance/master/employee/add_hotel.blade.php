...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
       ...
       <li class="Active"><a href="{{ URL('/Master/ModeOfTransport/Emp-Mode-of-Transport-Mast')}}">Master Hotel</a></li>

       <li class="Active"><a href="{{ URL('/Master/ModeOfTransport/Emp-Mode-of-Transport-Mast')}}">Add Hotel </a></li>

       <?php } else { ?>

       <li class="Active"><a href="#">Master Hotel </a></li>

       <li class="Active"><a href="#">Update Master Hotel </a></li>
        ...
        <div class="box box-primary Custom-Box">
          ...
          <div class="box-header with-border" style="text-align: center;">
            ...
            <?php if($button=='Save') { ?>
               ...
               <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Add Hotel Master</h2>
              
               <?php } else{  ?>

               <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Update Hotel Master</h2>
          ...
          <div class="box-body">
                  ...
                  <div class="col-md-4">
                   ...
                   <div class="form-group">
                    ...
                    <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="hotel" value="{{ $hotel }}" placeholder="Hotel" id="hotel" autocomplete="off">
                    </div>

                    <small id="emailHelp" class="form-text text-muted">

                    {!! $errors->first('hotel', '<p class="help-block" style="color:red;">:message</p>') !!}
            ...
            <div class="row">
             ...
             <div class="col-md-6">
              ...
              <label> Hotel Block :</label>

              <div class="input-group">

                <input type="radio" class="form-check-input" name="hotel_block" value="YES" <?php if($hotel_block=='YES'){ echo 'checked';} else{ echo '';} ?>>&nbsp;&nbsp;<label class="form-check-label" for="radio1">YES</label>&nbsp;&nbsp;&nbsp;


                <input type="radio" class="form-check-input" name="hotel_block" value="NO" <?php if($hotel_block=='NO'){ echo 'checked';} else{ echo '';} ?> >&nbsp;&nbsp;&nbsp;<label class="form-check-label" for="radio1">NO</label>
    ...
    <div class="col-sm-3">
      ...
      <div class="box-tools pull-right">
       ...
       <a href="{{ url('/Master/Hotel/View-Emp-Hotel-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Hotel</a>
