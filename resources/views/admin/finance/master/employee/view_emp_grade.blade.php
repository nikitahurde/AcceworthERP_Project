  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/Master/Employee/View-Emp-Grade-Mast')}}">Master Employee Grade</a></li>



            <li class="Active"><a href="{{ URL('/Master/Employee/View-Emp-Grade-Mast')}}">View Employee Grade </a></li>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Employee Grade </h3>
          ...
          <a href="{{ url('/Master/Employee/Emp-Grade-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Emp. Grade</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form action="#" method="post">
          ...
          <input type="hidden" name="tblName" id="tblName" value="MASTER_GRADE">
          
          <input type="hidden" name="colName" id="colName" value="GRADE_CODE">
          <input type="hidden" name="colNameTwo" id="colNameTwo" value="GRADE_NAME">
    ...
    var t = $("#example").DataTable({
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER EMPLOYEE GRADE'+$("#headerexcelDt").val(),
                      filename: 'MASTER_EMPLOYEE_GRADE_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Employee/View-Emp-Grade-Mast') }}"
       ...
       columns: [
         ...
         { data:"GRADE_CODE",className:"text-center"},
         { data:"GRADE_NAME",className:"text-center"},
         ...
         //     var gradeCodeName = gradeCode+' ['+gradeName+' ]';
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['GRADE_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['GRADE_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['DT_RowIndex']+'" value="'+full['GRADE_CODE']+'"><a href="Edit-Emp-Grade/'+btoa(full['GRADE_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getId(\''+full['GRADE_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
