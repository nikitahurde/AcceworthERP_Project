  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/finance/view-cost-category')}}"> Employee Leave Quota</a></li>



            <li class="Active"><a href="{{ URL('/finance/view-cost-category')}}">View Employee Leave Quota </a></li>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Leave Quota </h3>
          ...
          <a href="{{ url('/Master/Employee/Emp-leave-Quota-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Leave Quota</a>
...
<div class="modal fade" id="leaveQuotaDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal" style="margin-right: 23%;">Cancel</button>
          ...
          <form action="#" method="post">
           @csrf
            ...
            <input type="hidden" name="leavequota" id="leavequota" value="">

            <input type="hidden" name="AssetViewLink" id="AssetViewLink" value="Master/Asset/View-Asset-Group">

            <input type="hidden" name="tblName" id="tblName" value="MASTER_EMPLEAVEQUOTA">
            ...
            <input type="hidden" name="colNameFour" id="colNameFour" value="LEAVE_TYPE">

            <input type="hidden" name="colNameFive" id="colNameFive" value="LEAVE_NAME">
    ...
    var t = $("#example").DataTable({
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER EMPLOYEE LEAVE QUOTA'+$("#headerexcelDt").val(),
                      filename: 'MASTER_EMPLOYEE_LEAVE_QUOTA_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Employee/View-Emp-leave-Quota-Mast') }}"
       ...
       columns: [
         ...
         //     var leaveCode  = full['LEAVE_TYPE'];
         //     var leaveName  = full['LEAVE_NAME'];
            

         //     var leaveCodeName = leaveName+' ['+leaveCode+' ]';

         //     return  leaveCodeName;


         //    }
         //  },
         { data: "YROPEN",className:"text-right"},
         { data: "YRADD",className:"text-right" },
         { data: "YRDEDUCTION",className:"text-right" },
         { data: "YROPBAL",className:"text-right" },
         
        
         { render: function (data, type, full, meta){


                  if(full['LEAVEQUOTA_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['LEAVEQUOTA_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['ID']+'" value="'+full['ID']+'"><a href="Edit-Emp-leave-Quota-Mast/'+btoa(full['ID'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getId(\''+full['ID']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
...
<script type="text/javascript">
 ...
 $.ajaxSetup({
  ...
  function getId(tblId,rowId)
  {
    ...
    $("#leaveQuotaDelete").modal('show');

    $("#leavequota").val(getval);
