  ...
  <section class="content-header">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">
          ...
          <a href="{{ url('/finance/form-transaction-mast') }}"> Employee Pay Master</a>

        </li>
        <li class="active">

          <a href="{{ url('/finance/form-transaction-mast') }}"> Update Employee Pay Master</a>
      ...
      <div class="col-sm-12">
        ...
        <div class="box box-primary Custom-Box">
          ...
          <div class="box-header with-border" style="text-align: center;">
            ...
            <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Update Employee Pay Master</h2>
                  ...
                  <div class="panel-body">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane fade in active" id="tab1info">
                       ...
                       <form action="{{ url('/Master/Employee/emp-pay-update') }}" method="POST" enctype="multipart/form-data">

                         @csrf
                        <div class="row">
                              <!-- /.col -->
                          <div class="col-md-3">
                            <input type="hidden" value="{{$classData->ID}}" name="emppayid">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control  fydatepicker rightcontent" name="vr_date" id="vr_date"value="{{$classData->DATE}}" onchange="todayDate()">
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input list="emp_list" id="emp_code" name="emp_code" class="form-control  pull-left" value="{{$classData->EMP_CODE}}" placeholder="Employee Code" autocomplete="off" readonly>
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input  id="emp_name" name="emp_name" class="form-control  pull-left" value="{{$classData->EMP_NAME}}" placeholder="Employee Name" autocomplete="off" readonly>
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input  id="emp_grade" name="emp_grade" class="form-control  pull-left" value="{{$classData->GRADE_CODE}}" placeholder="Employee Grade" autocomplete="off" readonly>

                                <input type="hidden" id="grade_name" name="grade_name" value="{{$classData->GRADE_NAME}}">
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input class="form-control" id="plant_code" name="plant_code" placeholder="Select Plant" maxlength="11" value="{{$classData->PLANT_CODE}}" autocomplete="off" oninput="funPlantcode()" readonly>
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input list="profitList"  id="profitcen_code" name="profitcen_code" class="form-control  pull-left" value="{{$classData->PFCT_CODE}}" placeholder="Profit Center Code" readonly>
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input id="desig_code" name="designation" class="form-control  pull-left" value="{{$classData->DESIG_CODE}}" placeholder="Designation"  readonly>
                               

                                <input type="hidden" id="desig_name" name="desig_name" value="{{$classData->DESIG_NAME}}">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" id="from_date" name="from_date" class="form-control  pull-left transdatepicker" value="{{$fromDate}}" placeholder="From Date" onchange="fromdate()" autocomplete="off">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <?php $toDate = date('d-m-Y', strtotime($classData->TO_DATE)); ?>
                                <input type="text" id="to_date" name="to_date" class="form-control  pull-left transdatepicker" value="{{$toDate}}" onchange="todate()" placeholder="To Date" autocomplete="off">
                           ...
                           <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <div class="input-group-addon">
                                   ...
                                   <input type="text" id="basic" name="basic" class="form-control  pull-left" value="{{$classData->CTC}}" placeholder="basic" autocomplete="off" oninput="funbasiccal()" readonly>
                                   </div>
                            ...
                            <div class="col-md-3">
                               ...
                               <label>Emp Pay Block : </label>
                              
                              <div class="input-group">

                                <input type="radio" class="optionsRadios1" name="emppay_block" value="YES" <?php if($classData->EMPPAY_BLOCK=='YES'){ echo 'checked';} else{ echo '';} ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;YES &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                <input type="radio" class="optionsRadios1" name="emppay_block" value="NO" <?php if($classData->EMPPAY_BLOCK== 'NO'){ echo 'checked';} else{ echo '';} ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NO
                            ...
                            <div class="col-md-1">
                             ...
                             <input type="hidden" id="data_count1" class="dataCountCl" value="0" name="data_Count[]">
                              ...
                              <input type="hidden" class="setGrandAmnt" id="get_grand_num1" name="crAmtPerItm[]">
                               ...
                               <button class="btn btn-primary btn-sm" type="button"  id="calbasic" data-toggle="modal" data-target="#cal_basic" onclick="CalculateBasic(1);getStatic();" style="margin-top: 53%;">calc</button>
                  ...
                  if(obj.data ==''){
                      ...
                      $('#basic_rate').empty();
                         ...
                         $.each(obj.data.wagetype_data, function(k, getData) {
                            ...
                            var emppayData = obj.data.emppayData;

                            var payCounter = counter - 1;
                            dataI = datacount;
                            ...
                            if(getData.RATE_CODE == 'M' || getData.RATE_CODE == 'L'){
                              ...
                              var tblfootData = "<button type='button' class='btn btn-primary ' style='width: 10%;' data-dismiss='modal' id='ApplyOkbtn' onclick='OkGetTransVal("+payid+","+dataI+","+countI+",1);'>Ok</button>";
            ...
            success: function (data) {
              ...
              var obj = JSON.parse(data);
                ...
                if (obj.response == 'success') {
                  ...
                  console.log('gradecode',obj.data.GRADE_CODE);
