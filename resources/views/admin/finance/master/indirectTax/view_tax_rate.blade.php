...
<small>View Details</small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/Master/InDirect-Direct-Tax/View-Tax-Rate-Mast') }}">View Tax Rate List</a></li>
...
<h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Tax Rate List</h3>
...
<a href="{{ url('/Master/InDirect-Direct-Tax/Tax-Rate-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Tax Rate</a>
...
<div class="modal fade" id="transtaxDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-sm" role="document">
      ...
      <form action="{{ url('/Master/InDirect-Direct-Tax/Delete-Tax-Rate') }}" method="post">
      ...
      @csrf
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_TAXRATE">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="TAX_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="TAX_TYPE">
   ...
   $(document).ready(function(){
    ...
    var t = $("#trantaxMast").DataTable({
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER TAX RATE'+$("#headerexcelDt").val(),
                      filename: 'MASTER_TAX_RATE_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/InDirect-Direct-Tax/View-Tax-Rate-Mast') }}"
       ...
       columns: [
         ...
         { data: "TAX_CODE",className:"text-center"},
         { data: "TAX_NAME",className:"text-center"},
         {  
            render: function (data, type, full, meta){

                      var enableBtn = 'enable';
                      var deletebtn ='<a href="Edit-Tax-Rate/'+btoa(full['TAX_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return deleteTaxRate(\''+full['TAX_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
...
<script type="text/javascript">
 ...
 var AssetCode  = $("#trantaxdelid").val();
 ...
 $.ajaxSetup({
  ...
  function deleteTaxRate(id,rowId){
      //console.log(id);
