...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/Master/InDirect-Direct-Tax/Tax-Indicator-Mast')}}">Master Tax Indicator</a></li>

            <li class="Active"><a href="{{ URL('/Master/InDirect-Direct-Tax/Tax-Indicator-Mast')}}">Add Tax Indicator </a></li>
      ...
      <div class="col-sm-7">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Add Master Tax Indicator</h2>
          ...
          <div class="box-body">
            ...
            <form action="{{ url('Master/InDirect-Direct-Tax/Tax-Indicator-Save') }}" method="POST" >
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control codeCapital" id="tax_ind_code" name="tax_ind_code" value="{{old('tax_ind_code')}}" placeholder="Enter Tax Indicator Code" maxlength="4" autocomplete="off">
                          ...
                          <span class="input-group-addon" style="padding: 1px 7px;">
                            ...
                            <div id="myForm" class="hide">
                                ...
                                <div id="result">
                                <table class="table table-bordered" style="margin-top: 3%;width:160px;" id="HideWhenSearch">
                                  <thead>
                                    <tr>
                                     <th class="nameheading">Tax Ind Code</th>
                                     <th class="nameheading">Tax Ind Name</th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                    <?php foreach ($help_tax_ind_list as $key) { ?>

                                      <tr>
                                        <td class="setetxtintd"><?php echo $key->TAXIND_CODE; ?></td>
                                        <td class="setetxtintd"><?php echo $key->TAXIND_NAME; ?></td>
                                      </tr>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="tax_ind_name" value="{{old('tax_ind_name')}}" placeholder="Enter Tax Indicator Name" maxlength="40" autocomplete="off">
                          ...
                          $('#errorItem').html('');
                           ...
                           var objcity = data1.data;
                             ...
                             $.each(objcity, function (i, objcity) {
                               $('#ShowWhenSeaech').append('<tr><th>Tax Code</th><th>Tax Name</th></tr><tr><td style="font-size: 12px;padding-top: 2%;padding-bottom: 2%;">'+objcity.TAXIND_CODE+'</td><td style="font-size: 12px;padding-top: 2%;padding-bottom: 2%;">'+objcity.TAXIND_NAME+'</td></tr>');
                             });
                      }
                 }
