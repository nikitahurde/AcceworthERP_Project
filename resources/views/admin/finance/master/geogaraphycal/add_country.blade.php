...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/master/geogaraphycal/country-master')}}">Add Country </a></li>
      ...
      <div class="col-sm-12">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Add Country</h2>
            ...
            <div class="box-body">
              ...
              <form action="{{ url('/master/geogaraphycal/country-master-save') }}" method="POST" id="CountryForm">
                        ...
                        <div class="col-sm-4">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="country_code" id="countryCode" value="{{old('country_code')}}" placeholder="Enter Country Code" maxlength="20">
                        ...
                        <div class="col-sm-4">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="country_name" id="countryName" value="{{old('country_name')}}" placeholder="Enter Country Name" maxlength="20">
