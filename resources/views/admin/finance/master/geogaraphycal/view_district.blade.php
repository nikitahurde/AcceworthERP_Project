...
<style type="text/css">
  ...
  <div class="content-wrapper">
       ...
       <section class="content-header">
          ...
          <h1>  Master District<small> View Details</small> </h1>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/master/geogaraphycal/view-district-master') }}">Master District</a></li>

            <li class="active"><a href="{{ url('/master/geogaraphycal/view-district-master') }}">View District</a></li>
        ...
        <div class="row">
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">View District</h3>
              ...
              <a href="{{ url('/master/geogaraphycal/district-master') }}" class="btn btn-primary" style="margin-right: 10px;" id="getPAgeTitleNAme"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add District</a>
 ...
 <div class="modal fade" id="districtDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
       ...
       <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal" style="margin-right: 23%;">Cancel</button>
          ...
          <form action="#" method="post">
            ...
            <!-- <input type="hidden" name="district_id" value="" id="districtId"> -->
            <input type="hidden" name="district_code" value="" id="districtCode">

            <input type="hidden" name="AssetViewLink" id="AssetViewLink" value="Master/Asset/View-Asset-Group">

            <input type="hidden" name="tblName" id="tblName" value="MASTER_DISTRICT">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="DISTRICT_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="DISTRICT_NAME">
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER DISTRICT'+$("#headerexcelDt").val(),
                      filename: 'MASTER_DISTRICT_'+$("#headerexcelDt").val(),
                    }
                  ],

       ajax:{

        url : "{{ url('/master/geogaraphycal/view-district-master') }}"
       ...
       columns: [
         ...
         { data: "STATE_NAME" },
          ...
          { render: function (data, type, full, meta){
            ...
            if(full['DISTRICT_BLOCK']=='NO'){

                return '<span class="label label-success">Active</span>';

              }else if(full['DISTRICT_BLOCK']=='YES'){
          ...
          {  
            ...
            render: function (data, type, full, meta){
                ...
                var deletebtn ='<a href="edit-district-master/'+btoa(full['ID'])+'/'+btoa(full['DISTRICT_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return deleteDistrict(\''+full['ID']+'\',\''+full['DISTRICT_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
...
function funDelData(){
 ...
 var AssetCode  = $("#districtCode").val();
 ...
 $.ajaxSetup({
  ...
  function deleteDistrict(tblId,district_code,rowId){
    ...
    $('#delText').html('<div class="col-md-12 "><div class="form-group"><label>Remarks : <span class="required-field"></span></label><textarea class="form-control" id="del_remark" name="del_remark'+rowId+'" rows="2" oninput="deleteRemark()"></textarea></div></div>');
     ...
     $('#districtDelete').modal('show');

     // $('#districtId').val(tblId);
     $('#districtCode').val(district_code);
