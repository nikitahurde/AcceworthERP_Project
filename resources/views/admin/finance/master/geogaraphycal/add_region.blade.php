...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/master/geogaraphycal/region-master')}}">Add Region </a></li>
      ...
      <div class="col-sm-12">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-body">
              ...
              <form action="{{ url('/master/geogaraphycal/region-master-save') }}" method="POST" id="CountryForm">
                        ...
                        <div class="col-sm-4">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="region_code" id="regionCode" value="{{old('region_code')}}" placeholder="Enter Region Code" maxlength="20" autocomplete="off">
                        ...
                        <div class="col-sm-4">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="region_name" id="regionName" value="{{old('region_name')}}" placeholder="Enter Region Name" maxlength="20" autocomplete="off">
