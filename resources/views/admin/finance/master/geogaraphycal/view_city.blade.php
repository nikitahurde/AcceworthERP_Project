...
<style type="text/css">
  ...
  <div class="content-wrapper">
       ...
       <section class="content-header">
          ...
          <h1>  Master City<small> View Details</small> </h1>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/master/geogaraphycal/view-district-master') }}">Master City</a></li>

            <li class="active"><a href="{{ url('/master/geogaraphycal/view-district-master') }}">View City</a></li>
        ...
        <div class="row">
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">View City</h3>
              ...
              <a href="{{ url('/master/geogaraphycal/city-master') }}" class="btn btn-primary" style="margin-right: 10px;" id="getPAgeTitleNAme"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add City</a>
 ...
 <div class="modal fade" id="districtCity" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
       ...
       <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal" style="margin-right: 23%;">Cancel</button>
          ...
          <form action="#" method="post">
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_CITY">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="CITY_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="CITY_NAME">
        ...
        buttons:  [
                    {
                      ...
                      title: ' MASTER CITY '+$("#headerexcelDt").val(),
                      filename: 'MASTER_CITY_'+$("#headerexcelDt").val(),
                    }
                  ],

       ajax:{

        url : "{{ url('/master/geogaraphycal/view-city-master') }}"
         ...
         { data: "DIST_NAME" },
          ...
          {  
            ...
            render: function (data, type, full, meta){
                ...
                var deletebtn ='<a href="edit-city-master/'+btoa(full['CITY_CODE'])+'/'+btoa(full['CITY_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return deleteCity(\''+full['CITY_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
...
function funDelData(){
 ...
 $.ajaxSetup({
  ...
  function deleteCity(city_code,rowId){
