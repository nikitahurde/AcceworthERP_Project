...
<style type="text/css">
  ...
  <div class="content-wrapper">
       ...
       <section class="content-header">
          ...
          <h1> Region Master <small> View Details</small> </h1>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/master/geogaraphycal/view-region-master') }}">Master Region</a></li>

            <li class="active"><a href="{{ url('/master/geogaraphycal/view-region-master') }}">View Region</a></li>
        ...
        <div class="row">
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">View Region</h3>
              ...
              <a href="{{ url('/master/geogaraphycal/region-master') }}" class="btn btn-primary" style="margin-right: 10px;" id="getPAgeTitleNAme"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Region</a>
 ...
 <div class="modal fade" id="regionDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-sm" role="document">
      ...
      @csrf
            ...
            <input type="hidden" name="region_code" value="" id="regionCode">


            <input type="hidden" name="AssetViewLink" id="AssetViewLink" value="Master/Asset/View-Asset-Group">

            <input type="hidden" name="tblName" id="tblName" value="MASTER_REGION">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="REGION_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="REGION_NAME">
    ...
    var t = $("#example").DataTable({
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER REGION'+$("#headerexcelDt").val(),
                      filename: 'MASTER_REGION_'+$("#headerexcelDt").val(),
                    }
                  ],

       ajax:{

        url : "{{ url('/master/geogaraphycal/view-region-master') }}"
       ...
       columns: [
         ...
         //    var state_code = full['STATE_CODE'];
         //    var state_name = full['STATE_NAME'];
         //    var statename = state_name + ' [ '+ state_code + ' ]';
         //    return statename;
         ...
         // },
          ...
          { render: function (data, type, full, meta){
            ...
            if(full['REGION_BLOK']=='NO'){

                return '<span class="label label-success">Active</span>';

              }else if(full['REGION_BLOK']=='YES'){
          ...
          {  
            ...
            render: function (data, type, full, meta){
                ...
                var deletebtn ='<a href="edit-region-master/'+btoa(full['ID'])+'/'+btoa(full['REGION_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return deleteRegion(\''+full['ID']+'\',\''+full['REGION_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
...
<script type="text/javascript">
 ...
 $.ajaxSetup({
  ...
  function deleteRegion(tblId,region_code,rowId){
