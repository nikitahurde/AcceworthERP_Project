...
<style type="text/css">
  ...
  <div class="content-wrapper">
       ...
       <section class="content-header">
          ...
          <h1> Country Master <small> View Details</small> </h1>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/master/geogaraphycal/view-country-master') }}">Master Country</a></li>

            <li class="active"><a href="{{ url('/master/geogaraphycal/view-country-master') }}">View Country</a></li>
        ...
        <div class="row">
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">View Country</h3>
              ...
              <a href="{{ url('/master/geogaraphycal/country-master') }}" class="btn btn-primary" style="margin-right: 10px;" id="getPAgeTitleNAme"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Country</a>
 ...
 <div class="modal fade" id="contryDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-sm" role="document">
      ...
      @csrf
            ...
            <input type="hidden" name="country_code" value="" id="countryCode">

            <input type="hidden" name="AssetViewLink" id="AssetViewLink" value="Master/Asset/View-Asset-Group">

            <input type="hidden" name="tblName" id="tblName" value="MASTER_COUNTRY">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="COUNTRY_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="COUNTRY_NAME">
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER COUNTRY MASTER '+$("#headerexcelDt").val(),
                      filename: 'MASTER_COUNTRY_'+$("#headerexcelDt").val(),
                    }
                  ],

       ajax:{

        url : "{{ url('/master/geogaraphycal/view-country-master') }}"
       ...
       columns: [
         ...
         { data: "COUNTRY_NAME" },
          ...
          { render: function (data, type, full, meta){
            ...
            if(full['COUNTRY_BLOK']=='NO'){

                return '<span class="label label-success">Active</span>';

              }else if(full['COUNTRY_BLOK']=='YES'){
          ...
          {  
            ...
            render: function (data, type, full, meta){
                ...
                var deletebtn ='<a href="edit-country-master/'+btoa(full['ID'])+'/'+btoa(full['COUNTRY_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return deleteHsn(\''+full['ID']+'\',\''+full['COUNTRY_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
...
function funDelData(){
 ...
 $.ajaxSetup({
  ...
  function deleteHsn(tblId,country_code,rowId){
