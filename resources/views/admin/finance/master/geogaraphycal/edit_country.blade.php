...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/master/geogaraphycal/country-master')}}">Geographical   </a></li>



            <li class="Active"><a href="{{ URL('/master/geogaraphycal/country-master')}}">Update Country </a></li>
      ...
      <div class="col-sm-12">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Update Country</h2>

               <div class="box-tools pull-right">

                <a href="{{ url('/master/geogaraphycal/view-country-master') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Country</a>
            ...
            <div class="box-body">
              ...
              <form action="{{ url('/master/geogaraphycal/country-master-update') }}" method="POST" id="CountryForm">
                        ...
                        <div class="col-sm-4">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="country_code" id="countryCode" value="{{$country_list->COUNTRY_CODE}}" placeholder="Enter Country Code" readonly maxlength="20">

                                <input type="hidden" name="countryId" value="{{$country_list->ID}}">
                        ...
                        <div class="col-sm-4">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="country_name" id="countryName" value="{{$country_list->COUNTRY_NAME}}" placeholder="Enter Country Name" maxlength="20">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="radio" class="optionsRadios1" name="country_block" value="YES"<?php if($country_list->COUNTRY_BLOK=='YES'){ echo 'checked';} else{ echo '';} ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;YES &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                <input type="radio" class="optionsRadios1" name="country_block" value="NO"<?php if($country_list->COUNTRY_BLOK=='NO'){ echo 'checked';} else{ echo '';} ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NO
