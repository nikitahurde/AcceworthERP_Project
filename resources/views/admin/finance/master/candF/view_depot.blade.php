...
<div class="modal fade" id="depotDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <form action="#" method="post">
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_DEPOT">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="DEPOT_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="CONTACT_PERSON">
            <input type="hidden" name="colNameThree" id="colNameThree" value="CONTACT_NO">
            <input type="hidden" name="colNameFour" id="colNameFour" value="CONTACT_EMAIL">
    ...
    var t = $("#example").DataTable({
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER DEPOT'+$("#headerexcelDt").val(),
                      filename: 'MASTER_DEPOT_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/view-mast-depot') }}"
       ...
       columns: [
         ...
         { data: "DEPOT_CODE"},
         { data: "DEPOT_NAME"},
         { data: "CONTACT_PERSON",className:"text-right"},
         { data: "CONTACT_EMAIL"},
         { data: "ADD1" },
         { data: "ADD2" },
         { data: "ADD3" },
         ...
         { data: "STATE_CODE" },
         { data: "CITY_CODE" },
         { data: "PIN_CODE",className:"text-right"},
         { render: function (data, type, full, meta){


                  if(full['BLOCK_DEPOT']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['BLOCK_DEPOT']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<a href="edit-depot/'+btoa(full['DEPOT_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return deleteDepot(\''+full['DEPOT_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
