  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/Master/other/View-Department-Mast')}}">Master Department </a></li>



            <li class="Active"><a href="{{ URL('/Master/other/View-Department-Mast')}}">View Department </a></li>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;">View Department</h3>
          ...
          <a href="{{ url('/Master/other/Department-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Department</a>
...
<div class="modal fade" id="deptDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog modal-sm" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <i class="fa fa-caret-right"></i>You Want To Delete This Department Data...!
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal" style="margin-right: 23%;">Cancel</button>
          ...
          <form action="{{ url('Master/other/Delete-Department') }}" method="post">
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_DEPT">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="DEPT_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="DEPT_NAME">
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER DEPARTMENT'+$("#headerexcelDt").val(),
                      filename: 'MASTER_DEPARTMENT_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/other/View-Department-Mast') }}"
       ...
       columns: [
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['DEPT_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['DEPT_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['DEPT_CODE']+'" value="'+full['DEPT_CODE']+'"><a href="Edit-Department-Mast/'+btoa(full['DEPT_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getId(\''+full['DEPT_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
...
function funDelData(){
 ...
 $.ajaxSetup({
  ...
  function getId(deptcode,rowId)
  {

    var getval = $('#deleteinput_'+deptcode).val();
