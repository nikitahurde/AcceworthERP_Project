                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <span class="input-group-addon"><i class="fa fa-sort-numeric-asc" aria-hidden="true"></i></span>
                           ...
                           <input type="text" class="form-control" name="rack_code" value="{{ $rack_code }}" placeholder="Enter Rack Code" maxlength="20" id="RackSearch">
                           ...
                           <span class="input-group-addon" style="padding: 5px 7px;">
                            ...
                            <div id="myForm" class="hide">
                                 <div class="row">
                                      <div class="col-md-9">
                                        <input type="text" name="GlmstnameH" id="rackCodeH" class="form-control input-md setheightinput" style="text-transform: uppercase;">
                                      </div>
                                ...
                                <table class="table table-bordered" style="margin-top: 3%;" id="HideWhenSearch">
                                  <thead>
                                    <tr>
                                     <th class="nameheading">Rack Code</th>
                                     <th class="nameheading">Rack Name</th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                    <?php foreach ($RackM_lists as $key) { ?>

                                      <tr>
                                        <td class="setetxtintd"><?php echo $key->rack_code; ?></td>
                                        <td class="setetxtintd"><?php echo $key->rack_name; ?></td>
                                      </tr>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="rack_name" value="{{ $rack_name }}" placeholder="Enter Rack Name" maxlength="40">
                 ...
                 <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="radio" class="optionsRadios1" name="rack_block" value="1" <?php if($rack_block=='1'){ echo 'checked';} else{ echo '';} ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;YES &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                          <input type="radio" class="optionsRadios1" name="rack_block" value="0" <?php if($rack_block=='0'){ echo 'checked';} else{ echo '';} ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NO
...
<script type="text/javascript">
 $(function(){
    $('#login').popover({
        ...
        placement: 'bottom',
        title: 'Help Rack Code <a  class="btn btn-default btn-xs pull-right" style="margin-top: -1%;" id="closeModel">X</a>',
        html:true,
        content:  $('#myForm').html()
    }).on('click', function(){
          ...
          var rackCodeH = $('#rackCodeH').val();
           ...
           if(rackCodeH == ''){
              ...
              $.ajax({
                ...
                url:"{{ url('help-rackcode-getdata') }}",

                 method : "POST",

                 type: "JSON",

                 data: {rackCodeH: rackCodeH},
                 ...
                 success:function(data){
                      ...
                      if (data1.response == 'error') {
                          ...
                          $('#errorItem').html("<p style='color:red;font-size: 11px;padding-top: 2%;'>Rack Code Not Found...!</p>");
                          ...
                          $('#errorItem').html('');
                           ...
                           var objcity = data1.data;
                             ...
                             $.each(objcity, function (i, objcity) {
                               $('#ShowWhenSeaech').append('<tr><td style="font-size: 12px;padding-top: 2%;padding-bottom: 2%;">'+objcity.rack_code+'</td><td style="font-size: 12px;padding-top: 2%;padding-bottom: 2%;">'+objcity.rack_name+'</td></tr>');
                             });
                      }
                 }
    ...
    $('#RackSearch').on('keyup',function(){
      ...
      var RackSearch = $('#RackSearch').val();
       ...
       $.ajax({
            ...
            url:"{{ url('serach-rack-code-getdata') }}",

             method : "POST",

             type: "JSON",

             data: {RackSearch: RackSearch},
