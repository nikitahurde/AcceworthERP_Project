...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>Master Seasonal<small>View Details</small></h1>
            ...
            <table id="example" class="table table-bordered table-striped table-hover">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <th class="text-center">Seasonal Code </th>
                  <th class="text-center">Seasonal Name </th>
                  <th class="text-center">Item Code</th>
                  <th class="text-center">Item Name</th>
                  <th class="text-center">From Date</th>
                  <th class="text-center">Middle Date</th>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <form action="{{ url('/Master/ColdStorage/Delete-Seasonal') }}" method="post">
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_SEASONAL">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="SEASONAL_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="SEASONAL_NAME">
            <input type="hidden" name="colNameThree" id="colNameThree" value="ITEM_CODE">
            <input type="hidden" name="colNameFour" id="colNameFour" value="ITEM_NAME">
    ...
    var t = $("#example").DataTable({
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: ' MASTER SEASONAL'+$("#headerexcelDt").val(),
                      filename: 'MASTER_SEASONAL_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{
       ...
       columns: [
         ...
         { data: "MIDDLE_DATE",className:"text-right",
         ...
         { data: "END_DATE",className:"text-right",
         ...
         { render: function (data, type, full, meta){
                if(full['BLOCK_SEASONAL']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['BLOCK_SEASONAL']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<a href="Edit-Seasonal-Mast/'+btoa(full['SEASONAL_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getID(\''+full['SEASONAL_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
