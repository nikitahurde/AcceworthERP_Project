...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>Master Chamber <small>Update Details</small></h1>
    ...
    <ol class="breadcrumb">
      ...
      <li class="Active"><a href="{{ URL('/Master/Item/Item-Group-Mast')}}">Update Chamber </a></li>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary Custom-Box" >
          ...
          <div class="box-body">
            ...
            <form action="{{ url('/Master/ColdStorage/Chamber-Update') }}" method="POST" >
                ...
                <div class="col-md-2">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="chamber_code" value="{{ $classData->CHAMBER_CODE }}" readonly placeholder="Eneter Chamber Code" id="chamber_code" autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <label>Chamber Name: <span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                        ...
                        <input  class="form-control" id="chamber_name" name="chamber_name" placeholder="Enter Chamber Name" value="{{ $classData->CHAMBER_NAME }}" autocomplete="off">
              ...
              <div style="text-align: center;">
                ...
                <input type="hidden" id="chamberId" name="chamberId" value="{{ $classData->CHAMBER_CODE}}">
