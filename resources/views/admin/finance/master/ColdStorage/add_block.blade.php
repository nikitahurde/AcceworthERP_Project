...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>Master Block <small>Add Details</small></h1>
    ...
    <ol class="breadcrumb">
      ...
      <li class="Active"><a href="{{ URL('/Master/Item/Item-Group-Mast')}}">Add Block </a></li>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary Custom-Box" >
          ...
          <div class="box-header with-border" style="text-align: center;">
            ...
            <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Add Block </h2>
          ...
          <div class="box-body">
            ...
            <form action="{{ url('Master/ColdStorage/Block-storage-Save') }}" method="POST" >
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="cs_name" value="{{old('cs_name')}}" placeholder="Cold Storage Name" id="cs_name" readonly autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <label>Floor Name: <span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                        ...
                        <input  class="form-control" id="floor_name" name="floor_name" placeholder="Floor Name" value="{{old('floor_name')}}" autocomplete="off" readonly>
                  ...
                  <div class="form-group">
                    ...
                    <label>Block Code: <span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                        ...
                        <input  class="form-control" id="block_code" name="block_code" placeholder="Block Code" value="{{old('block_code')}}" autocomplete="off">
...
<script type="text/javascript">
  ...
  $("#cs_code").bind('change', function () {
      ...
      if(msg=='No Match'){
         $(this).val('');
         $('#cs_name').val('');
         $("#chamber_list,#floor_list").empty();
          $('#chamber_code,#chamber_name,#floor_code,#floor_name').val('');
      }else{
        $("#chamber_list,#floor_list").empty();
        $('#chamber_code,#chamber_name,#floor_code,#floor_name').val('');
         $('#cs_name').val(msg);
  ...
  function getStorage(field1,field2,field3,master){
    ...
    $.ajax({
          ...
          method : "POST",
          type: "JSON",
          data: {field1: field1,field2:field2,master:master},
