...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>Master Cold Storage<small>View Details</small></h1>
        ...
        buttons:  [
                    {
                      ...
                      title: ' MASTER COLD STORAGE'+$("#headerexcelDt").val(),
       ...
       columns: [
          ...
          {  
            render: function (data, type, full, meta){
              ...
              var deletebtn ='<a href="Edit-Cold-storage-Mast/'+btoa(full['COMP_CODE'])+'/'+btoa(full['PLANT_CODE'])+'/'+btoa(full['CS_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getID(\''+full['COMP_CODE']+'\',\''+full['PLANT_CODE']+'\',\''+full['CS_CODE']+'\');"><i class="fa fa-trash" title="Delete"></i></button>';
...
<script type="text/javascript">
  ...
  function getID(compCd,plantCd,csCd){

    $("#coldstorageDelete").modal('show');
    var uniqID = compCd+'~'+plantCd+'~'+csCd;
    $('#coldstorageid').val(uniqID);
