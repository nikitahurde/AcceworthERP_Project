...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>Master Floor <small>Add Details</small></h1>
    ...
    <ol class="breadcrumb">
      ...
      <li class="Active"><a href="{{ URL('/Master/Item/Item-Group-Mast')}}">Add Floor </a></li>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary Custom-Box" >
          ...
          <div class="box-header with-border" style="text-align: center;">
            ...
            <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Add Floor </h2>
          ...
          <div class="box-body">
            ...
            <form action="{{ url('Master/ColdStorage/Floor-storage-Save') }}" method="POST" >
                  ...
                  <div class="form-group">
                    ...
                    <label>Floor Code: <span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                        ...
                        <input  class="form-control" id="floor_code" name="floor_code" placeholder=" Floor Code" value="{{old('floor_code')}}" autocomplete="off">

                      </div>

                      <small id="emailHelp" class="form-text text-muted">

                        {!! $errors->first('floor_code', '<p class="help-block" style="color:red;line-height:1">:message</p>') !!}
                      </small>
                  ...
                  <div class="form-group">
                    ...
                    <label>Floor Name: <span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                        ...
                        <input  class="form-control" id="floor_name" name="floor_name" placeholder="Enter Floor Name" value="{{old('floor_name')}}" autocomplete="off">
...
<script type="text/javascript">
  ...
  $("#cs_code").bind('change', function () {
      ...
      if(msg=='No Match'){
         $(this).val('');
         $('#cs_name').val('');
         $('#chamber_code,#chamber_name,#comp_code,#comp_name').val('');
         $("#chamber_list").empty();
      }else{
         $('#cs_name').val(msg);  
         $("#chamber_list").empty();
