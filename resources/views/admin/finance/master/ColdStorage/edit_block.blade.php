...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>Master Block <small>Update Details</small></h1>
    ...
    <ol class="breadcrumb">
      ...
      <li class="Active"><a href="{{ URL('/Master/Item/Item-Group-Mast')}}">Master Block </a></li>

      <li class="Active"><a href="{{ URL('/Master/Item/Item-Group-Mast')}}">Update Block</a></li>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary Custom-Box" >
          ...
          <div class="box-header with-border" style="text-align: center;">
            ...
            <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Update Block </h2>

            <div class="box-tools pull-right">

              <a href="{{ url('/Master/ColdStorage/View-Block-storage-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Block </a>
          ...
          <div class="box-body">
            ...
            <form action="{{ url('/Master/ColdStorage/Block-storage-Update') }}" method="POST" >
                  ...
                  <div class="form-group">
                    ...
                    <label>Floor Code: <span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                        ...
                        <input list="floor_list" class="form-control" id="floor_code" name="floor_code" placeholder="Enter Floor Code" value="{{ $classData->FLOOR_CODE }}" readonly autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <label>Floor Name: <span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                        ...
                        <input  class="form-control" id="floor_name" name="floor_name" placeholder="Enter Floor Name" value="{{ $classData->FLOOR_NAME }}" readonly autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <label>Block Code: <span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                        ...
                        <input  class="form-control" id="block_code" name="block_code" placeholder="Enter Block Code" value="{{ $classData->BLOCK_CODE }}" readonly autocomplete="off">

                      </div>

                      <small id="emailHelp" class="form-text text-muted">

                        {!! $errors->first('block_code', '<p class="help-block" style="color:red;">:message</p>') !!}
                      </small>
                  ...
                  <div class="form-group">
                    ...
                    <label>Block Name: <span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                        ...
                        <input  class="form-control" id="block_name" name="block_name" placeholder="Enter Block Name" value="{{ $classData->BLOCK_NAME }}" autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <label>Storage Capacity: <span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                        ...
                        <input  class="form-control" id="storage_capacity" name="storage_capacity" placeholder="Enter Storage Capacity" value="{{ $classData->STORAGE_CAPACITY }}" autocomplete="off">
              ...
              <div style="text-align: center;">
                ...
                <input type="hidden" id="compcode" name="compcode" value="{{ $classData->COMP_CODE }}">
                <input type="hidden" id="cscode" name="cscode" value="{{ $classData->CS_CODE }}">
                <input type="hidden" id="chamberCd" name="chamberCd" value="{{ $classData->CHAMBER_CODE }}">
                <input type="hidden" id="floorCd" name="floorCd" value="{{ $classData->FLOOR_CODE }}">
                <input type="hidden" id="blockCd" name="blockCd" value="{{ $classData->BLOCK_CODE }}">
