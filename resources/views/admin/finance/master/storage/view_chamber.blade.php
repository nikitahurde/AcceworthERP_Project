       ...
       columns: [
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<a href="Edit-Chamber-Mast/'+btoa(full['CHAMBER_ID'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getID(\''+full['CHAMBER_ID']+'\');"><i class="fa fa-trash" title="Delete"></i></button>';
