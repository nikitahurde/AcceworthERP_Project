  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/view-mast-task')}}">Master Task </a></li>

            <li class="Active"><a href="{{ URL('/view-mast-task')}}">View Task </a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;">View Task</h3>

                  <div class="box-tools pull-right">

                    <a href="{{ url('/form-mast-task') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Task</a>
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal" style="margin-right: 23%;">Cancel</button>
                ...
                <form action="#" method="post">
                  ...
                  <input type="hidden" name="tblName" id="tblName" value="MASTER_TASK">
                  <input type="hidden" name="tblName2" id="tblName2" value="">
                  <input type="hidden" name="colName" id="colName" value="TASK_CODE">
                  <input type="hidden" name="colNameTwo" id="colNameTwo" value="TASK_NAME">
                  <input type="hidden" name="colNameThree" id="colNameThree" value="DEPT_CODE">
                  <input type="hidden" name="colNameFour" id="colNameFour" value="DEPT_NAME">
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER TASK'+$("#headerexcelDt").val(),
                      filename: 'MASTER_TASK_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/view-mast-task') }}"
       ...
       columns: [
         ...
         { data: "DEPT_CODE" },
         {
          render: function (data, type, full, meta){
            ...
            if(full['DEPT_NAME'] == null){
              return '---';
            }else{
              var dept_name = full['DEPT_NAME'];
              return dept_name;
            }
          }
         },
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['TASK_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['TASK_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['TASK_CODE']+'" value="'+full['TASK_CODE']+'"><a href="edit-mast-task/'+btoa(full['TASK_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getId(\''+full['TASK_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
