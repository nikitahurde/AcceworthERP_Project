...
<!-- Content Header (Page header) -->
  ...
  <section class="content-header">
    ...
    <h1>Master Bank<small>View Details</small></h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ url('/Master/House-Bank-Cash/View-Bank-Mast') }}">Master Bank</a></li>

        <li class="active"><a href="{{ url('/Master/House-Bank-Cash/View-Bank-Mast') }}">View Bank</a></li>
      ...
      <div class="col-xs-12">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Bank</h3>

              <div class="box-tools pull-right">

                <a href="{{ url('/Master/House-Bank-Cash/Bank-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Bank</a>
    ...
    <div class="modal-dialog modal-sm" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row" style="margin-top: 5%;" id="delText"></div></div>

        <div class="modal-footer">

          <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal" style="margin-right: 23%;">Cancel</button>

          <form action="{{ url('/delete-bank-mast') }}" method="post">

            @csrf

            <input type="hidden" name="bankid" value="" id="bankgetid">

            <input type="hidden" name="tblName" id="tblName" value="MASTER_BANK">
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER BANK'+$("#headerexcelDt").val(),
                      filename: 'MASTER_BANK_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

       url : "{{ url('/Master/House-Bank-Cash/View-Bank-Mast') }}"
       ...
       columns: [
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['BANK_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['BANK_BLOCK']=='YES'){
          ...
          {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['BANK_CODE']+'" value="'+full['BANK_CODE']+'"><a href="Edit-Bank-Mast/'+btoa(full['BANK_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getID(\''+full['BANK_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
