...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('Master/Asset/Asset-Class') }}">Add Asset Class</a></li>
      ...
      <div class="col-sm-8">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Add Asset Class </h2>
          ...
          <div class="box-body">
            ...
            <form action="{{ url('Master/Asset/Save-Asset-Class') }}" method="POST" >
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <span class="input-group-addon"><i class="fa fa-sort-numeric-asc" aria-hidden="true"></i></span>
                           ...
                           <input type="text" class="form-control codeCapital" name="asset_class_code" id="asset_class_code" value="{{old('asset_class_code')}}" placeholder="Enter Asset Class Code" maxlength="6" autocomplete="off" >
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="asset_class_name" id="asset_class_name" value="{{ old('asset_class_name')}}" placeholder="Enter Asset Class Name" maxlength="40" autocomplete="off">
