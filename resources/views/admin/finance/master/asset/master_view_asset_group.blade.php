  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('Master/Asset/View-Asset-Group') }}">View Asset Group</a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Asset Group List </h3>


                  <div class="box-tools pull-right">


                    <a href="{{ url('Master/Asset/Asset-Group') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Asset Group</a>
                  ...
                  <table id="example" class="table table-bordered table-striped table-hover">
                    ...
                    <thead>
                      ...
                      <tr>
                        ...
                        <th class="text-center">Gl Code Code</th>

                        <th class="text-center">Asset Dep. Code</th>
        ...
        buttons:  [
                    {
                      ...
                      title: ',MASTER ASSET GROUP'+$("#headerexcelDt").val(),
                      filename: 'MASTER_ASSET_GROUP_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('Master/Asset/View-Asset-Group') }}",
       ...
       columns: [
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['ASGROUP_CODE']+'" value="'+full['ASGROUP_CODE']+'"><a href="Update-Asset-Group/'+btoa(full['ASGROUP_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getID(\''+full['ASGROUP_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
