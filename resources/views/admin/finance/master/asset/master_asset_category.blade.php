...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('Master/Asset/Asset-Category') }}">Add Asset Category</a></li>
      ...
      <div class="col-sm-8">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Add Asset Category </h2>
          ...
          <div class="box-body">
            ...
            <form action="{{ url('Master/Asset/Save-Asset-Category') }}" method="POST" >
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <span class="input-group-addon"><i class="fa fa-sort-numeric-asc" aria-hidden="true"></i></span>
                           ...
                           <input type="text" class="form-control codeCapital" name="asset_category_code" id="asset_category_code" value="{{ old('asset_category_code')}}" placeholder="Enter Asset Category Code" maxlength="6" autocomplete="off">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="asset_category_name" id="asset_category_name" value="{{ old('asset_category_name')}}" placeholder="Enter Asset Category Name" maxlength="40" autocomplete="off">
