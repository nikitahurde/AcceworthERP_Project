...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="JavaScript:void(0);">Update Asset Group</a></li>
      ...
      <div class="col-sm-8">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Update Asset Group </h2>
          ...
          <div class="box-body">
            ...
            <form action="{{ url('Master/Asset/Asset-Group-Update/') }}" method="POST" >
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <span class="input-group-addon"><i class="fa fa-sort-numeric-asc" aria-hidden="true"></i></span>
                           ...
                           <input type="text" class="form-control" name="asset_group_code" id="asset_group_code" value="{{ $ASGROUP_CODE }}" placeholder="Enter Asset Group Code" maxlength="6" autocomplete="off" readonly="">


                           <input type="hidden" name="asgroupCode" value="{{ $ASGROUP_CODE }}">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="asset_group_name" id="asset_group_name" value="{{ $ASGROUP_NAME }}" placeholder="Enter Asset Group Name" maxlength="40" autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                            ...
                            <input type="hidden" id="gl_name" name="gl_name" class="form-control  pull-left" value="{{$GL_NAME}}" placeholder="Enter GL Name" autocomplete="off" maxlength="6" readonly>
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <span class="input-group-addon"><i class="fa fa-sort-numeric-asc" aria-hidden="true"></i></span>
                           ...
                           <input type="text" class="form-control" name="gl_dep_code" id="gl_dep_code" value="{{ $GL_DEP_CODE }}" placeholder="Enter GL Dep. Code" autocomplete="off" maxlength="6">
