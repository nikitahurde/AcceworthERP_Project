  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/view-mast-fleet') }}">Master LR Expenses</a></li>

            <li class="active"><a href="{{ url('/view-mast-fleet') }}">View LR Expenses</a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">View LR Expenses</h3>

                  <div class="box-tools pull-right">

          <a href="{{ url('/lr-exp-mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add LR Expenses</a>
                  ...
                  <table id="example" class="table table-bordered table-striped table-hover">
                    ...
                    <thead>
                      ...
                      <tr>
                        ...
                        <th class="text-center">LR INDICATOR</th>
                        <th class="text-center">LR NAME</th>

                        <th class="text-center">LR INDEX</th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <form action="#" method="post">
            ...
            <input type="hidden" name="lrExpID" id="lrExpID" value="">



            <input type="hidden" name="AssetViewLink" id="AssetViewLink" value="Master/Asset/View-Asset-Group">
            
            <input type="hidden" name="tblName" id="tblName" value="MASTER_LREXP">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="LREXPID">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="LRIND">
            <input type="hidden" name="colNameThree" id="colNameThree" value="LRIND_NAME">
            <input type="hidden" name="colNameFour" id="colNameFour" value="LRINDEX">
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER LR EXPENSES '+$("#headerexcelDt").val(),
                      filename: 'MASTER_LR_EXPENSES_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/view-lr-exp-mast') }}"
       ...
       columns: [
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['BLOCK_LREXP']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['BLOCK_LREXP']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                     ...
                     if(full['access_flag']==1){
                      return '<a href="edit-lr-exp-mast/'+btoa(full['LREXPID'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" disabled><i class="fa fa-trash" title="Delete"></i></button>';
                    }else{

                      return '<a href="edit-lr-exp-mast/'+btoa(full['LREXPID'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getId('+full['LREXPID']+','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
                    }
