  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/Master/Employee/View-Emp-Grade-Mast')}}">Master Freight Type</a></li>



            <li class="Active"><a href="{{ URL('/Master/Employee/View-Emp-Grade-Mast')}}">View Freight Type </a></li>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Freight Type </h3>
          ...
          <a href="{{ url('/logistic-transportation/master/add-freight-type') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Freight Type</a>
                  ...
                  <table id="example" class="table table-bordered table-striped table-hover">
                    ...
                    <thead>
                      ...
                      <tr>
                        ...
                        <th class="text-center">Freight Type Code</th>

                        <th class="text-center">Freight Type Name</th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form action="#" method="post">
          ...
          <input type="hidden" name="AssetViewLink" id="AssetViewLink" value="/logistic-transportation/master/view-freight-type-master">
          
          <input type="hidden" name="tblName" id="tblName" value="MASTER_FREIGHTTYPE">
          
          <input type="hidden" name="colName" id="colName" value="FREIGHTTYPE_CODE">
          <input type="hidden" name="colNameTwo" id="colNameTwo" value="FREIGHTTYPE_NAME">
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER FREIGHT TYPE'+$("#headerexcelDt").val(),
                      filename: 'MASTER_FREIGHT_TYPE_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/logistic-transportation/master/view-freight-type-master') }}"
       ...
       columns: [
        ...
        { data:"FREIGHTTYPE_CODE",className:"text-left"},
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['FREIGHTTYPE_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['FREIGHTTYPE_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['DT_RowIndex']+'" value="'+full['FREIGHTTYPE_CODE']+'"><a href="edit-freight-type-master/'+btoa(full['FREIGHTTYPE_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getId(\''+full['FREIGHTTYPE_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
