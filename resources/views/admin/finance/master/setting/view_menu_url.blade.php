  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="#">View Menu URL </a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Menu URL </h3>

                  <div class="box-tools pull-right">

                     <a href="{{ url('/Master/Setting/add-menu-url') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Menu URL</a>
                  ...
                  <table id="example" class="table table-bordered table-striped table-hover">
                    <thead>
                      <tr>
                        ...
                        <th class="text-center" style="width:20%;">Submenu Name</th>
                        
                        <th class="text-center" style="width:20%;">Form Name</th>
                        
                        <th class="text-center" style="width:10%;">Form Code</th>
...
<div class="modal fade" id="MenuUrlDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form action="#" method="post">
          ...
          <input type="hidden" name="tblName" id="tblName" value="USERACCESS_FORM">
          
          <input type="hidden" name="colName" id="colName" value="ID">
          <input type="hidden" name="colNameTwo" id="colNameTwo" value="MENU_NAME">
    ...
    var t = $("#example").DataTable({
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: ' MASTER MENU URL'+$("#headerexcelDt").val(),
                      filename: 'MASTER_MENU__URL'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Setting/view-menu-url') }}"
       ...
       columns: [
         ...
         { data:"SUBMENU_NAME",className:"text-left"},
         { data:"FORM_NAME",className:"text-left"},
         { data:"FORM_CODE",className:"text-left"},
         { data:"FORM_LINK",className:"text-left"},
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['DT_RowIndex']+'" value="'+full['ID']+'"><a href="Edit-menu-url/'+btoa(full['ID'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getId(\''+full['ID']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
