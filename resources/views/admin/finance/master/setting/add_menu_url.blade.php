...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="Active"><a href="#">Add Menu URL</a></li>
      ...
      <div class="col-sm-12">
        ...
        <div class="box box-primary Custom-Box">
          ...
          <div class="box-header with-border" style="text-align: center;">
               ...
               <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Add Menu URL</h2>
          ...
          <div class="box-body">
            ...
            <form action="{{url('/Master/Setting/Save-menu-url')}}" method="POST" >
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="form-group">
                       ...
                       <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="menu_name" value="{{old('menu_name')}}" maxlength="100" id="menu_name" placeholder="Menu Name" autocomplete="off">
                  ...
                  <div class="col-md-4">
                   ...
                   <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="submenu_name" value="{{old('submenu_name')}}" placeholder="Sub Menu Name" maxlength="100" autocomplete="off">
                      </div>
                  ...
                  <div class="col-md-4">
                   ...
                   <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="form_name" id="form_name" value="{{old('form_name')}}" placeholder="Form Name" maxlength="60" autocomplete="off">
                      </div>
                  ...
                  <div class="col-md-4">
                   ...
                   <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="form_code" id="form_code" value="{{old('form_code')}}" placeholder="Form code" maxlength="10" autocomplete="off">
                      </div>
                  ...
                  <div class="col-md-6">
                   ...
                   <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="form_url" id="form_url" value="{{old('form_url')}}" placeholder="Form URL" maxlength="200" autocomplete="off">
                      </div>

                      <small id="emailHelp" class="form-text text-muted">

                        {!! $errors->first('form_url', '<p class="help-block" style="color:red;">:message</p>') !!}
