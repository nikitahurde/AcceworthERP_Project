  ...
  <section class="content-header">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">
          ...
          <a href="{{ url('/finance/form-transaction-mast') }}">Pay Calender</a>
      ...
      <div class="col-sm-12">
        ...
        <div class="box box-primary Custom-Box">
          ...
          <div class="box-header with-border" style="text-align: center;">
            ...
            <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Pay Calender</h2>

            <div class="box-tools pull-right">

                <a href="{{url('/finance/view-pay-calender')}}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Pay Calender</a>
                  ...
                  <div class="panel-body">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane fade in active" id="tab1info">
                       ...
                       <form action="{{ url('/add-pay-calendar-save') }}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="col-md-4">
    		                    ...
    		                    <div class="form-group">
              								...
              								<div class="input-group">
              									...
              									<input list="compList" type="text" name="comp_code" id="comp_code" class="form-control" placeholder="Select Company Code" maxlength="11" style="z-index: 1;" autocomplete="off"/>
