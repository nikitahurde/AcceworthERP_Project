...
<style>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1> Master Transaction <small>View Details</small></h1>
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h3 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;">View Transaction</h3>

              <div class="box-tools pull-right">

                <a href="{{ url('/Master/Setting/Transaction-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Transaction</a>
  ...
  <div class="modal fade" id="transDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-sm" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <i class="fa fa-caret-right"></i> &nbsp;You Want To Delete This Transaction Data...!
        ...
        <div class="modal-footer">
          ...
          <form action="{{ url('delete-transaction') }}" method="post">
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_TRANSACTION">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="TRAN_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="TRAN_HEAD">
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: ' MASTER TRANSACTION'+$("#headerexcelDt").val(),
                      filename: 'MASTER_TRANSACTION_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Setting/View-Transaction-Mast') }}"
       ...
       columns: [
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['TRAN_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['TRAN_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['TRAN_CODE']+'" value="'+full['TRAN_CODE']+'"><a href="Edit-Transaction-Mast/'+btoa(full['TRAN_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getId(\''+full['TRAN_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
...
function funDelData(){
 ...
 var AssetCode  = $("#transactionId").val();
 ...
 $.ajaxSetup({
  ...
  function getId(trancode,rowId)
  {
    var getval = $('#deleteinput_'+trancode).val();
    ...
    $("#transDelete").modal('show');

    $("#transactionId").val(getval);
