  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <!--   <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;"> Acc Bal/Gl Bal </h2> -->
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;">Carry Forword DEMO Gl Balance For Financial Year <?= $nextyr ?></h2>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm" style="margin-top: 150px;">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-success" id="submitglbal">Procceed</button>
...
$('#submitglbal').on('click', function(e){
