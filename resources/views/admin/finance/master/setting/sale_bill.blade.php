          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <div class="box-tools pull-right">
                ...
                <a href="{{ url('/logistic/sale-bill-provisional-view') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Transaction</a>
        ...
        <div class="box-body">
          ...
          <table id="saleBillManage" class="table table-bordered table-striped table-hover billgenerate">
            ...
            <thead class="theadC">
              ...
              <tr>
                ...
                <th class="text-center" width="10%">LR No.</th>
                <th class="text-center" width="5%">DO NO.</th>
                <th class="text-center" width="10%">Wagon No</th>
                <th class="text-center" width="10%">Vehicle No</th>
                <th class="text-center" width="10%">LR-Qty</th>
                <th class="text-center" width="10%">Ack-Qty </th>
                <th class="text-center" width="10%">Net Qty </th>
                <th class="text-center ratebk">Gross Qty </th>
                <th class="text-center" width="10%">FRT-Rate </th>
                <th class="text-center" width="5%">Freight Amt. </th>
              </tr>
          ...
          <div style="text-align: center;">
           ...
           <button class="btn btn-success" type="button" onClick="window.location.reload();" id="submitNDown1" disabled><i class="fa fa-refresh" aria-hidden="true"></i>&nbsp;&nbsp; Reload</button>
            ...
            <button type="button" name="submit" value="submit" id="submitinsalebill" onclick="submitAllData(0)" class='btn btn-primary' disabled style="width: 16%;">&nbsp;Save&nbsp;&nbsp;<i class="fa fa-sign-in" aria-hidden="true"></i></button> 
...
/* -------- START: DATA-TABLE ----------- */
  ...
  function load_data(vrDateId='',series_code='',plant_code='',tranType='',accountCode='',AccountText='',from_date='',to_date='',deliveryNo='',wagonNo='',lrNo='',vehicleNo=''){
      ...
      $('#saleBillManage').DataTable({
          ...
          ajax:{
            ...
            data: {vrDateId:vrDateId,series_code:series_code,plant_code:plant_code,tranType:tranType,accountCode:accountCode,AccountText:AccountText,from_date:from_date,to_date:to_date,deliveryNo:deliveryNo,wagonNo:wagonNo,lrNo:lrNo,vehicleNo:vehicleNo},
            method:"POST",
          },
          columns: [
            ...
            },
            {
              ...
              'render': function (data, type, full, meta){
                  ...
                  return GETQTY+'<input type="hidden" name="qty[]" id="getQty'+full['DT_RowIndex']+'" value="'+full['QTY']+'">';
              },
              className:'text-right'
            },
            {
            ...
            {
              render: function (data, type, full, meta) {
                  var NETWEIGHT = full['NET_WEIGHT'];
                 
                  return NETWEIGHT+'<input type="hidden" name="netWeight[]" id="getNetWeight'+full['DT_RowIndex']+'" value="'+full['NET_WEIGHT']+'">'; 
              },
              className:'text-right'
            },
            {
              render: function (data, type, full, meta) {
                  var GROSSWEIGHT = full['GROSS_WEIGHT'];
                 
                  return GROSSWEIGHT+'<input type="hidden" name="grossWeight[]" id="getgrossWeight'+full['DT_RowIndex']+'" value="'+full['GROSS_WEIGHT']+'">';  
              },
              className:'text-right'
            },
            {
              render: function (data, type, full, meta) {
                  ...
                  return FSORATE+'<input type="hidden" name="fsoRate[]" id="getFsoRate'+full['DT_RowIndex']+'" value="'+full['FSORATE']+'">'; 
              },
              className:'text-right'
            },
            {
              render: function (data, type, full, meta) {
                  ...
                  return newQty+'<input type="hidden" name="fsoQty[]" id="getFsoQty'+full['DT_RowIndex']+'" value="'+newQty+'">';
              },
              className:'text-right'
            }
