      ...
      <div class="col-sm-12">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme"> Update Project Master</h2>
          ...
          <div class="box-body">
            ...
            <form action="{{ url('Master/Infrastructure/Update-Project-Master') }}" method="POST" >

               @csrf
               <input type="hidden" value="{{ $editdata->PROJECT_CODE}}" name="codehidn">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <span class="input-group-addon"><i class="fa fa-sort-numeric-asc" aria-hidden="true"></i></span>
                           ...
                           <input type="" readonly class="form-control codeCapital" name="Poject_code"  value="{{ $editdata->PROJECT_CODE}}" placeholder="Enter Poject Code"autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="Name_project" class="form-control  pull-left" value="{{$editdata->PROJECT_NAME}}" placeholder="Enter Poject name" autocomplete="off" >
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"  name="Project_dis" class="form-control  pull-left" value="{{ $editdata->PROJECT_DESC}}" placeholder="Enter Project Discription" autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                            ...
                            <?php
                             $ps_dt = $editdata->PLAN_STDATE;
                            if($ps_dt){
                             $pltstdt = date('d-m-Y',strtotime($editdata->PLAN_STDATE));
                          }else{
                              $pltstdt = '';
                            }
                              ?>

                            <input type="text" id="start_date" name="Plant_start" class="form-control  pull-left" value="{{ $pltstdt}}" placeholder="Select Start Date" autocomplete="off" >
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <?php 
                           $p_dt = $editdata->PLAN_ENDATE;
                            if($p_dt){
                          $pltenddt = date('d-m-Y',strtotime($editdata->PLAN_ENDATE));
                              }else{
                              $pltenddt = '';
                            }
                             
                              ?>
                           <input type="text" class="form-control" name="Plant_enddate" id="end_date" value="{{ $pltenddt}}" placeholder="Enter Plant End Date" autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                            ...
                            <?php 
                            $a_dt = $editdata->ACT_STDATE;
                            if($a_dt){
                              $actdt = date('d-m-Y',strtotime($editdata->ACT_STDATE));
                            }else{
                              $actdt = '';
                            }
                             ?>
                            ...
                            <input type="text" id="date" name="Actual_start" class="form-control  pull-left" value="{{$actdt}}" placeholder="Select Actual Startdate" autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                            ...
                            <?php 
                              $actend_dt = $editdata->ACT_ENDATE;
                            if($actend_dt){
                            $actenddt = date('d-m-Y',strtotime($editdata->ACT_ENDATE));
                            }else{
                              $actenddt = '';
                            }
                              ...
                              <input type="text" id="actend_date" name="Actual_enddate" class="form-control  pull-left" value="{{ $actenddt}}" placeholder="Select Actual Startdate" autocomplete="off">
                           


                            <!-- <input type="text" id="end_date" name="Actual_enddate" class="form-control  pull-left" value=" {{ $actenddt}}" placeholder="Select  Actual End Date " autocomplete="off">
                            -->
                        </div>
