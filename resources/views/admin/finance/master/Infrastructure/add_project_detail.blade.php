          ...
          <div class="box-body">
            ...
            <div class="col-sm-12">
                    ...
                    <table class="table tdthtablebordr" border="1" cellspacing="0" id="tblProj_details">
                      ...
                      <tr class="useful">
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input list='projectcode_list' name='project_code[]' id='project_code1' value='' class='' style="margin-bottom:5px;" autocomplete="off" onclick="funProjCode(1)" >
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                         ...
                         <input type="text" name='wing_no[]' id='wing_no1' class=""  autocomplete="off" style="margin-bottom:5px;" maxlength="3"><br>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input type="text" name='tower_no[]' id='tower_no1' class=""  autocomplete="off" style="margin-bottom:5px;"  maxlength="3"><br>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input  type="text" name='floorNo[]' id='floorNo1' class="Number" autocomplete="off" style="margin-bottom:5px;"  maxlength="3"><br>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input  type="text" name='unit[]' id='unit1' class="Number" autocomplete="off" style="margin-bottom:5px;" maxlength="6"><br>
              ...
              <div class="text-center col-md-12">
                ...
                <button type="button" class="btn btn-success" id="AddProjectDetail"><i class="fa fa-floppy-o"></i> Save</button>
