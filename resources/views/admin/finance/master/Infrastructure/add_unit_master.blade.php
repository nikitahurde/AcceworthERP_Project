  ...
  <section class="content-header">
    ...
    <ul class="breadcrumb">
      ...
      <li class="active">
        ...
        <a href="{{ url('Master/Infrastructure/add-unit-master') }}"> Add Unit Master </a>
                    ...
                    <table class="table tdthtablebordr" border="1" cellspacing="0" id="tblMilestone">
                      ...
                      <tr class="useful">
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input type='text' name='unitCode[]' id='unitCodefun1' value='' class='' style="margin-bottom:5px;width:120px;" autocomplete="off" ><br>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input type="text" name='unitName[]' id='UnitNameFun1' class=""  autocomplete="off" style="margin-bottom:5px;width:120px;" ><br>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input list='unitList' type="text" name='unitType[]' id='unitTypeFun1' class="number"  autocomplete="off" style="width:120px;margin-bottom:5px;" onclick="funUnitCode(1)" ><br>

                           <input  type="text" name='unitTypeName1[]' id='unitTypeNameFun1' class="number"  autocomplete="off"  >

                          <datalist id="unitList">

                            @foreach ($unitList as $key)

                            <option value='<?= $key->UNITTYPE_CODE ?> - <?= $key->UNITTYPE_NAME ?>' data-xyz='<?= $key->UNITTYPE_NAME?>'>{{ $key->UNITTYPE_CODE   }} = {{ $key->UNITTYPE_NAME  }}</option>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input  type="text" maxlength="10" name='unitArea[]' id='unitAreaFun1' class="number"  autocomplete="off" style="width:120px;margin-bottom:5px; text-align: right;"  ><br>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input list="unitUm" type="text" name='unitUm[]' id='unitUmfun1' class=""  autocomplete="off" style="width:120px;margin-bottom:5px;" onclick="funUniTum(1)"><br>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input  type="text" maxlength="10" name='unitRate[]' id='unitRate1' class="number" autocomplete="off"  style="width:120px;margin-bottom:5px; text-align:right; "><br>
                        ...
                        <td  class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input  list="plantList" type="text" name='wingNo[]' id='wingNo1' class=""  autocomplete="off" style="width:120px;margin-bottom:5px;" onclick="funplantCode(1)" ><br>
                          ...
                          <datalist id="plantList">
                            ...
                            <option value='<?php echo $key->WING_NO?>' data-xyz ="<?php echo $key->WING_NO; ?>" ><?php echo $key->WING_NO ;  ?></option>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input  list="towerList" type="text" name='towerNo[]' id='towerNo1' class=""  autocomplete="off" style="width:120px;margin-bottom:5px;" onclick="funTower(1)"><br>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input   list="floorList" type="text" name='floorNo[]' id='floorNo1' class=""  autocomplete="off" style="width:120px;margin-bottom:5px;" onclick="funFloor(1)" ><br>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input list="unitListto" type="text" name='unitNo[]' id='unitNo1' class=""  autocomplete="off" style="width:120px;margin-bottom:5px;" onclick="funUnit(1)" ><br>
...
<script type="text/javascript">
  ...
  function funUnit(id){
    ...
    $("#unitNo"+id).bind('change', function () {  
      ...
      var xyz = $('#unitListto option').filter(function() {
...
$(document).ready(function(){
  ...
  $('#checkValidation').on('click',function(){
    ...
    $.ajax({
      ...
      url: "{{ url('/Master/Infrastructure/save-unit-master') }}",
