...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>Master Project WBS <small>Add Details</small> </h1>
      ...
      <div class="col-sm-12">
        ...
        <div class="box box-primary Custom-Box">
          ...
          <div class="box-header with-border" style="text-align: center;">
            ...
            <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Add Project WBS</h2>
            <div class="box-tools pull-right">

              <a href="{{url('Master/Infrastructure/View-Project-Wbs-Master')}}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Project WBS</a>
          ...
          <div class="box-body">
            <form action="{{ url('Master/Infrastructure/Save-Project-Wbs-Master') }}" method="POST" >
            ...
            <div class="col-sm-12">
                    ...
                    <table class="table tdthtablebordr" border="1" cellspacing="0" id="tblProj_details">
                      ...
                      <tr class="useful">
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input list='projectcode_list' name='project_code[]' velue="{{old('project_code')}}"id='project_code1' value='' class='' style="margin-bottom:5px;" autocomplete="off" onclick="funProjCode(1)" >
                           <datalist id='projectcode_list'>
                          <?php foreach($project_code as $key) { ?>

                          <option value='<?= $key->PROJECT_CODE ?> - <?= $key->PROJECT_NAME ?>' data-xyz='<?= $key->PROJECT_NAME?><?= $key->PROJECT_CODE?>'>{{ $key->PROJECT_CODE   }} = {{ $key->PROJECT_NAME  }}</option>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input type="text" name='wbscode[]' id='wbscode1' class=""value="{{ old('wbscode')}}"  autocomplete="off" style="margin-bottom:5px;"  maxlength="10"value=''><br>

                          <small id="wbscodeErr1"></small>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input  type="text" name='wbsname[]' id='wbsname1' class="" value="{{ old('wbsname')}}" autocomplete="off" style="margin-bottom:5px;"  maxlength="30" value=""><br>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input  type="text" name='wbs_plantst_date[]' velue="{{old('wbs_plantst_date')}}"id='plantstdate1' class="plantst_date" autocomplete="off" style="margin-bottom:5px;" maxlength="10" value=""><br>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input  type="text"  name='wbs_planted_date[]'value="{{ old('wbs_planted_date')}}" id='planteddate1' class="planted_date" autocomplete="off" style="margin-bottom:5px;" maxlength="10" value="" ><br>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input  type="text" name='wbs_actual_stdate[]' value="{{ old('wbs_actual_stdate')}}"id='actualstdate1' class="actualst_date" autocomplete="off" style="margin-bottom:5px;" maxlength="10" value="" ><br>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input  type="text" name='wbs_actual_eddate[]'value="{{ old('wbs_actual_eddate')}}" id='actualeddate1' class="actualed_date" autocomplete="off" style="margin-bottom:5px;" maxlength="10"  value=""><br>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input  type="text" name='wbs_status[]' id='wbsstatus1' value="{{ old('wbs_status')}}" class="" autocomplete="off" style="margin-bottom:5px;" maxlength="20" value=""><br>
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input  type="text" name='wbs_progress[]'value="{{ old('wbs_progress')}}" id='wbsprogress1' class="" autocomplete="off" style="margin-bottom:5px;" maxlength="10" value=""><br>
              ...
              <div class="text-center col-md-12">
               ...
               <button type="button" class="btn btn-info confirm" id="confirmbtn confirmbtn"><i class="fa fa-check-circle" disabled ></i> Confirm</button>

                <button type="submit" class="btn btn-success" id="AddProjectDetail" disabled><i class="fa fa-floppy-o"></i> Save</button>
...
$(function(){
  ...
  $(".addmore").on('click',function(){
     console.log('addmore',addmore);
        ...
        if(wbs_code == ''){
          $('#wbscodeErr'+countTr).html('WBS code Is Required').css('color','red');
          return false;
        }else{
          $('#wbscodeErr'+countTr).html('');
        }
...
$(".confirm").on('click',function(){
        ...
        count=$('.tdthtablebordr tr').length;
       ...
       var wbs_plantst_date  =  $('#plantstdate'+countTr).val();
        ...
        return false;
          ...
          $('#AddProjectDetail').prop('disabled',false);
