...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>Master Unit WBS <small>Add Details</small> </h1>
    ...
    <ol class="breadcrumb">
      ...
      <li class="Active"><a href="{{ url('Master/Infrastructure/View-Unit-Wbs-Master') }}">Master Unit WBS</a></li>

      <li class="Active"><a href="{{ url('Master/Infrastructure/View-Project-Unit-Master') }}">Add Unit WBS</a></li>
      ...
      <div class="col-sm-12">
        ...
        <div class="box box-primary Custom-Box">
          ...
          <div class="box-header with-border" style="text-align: center;">
            ...
            <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Add Unit WBS</h2>
          ...
          <div class="box-body">
            <form action="#" method="POST" enctype="multipart/form-data" id="unitDetailForm">
                  ...
                  <div class="box box-primary Custom-Box">
                    ...
                    <div class="box-body">
                        ...
                        <table class="table tdthtablebordr" border="1" cellspacing="0" id="tblUnit_details">
                          ...
                          <tr class="useful">
                            ...
                            <td class="tdthtablebordr" style='padding-top: 2%;'>
                              ...
                              <input list='unitcode_list' name='unit_code[]' id='unit_code1' value="{{ old('unit_code')}}" class='' style="margin-bottom:5px;" autocomplete="off" onclick="funUnitCode(1)" >

                              <datalist id='unitcode_list'>

                                @foreach ($unitListmaster as $key)

                                  <option value='<?php echo $key->UNIT_CODE?>' data-xyz ="<?php echo $key->UNIT_NAME; ?>" ><?php echo $key->UNIT_NAME ; echo " [".$key->UNIT_CODE."]" ; ?></option>
                            ...
                            <td class="tdthtablebordr" style='padding-top: 2%;'>
                              ...
                              <input list='unitname_list' name='unit_name[]' id='unit_name1' value="{{old('unit_name')}}" class='' style="margin-bottom:5px;" autocomplete="off" onclick="funUnitName(1)" readonly >
                            ...
                            <td class="tdthtablebordr" style='padding-top: 2%;'>
                              ...
                              <input list='wbs_codeList' name='wbscode[]' id='wbs_code1' value="{{old('wbscode')}}" class='' style="margin-bottom:5px;" autocomplete="off" onclick="funWbsCode(1)" >

                              <datalist id='wbs_codeList'>

                                @foreach ($wbscodelist as $key)

                                <option value='<?php echo $key->WBS_CODE?>' data-xyz ="<?php echo $key->WBS_NAME; ?>" ><?php echo $key->WBS_CODE ; echo " [".$key->WBS_NAME."]" ; ?></option>
                            ...
                            <td class="tdthtablebordr" style='padding-top: 2%;'>
                              ...
                              <input list='wbs_nameList' name='wbsname[]' id='wbs_name1' value="{{old('wbsname')}}" class='' style="margin-bottom:5px;" autocomplete="off" onclick="funWbsName(1)" readonly >
                            ...
                            <td class="tdthtablebordr" style='padding-top: 2%;'>
                              ...
                              <input  type="text" name='wbs_plantst_date[]'value='' id='plantstdate1' class="plantst_date" autocomplete="off" style="margin-bottom:5px;" maxlength="10"><br>
                            ...
                            <td class="tdthtablebordr" style='padding-top: 2%;'>
                              ...
                              <input  type="text"  name='wbs_planted_date[]' id='planteddate1' class="planted_date" autocomplete="off" style="margin-bottom:5px;" maxlength="10"><br>
                            ...
                            <td class="tdthtablebordr" style='padding-top: 2%;'>
                              ...
                              <input  type="text" name='wbs_actual_stdate[]' id='actualstdate1' class="actualst_date" autocomplete="off" style="margin-bottom:5px;" maxlength="10"><br>
                            ...
                            <td class="tdthtablebordr" style='padding-top: 2%;'>
                              ...
                              <input  type="text" name='wbs_actual_eddate[]' id='actualeddate1' class="actualed_date" autocomplete="off" style="margin-bottom:5px;" maxlength="10"><br>
                            ...
                            <td class="tdthtablebordr" style='padding-top: 2%;'>
                              ...
                              <input  type="text" name='wbs_status[]' id='wbsstatus1' class="" autocomplete="off" style="margin-bottom:5px;" maxlength="20"><br>
                            ...
                            <td class="tdthtablebordr" style='padding-top: 2%;'>
                              ...
                              <input  type="text" name='wbs_progress[]' id='wbsprogress1' class="number" autocomplete="off" style="margin-bottom:5px; text-align: right; " maxlength="10"><br>
                      ...
                      <div class="text-center col-md-12">
                        ...
                        <button type="button" class="btn btn-success" id="AddUnitDetail"><i class="fa fa-floppy-o"></i> Save</button>
...
$('#AddUnitDetail').on('click',function(){
  ...
  for(var q=0;q<trCount;q++){
    ...
    $.ajax({
      ...
      url: "{{ url('/Master/Infrastructure/save-unit-wbs-master') }}",
