      ...
      <div class="col-sm-8">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Add Milestone </h2>
          ...
          <div class="box-body">
            ...
            <form action="{{ url('Master/Infrastructure/Add-Milestone') }}" method="POST" >
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <span class="input-group-addon"><i class="fa fa-sort-numeric-asc" aria-hidden="true"></i></span>
                           ...
                           <input type="text" class="form-control codeCapital" velue="{{old('milestone_code')}}" name="milestone_code" id="asset_group_code" value="" placeholder="Enter milestone code" autocomplete="off">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="milestone_name" id="asset_group_name" value="{{old('milestone_name')}}" placeholder="Enter Milestone Name"   autocomplete="off">
