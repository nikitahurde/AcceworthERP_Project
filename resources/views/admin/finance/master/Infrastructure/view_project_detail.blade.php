  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="#">View Project Detail </a></li>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Project Detail</h3>
          ...
          <a href="{{ url('/Master/Infrastructure/Add-Project-Detail-Master') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Project Detail</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form action="#" method="post">
          ...
          <input type="hidden" name="tblName" id="tblName" value="MASTER_PROJECT_DETAIL">
          
          <input type="hidden" name="colName" id="colName" value="PROJECTID">
          <input type="hidden" name="colNameTwo" id="colNameTwo" value="PROJECT_CODE">
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER PROJECT DETAIL'+$("#headerexcelDt").val(),
                      filename: 'MASTER_PROJECT_DETAIL_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Infrastructure/View-Project-Detail-Master') }}"
       ...
       columns: [
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['DT_RowIndex']+'" value="'+full['PROJECTID']+'"><a href="Edit-Project-Detail/'+btoa(full['PROJECTID'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getId(\''+full['PROJECTID']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
