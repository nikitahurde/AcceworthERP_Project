...
<small>View Details</small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/Master/Item/View-Item-Category-Mast') }}">Master Item Category</a></li>



            <li class="active"><a href="{{ url('/Master/Item/View-Item-Category-Mast') }}">View Item Category</a></li>
...
<h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Item Category</h3>
...
<a href="{{ url('/Master/Item/Item-Category-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Item Category</a>
...
<tbody>
  ...
  <div class="modal fade" id="itemcatDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-sm" role="document">
      ...
      <form action="{{ url('/Master/Item/Delete-Item-Category') }}" method="post">
      ...
      @csrf
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_ITEM_CATEGORY">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="ICATG_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="ICATG_NAME">
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER ITEM CATEGORY'+$("#headerexcelDt").val(),
                      filename: 'MASTER_ITEM_CATEGORY_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Item/View-Item-Category-Mast') }}"
       ...
       columns: [
         ...
         { data: "ICATG_CODE",className:"text-left"},
         { data: "ICATG_NAME" },
        
         { render: function (data, type, full, meta){


                  if(full['ICATG_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['ICATG_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['ICATG_CODE']+'" value="'+full['ICATG_CODE']+'"><a href="Edit-Item-Category/'+btoa(full['ICATG_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getID(\''+full['ICATG_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
