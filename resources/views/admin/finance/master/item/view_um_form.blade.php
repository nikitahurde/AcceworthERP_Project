  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/Master/Item/view-Um-Mast') }}">Master UM</a></li>

            <li class="active"><a href="{{ url('/Master/Item/view-Um-Mast') }}">View Master UM</a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;">View UM</h3>

                  <div class="box-tools pull-right">

          <a href="{{ url('/Master/Item/Um-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add UM</a>
  ...
  <div class="modal-dialog modal-sm" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <form action="{{ url('Master/Item/Delete-Um') }}" method="post">
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_UM">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="UM_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="UM_NAME">
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER UM'+$("#headerexcelDt").val(),
                      filename: 'MASTER_UM_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Item/view-Um-Mast') }}"
       ...
       columns: [
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['UM_CODE']+'" value="'+full['UM_CODE']+'"><a href="Edit-Um-Mast/'+btoa(full['UM_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getId(\''+full['UM_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
...
function getId(umcode,rowId){

    //alert(id);return false;
  var getval = $('#deleteinput_'+umcode).val();
