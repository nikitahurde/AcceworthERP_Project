...
<small>View Details</small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/Master/Item/View-Item-Schedule-Mast') }}">Master Item Schedule</a></li>



            <li class="active"><a href="{{ url('/Master/Item/View-Item-Schedule-Mast') }}">View Item Schedule</a></li>
...
<h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Item Schedule</h3>
...
<a href="{{ url('/Master/Item/Item-Schedule-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Item Schedule</a>
...
<table id="example" class="table table-bordered table-striped table-hover">
  ...
  <thead>
    ...
    <tr>
      ...
      <th class="text-center">Item Schedule Code</th>



      <th class="text-center">Item Schedule Name </th>
...
<tbody>
  ...
  <div class="modal fade" id="itemScheDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-sm" role="document">
      ...
      <form action="{{ url('/Master/Item/Delete-Item-Schedule') }}" method="post">
      ...
      @csrf
            ...
            <input type="hidden" name="itemsche" value="" id="itemsche">

            <input type="hidden" name="AssetViewLink" id="AssetViewLink" value="Master/Asset/View-Asset-Group">

            <input type="hidden" name="tblName" id="tblName" value="MASTER_ITEM_SCHEDULE">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="ISCHE_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="ISCHE_NAME">
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER ITEM SCHEDULE'+$("#headerexcelDt").val(),
                      filename: 'MASTER_ITEM_SCHEDULE_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Item/View-Item-Schedule-Mast') }}"
       ...
       columns: [
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['ISCHE_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['ISCHE_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['ISCHE_CODE']+'" value="'+full['ISCHE_CODE']+'"><a href="Edit-Item-Schedule/'+btoa(full['ISCHE_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getID(\''+full['ISCHE_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
...
<script type="text/javascript">
 ...
 $.ajaxSetup({
  ...
  function getID(itemcate,rowId){

      //console.log(id);
     var getval = $('#deleteinput_'+itemcate).val();
