  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/Master/Item/View-Item-Class-Mast')}}">Master Item Class </a></li>



            <li class="Active"><a href="{{ URL('/Master/Item/View-Item-Class-Mast')}}">View Item Class </a></li>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;">View Item Class</h3>
          ...
          <a href="{{ url('/Master/Item/Item-Class-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Item Class</a>
  ...
  <div class="modal-dialog modal-sm" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <form action="{{ url('/Master/Item/Delete-Item-Class') }}" method="post">
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_ITEM_CLASS">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="ITEMCLASS_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="ITEMCLASS_NAME">
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER ITEM CLASS'+$("#headerexcelDt").val(),
                      filename: 'MASTER_ITEM_CLASS_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Item/View-Item-Class-Mast') }}"
       ...
       columns: [
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['ITEMCLASS_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['ITEMCLASS_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['ITEMCLASS_CODE']+'" value="'+full['ITEMCLASS_CODE']+'"><a href="Edit-Item-Class-Mast/'+btoa(full['ITEMCLASS_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getID(\''+full['ITEMCLASS_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
...
function getID(itemclass,rowId){
      //console.log(id);
  var getval = $('#deleteinput_'+itemclass).val();
