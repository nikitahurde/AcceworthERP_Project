...
<small>View Details</small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/Master/Item/View-Item-Group-Mast') }}">Master Item Group</a></li>



            <li class="active"><a href="{{ url('/Master/Item/View-Item-Group-Mast') }}">View Item Group</a></li>
...
<h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Item Group</h3>
...
<a href="{{ url('/Master/Item/Item-Group-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Item Group</a>
  ...
  <div class="modal fade" id="itemgroupDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-sm" role="document">
      ...
      @csrf
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_ITEMGROUP">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="ITEMGROUP_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="ITEMGROUP_NAME">
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER ITEM GROUP'+$("#headerexcelDt").val(),
                      filename: 'MASTER_ITEM_GROUP_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Item/View-Item-Group-Mast') }}"
       ...
       columns: [
         ...
         { data: "ITEMGROUP_CODE",className:"text-left"},
         { data: "ITEMGROUP_NAME" },
         
         { render: function (data, type, full, meta){


                  if(full['ITEMGROUP_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['ITEMGROUP_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<a href="Edit-Item-Group-Mast/'+btoa(full['ITEMGROUP_CODE'])+'" class="btn btn-warning btn-x actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getID(\''+full['ITEMGROUP_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
