  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/Master/Cost-Center/View-Cost-Type-Mast')}}">View Cost Type </a></li>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;">View Cost Type</h3>
          ...
          <a href="{{ url('/Master/Cost-Center/Cost-Type-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Cost Type</a>
                  ...
                  <table id="example" class="table table-bordered table-striped table-hover">
                    ...
                    <thead>
                      ...
                      <tr>
                        ...
                        <th class="text-center">Cost Type Code</th>



                        <th class="text-center">Cost Type Name</th>
  ...
  <div class="modal-dialog modal-sm" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <form action="{{ url('/Master/Cost-Center/Delete-Cost-Type') }}" method="post">@csrf
            <input type="hidden" name="costTypeId" id="costTypeId" value="">

            <input type="hidden" name="AssetViewLink" id="AssetViewLink" value="Master/Asset/View-Asset-Group">

            <input type="hidden" name="tblName" id="tblName" value="MASTER_CTYPE">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="CTYPE_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="CTYPE_NAME">
    ...
    var t = $("#example").DataTable({
        ...
        buttons:  [
                    {
                      ...
                      messageTop: 'Master Cost Type',
                      title:'',
                      filename: 'MASTER_COST_TYPE'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Cost-Center/View-Cost-Type-Mast') }}"
       ...
       columns: [
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['CTYPE_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['CTYPE_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['CTYPE_CODE']+'" value="'+full['CTYPE_CODE']+'"><a href="Edit-Cost-Type/'+btoa(full['CTYPE_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getID(\''+full['CTYPE_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
