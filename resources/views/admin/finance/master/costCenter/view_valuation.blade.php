  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/Master/Cost-Center/View-Valuation-Mast')}}">Master Valuation </a></li>



            <li class="Active"><a href="{{ URL('/Master/Cost-Center/View-Valuation-Mast')}}">View Valuation </a></li>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;">View Valuation</h3>
          ...
          <a href="{{ url('/Master/Cost-Center/Valuation-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Valuation</a>
  ...
  <div class="modal-dialog modal-sm" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <form action="{{ url('/Master/Cost-Center/Delete-Valuation') }}" method="post">
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_VALUATION">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="VALUATION_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="VALUATION_NAME">
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER VALUATION'+$("#headerexcelDt").val(),
                      filename: 'MASTER_VALUATION_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Cost-Center/View-Valuation-Mast') }}"
       ...
       columns: [
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['VALUATION_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['VALUATION_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['VALUATION_CODE']+'" value="'+full['VALUATION_CODE']+'"><a href="Edit-Valuation-Mast/'+btoa(full['VALUATION_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getID(\''+full['VALUATION_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
...
<script type="text/javascript">
 ...
 $.ajaxSetup({
  ...
  function getID(valcode,rowId){
      //console.log(id);
    var getval = $('#deleteinput_'+valcode).val();
