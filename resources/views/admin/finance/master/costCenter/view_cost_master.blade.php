  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/Master/Cost-Center/View-Cost-Mast')}}">Master Cost</a></li>



            <li class="Active"><a href="{{ URL('/Master/Cost-Center/View-Cost-Mast')}}">View Cost</a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;">View Cost</h3>
                  ...
                  <div class="box-tools pull-right">
                    ...
                    <a href="{{ url('/Master/Cost-Center/Cost-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Cost</a>
...
<div class="modal fade" id="costMastDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog modal-sm" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <form action="{{ url('Master/Cost-Center/Delete-Cost') }}" method="post">
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_COST">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="COST_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="COST_NAME">
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/Master/Cost-Center/View-Cost-Mast') }}"
      ...
      dom: "<'top'Bf><'row'<'col-sm-12'rt>>" +"<'row'<'col-sm-2'l><'col-sm-2'i><'col-sm-8'p>>",
        buttons:  [
                    {
                      ...
                      title: 'MASTER COST '+$("#headerexcelDt").val(),
                      filename: 'MASTER_COST_'+$("#headerexcelDt").val(),
                    }
                  ],
       ...
       columns: [
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['COST_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['COST_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<a href="Edit-Cost-Mast/'+btoa(full['COST_CODE'])+'/'+btoa(enableBtn)+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getId(\''+full['COST_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
