  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/Master/Cost-Center/View-Cost-Category')}}">Master Cost Category  </a></li>



            <li class="Active"><a href="{{ URL('/Master/Cost-Center/View-Cost-Category')}}">View Cost Category </a></li>
        ...
        <section class="content">
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">View Cost Category </h3>
          ...
          <a href="{{ url('/Master/Cost-Center/Cost-Category') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Cost Category</a>
                  ...
                  <table id="example" class="table table-bordered table-striped table-hover">
                    ...
                    <thead>
                      ...
                      <tr>
                        ...
                        <th class="text-center">Cost Category Code</th>



                        <th class="text-center">Cost Category Name</th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <form action="#" method="post">
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_CCATG">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="CCATG_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="CCATG_NAME">
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER COST CATEGORY'+$("#headerexcelDt").val(),
                      filename: 'MASTER_COST_CATEGORY_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Cost-Center/View-Cost-Category') }}"
       ...
       columns: [
         ...
         { 
            render: function (data, type, full, meta){
                  ...
                  if(full['CCATG_BLOCK']=='NO'){
                    return '<span class="label label-success">Active</span>';
                  }else if(full['CCATG_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['CCATG_CODE']+'" value="'+full['CCATG_CODE']+'"><a href="Edit-Cost-Category/'+btoa(full['CCATG_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getId(\''+full['CCATG_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
...
function funDelData(){
 ...
 $.ajaxSetup({
  ...
  function getId(costcat,rowId)
  {

    var getval = $('#deleteinput_'+costcat).val();
