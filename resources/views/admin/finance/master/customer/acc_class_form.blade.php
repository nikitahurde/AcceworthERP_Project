...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/Master/Customer-Vendor/Acc-Class') }}">Master Account Class</a></li>

            <?php if($button == 'Save'){?>
               <li class="active"><a href="{{ url('/Master/Customer-Vendor/Acc-Class') }}">Add Account Class</a></li>  
            <?php }else{ ?>
               <li class="active"><a href="{{ url('/Master/Customer-Vendor/Acc-Class') }}">Update Account Class</a></li>  
            <?php } ?>
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <?php if($button == 'Save'){?>
                ...
                <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Add Account Class </h2>

                <?php }else{  ?>

                 <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Update Account Class </h2>

                <?php } ?>

              <div class="box-tools pull-right showinmobile">

                <a href="{{ url('/Master/Customer-Vendor/View-Acc-Class') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Account Class</a>
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <span class="input-group-addon"><i class="fa fa-sort-numeric-asc" aria-hidden="true"></i></span>
                           ...
                           <input type="text" class="form-control codeCapital" name="acc_class_code" value="{{ $acc_class_code }}" placeholder="Enter Acc Class Code" maxlength="6" id="AccClassSearch" <?php if($button=='Update') { ?> readonly <?php } ?>>
                          ...
                          <span class="input-group-addon" style="padding: 1px 7px;">
                            ...
                            <div id="myForm" class="hide">
                                 <div class="row">
                                      <div class="col-md-9">
                                        <input type="text" name="GlmstnameH" id="AccClsHelp" class="form-control input-md setheightinput" style="text-transform: uppercase;">
                                      </div>
                                ...
                                <table class="table table-bordered" style="margin-top: 3%;" id="HideWhenSearch">
                                  <thead>
                                    <tr>
                                     <th class="nameheading">Acc Class Code</th>
                                     <th class="nameheading">Acc Class Name</th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                    <?php foreach ($AccClass_mst_list as $key) { ?>

                                      <tr>
                                        <td class="setetxtintd"><?php echo $key->ACLASS_CODE; ?></td>
                                        <td class="setetxtintd"><?php echo $key->ACLASS_NAME; ?></td>
                                      </tr>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="acc_class_name" value="{{ $acc_class_name }}" placeholder="Enter Acc Class Name" maxlength="40">
