  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/Master/Customer-Vendor/View-Acc-Type') }}">Master Account Type</a></li>

            <li class="active"><a href="{{ url('/Master/Customer-Vendor/View-Acc-Type') }}">View Mast Account Type</a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Account Type</h3>

                  <div class="box-tools pull-right">

          <a href="{{ url('/Master/Customer-Vendor/Mast-Acc-Type') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Account Type</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <form action="#" method="post">
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_ACCTYPE">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="ATYPE_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="ATYPE_NAME">
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER ACCOUNT TYPE '+$("#headerexcelDt").val(),
                      filename: 'MASTER_ACCOUNT_TYPE_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Customer-Vendor/View-Acc-Type') }}"
       ...
       columns: [
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['ATYPE_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['ATYPE_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['ATYPE_CODE']+'" value="'+full['ATYPE_CODE']+'"><a href="Edit-Acc-Type/'+btoa(full['ATYPE_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getId(\''+full['ATYPE_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
