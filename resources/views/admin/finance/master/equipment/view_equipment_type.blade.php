...
<small>View Details</small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/Master/Maintenance/View-Equipment-Type-Mast') }}">Master Equipment Type</a></li>



            <li class="active"><a href="{{ url('//Master/Maintenance/View-Equipment-Type-Mast') }}">View Equipment Type</a></li>
...
<h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Equipment Type</h3>
...
<a href="{{ url('/Master/Maintenance/Equipment-Type-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Equipment Type</a>
...
<table id="example" class="table table-bordered table-striped table-hover">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th class="text-center">Equipment Type Code</th>



                    <th class="text-center">Equipment Type Name </th>
  ...
  <div class="modal fade" id="equipmentgroupDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-sm" role="document">
      ...
      @csrf
            ...
            <input type="hidden" name="typeId" value="" id="equipmentgroup">

            <input type="hidden" name="AssetViewLink" id="AssetViewLink" value="Master/Asset/View-Asset-Group">

            <input type="hidden" name="tblName" id="tblName" value="MASTER_EQPTYPE">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="EQPTYPE_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="EQPTYPE_NAME">
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER EQUIPMENT TYPE '+$("#headerexcelDt").val(),
                      filename: 'MASTER_EQUIPMENT_TYPE_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Maintenance/View-Equipment-Type-Mast') }}"
       ...
       columns: [
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['EQPTYPE_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['EQPTYPE_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<a href="Edit-Equipment-Type-Mast/'+btoa(full['EQPTYPE_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getID(\''+full['EQPTYPE_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
