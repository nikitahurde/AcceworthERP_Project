...
<small>View Details</small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/Master/Item/View-Item-Class-Mast') }}">Master Equipment Class</a></li>



            <li class="active"><a href="{{ url('/Master/Item/View-Item-Class-Mast') }}">View Equipment Class</a></li>
...
<h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Equipment Class</h3>
...
<a href="{{ url('/Master/Maintenance/Equipment-Class-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Equipment Class</a>
...
<table id="example" class="table table-bordered table-striped table-hover">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th class="text-center">Equipment Class Code</th>



                    <th class="text-center">Equipment Class Name </th>
  ...
  <div class="modal fade" id="equipmentgroupDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-sm" role="document">
      ...
      @csrf
            ...
            <input type="hidden" name="equipmentgroupid" value="" id="equipmentgroup">



            <input type="hidden" name="AssetViewLink" id="AssetViewLink" value="Master/Asset/View-Asset-Group">

            <input type="hidden" name="tblName" id="tblName" value="MASTER_EQPCLASS">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="EQPCLASS_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="EQPCLASS_NAME">
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER EQUIPMENT CLASS'+$("#headerexcelDt").val(),
                      filename: 'MASTER_EQUIPMENT_CLASS_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Maintenance/View-Equipment-Class-Mast') }}"
       ...
       columns: [
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['EQPCLASS_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['EQPCLASS_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<a href="Edit-Equipment-Class-Mast/'+btoa(full['EQPCLASS_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getID(\''+full['EQPCLASS_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
