        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
           ...
           <?php if($button=='Save') { ?>
            ...
            <li class="Active"><a href="{{ URL('/Master/Item/Item-Group-Mast')}}">Master Equipment Group</a></li>

            <li class="Active"><a href="{{ URL('/Master/Item/Item-Group-Mast')}}">Add Equipment Group </a></li>
           ...
           <?php } else { ?>
             ...
             <li class="Active"><a href="{{ URL('/Master/Item/Edit-Item-Group-Mast/'.base64_encode($equipmentgroup_id))}}"> Equipment Group</a></li>

             <li class="Active"><a href="{{ URL('/Master/Item/Edit-Item-Group-Mast/'.base64_encode($equipmentgroup_id))}}">Update Equipment Group </a></li>
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <?php if($button=='Save') { ?>
               ...
               <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Add  Equipment Group</h2>
               <div class="box-tools pull-right showinmobile">

                <a href="{{ url('/Master/Item/View-Item-Group-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Equipment Group</a>
             ...
             <?php } else{  ?>
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Update  Equipment Group</h2>
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="equipmentgroup_code" value="{{$equipmentgroup_code}}" placeholder="Enter Equipment Group Code" maxlength="6" id="SearchItemGroup" <?php if($button=='Update') { ?> readonly <?php } ?> autocomplete="off">
                        ...
                        <?php } ?>
                          ...
                          <small id="emailHelp" class="form-text text-muted">
                            ...
                            {!! $errors->first('equipmentgroup_code', '<p class="help-block" style="color:red;">:message</p>') !!}
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="equipmentgroup_name" id="equipmentgroup_name" value="{{$equipmentgroup_name}}" placeholder="Enter Equipment Group Name" maxlength="40" autocomplete="off">
                      ...
                      <small id="emailHelp" class="form-text text-muted">
                        ...
                        {!! $errors->first('equipmentgroup_name', '<p class="help-block" style="color:red;">:message</p>') !!}
...
<?php } ?>
              ...
              <div style="text-align: center;">
                 ...
                 <button type="Submit" class="btn btn-primary">
                  ...
                  <input type="hidden" name="idgroup" value="{{$equipmentgroup_id}}">
      ...
      <div class="col-sm-3 hideinmobile">
        ...
        <div class="box-tools pull-right">
          ...
          <a href="{{ url('/Master/Maintenance/View-Equipment-Group-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Equipment Group</a>
