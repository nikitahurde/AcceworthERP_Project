...
<small>View Details</small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/Master/Item/View-Item-Category-Mast') }}">Master Equipment Category</a></li>



            <li class="active"><a href="{{ url('/Master/Item/View-Item-Category-Mast') }}">View Equipment Category</a></li>
...
<h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Equipment Category</h3>
...
<a href="{{ url('/Master/Maintenance/Equipment-Category-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Equipment Category</a>
...
<table id="example" class="table table-bordered table-striped table-hover">
  ...
  <thead>
    ...
    <tr>
      ...
      <th class="text-center">Equipment Category Code</th>



      <th class="text-center">Equipment Category Name </th>
  ...
  <div class="modal fade" id="itemcatDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-sm" role="document">
      ...
      @csrf
            ...
            <input type="hidden" name="itemcat" value="" id="itemcat">



            <input type="hidden" name="AssetViewLink" id="AssetViewLink" value="Master/Asset/View-Asset-Group">

            <input type="hidden" name="tblName" id="tblName" value="MASTER_EQPCATG">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="EQPCATG_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="EQPCATG_NAME">
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER EQUIPMENT CATEGORY'+$("#headerexcelDt").val(),
                      filename: 'MASTER_EQUIPMENT_CATEGORY_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Maintenance/View-Equipment-Category-Mast') }}"
       ...
       columns: [
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['EQPCATG_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['EQPCATG_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<input type="hidden" id="deleteinput_'+full['EQPCATG_CODE']+'" value="'+full['EQPCATG_CODE']+'"><a href="Edit-Equipment-Category-Mast/'+btoa(full['EQPCATG_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getID(\''+full['EQPCATG_CODE']+'\');"><i class="fa fa-trash" title="Delete"></i></button>';
