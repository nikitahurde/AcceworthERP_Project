...
<small>View Details</small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/Master/Item/View-Item-Group-Mast') }}">Master Equipment</a></li>



            <li class="active"><a href="{{ url('/Master/Item/View-Item-Group-Mast') }}">View Equipment</a></li>
...
<h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Equipment</h3>
...
<a href="{{ url('/Master/Maintenance/Equipment-Mast') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Equipment</a>
  ...
  <div class="modal fade" id="equipmentgroupDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-sm" role="document">
      ...
      @csrf
            ...
            <input type="hidden" name="tblName" id="tblName" value="MASTER_EQP">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="EQP_CODE">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="EQP_NAME">
            <input type="hidden" name="colNameThree" id="colNameThree" value="EQPGROUP_CODE">
            <input type="hidden" name="colNameFour" id="colNameFour" value="EQPCATG_CODE">
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: 'MASTER EQUIPMENT'+$("#headerexcelDt").val(),
                      filename: 'MASTER_EQUIPMENT_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Maintenance/View-Equipment-Mast') }}"
       ...
       columns: [
         ...
         { render: function (data, type, full, meta){
                  ...
                  if(full['EQP_BLOCK']=='NO'){
                      return '<span class="label label-success">Active</span>';
                    }else if(full['EQP_BLOCK']=='YES'){
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<a href="Edit-Equipment-Mast/'+btoa(full['EQP_CODE'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getID(\''+full['EQP_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';
