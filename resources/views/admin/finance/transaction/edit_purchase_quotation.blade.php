        ...
        <div class="col-sm-12">
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">Purchase Quotation Transaction</h2>
                        ...
                        <div class="form-group">
                          ...
                          <label>Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control transdatepicker rightcontent" name="vr" id="vr_date" value="{{ $getPurchaseQuotation[0]->vr_date }}" placeholder="Select Date" autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label> T Code : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="tran" value="{{ $getPurchaseQuotation[0]->tran_code }}" id="transcode" placeholder="Enter Transaction Head" readonly autocomplete="off">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input list="seriesList1"  id="series_code" name="series" class="form-control  pull-left" value="{{ $getPurchaseQuotation[0]->series_code  }}" placeholder="Select Series" oninput="this.value = this.value.toUpperCase()" autocomplete="off">
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control rightcontent" name="vro" value="{{  $getPurchaseQuotation[0]->vr_no }}" placeholder="Enter Vr No" id="vrseqnum" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Plant Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="PlantcodeList" class="form-control" id="Plant_code" name="plantcode" placeholder="Select Plant" maxlength="11" value="{{  $getPurchaseQuotation[0]->plant_code }}" autocomplete="off" readonly>
                        ...
                        <div class="form-group">
                          ...
                          <label>Profit Center Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="profitList"  id="profitctrId" name="pfct" class="form-control  pull-left" value="{{ $getPurchaseQuotation[0]->pfct_code }}" placeholder="Select Profit Center Code" oninput="this.value = this.value.toUpperCase()"  autocomplete="off" readonly>
                        ...
                        <div class="form-group">
                          ...
                          <label>Acc Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="AccountList"  id="account_code" name="AccCode" class="form-control  pull-left" value="{{ $getPurchaseQuotation[0]->acc_code }}" placeholder="Select Account" oninput="this.value = this.value.toUpperCase()"  autocomplete="off" readonly> 
                        ...
                        <div class="form-group">
                          ...
                          <label> Account Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="acctname" value="" id="accountName" placeholder="Enter Profit Account Name" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Enquiry No :
                            ...
                            <div class="input-group">
                              ...
                              <input list="enquirynoList"  id="enquiryNum" name="enqry" class="form-control  pull-left" value="{{ $getPurchaseQuotation[0]->enqNum }}" placeholder="Select Enquiry No" oninput="this.value = this.value.toUpperCase()" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Tax Code: 
                            ...
                            <div class="input-group">
                              ...
                              <input list="TaxcodeList"  id="tax_code" name="taxcode" class="form-control  pull-left" value="{{ $getPurchaseQuotation[0]->tax_code }}" placeholder="Select Tax" oninput="this.value = this.value.toUpperCase()" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Due Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control rightcontent" name="due_date" id="due_date" value="{{ $getPurchaseQuotation[0]->due_date }}" placeholder="Select Due" autocomplete="off" readonly>
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="party_ref" id="party_rf_no" placeholder="Enter Party Ref No" maxlength="30" value="{{ $getPurchaseQuotation[0]->partyref_no }}" autocomplete="off">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control partyrefdatepicker" name="party_ref_d" id="party_ref_date" value="{{ $getPurchaseQuotation[0]->partyref_date }}" placeholder="Select Party Ref Date" autocomplete="off">
                            ...
                            <div class="form-group">
                              ...
                              <label>Consine Code : <span class="required-field"></span></label>
                                ...
                                <div class="input-group">
                                  ...
                                  <input list="consineList"  id="consine_code" name="consine" class="form-control pull-left" value="{{ $getPurchaseQuotation[0]->consine_code }}" placeholder="Select consine" oninput="this.value = this.value.toUpperCase()" autocomplete="off">
            ...
            <form id="salesordertrans">
              ...
              <div class="table-responsive">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                 ...
                 <?php $srno=1; $incNo=1; $allcount = count($getPurchaseQuotation); foreach($getPurchaseQuotation as $row) { ?>
                  ...
                  <tr class="useful">
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type="hidden" id="enquiry_date<?php echo $incNo;?>" name="enquiry_date[]">
                        <input type="hidden" id="enquiry_tran_code<?php echo $incNo;?>" name="enquiry_tran_code[]">
                        <input type="hidden" id="enquiry_series_code<?php echo $incNo;?>" name="enquiry_series_code[]">
                        <input type="hidden" id="enquiry_vr_no<?php echo $incNo;?>" name="enquiry_vr_no[]">
                        <input type="hidden" id="enquiry_sl_no<?php echo $incNo;?>" name="enquiry_sl_no[]">


                        <input type ="hidden" name="quahead_id[]" id="quahead_id<?php echo $incNo;?>" value="{{ $row->purchase_quotation_head_id }}">
                        <input type ="hidden" name="body_taxcode[]" id="quahead_id<?php echo $incNo;?>" value="{{ $row->tax_code }}">

                      <div class="input-group">
                        <input list="ItemList<?php echo $incNo;?>" class="inputboxclr SetInCenter" style="width: 90px;margin-bottom: 5px;" id='ItemCodeId<?php echo $incNo;?>' value="{{ $row->item_code }}" name="item_code[]"  onchange="ItemCodeGet('<?php echo $incNo;?>'); checktaxCode('<?php echo $incNo;?>');taxIntaxrate('<?php echo $incNo;?>');"  oninput="this.value = this.value.toUpperCase()" />

                          <datalist id="ItemList<?php echo $incNo;?>">
                      
                          </datalist>
                      </div>
                      <div class="divhsn" id="showHsnCd<?php echo $incNo;?>"></div>
                      ...
                      <input type="hidden" name="body_id[]" id="body_id<?php echo $incNo;?>" value="{{ $row->id }}">
                    </td>

                    <td class="tdthtablebordr">

                      <input type="text" class="inputboxclr getAccNAme" style="width: 190px;margin-bottom: 5px;" id='Item_Name_id<?php echo $incNo;?>' name="item_name[]" readonly  value="{{ $row->item_name }}"/>

                      <textarea id="remark_data<?php echo $incNo;?>" rows="1" style="width: 190px;margin-bottom: 2%;" class="" name="remark[]" placeholder="Enter Description" readonly>{{ $row->remark }}</textarea>
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter"  id='qty<?php echo $incNo;?>' name="qty[]" oninput="CalAQty('<?php echo $incNo;?>')" style="width: 80px"  value="{{ $row->quantity }}"/>

                      <input type="text" name="unit_M[]" id="UnitM<?php echo $incNo;?>" class="inputboxclr SetInCenter AddM" readonly value="{{ $row->um_code }}">
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter"  id='A_qty<?php echo $incNo;?>' name="Aqty[]"  style="width: 80px" readonly value="{{ $row->Aquantity }}"/>

                      <input type="text" name="add_unit_M[]" id="AddUnitM<?php echo $incNo;?>" class="inputboxclr SetInCenter AddM" value="{{ $row->aum_code }}" readonly>
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type='text' class="debitcreditbox inputboxclr cr_amount SetInCenter" oninput="calculateBasicAmt(1)" id='rate<?php echo $incNo;?>' name="rate[]"  style="width: 80px" readonly value="{{ $row->rate }}"/>

                    </td>

                    <td class="tdthtablebordr">

                       <input type="text" name="basic_amt[]" id="basic<?php echo $incNo;?>" value="{{ $row->basic_amt }}" class="form-control basicamt debitcreditbox" style="width: 110px;margin-top: 14%;height: 22px;" readonly>

                    </td>

                    <td>
                        <input type="hidden" id="data_count<?php echo $incNo;?>" class="dataCountCl" value="0" name="data_Count[]">

                        <input type="hidden" class="setGrandAmnt" id="get_grand_num<?php echo $incNo;?>" name="crAmtPerItem[]">
                     ...
                     <td>
                        ...
                        <div style="margin-top: 12%;">
                            <small id="qpnotfound<?php echo $incNo;?>" class="label label-danger"></small>
                        </div>

                        <input type="hidden" id="quaP_count<?php echo $incNo;?>" value="0" name="quaP_count[]" class="quaPcountrow" style="z-index: 0;">
                        <button type="button" class="btn btn-primary btn-xs tdsratebtn" id="qua_paramter<?php echo $incNo;?>" data-toggle="modal" data-target="#quality_parametr<?php echo $incNo;?>" onclick="qty_parameter('<?php echo $incNo;?>')" disabled="" style="padding-bottom: 0px;padding-top: 0px;">Quality Parametr </button>

                        <div id="cancelQpbtn<?php echo $incNo;?>"></div>
                        <div id="appliedQpbtn<?php echo $incNo;?>"></div>
                        
                        <div id="qpApplyOrNot<?php echo $incNo;?>" class="aplynotStatus">0</div>


                        <small id="qPnotfountbtn<?php echo $incNo;?>" class="label label-danger"></small>
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  <div class="form-group">
                      ...
                      <input type="text" class="settaxcodemodel col-md-7" id="tax_code<?php echo $incNo;?>" value="{{ $row->tax_code }}" style="border: none; padding: 0px;" readonly>
                  </div>
                </div>
            ...
            <div class="modal-content" style="border-radius: 5px;">
                ...
                <div class="modal-footer">
                   <button type="button" class="btn btn-primary" data-dismiss="modal" >Ok</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="cancleblnkItm('<?php echo $incNo;?>');" >Cancel</button>
                 ...
                 <input type="hidden" value="<?php echo $allcount;?>" id="rowcountE">
             ...
             <!--  <div class="row">
              ...
              <div class="row" style="display: flex;">
                  ...
                  <div class="col-md-1">
                    ...
                    <input class="credittotldesn inputboxclr" type="text" name="TotalCredit" id="basicTotal" value="" style="margin-top: 3px;">
               ...
               <div class="row" style="display: flex;">
                  ...
                  <div class="col-md-1">
                    ...
                    <input class="credittotldesn inputboxclr" type="text" name="TotalCredit" id="otherTotalAmt" readonly="" value="" style="margin-top: 3px;">
               ...
               <div class="row" style="display: flex;">
                  ...
                  <div class="col-md-1">
                    ...
                    <input class="credittotldesn inputboxclr" type="text" name="TotalCredit" id="allgrandAmt" readonly="" value="" style="margin-top: 3px;">
  ...
  $(document).ready(function() {
    ...
    $( window ).on( "load", function() {
     ...
     // alert(head_id);
      ...
      var rowcountE =  $('#rowcountE').val();

      //alert(rowcountE);
     
      
      for(var q=1; q<=rowcountE; q++){
        
      var scount =  $('#snum').html();
              ...
              //  var p = --q;
                ...
                if (data1.response == 'error') {
                    ...
                    if(data1.data==''){
                      ...
                      $('#Cfactor'+p).val(data1.data[0].aum_factor);
...
/*on click model*/
  function CalculateTax(taxid){
    ...
    if(taxOnModel){
      ...
      var bodyId   = $('#body_id'+taxid).val();
      
      var headId   = $('#quahead_id'+taxid).val();
      ...
      $.ajax({
              ...
              url:"{{ url('get-a-field-by-quation-trans-code') }}",

              method : "POST",

              type: "JSON",

              data: { tax_code: tax_code,bodyId:bodyId,headId:headId,ItemCode:ItemCode},
            ...
            success:function(data){
              ...
              var data1 = JSON.parse(data);
                ...
                if (data1.response == 'error') {
                  ...
                  //console.log(data1.data);
                    $("#enquirynoList"+adrow).empty();
                    $.each(data1.data, function(k, getData){

                    $("#enquirynoList"+adrow).append($('<option>',{
...
<script type="text/javascript">
  ...
  function getenquiryNo(enqNo){
    var enquiryno =$('#enquiryno'+enqNo).val();
    
    var xyz = $('#enquirynoList'+enqNo+' option').filter(function() {

          return this.value == enquiryno;
      ...
      if(msg == 'No Match'){
        ...
        $.ajax({
            ...
            url:"{{ url('get-enquiry-no-for-qtn') }}",
    ...
    $("#submitdata").click(function(event) {
      ...
      var data = $("#salesordertrans").serialize();
        ...
        $.ajax({
            ...
            url: "{{ url('/finance/update-perchase-quotation-trans') }}",
            ...
            success: function (data) {
             ...
             var url = "{{url('finance/view-purchase_order-msg')}}"
