       ...
       columns: [
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<a href="edit-dealer/'+btoa(full['SREQHID'])+'" class="btn btn-warning btn-xs" title="edit" disabled><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" onclick="return dealerDelete('+full['SREQHID']+');" disabled><i class="fa fa-trash" title="Delete"></i></button>';
               ...
               success:function(data){
                  ...
                  if (data1.response == 'error') {
                      ...
                      var deletebtn ='<a href="edit-purchase-indent/'+btoa(objrow.purchase_indent_head_id)+'" class="btn btn-warning btn-xs" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" onclick="return pindentDelete('+objrow.id+');"><i class="fa fa-trash" title="Delete"></i></button>';
                               ...
                               $('#childData_'+tableid).append('<tr><td class="text-center">'+srNo+'</td><td>'+objrow.item_name+' / '+objrow.item_code+'</td><td class="text-right">'+objrow.qty_recvd+'</td><td class="text-right">'+objrow.aq_recvd+'</td><td class="text-right">'+approval_btn1+'</td><td class="text-right">'+approval_btn+'</td><td class="text-right">'+deletebtn+'</td></tr>');
                              srNo++;
                             });
