...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">
          <a href="{{ url('/Transaction/Purchase/Purchase-Enquiry-Trans') }}"> CRM Enquiry</a>
        </li>
        ...
        <div class="col-sm-12">
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">CRM Enquiry Transaction</h2>

              <div class="box-tools pull-right">

                <a href="{{ url('Transaction/Crm/View-Crm-Enquery-Trans') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Transaction</a>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <label>Emp-Id: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="empid" id="empid" value="{{ $userid }}"  autocomplete="off" readonly="">
                            ...
                            <small id="emailHelp" class="form-text text-muted">
                                    ...
                                    {!! $errors->first('empid', '<p class="help-block" style="color:red;">:message</p>') !!}
                        ...
                        <div class="form-group">
                          ...
                          <label>Emp Name: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="empname" id="empname" value="{{ $username }}"  autocomplete="off" readonly>
                        ...
                        <div class="form-group">
                          ...
                          <label>Account Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                             ...
                             <input list="AccountList"  id="account_code" name="AccCode" class="form-control  pull-left" value="<?php if($accCount == 1){echo $getacc[0]->ACC_CODE;}else{} ?>" placeholder="Select Vendor" oninput="this.value = this.value.toUpperCase()"  autocomplete="off" > 
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                  ...
                  <tr class="useful">
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type='text' class="debitcreditbox dr_amount getqtytotal inputboxclr SetInCenter"  id='qty1' name="qty[]" onclick="showbtn(1)" oninput="CalAQty(1)" style="width: 80px" />
...
<script type="text/javascript">
  ...
  function getvrnoBySeries(){
    ...
    $.ajax({
          ...
          url:"{{ url('get-vr-sequence-by-series-crm') }}",
...
$(document).ready(function(){
    ...
    $("#savedataAfterAlert1").click(function(event) {
    ...
    var trcount=$('table tr').length;
      ...
      if(found == 0){
          ...
          $.ajax({
              ...
              url: "{{ url('/Transaction/Crm/Save-Crm-Enquiry-Trans') }}",
