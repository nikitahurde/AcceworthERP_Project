...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">
          <a href="{{ url('/Transaction/Sales/Sales-Order-Trans') }}"> CRM Order Transaction</a>
        </li>
        ...
        <div class="col-sm-12">
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">CRM Order Transaction</h2>
                        ...
                        <div class="form-group">
                          ...
                          <label>Consignee/Delivery To: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="shipTAdd"  id="shipTAddr" class="form-control  pull-left" value="" placeholder="Select Consignee/Delivery To" oninput="this.value = this.value.toUpperCase()" onchange="gettaxByStatCdSale();" autocomplete="off"> 
...
<script type="text/javascript">
  ...
  function getvrnoBySeries(){
    ...
    $.ajax({
          ...
          url:"{{ url('get-vrno-by-series-trans-in-crm') }}",
    ...
    $("#taxSelectModel"+ItemId).modal({
      ...
      if(msg=='No Match'){
        ...
        $('#itmC_code'+ItemId).val(ItemCode);
         ...
         $('#vr_date,#series_code_sale,#profitctrId,#Plant_code_sale,#shipTAddr,#sale_rep_code,#costCent_code_sale,#account_code_sale,#tax_code_get,#due_days,#saleConNo,#party_rf_no,#party_ref_date,#consine_code,#rfhead1,#rfhead2,#rfhead3,#rfhead4,#rfhead5').prop('readonly',true);
