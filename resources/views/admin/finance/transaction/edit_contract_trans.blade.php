        ...
        <div class="col-sm-12">
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">Contract Transaction</h2>
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text"  id="series_code" name="series" class="form-control  pull-left" value="{{ $contract_head->series_code }}" placeholder="Select Series" oninput="this.value = this.value.toUpperCase()" autocomplete="off">

                            <input type="hidden" id="head_id" name="head_id" value="{{ $contract_head->id }}">
                        ...
                        <div class="form-group">
                          ...
                          <label> Series Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="tran" id="seriesName" placeholder="Enter Series Name" value="{{ $series_name->series_name }}" readonly autocomplete="off">
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control rightcontent" name="vro" value="{{ $contract_head->vr_no }}" placeholder="Enter Vr No" id="vrseqnum" readonly autocomplete="off">

                            <!-- <input type="text" name="vnum" id="vnum" value="{{ $contract_head->plant_code }}"> -->
                        ...
                        <div class="form-group">
                          ...
                          <label>Plant Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" id="Plant_code" value="{{ $contract_head->plant_code }}" name="plantcode" placeholder="Select Plant" maxlength="11" autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Profit Center Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="profitList"  id="profitctrId" name="pfct" class="form-control  pull-left" value="{{ $contract_head->pfct_code }}" placeholder="Select Profit Center Code" oninput="this.value = this.value.toUpperCase()"  autocomplete="off" readonly>
                        ...
                        <div class="form-group">
                          ...
                          <label>Acc Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="AccountList"  id="account_code" name="AccCode" class="form-control  pull-left" value="{{ $contract_head->acc_code }}" placeholder="Select Account" oninput="this.value = this.value.toUpperCase()"  autocomplete="off"> 
                        ...
                        <div class="form-group">
                          ...
                          <label>Tax Code: 
                            ...
                            <div class="input-group">
                              ...
                              <input list="TaxcodeList"  id="tax_code" name="taxcode" class="form-control  pull-left" value="{{ $contract_head->tax_code }}" placeholder="Select Tax" oninput="this.value = this.value.toUpperCase()" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Due Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control rightcontent" name="due_date" id="due_date" value="{{ $contract_head->due_date }}" placeholder="Select Due" autocomplete="off" readonly>
          ...
          <div class="box-body">
            ...
            <form id="salesordertrans">
              ...
              <div class="table-responsive">
                ...
                <?php $srno=1; $incNo =1; $allcount = count($contract_body);  foreach($contract_body as $row)  { ?> 
                  ...
                  <tr class="useful">
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type="hidden" name="vnum[]" value="{{ $row->vrno }}">
                    </td> 

                    <td class="tdthtablebordr">
                      <div class="input-group">
                        <input list="ItemList<?php echo $incNo;?>" class="inputboxclr SetInCenter" style="width: 90px;margin-bottom: 5px;" id='ItemCodeId<?php echo $incNo;?>' name="item_code[]"  onchange="ItemCodeGet('<?php echo $incNo;?>'); checktaxCode('<?php echo $incNo;?>');taxIntaxrate('<?php echo $incNo;?>');getQtyFrQuoComp('<?php echo $incNo;?>');"  oninput="this.value = this.value.toUpperCase()"  value="{{ $row->item_code }}" />
                      ...
                      <input type="hidden" id="purqtn_head_id<?php echo $incNo;?>" value="{{ $row->contract_head_id }}">
                      <input type="hidden" id="purb_id_fpurtax<?php echo $incNo;?>">
                    </td>
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type="text" class="inputboxclr getAccNAme" style="width: 190px;margin-bottom: 5px;" id='Item_Name_id<?php echo $incNo;?>' name="item_name[]" readonly  value="{{ $row->item_name }}" />
                       ...
                       <input type ="hidden" name="bodytax_code[]" value="{{ $row->tax_code }}">

                      <textarea id="remark_data1" rows="1" style="width: 190px;margin-bottom: 2%;" class="" name="remark[]" placeholder="Enter Description" readonly value="{{ $row->remark }}"></textarea>
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter"  id='qty<?php echo $incNo;?>' name="qty[]" onkeyup="CalAQty('<?php echo $incNo;?>')" style="width: 80px"  value="{{ $row->quantity}}" />
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type="text" name="add_unit_M[]" id="AddUnitM<?php echo $incNo;?>" class="inputboxclr SetInCenter AddM" readonly value="{{ $row->aum_code}}"> 
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type='text' class="debitcreditbox inputboxclr cr_amount SetInCenter" oninput="calculateBasicAmt('<?php echo $incNo;?>')" id='rate<?php echo $incNo;?>' name="rate[]"  style="width: 80px"  value="{{ $row->rate }}"/>

                    </td>

                    <td class="tdthtablebordr">

                       <input type="text" name="basic_amt[]" id="basic<?php echo $incNo;?>" class="form-control basicamt" style="width: 110px;margin-top: 14%;height: 22px;" readonly value="{{ $row->basic_amt }}">
                    ...
                    <td>
                       ...
                       <button type="button" class="btn btn-primary btn-xs tdsratebtn" id="CalcTax<?php echo $incNo;?>" data-toggle="modal" data-target="#tds_rate_model<?php echo $incNo;?>" onclick="CalculateTax('<?php echo $incNo;?>'); getGrandTotal('<?php echo $incNo;?>'); grandCalculation('<?php echo $incNo;?>');">Calc Tax </button>
        ...
        <div class="modal-dialog" role="document" style="margin-top: 5%;">
          ...
          <div class="modal-content" style="border-radius: 5px;">
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  <div class="form-group">
                      ...
                      <input type="text" class="settaxcodemodel col-md-7" id="tax_codeid<?php echo $incNo;?>" value="{{ $row->tax_code }}" style="border: none; padding: 0px;" readonly>
                  </div>
                </div>
            ...
            <div class="modal-footer">
              ...
              <span  id="footer_tax_btn<?php echo $incNo;?>" style="width: 56px;"></span>
            </center>
             ...
             <!--  <div class="row">
              ...
              <div class="row" style="display: flex;">
                  ...
                  <div class="col-md-1">
                    ...
                    <input class="credittotldesn inputboxclr" type="text" name="TotalCredit" id="basicTotal" value="<?= $total ?>" readonly="" style="margin-top: 3px;">
               ...
               <div class="row" style="display: flex;">
                  ...
                  <div class="col-md-1">
                    ...
                    <input class="credittotldesn inputboxclr" type="text" name="TotalCredit" id="allgrandAmt" value="<?= number_format($grndtotal,2) ?>" readonly="" style="margin-top: 3px;">
...
/*on click model*/
  function CalculateTax(taxid){
    ...
    $.ajaxSetup({
      ...
      var taxOnModel = $('#tax_codeid'+taxid).val();
    ...
    if(taxOnModel){
      ...
      var tax_code = $('#tax_codeid'+taxid).val();

      var headId = $('#purqtn_head_id'+taxid).val();
      var bodyId = $('#body_id'+taxid).val();
      var ItemCode = $('#ItemCodeId'+taxid).val();


//console.log('taxOnModel',tax_code);

      console.log(tax_code);

      $.ajax({

              url:"{{ url('get-a-field-by-contract-trans-code') }}",

              method : "POST",

              type: "JSON",

              data: {tax_code:tax_code,headId:headId,bodyId:bodyId,ItemCode:ItemCode},
                   ...
                   //console.log('Get Data => ',data1);
                    if (data1.response == 'error') {
                      ...
                      $("#CalcTax1").prop('disabled',false);
                        ...
                        console.log('basicheadval',basicheadval);
                          var counter = 1;
  ...
  function ItemCodeGet(ItemId){
    ...
    $("#HsnSameShow"+ItemId).modal({
      ...
      if(msg=='No Match'){
         ...
         $('#Plant_code,#series_code,#account_code,#Quotn_compare_no,#due_days').prop('readonly',true); 
    ...
    $("#submitdata").click(function(event) {
      ...
      var data = $("#salesordertrans").serialize();
        ...
        $.ajax({
            ...
            url: "{{ url('/finance/update-contract-transaction') }}",
