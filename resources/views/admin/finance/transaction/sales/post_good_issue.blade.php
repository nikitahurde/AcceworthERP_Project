...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">
          <a href="{{ url('/Transaction/Sales/Sales-Order-Trans') }}"> Post Goods Issue</a>
        </li>
        ...
        <div class="col-sm-12">
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Post Goods Issue</h2>

              <div class="box-tools pull-right">

                <a href="{{ url('/Transaction/Sales/View-Post-Good-Issue-Trans')}}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Transaction</a>
              ...
              <div class="tab-content">
                  <div class="tab-pane fade in active" id="tab1info">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <input type="hidden" id="seriesPostc" name="seriesPostc">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <a class="btn btn-info"  href="#tab2info" data-toggle="tab" style="margin-top: 25px;" id="nextbtn" >Next&nbsp;&nbsp;<i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                      </div>
                            ...
                            <div class="form-group">
                              ...
                              <label>Transporter Code : <span class="required-field"></span></label>
                                ...
                                <div class="input-group">
                                  ...
                                  <input list="trptList"  id="trpt_code" name="trptcd" class="form-control pull-left" value="{{ old('trpt')}}" placeholder="Select Transporter" oninput="this.value = this.value.toUpperCase()" autocomplete="off">

                                  <datalist id="trptList">

                                    <option selected="selected" value="">-- Select --</option>

                                    @foreach ($transp_list as $key)
                                ...
                                <small id="trpt_err" style="color: red;" class="form-text text-muted"> </small>

                                <small> <div class="pull-left showSeletedName" id="trptText"></div> </small>
                            ...
                            <div class="form-group">
                              ...
                              <label>Transporter Name : <span class="required-field"></span></label>
                                ...
                                <div class="input-group">
                                  ...
                                  <input typ="text"  id="trpt_name" name="trptnm" class="form-control pull-left" value="{{ old('trptname')}}" placeholder="Select Transporter Name" oninput="this.value = this.value.toUpperCase()" autocomplete="off" readonly> 
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="form-group">
                            ...
                            <label>Vehical No : <span class="required-field"></span></label>
                              ...
                              <div class="input-group">
                                ...
                                <input typ="text"  id="vehical_no" name="vehicl" class="form-control pull-left" value="{{ old('vehicl')}}" placeholder="Enter Vehical No" oninput="this.value = this.value.toUpperCase()" autocomplete="off" > 
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="form-group">
                            ...
                            <label>LR No : <span class="required-field"></span></label>
                              ...
                              <div class="input-group">
                                ...
                                <input typ="text"  id="lrNo" name="lrn" class="form-control pull-left" value="{{ old('lrn')}}" placeholder="Enter LR No" oninput="this.value = this.value.toUpperCase()" autocomplete="off" > 
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="form-group">
                            ...
                            <label>E-WAY Bil No : <span class="required-field"></span></label>
                              ...
                              <div class="input-group">
                                ...
                                <input typ="text"  id="eWayBilN" name="eway" class="form-control pull-left" value="{{ old('eway')}}" placeholder="E-WAY Bil No" oninput="this.value = this.value.toUpperCase()" autocomplete="off" > 
  ...
  <section class="content" style="margin-top: -10%;">
            ...
            <form id="salesQuoTrans">
              ...
              <div class="table-responsive">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                  ...
                  <input type="hidden" name="seriesGlCode" id="getseriesGl">
                  <input type ="hidden" name="consneAdd" id="gateconsAdd">
                  <input type ="hidden" name="Sale_Reps" id="gateSaleRep">
                  <input type ="hidden" name="sale_reps_name" value="<?php if($salerCd == 1){echo $sale_rep_list[0]->ACC_NAME;}?>" id="gateSaleRepsName">
                  ...
                  <input type ="hidden" name="transpt_code" id="gettrpt_code">
                  <input type ="hidden" name="transpt_name" id="gettrpt_name">
                  <input type ="hidden" name="vehical_no" id="getvehicalNo">
                  <input type ="hidden" name="lrNum" id="getlrno">
                  <input type ="hidden" name="eWayBilNo" id="getEWayBilNo">
                  ...
                  <tr class="useful" id="firstRowtr">
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="inputboxclr itmbyQc" style="width: 90px;margin-bottom: 4px;margin-top: 13px;" id='Item_CodeId1' name="itemsale[]" onclick="ShowItemCode(1);" oninput="this.value = this.value.toUpperCase()" readonly />

                        <input list="ItemList1" class="inputboxclr SetInCenter" style="width: 90px;margin-bottom: 5px;" id='ItemCodeId1' name="item_code[]"  onchange="ItemCodeGet(1); taxIntaxrate(1);"  oninput="this.value = this.value.toUpperCase()" readonly />
                       ...
                       <button type="button" class="btn btn-primary btn-xs showdetail viewbtnitem" id="viewItemDetail1" data-toggle="modal" data-target="#view_detail1" onclick="showItemDetail(1)"><i class="fa fa-info" aria-hidden="true" style="font-size: 13px;"></i> </button>
                        ...
                        <p id="stockOpQty1" class="badge" style="background-color:#25b6bd;"></p>
                        <input type="hidden" value="" name="stock_quantity[]" id="stock_Qty1">
                        ...
                        <input type="hidden" id="glByItem1" value="0" name="glByItem[]">
                        <input type="hidden" id="glnameByItem1" name="glNameByItem[]">
                        <input type="hidden" id="stdRateByItm1" value="0" name="stdRateByItm[]">
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type="hidden" id="std_rateitm1" class="stdRateAmtC" value="0" name="std_rateitm[]">
                    </td>
             ...
             <!--  <div class="row">
               ...
               <input type="hidden" id="totalStdRateAmt" name="totalStdRateAmt" value="0">
    ...
    <!--  when gl/post code not applied show model -->
    ...
    <!--  when gl/post code not applied show model -->
     ...
     <!-- show modal when click on item code -->
      ...
      <!--  year opening stock qty -->

      <div id="yrOpQtyShModel1" class="modal fade" tabindex="-1">
        ...
        <div class="modal-dialog modal-sm" style="margin-top: 13%;">
            ...
            <div class="modal-content" style="border-radius: 5px;">
                ...
                <div class="modal-header">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-12">
                        ...
                        <h5 class="modal-title modltitletext" id=""  style="color: red;font-weight: 800;"><i class="fa fa-exclamation-triangle" aria-hidden="true" style="font-size: 25px;"></i> Alert</h5>
                ...
                <div class="modal-body table-responsive">
                    ...
                    <p>Dispatch Quantity Should Not Be Greater Than Available Stock.</p>

                </div>

                <div class="modal-footer" style="text-align: center;" id="greatQtyFooter">

                    <button type="button" class="btn btn-primary" data-dismiss="modal" style="width: 61px;" onclick="cancleDisGreatQty(1);">ok</button>
  ...
  <!-- show modal when click on simulation  -->
                ...
                if (data1.response == 'error') {
                  ...
                  $('#errorItem').html("<p style='color:red'>"+ data1.message +"</p>");
                    ...
                    if(data1.sale_quotation_data == ''){
                      ...
                      $('#saleConNotF').html('Sale Order No. Not Found').css('color','red');
                      ...
                      $.each(data1.sale_quotation_data, function(k, saleQuo){
                        ...
                        var startyear = saleQuo.FY_CODE;
                        var getyear = startyear.split('-');

                        $("#saleConList").append($('<option>',{

                          value:getyear[0]+' '+saleQuo.SERIES_CODE+' '+saleQuo.VRNO,

                          'data-xyz':getyear[0]+' '+saleQuo.SERIES_CODE+' '+saleQuo.VRNO,
                          text:getyear[0]+' '+saleQuo.SERIES_CODE+' '+saleQuo.VRNO
...
<script type="text/javascript">
    ...
    function getITmBySaleContra(){
      ...
      $.ajax({
            ...
            data: {account_code: account_code,sale_ContNo:sale_ContNo,trans_code:trans_code},
              ...
              var data1 = JSON.parse(data);
                if (data1.response == 'error') {
                  ...
                  if(data1.data == ''){
                    ...
                    $('#gateduedays').val(diffInDays);
                    $('#due_date').val(endDate);
                    $('#get_due_date').val(endDate);
                ...
                if (data1.response == 'error') {
                  ...
                  //console.log(data1.data[0].item_name);
                    if(data1.data == ''){
                      ...
                      var tableHead= "<div class='box-row'><div class='box10 texIndbox'>#</div><div class='box10 vrnoinbox'>Vr. No</div><div class='box10 itemIndbox'>Item </div><div class='box10 rateIndbox'>Qty Order </div><div class='box10 rateIndbox'>Qty Post Goods Issue </div><div class='box10 rateIndbox'>Qty Cancle </div><div class='box10 rateIndbox'>Bal. Qty </div></div>";
  ...
  function umAumByitm(umaumvl,cfval){
      ...
      $.ajax({
          ...
          data: {ItemCode: ItemCode,taxCode:taxCode,plantCode:plantCode},
           ...
           success:function(data){
                ...
                if (data1.response == 'error') {
                    ...
                    if(data1.itypeGl==''){
                      ...
                      $('#glByItem'+umaumvl).val(data1.itypeGl[0].POST_CODE);
                      $('#glnameByItem'+umaumvl).val(data1.itypeGl[0].GL_NAME);
                    }

                    if(data1.stdRate==''){
                      $('#stdRateByItm'+umaumvl).val('0');
                    }else{
                      $('#stdRateByItm'+umaumvl).val(data1.stdRate[0].STDRATE);

                      var stdRate = data1.stdRate[0].STDRATE;

                      var calstdRate =  qunatity * stdRate;
                       $('#std_rateitm'+umaumvl).val(calstdRate);
                  ...
                  if(data1.data == ''){
                    ...
                    $('#getseriesGl').val('');
                      ...
                      if(data1.data[0].POST_CODE == null || data1.data[0].POST_CODE == ''){
                        ...
                        $('#seriesPostc').val(data1.data[0].POST_CODE);
                      }

                      $('#seriesGl').val(data1.data[0].GL_CODE);
                      $('#getseriesGl').val(data1.data[0].GL_CODE);
...
<script type="text/javascript">
  ...
  function ItemCodeGet(ItemId){
    ...
    $("#taxSelectModel"+ItemId).modal({
      ...
      if(msg=='No Match'){
       ...
       var itemCountCk = $('#itmCountchk').val();
      ...
      if(ItemCode){
            ...
            $.ajax({
                ...
                data: {ItemCode: ItemCode,plantCode:plantCode,taxCode:taxCode,accCode:accCode,taxType:taxType},
                      ...
                      if (data1.response == 'error') {
                        ...
                        console.log('data1.data',data1.data);
                          ...
                          if(data1.itypeGl==''){
                            ...
                            $('#glByItem'+ItemId).val(data1.itypeGl[0].POST_CODE);
                            $('#glnameByItem'+ItemId).val(data1.itypeGl[0].GL_NAME);
                          }

                          if(data1.stdRate==''){
                            $('#stdRateByItm'+ItemId).val('0');
                          }else{
                            $('#stdRateByItm'+ItemId).val(data1.stdRate[0].STDRATE);

                            var yrOpStockQty = parseFloat(data1.stdRate[0].YROPQTY) + parseFloat(data1.stdRate[0].YRQTRECD) - parseFloat(data1.stdRate[0].YRQTYISSUED);

                            $('#stockOpQty'+ItemId).html('Stock : '+yrOpStockQty);
                            $('#stock_Qty'+ItemId).val(yrOpStockQty);
  ...
  function taxIntaxrate(trateid){
    setTimeout(function() {
      ...
      console.log('taxCodebyitm chk',taxCodebyitm);
  ...
  function submitAllData(valD){
    ...
    var trcount=$('table tr').length;
      ...
      for(var y=0;y<trcount;y++){
        ...
        var ifglnotaply = $('#glByItem'+trid).val();
        var ifstdratenotF = $('#stdRateByItm'+trid).val();

        valuetax.push(ifnotaply);
        valuegl.push(ifglnotaply);
        stdRate.push(ifstdratenotF);
      ...
      var found_stdRate = stdRate.find(function (element) {
        return element;
      });
        ...
        if(found == 0 && grandAmt < 0){
        ...
        }else if(found_glP == '' || found_glP ==null || found_glP == 0){

            $("#gl_postNotAppied").modal('show');
            $('#notApMsgforSeries').html('');
            $('#notApMsgforstdRate').html('');
            $('#showWhenCrLimitLow').html('');
            $('#notApMsgforitem').html('The <b>Post Code </b> Has Not Been Applied. In Some Of The Above Item.');

        }else if(found_stdRate == '0.00'){
            $("#gl_postNotAppied").modal('show');
            $('#notApMsgforSeries').html('');
            $('#notApMsgforitem').html('');
            $('#showWhenCrLimitLow').html('');
            $('#notApMsgforstdRate').html('The <b>Std Rate </b> Has Not Been Applied. In Some Of The Above Item.');
          ...
          $.ajax({
              ...
              url: "{{ url('/Transaction/Sales/Save-Post_Godd_Issue-Trans') }}",
              ...
              success: function (data) {
                ...
                if (data1.response == 'error') {
                    ...
                    var url = "{{url('Transaction/Sales/Post-Good-Issue-Save-Msg')}}"
...
/* -------- simulation ------------- */
  ...
  function simulationcal(){
    ...
    var totalRate    = $('#totalStdRateAmt').val();
    var itmePostCode = [];
    var itmstdRate   = [];
    var itemCode     = [];

    $('input[name^="glByItem"]').each(function (){
          itmePostCode.push($(this).val());
    });

    $('input[name^="std_rateitm"]').each(function (){
          itmstdRate.push($(this).val());
    });
    ...
    $.ajax({
        ...
        url:"{{ url('get-simulation-data-for-sale-challan') }}",

        method : "POST",

        type: "JSON",

        data: {seriesGl: seriesGl,totalRate:totalRate,itmePostCode:itmePostCode,itmstdRate:itmstdRate,itemCode:itemCode},
