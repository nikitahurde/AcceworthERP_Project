...
<style>
  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <!--   <small><b>< ?php echo $form_number; ?></b></small> -->
             ...
             <small><b>Sale Contract Transaction Details</b></small> 
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/Transaction/Sales/View-Sale-Contract-Trans') }}">Master Account</a></li>

            <li class="active"><a href="{{ url('/Transaction/Sales/View-Sale-Contract-Trans') }}">View Sale Contract</a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">View Sale Contract Trans</h3>

                  <div class="box-tools pull-right">

          <a href="{{ url('/Transaction/Sales/Sales-Contract-Trans') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Sale Contract Trans</a>
 ...
 <div class="modal fade" id="salecontDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal" style="margin-right: 23%;">Cancle</button>
          ...
          <form action="{{ url('/Transaction/Sales/Delete-Sale-Contract-Trans') }}" method="post">
...
<script type="text/javascript">
   ...
   function format ( d ) {
    console.log('d',d.SCNTRHID);
    // `d` is the original data object for the row
    return '<table border="0" class="table table-bordered table-striped table-hover chieldtblecls" id="childData_'+d.SCNTRHID+'" style="padding-left:50px;">'+
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/Transaction/Sales/View-Sale-Contract-Trans') }}"
       ...
       columns: [
          ...
          { data:"",className:'details-control',
            ...
            return '<button id="showchildtable" onclick="showchildtable('+full.VRNO+','+full.SCNTRHID+')"><i class="fa fa-plus" id="minus'+full.VRNO+''+full.SCNTRHID+'" title="Edit"></i></button>'
          }
         },
         {  
            render: function (data, type, full, meta){
         ...
         {  
            render: function (data, type, full, meta){
              ...
              if((found == undefined) && (foundQty == undefined)){
                  /*var deletebtn ='<a href="Edit-Sale-Contract-Trans/'+btoa(full['salehid'])+'/'+btoa(full['SCNTRBID'])+'/'+btoa(full['VRNO'])+'" class="btn btn-warning btn-xs" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" onclick="return saleConDelete('+full['salehid']+');"><i class="fa fa-trash" title="Delete"></i></button>';
                  return deletebtn;*/
       ...
       },
       {
        render:function(data, type, full, meta){
          ...
          return '<button class="btn btn-success pdfbtndn" type="button" id="pdfDown" onclick="downloadPDF('+full['DT_RowIndex']+','+full['SCNTRHID']+','+full['VRNO']+',\''+full['TRAN_CODE']+'\');"><i class="fa fa-download" aria-hidden="true"></i></button>';
        }
       }
   ...
   function showchildtable(vrno,tblid){
            var vrno,tblid;
             ...
             $.ajax({
              ...
              url:"{{ url('view-sale-contract-chield-row-data') }}",
...
<script type="text/javascript">
  function saleConDelete(id) {

    $("#salecontDelete").modal('show');
