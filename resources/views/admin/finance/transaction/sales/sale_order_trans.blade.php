...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">
          <a href="{{ url('/Transaction/Sales/Sales-Order-Trans') }}"> Sales Order Transaction</a>
        </li>
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input list="series_List1"  id="series_code_sale" name="series" class="form-control  pull-left" value="<?php if($seriesCount == 1){echo $series_list[0]->SERIES_CODE; echo "[ ".$series_list[0]->SERIES_NAME." ]";}else{echo old('series_code');} ?>" placeholder="Select Series" oninput="this.value = this.value.toUpperCase()" onchange="getvrnoBySeries()" autocomplete="off">
                ...
                if (data1.response == 'error') {
                  ...
                  $('#errorItem').html("<p style='color:red'>"+ data1.message +"</p>");
                    ...
                    if(data1.dataAccAddr == ''){
                      ...
                      $("#shipTAdd").empty();
                      console.log('dataAccAddr',data1.dataAccAddr);
                ...
                if (data1.response == 'error') {
                  ...
                  //console.log(data1.data[0].item_name);
                    if(data1.data == ''){
                      ...
                      var tableHead= "<div class='box-row'><div class='box10 texIndbox'>#</div><div class='box10 vrnoinbox'>Vr. No</div><div class='box10 itemIndbox'>Item </div><div class='box10 rateIndbox'>Qty Contract </div><div class='box10 rateIndbox'>Qty Order </div><div class='box10 rateIndbox'>Qty Cancle </div><div class='box10 rateIndbox'>Bal. Qty </div></div>";
  ...
  function CalculateTax(taxid){
    ...
    if(taxOnModel == ''){
      ...
      $.ajax({
                ...
                data: {trans_code:trans_code,tax_code: tax_code,slContrHeadId:slContrHeadId,slContrBodyId:slContrBodyId,ItemCode:ItemCode},
  ...
  function ItemCodeGet(ItemId){
    ...
    $("#taxSelectModel"+ItemId).modal({
      ...
      if(msg=='No Match'){
             ...
             $('#rate'+ItemId).val('');
             $('#basic'+ItemId).val('');
             $('#qltyvalue'+ItemId).val('0');
             $('#aplytaxOrNot'+ItemId).val('0');
        ...
        $('#itmC_code'+ItemId).val(ItemCode);
         ...
         $('#vr_date,#series_code_sale,#profitctrId,#Plant_code_sale,#shipTAddrs,#sale_rep_code,#costCent_code_sale,#account_code_sale,#tax_code_get,#due_days,#saleConNo,#party_rf_no,#party_ref_date,#consine_code,#rfhead1,#rfhead2,#rfhead3,#rfhead4,#rfhead5').prop('readonly',true);
      ...
      var foundItm = valueitm.find(function (element) {
        ...
        if(foundItm == ''){
          ...
          $.ajax({
              ...
              url: "{{ url('/Transaction/Sales/Save-Sales-Order-Trans') }}",
              ...
              success: function (data) {
                ...
                //console.log(data);
               var url = "{{url('Transaction/Sales/Sales-Order-Save-Msg')}}"
