...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">
          <a href="{{ url('/Transaction/Sales/Sales-Contract-Trans') }}"> Sales Contract Transaction</a>
        </li>
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <div class="box-tools pull-right">
                ...
                <a href="{{ url('/Transaction/Sales/View-Sale-Contract-Trans')}}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Transaction</a>
                        ...
                        <div class="form-group">
                          ...
                          <label>Customer Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="AccountList"  id="account_code_sale" name="AccCode" class="form-control  pull-left" value="<?php if($accCount == 1){echo $acc_list[0]->ACC_CODE;echo "[ ".$acc_list[0]->ACC_NAME." ]";}else{} ?>" placeholder="Select Customer" oninput="this.value = this.value.toUpperCase()"  autocomplete="off" readonly> 
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <div class="input-group">
                       ...
                       <button type="button" class="btn btn-primary btn-xs showdetail viewbtnitem" id="viewItemDetail1" data-toggle="modal" data-target="#view_detail1" onclick="showItemDetail(1)"><i class="fa fa-info" aria-hidden="true" style="font-size: 13px;"></i> </button>
                        ...
                        <input type="hidden" id="sq_transcode1" name="sq_trans[]">
                        <input type="hidden" id="sq_seriescode1" name="sq_series[]">
                        <input type="hidden" id="sq_vrno1" name="sq_vrno[]">
                        <input type="hidden" id="sq_slno1" name="sq_slno[]">
                        <input type="hidden" id="sq_headid1" name="sq_head[]">
                        <input type="hidden" id="sq_bodyid1" name="sq_body[]">
      ...
      $("#account_code_sale").change(function(){
        ...
        var transDate    =  $('#vr_date').val();
          ...
          $.ajax({
            ...
            data: {account_code: account_code,transDate:transDate,trans_code:trans_code},
...
<script type="text/javascript">
    ...
    function getITmBySaleQC(){
      ...
      var xyz = $('#saleQuoList option').filter(function() {

          return this.value == saleQuoNo;
      ...
      $.ajax({
            ...
            data: {account_code: account_code,sale_QuoNo:sale_QuoNo,trans_code:trans_code},
              ...
              var data1 = JSON.parse(data);
                if (data1.response == 'error') {
                  ...
                  if(data1.data == ''){
                    ...
                    $('#getTaxCode').val(data1.data[0].TAX_CODE).prop('readonly',true);
                  }
                ...
                if (data1.response == 'error') {
                  ...
                  //console.log(data1.data[0].item_name);
                    if(data1.data == ''){
                      ...
                      var tableHead= "<div class='box-row'><div class='box10 texIndbox'>#</div><div class='box10 vrnoinbox'>Vr. No</div><div class='box10 itemIndbox'>Item </div><div class='box10 rateIndbox'>Qty quotation </div><div class='box10 rateIndbox'>Qty Contract </div><div class='box10 rateIndbox'>Qty Cancle </div><div class='box10 rateIndbox'>Bal. Qty </div></div>";
  ...
  function selectitem(rowid,itmebyid){
    ...
    $('#cancelQpbtn'+rowid).html(cnclbtnqp);
      ...
      console.log('sqitmdiscriptn',sqitmdiscriptn);
      if(sqitmdiscriptn == '' || sqitmdiscriptn == null || sqitmdiscriptn == 'null'){
      ...
      $('#vr_date,#series_code_sale,#Plant_code_sale,#profitctrId,#account_code_sale,#shipTAddrs,#sale_rep_code,#costCent_code_sale,#saleQuoNo,#tax_code,#due_days,#party_rf_no,#party_ref_date,#rfhead1,#rfhead2,#rfhead3,#rfhead4,#rfhead5').prop('readonly',true);
          ...
          var itmpositn = exploitm.length;
            ...
            for(var t= 0;t<itmpositn;t++){
              ...
              if(exploitm[t] == newitm){
                ...
                $('#itmC_code'+rowid).val('');
                $('#taxByItem'+rowid).val('');
                $('#sq_transcode'+rowid).val('');
                $('#sq_seriescode'+rowid).val('');
                $('#sq_headid'+rowid).val('');
                $('#sq_bodyid'+rowid).val('');
                $('#sq_vrno'+rowid).val('');
                $('#sq_slno'+rowid).val('');
      ...
      var found = valuetax.find(function (element) {
        ...
        if(found == 0 && grandAmt < 0){
          ...
          $.ajax({
              ...
              url: "{{ url('/Transaction/Sales/Save-Sale-Contract-Trans') }}",
              ...
              success: function (data) {
                ...
                console.log(data);
               var url = "{{url('Transaction/Sales/Sale-Contract-Trans-save-msg')}}"
              ...
              success: function (data) {
                ...
                if (data1.response == 'error') {
                  ...
                  if(downloadFlg == 1){
                      ...
                      var fileN    = 'SCNTR_'+fyCd[0]+''+seriesCd+''+vrNo;
