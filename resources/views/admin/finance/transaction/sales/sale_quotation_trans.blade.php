                            ...
                            <div class="col-md-2">
                              ...
                              <div class="form-group">
                                ...
                                <label>Date: <span class="required-field"></span></label>
                                  ...
                                  <small id="err_datemsg" style="color: red;"></small>
                              ...
                              <div class="form-group">
                                ...
                                <label>Sale Enquiry No :</label>
                                  ...
                                  <div class="input-group">
                                    ...
                                    <input list="saleenquirynoList"  id="salenquiryNum" name="enqry" class="form-control  pull-left" value="" placeholder="Select Sale Enquiry No" oninput="this.value = this.value.toUpperCase()"  onchange="getItemByEnquiryNum()" autocomplete="off"> 

                                    <datalist id="saleenquirynoList">
                          ...
                          <div class="form-group">
                            ...
                            <label>Reverse Quotation: 
                              ...
                              <div class="input-group">
                                ...
                                <input list="revQuoList" id="revQuoNum" name="" class="form-control  pull-left Number" value="No" placeholder="Enter Reverse Quotation" autocomplete="off" style="text-align: end;" onchange="saleQuo.reverseQuoIfYes(gateSaleQuoNo)">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                  ...
                  <tr class="useful" id="firstRowtr">
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <div class="input-group">
                        <input list="ItemList1" class="inputboxclr SetInCenter" style="width: 90px;margin-bottom: 5px;" id='ItemCodeId1' name="item_code[]"  onchange="ItemCodeGet(1); taxIntaxrate(1);" autocomplete="off" readonly />
                      ...
                      <input type="hidden" id="saleQuoHeadId1" name="saleQuoHead[]">
                      <input type="hidden" id="saleQuoBodyId1" name="saleQuoBody[]">
                      <input type="hidden" id="saleEnqHId1" name="saleEnqHId[]">
                      <input type="hidden" id="saleEnqBId1" name="saleEnqBId[]">
                    ...
                    <td class="tdthtablebordr tooltips">
                      ...
                      <textarea id="remark_data1" rows="1" style="width: 190px;" class="" name="remark[]" placeholder="Enter Description" readonly></textarea>
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type='hidden' id='existQty1' name="existQty[]">
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type='hidden' id='existaddQty1' name='existaddQty[]' value="">
                      </div>
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type='hidden' value="" name='existrate[]' id='existrate1'>
                    </td>
                    ...
                    <td class="tdthtablebordr">
                       ...
                       <input type='hidden' value="" name='existbasic[]' id='existbasic1'>
                    </td>
             ...
             <!--  <div class="row">
              ...
              <div class="row" style="display: flex;">
                  ...
                  <div class="col-md-1">
                    ...
                    <input class="credittotldesn inputboxclr" type="text" name="basic_Total" id="basicTotal" readonly="" style="margin-top: 3px;">
               ...
               <div class="row" style="display: flex;">
                  ...
                  <div class="col-md-1">
                    ...
                    <input class="credittotldesn inputboxclr" type="text" name="other_total" id="otherTotalAmt" readonly="" style="margin-top: 3px;">
               ...
               <div class="row" style="display: flex;">
                  ...
                  <div class="col-md-1">
                    ...
                    <input class="credittotldesn inputboxclr" type="text" name="grand_total" id="allgrandAmt" readonly="" style="margin-top: 3px;">
...
/*on click model*/
  ...
  function getItemByEnquiryNum(){
      ...
      var slenqno      =  $('#salenquiryNum').val();

      var xyz = $('#saleenquirynoList option').filter(function() {

          return this.value == slenqno;
      ...
      var enqno      =  $('#salenquiryNum').val();
      var accno      =  $('#account_code_sale').val();
      var spliAcc    =  accno.split('[');
      var accnum     = spliAcc[0];
      ...
      $.ajax({
          ...
          url:"{{ url('get-item-by-enquiryInSale') }}",
...
<script type="text/javascript">
  ...
  $(".addmore").on('click',function(){
      ...
      if(ifnotaply == 0){
       ...
       var accno      =  $('#account_code_sale').val();
       var spliCode   = accno.split('[');
       var accnum     = spliCode[0];
       var tax_code   = $('#tax_code_get').val();
       ...
       var seriesEnq  = getenqvrno[1];
        ...
        $.ajax({
          ...
          url:"{{ url('get-item-in-salenquiry-addmore') }}",
...
<script type="text/javascript">
  ...
  function getitmByTax(){
      var prevTrnNo = $('#salenquiryNum').val();
    if(prevTrnNo){
  ...
  function ItemCodeGet(ItemId){
    ...
    $("#taxSelectModel"+ItemId).modal({
      ...
      if(msg=='No Match'){
             ...
             $('#ItemCodeId'+ItemId+',#Item_Name_id'+ItemId+',#remark_data'+ItemId+',#qty'+ItemId+',#A_qty'+ItemId+',#UnitM'+ItemId+',#AddUnitM'+ItemId+',#rate'+ItemId+',#basic'+ItemId+',#hsn_code'+ItemId+',#taxByItem'+ItemId+',#taxratebytax'+ItemId+',#Cfactor'+ItemId+',#get_grand_num'+ItemId+',#tax_code'+ItemId+'').val('');
             
             $('#data_count'+ItemId+',#aplytaxOrNot'+ItemId+',#quaP_count'+ItemId+'').val('0');
             ...
             $('#qty'+ItemId+'#rate'+ItemId+'').prop('readonly',true);
             
             $('#CalcTax'+ItemId).prop('disabled',true);
             $('#cancelbtn'+ItemId+',#appliedbtn'+ItemId+'').html('');

             $('#appliedQpbtn'+ItemId+',#cancelQpbtn'+ItemId+'').empty();

             rowWiseCalculation();
      }else{

          $('#qty'+ItemId+',#A_qty'+ItemId+',#UnitM'+ItemId+',#AddUnitM'+ItemId+',#remark_data'+ItemId+',#remark_data'+ItemId+',#hsn_code'+ItemId+',#taxByItem'+ItemId+',#taxratebytax'+ItemId+',#rate'+ItemId+',#basic'+ItemId+',#get_grand_num'+ItemId+',#data_count'+ItemId+',#tax_code'+ItemId+',#quaP_count'+ItemId+'').val('');
         ...
         $('#vr_date,#series_code_sale,#Plant_code_sale,#profitctrId,#account_code_sale,#shipTAddrs,#sale_rep_code,#costCent_code_sale,#salenquiryNum,#tax_code_get,#due_days,#party_rf_no,#party_ref_date,#rfhead1,#rfhead2,#rfhead3,#rfhead4,#rfhead5').prop('readonly',true);
        ...
        var saleEnqNo   = $('#salenquiryNum').val();
        var itmCountchk = $('#itmCountchk').val();
                 ...
                 success:function(data){
                      ...
                      if (data1.response == 'error') {
                        ...
                        console.log('data1.data',data1.data);
                          ...
                          console.log('data1.data_enq',data1.data_enq);
                          if(data1.data_enq==''){
                            var enqDate ='';
                            var enqtran ='';
                            var enqseries ='';
                            ...
                            $('#saleEnqHId'+ItemId).val(Aqty);
                            $('#saleEnqBId'+ItemId).val(Aqty);
                            $('#remark_data'+ItemId).val(remark);
                          }else{
                            $('#saleEnqHId'+ItemId).val(data1.data_enq[0].headID);
                            $('#saleEnqBId'+ItemId).val(data1.data_enq[0].bodyID);
                ...
                if (data1.response == 'error') {
                  ...
                  $('#errorItem').html("<p style='color:red'>"+ data1.message +"</p>");
                    ...
                    if(data1.dataAccAddr == ''){
                      ...
                      var gpDays = data1.dataAccAddr[0].GP_DAYS;
                      $('#due_days').val(gpDays);
                    ...
                    if(data1.enq_data==''){
                      ...
                      $.each(data1.enq_data, function(k, getData){

                        var yearf = getData.FY_CODE;

                        var startyear = yearf.split('-');

                        $("#saleenquirynoList").append($('<option>',{
                    ...
                    if(data1.itemList==''){
                      ...
                      $("#ItemList1").empty();
                      $.each(data1.itemList, function(k, getData){
