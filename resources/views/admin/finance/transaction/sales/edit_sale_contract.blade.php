...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">
          <a href="{{ url('/transaction/sales/sales-contract-transaction') }}"> Sales Contract Transaction</a>
        </li>
                        ...
                        <div class="form-group">
                          <label>Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control transdatepicker rightcontent" name="vr" id="vr_date" value="{{ $getSalecontract[0]->vr_date }}" placeholder="Select Date" autocomplete="off">
                      ...
                      <div class="col-md-5">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input list="series_List1"  id="series_code_sale" name="series" class="form-control  pull-left" value="{{ $getSalecontract[0]->series_code }}" placeholder="Select Series" oninput="this.value = this.value.toUpperCase()" autocomplete="off">
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control rightcontent" name="vro" value="{{ $getSalecontract[0]->vr_no }}" placeholder="Enter Vr No" id="vrseqnum" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Plant Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="PlantcodeList" class="form-control" id="Plant_code_sale" name="plantcode" placeholder="Select Plant" maxlength="55" value="{{ $getSalecontract[0]->plant_code }}" onchange="getpftcbyPlant();" autocomplete="off" readonly>
                        ...
                        <div class="form-group">
                          ...
                          <label>Profit Center Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="profitList"  id="profitctrId" name="pfct" class="form-control  pull-left" value="{{ $getSalecontract[0]->pfct_code }}" placeholder="Select Profit Center Code" oninput="this.value = this.value.toUpperCase()"  autocomplete="off" readonly>
                        ...
                        <div class="form-group">
                          ...
                          <label>Acc Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="AccountList"  id="account_code_sale" name="AccCode" class="form-control  pull-left" value="{{ $getSalecontract[0]->acc_code }}" placeholder="Select Account" oninput="this.value = this.value.toUpperCase()"  autocomplete="off" readonly> 
                        ...
                        <div class="form-group">
                          ...
                          <label>Sale Quotation No.: 
                            ...
                            <div class="input-group">
                              ...
                              <input  list="saleQuoList" id="saleQuoNo" name="" class="form-control  pull-left" value="" placeholder="Select Sale Quotation No" onchange="getITmBySaleQC()" autocomplete="off">

                                <datalist id="saleQuoList">
                                  
                                </datalist>
                              
                            </div>
                            <small style="color: red;" id="saleQuoNotF"></small>
                        </div>
                            <!-- /.form-group -->
                      </div>
                        ...
                        <div class="form-group">
                          ...
                          <label>Tax Code:
                            ...
                            <div class="input-group">
                              ...
                              <input list="TaxcodeList"  id="tax_code_get" name="taxcode" class="form-control  pull-left" value="{{$getSalecontract[0]->acc_code}}" placeholder="Select Tax" oninput="this.value = this.value.toUpperCase()" readonly autocomplete="off" onchange="getitmByTax()">
                        ...
                        <div class="form-group">
                          ...
                          <label>Due Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control rightcontent" name="due_date" id="due_date" value="{{$getSalecontract[0]->due_date}}" placeholder="Select Due" autocomplete="off" readonly>
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="party_ref" id="party_rf_no" placeholder="Enter Party Ref No" maxlength="30" value="{{$getSalecontract[0]->partyref_no}}" autocomplete="off">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control partyrefdatepicker" name="party_ref_d" id="party_ref_date" value="{{$getSalecontract[0]->partyref_date}}" placeholder="Select Party Ref Date" autocomplete="off">
                            ...
                            <div class="form-group">
                              ...
                              <label>Consine Code : <span class="required-field"></span></label>
                                ...
                                <div class="input-group">
                                  ...
                                  <input list="consineList"  id="consine_code" name="consine" class="form-control pull-left" value="{{$getSalecontract[0]->consine_code}}" placeholder="Select consine" oninput="this.value = this.value.toUpperCase()" autocomplete="off">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="Rfhead_1" placeholder="Enter Rfhead1" maxlength="30" value="{{$getSalecontract[0]->rfhead1}}" id="rfhead1" oninput="rfheadget(1)" autocomplete="off">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="Rfhead_2" value="{{$getSalecontract[0]->rfhead2}}" placeholder="Enter Rfhead2" maxlength="30" id="rfhead2" oninput="rfheadget(2)">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="Rfhead_3" value="{{$getSalecontract[0]->rfhead3}}" id="rfhead3" placeholder="Enter Rfhead3" maxlength="30" oninput="rfheadget(3)">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="Rfhead_4" value="{{$getSalecontract[0]->rfhead4}}" placeholder="Enter Rfhead4" maxlength="30" id="rfhead4" oninput="rfheadget(4)" autocomplete="off">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="Rfhead_5" value="{{$getSalecontract[0]->rfhead5}}" placeholder="Enter Rfhead5" maxlength="30" id="rfhead5" oninput="rfheadget(5)" autocomplete="off">
            ...
            <form id="salesQuoTrans">
              ...
              <div class="table-responsive">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                  ...
                  <?php $sr=1;$basicTot=0;$grandTot=0;$otherTot=0;$countr = count($getSalecontract); foreach ($getSalecontract as $rows) { 
                  ...
                  <?php if($sr==1){ ?>
                      <input type="hidden" id="rowcount" value="{{$countr}}">
                  <?php } ?>
                    ...
                    <tr class="useful" id="firstRowtr">
                      ...
                      <td class="tdthtablebordr">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="inputboxclr itmbyQc" style="width: 90px;margin-bottom: 4px;margin-top: 13px;" id='Item_CodeId<?php echo $sr;?>' name="itemsale[]" onclick="ShowItemCode(<?php echo $sr;?>);" onchange="ItemCodeGet(<?php echo $sr;?>); checktaxCode(<?php echo $sr;?>);taxIntaxrate(<?php echo $sr;?>);" value="{{$rows->item_code}}" oninput="this.value = this.value.toUpperCase()" readonly />

                          <input list="ItemList<?php echo $sr;?>" class="inputboxclr SetInCenter" style="width: 90px;margin-bottom: 5px;" id='ItemCodeId<?php echo $sr;?>' name="item_code[]"  onchange="ItemCodeGet(<?php echo $sr;?>); taxIntaxrate(<?php echo $sr;?>);" value="{{$rows->item_code}}" oninput="this.value = this.value.toUpperCase()" readonly />
                        ...
                        <input type="hidden" id="sq_transcode<?php echo $sr;?>" name="sq_trans[]" value="{{$rows->sqtran_code}}">
                        <input type="hidden" id="sq_seriescode1" name="sq_series[]" value="{{$rows->sqseries_code}}">
                        <input type="hidden" id="sq_vrno<?php echo $sr;?>" name="sq_vrno[]" value="{{$rows->sqvr_no}}">
                        <input type="hidden" id="sq_slno<?php echo $sr;?>" name="sq_slno[]" value="{{$rows->sqsl_no}}">
                        <input type="hidden" id="sq_headid<?php echo $sr;?>" name="sq_head[]" value="{{$rows->sale_contract_id}}">
                        <input type="hidden" id="sq_bodyid<?php echo $sr;?>" name="sq_body[]" value="{{$rows->id}}">
                      ...
                      <td class="tdthtablebordr">
                        ...
                        <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter"  id='qty<?php echo $sr;?>' name="qty[]" value="{{$rows->quantity}}" oninput="CalAQty(<?php echo $sr;?>)" style="width: 80px" readonly />

                        <input type="text" name="unit_M[]"  value="{{$rows->um_code}}"  id="UnitM<?php echo $sr;?>" class="inputboxclr SetInCenter AddM" readonly>
                      ...
                      <td class="tdthtablebordr">
                        ...
                        <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter" value="{{$rows->Aquantity}}"  id='A_qty<?php echo $sr;?>' name="Aqty[]"  style="width: 80px" readonly />
                      ...
                      <td>
                        ...
                        <div class="modal fade" id="tds_rate_model<?php echo $sr;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><div class="modal-dialog" role="document" style="margin-top: 5%;"><div class="modal-content" style="border-radius: 5px;overflow-y: scroll;height: 512px;"><div class="modal-header"><div class="row"><div class="col-md-6"><div class="form-group"><lable class="settaxcodemodel col-md-4" style="padding: 0px;">Tax Code - </lable><input type="text" class="settaxcodemodel col-md-7" id="tax_code<?php echo $sr;?>" style="border: none; padding: 0px;" readonly></div></div><div class="col-md-6"><h5 class="modal-title modltitletext" id="exampleModalLabel">Tax / Charges / etc Calculation</h5></div></div></div><div class="modal-body table-responsive"><div class="modalspinner hideloaderOnModl"></div><div class="boxer" id="tax_rate_<?php echo $sr;?>"></div></div><div class="modal-footer"><center> <small  id="footer_ok_btn<?php echo $sr;?>"></small><small  id="footer_tax_btn<?php echo $sr;?>" style="width: 10px;"></small></center></div></div></div></div>
             ...
             <!--  <div class="row">
              ...
              <div class="row" style="display: flex;">
                  ...
                  <div class="col-md-1">
                    ...
                    <input class="credittotldesn inputboxclr" type="text" name="TotalBasciAmt" id="basicTotal" value="{{number_format($basicTot,2)}}" readonly="" style="margin-top: 3px;">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $(window).on('load',function(){
        var rowTot      = $('#rowcount').val();
        var saleQuoNoIS = $('#saleQuoNo').val();
      
        for(var i=0;i<rowTot;i++){
            var row = i+1;
            $('#CalcTax'+row).prop('disabled',false);
            $('#qua_paramter'+row).prop('disabled',false);
      ...
      $("#account_code_sale").change(function(){
        ...
        var stateCode =  $('#getStateByPlant').val();
          ...
          $.ajax({
            ...
            url:"{{ url('check-state-of-plant-n-acc') }}",
                ...
                if (data1.response == 'error') {
                  ...
                  $('#errorItem').html("<p style='color:red'>"+ data1.message +"</p>");
                    ...
                    if(data1.sale_quotation_data == ''){
                      ...
                      $('#saleQuoNotF').html('Sale Quotation No. Not Found').css('color','red');
                      $('#saleQuoNo').prop('readonly',true);

                    }else{
                       $('#saleQuoNotF').html('');
                       $('#saleQuoNo').prop('readonly',false);
                       $("#saleQuoList").empty();
...
<script type="text/javascript">
    ...
    function getITmBySaleQC(){
      ...
      $.ajax({
            ...
            url:"{{ url('get-itmdata-by-sale-vrno') }}",

            method : "POST",

            type: "JSON",

            data: {account_code: account_code,sale_QuoNo:sale_QuoNo},
                ...
                if (data1.response == 'error') {
                  ...
                  //console.log(data1.data[0].item_name);
                    if(data1.data == ''){
                      ...
                      var tableBody = "<div class='box-row' id='hidebalNull_"+itemId+"_"+incemntval+"'><div class='box10 texIndbox'><input type='radio' id='sr_"+itemId+"_"+incemntval+"' name='itemname' value='"+itemId+"_"+incemntval+"'></div><div class='box10 texIndbox' style='width: 19%;'><input type='text' id='vrno_"+itemId+"_"+incemntval+"' name='head_tax_ind11[]' class='form-control inputtaxInd' value="+getyear[0]+'&nbsp;'+getData.series_code+'&nbsp;'+getData.vrno+" readonly></div><div class='box10 rateIndbox'><input type='hidden' value="+getData.fiscal_year+" id='sqfiscalyr_"+itemId+"_"+incemntval+"'><input type='hidden' value="+getData.series_code+" id='sqseries_"+itemId+"_"+incemntval+"'><input type='hidden' value="+getData.tran_code+" id='sqtran_"+itemId+"_"+incemntval+"'><input type='hidden' value="+getData.vr_no+" id='sqvrno_"+itemId+"_"+incemntval+"'><input type='hidden' value="+getData.slno+" id='sqslno_"+itemId+"_"+incemntval+"'><input type='hidden' value="+getData.bodyid+" id='sqbodyid_"+itemId+"_"+incemntval+"'><input type='hidden' value="+getData.sale_quotation_head_id+" id='sqheadid_"+itemId+"_"+incemntval+"'><input type='hidden' value='"+getData.remark+"' id='sqitmdisciptn_"+itemId+"_"+incemntval+"'><input type='text' id='itemcode_"+itemId+"_"+incemntval+"' name='itemco' class='form-control'  value='"+getData.item_code+"("+getData.item_name+")"+"' readonly><input type='hidden' value="+getData.tax_code+" id='taxCodeI_"+itemId+"_"+incemntval+"'></div><div class='box10 rateIndbox'><input type='text' id='qtyOreder_"+itemId+"_"+incemntval+"' name='qtyOrder' class='form-control rightcontent' value="+getData.quantity+" readonly><input type='hidden' value="+getData.rate+" id='sq_rate_"+itemId+"_"+incemntval+"'></div><div class='box10 rateIndbox'><input type='text' id='qtySupply_"+itemId+"_"+incemntval+"' name='qtySupply[]' class='form-control rightcontent' value="+qtyissued+" readonly></div><div class='box10 rateIndbox'><input type='text' id='balence_qty_"+itemId+"_"+incemntval+"' name='balQty[]' class='form-control rightcontent' value="+getData.quantity+" readonly><input type='hidden' class='form-control' id='remainBalQty_"+itemId+"_"+incemntval+"' value='' readonly></div></div>";
  ...
  function selectitem(rowid,itmebyid){
    ...
    if(checkitmIsAval == ''){
      ...
      var sq_rate        = $('#sq_rate_'+res1+'_'+res2).val();
      
      var sqseries       = $('#sqseries_'+res1+'_'+res2).val();
      var sqtransc       = $('#sqtran_'+res1+'_'+res2).val();
      var sqslno         = $('#sqslno_'+res1+'_'+res2).val();
      var sqvrno         = $('#sqvrno_'+res1+'_'+res2).val();
      var sqbody         = $('#sqbodyid_'+res1+'_'+res2).val();
      var sqhead         = $('#sqheadid_'+res1+'_'+res2).val();
      var sqitmdiscriptn = $('#sqitmdisciptn_'+res1+'_'+res2).val();
    ...
    $('#cancelQpbtn'+rowid).append(cnclbtnqp);
      ...
      $('#remark_data'+rowid).val(sqitmdiscriptn);
      
      $('#idsun'+rowid).val(res1+'_'+res2);

      $('#rate'+rowid).val(sq_rate);
      $('#qnrate'+rowid).val(sq_rate);
      $('#qty'+rowid).val(balencQtyByitm);
      $('#balQtyByItem'+rowid).val(balencQtyByitm);
      $('#sq_transcode'+rowid).val(sqtransc);
      $('#sq_seriescode'+rowid).val(sqseries);
      $('#sq_vrno'+rowid).val(sqvrno);
      $('#sq_slno'+rowid).val(sqslno);
      $('#sq_headid'+rowid).val(sqhead);
      $('#sq_bodyid'+rowid).val(sqbody);
  ...
  function CalculateTax(taxid){
    ...
    $.ajaxSetup({
      ...
      $('#FirstBlckAmnt_'+taxid+'_1').val(basicAmt);
        ...
        var sale_QtnHeadId = $('#saleQuoHeadId'+taxid).val();
        var saleQtn_HeadId = $('#sq_headid'+taxid).val();
        var sale_QtnBodyId = $('#saleQuoBodyId'+taxid).val();
        var saleQtn_BodyId = $('#sq_bodyid'+taxid).val();
        var ItemCd = $('#ItemCodeId'+taxid).val();
        var Item_Cde = $('#itmC_code'+taxid).val();

        if(sale_QtnHeadId){
          var saleQtnHeadId = sale_QtnHeadId;
        }else if(saleQtn_HeadId){
          var saleQtnHeadId = saleQtn_HeadId;
        }

        if(sale_QtnBodyId){
          var saleQtnBodyId = sale_QtnBodyId;
        }else if(saleQtn_BodyId){
          var saleQtnBodyId = saleQtn_BodyId;
        }
    ...
    if(taxOnModel == ''){
      ...
      $.ajax({
                ...
                url:"{{ url('get-a-field-calculation-by-tax-in-sale-quo')}}",

                method : "POST",

                type: "JSON",

                data: {tax_code: tax_code,saleQtnHeadId:saleQtnHeadId,saleQtnBodyId:saleQtnBodyId,ItemCode:ItemCode},
...
<script type="text/javascript">
  ...
  $(".addmore").on('click',function(){
      ...
      if(ifnotaply == 0){
        ...
        var saleQuoNoIS = $('#saleQuoNo').val();
        console.log('saleQuoNoIS',saleQuoNoIS);
        if(saleQuoNoIS ==''){
          $('#Item_CodeId'+i).addClass('itmbyQc');
          $('#ItemCodeId'+i).css('display','block');
          $('#ItemCodeId'+i).prop('readonly',false);
...
*/
          ...
          $.ajax({
              ...
              url: "{{ url('/finance/save-sale-contract-trans') }}",
              ...
              success: function (data) {
                ...
                console.log(data);
               var url = "{{url('transaction/sale/sale-contract-save-msg')}}"
...
<script type="text/javascript">
  ...
  function qty_parameter(qty){
   ...
   var saleQuoHeadId = $("#sq_headid"+qty).val();
   var saleQuoBodyId = $("#sq_bodyid"+qty).val();
    ...
    $.ajax({
        ...
        url: "{{ url('/get-quo-parameter-for-sale-quo') }}",
