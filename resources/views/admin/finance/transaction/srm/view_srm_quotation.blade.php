   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/Transaction/Srm/View-Srm-Quotation-Trans') }}"
       ...
       },
       {
        render:function(data, type, full, meta){
          ...
          return '<button class="btn btn-success pdfbtncl" type="button" id="pdfDown" onclick="downloadPDF('+full['DT_RowIndex']+','+full['pquoHid']+','+full['VRNO']+',\''+full['TRAN_CODE']+'\');"><i class="fa fa-download" aria-hidden="true"></i></button>';
        }
       }
