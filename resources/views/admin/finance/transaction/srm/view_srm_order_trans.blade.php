...
<script type="text/javascript">
    ...
    function format(d) {
      //  console.log('d',d.id);
        ...
        return '<table border="0" class="table table-bordered table-striped table-hover" id="childData_'+d.PORDERHID+'" style="padding-left:50px;">'+
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/Transaction/SRM/View-Srm-Order-Trans') }}"
       ...
       {  
        ...
        {  
            render: function (data, type, full, meta){
              ...
              if(full['GRNHID'] == null && full['GRNBID'] == null){
       ...
       },
       {
        render:function(data, type, full, meta){
          ...
          return '<button class="btn btn-success pdfbtncl" type="button" id="pdfDown" onclick="downloadPDF('+full['DT_RowIndex']+','+full['PORDERHID']+','+full['VRNO']+',\''+full['TRAN_CODE']+'\');"><i class="fa fa-download" aria-hidden="true"></i></button>';
        }
       }
