...
<style>
  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <small><b>Production(BOM) Details</b></small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/view-mast-dealer') }}">Production(BOM)</a></li>

            <li class="active"><a href="{{ url('/view-mast-dealer') }}">View Production(BOM)</a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Production(BOM)</h3>

                  <div class="box-tools pull-right">

          <a href="{{ url('/Transaction/Production/BOM') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Production(BOM)</a>
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/Transaction/Production/view-BOM') }}"
   ...
   function showchildtable(vrno,tblid){
            var vrno,tblid;
             ...
             $.ajax({
              ...
              url:"{{ url('view-production-chield-row-data') }}",
