...
<style>
  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <small><b>Wo Production(BOM) Details</b></small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/view-mast-dealer') }}">Wo Production(BOM)</a></li>

            <li class="active"><a href="{{ url('/view-mast-dealer') }}">View Wo Production(BOM)</a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Wo Production(BOM)</h3>

                  <div class="box-tools pull-right">

          <a href="{{ url('/Transaction/Production/wo-production') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Wo Production(BOM)</a>
...
<script type="text/javascript">
  ...
  //  console.log('d',d.id);
    ...
    return '<table border="0" class="table table-bordered table-striped table-hover chieldtblecls" id="childData_'+d.BOMHID+'" style="padding-left:50px;">'+
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/Transaction/Production/view-wo-production') }}"
       ...
       columns: [
          ...
          { data:"",className:'details-control',
            ...
            return '<button id="showchildtable" onclick="showchildtable('+full.VRNO+','+full.BOMHID+')"><i class="fa fa-plus" id="minus'+full.VRNO+''+full.BOMHID+'" title="Edit"></i></button>'
          }
         },
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<a href="edit-dealer/'+btoa(full['BOMHID'])+'/'+btoa(enableBtn)+'" class="btn btn-warning btn-xs" title="edit" disabled><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" onclick="return dealerDelete('+full['BOMHID']+');" disabled><i class="fa fa-trash" title="Delete"></i></button>';
   ...
   function showchildtable(vrno,tblid){
            var vrno,tblid;
             ...
             $.ajax({
              ...
              url:"{{ url('view-wo-production-chield-row-data') }}",
