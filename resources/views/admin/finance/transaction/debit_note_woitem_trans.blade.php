...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Debit Note Wo Item Transaction
        ...
        <div class="col-sm-12">
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Debit Note Wo Item Transaction</h2>

              <div class="box-tools pull-right">

                <a href="{{ url('/finance/transaction/view-debit-note-woitem-transaction') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Transaction</a>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel with-nav-tabs panel-info">
          ...
          <div class="panel-body">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input list="seriesList1"  id="series_code" name="series_code" class="form-control  pull-left" value="<?php if($seriesCount == 1){echo $series_list[0]->SERIES_CODE;}else{echo old('series_code');} ?>" placeholder="Select Series" oninput="this.value = this.value.toUpperCase()" autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label> Series Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="series_name" value="<?php if($seriesCount == 1){echo $series_list[0]->SERIES_NAME;}else{} ?>" id="seriesName" placeholder="Enter Series Name" readonly autocomplete="off">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                          ...
                          <label>Bill No. : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="billNoList"  id="bill_no" name="bill_no" class="form-control  pull-left" value="" placeholder="Select Bill No" oninput="this.value = this.value.toUpperCase()" onchange="getItmByBillNo()" autocomplete="off"> 
                        ...
                        <div class="form-group">
                          ...
                          <label>Bill Date: 
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" id="bill_date" name="bill_date" class="form-control  pull-left Number" value="{{ old('bill_date')}}" placeholder="Enter Bill Date" autocomplete="off" style="text-align: end;">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <label>Bill Diff Amt: <span class="required-field"></span></label>

                            <div class="input-group">

                              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            
                              <input type="text" class="form-control rightcontent" name="diff_amt" id="diff_amt" value="{{ old('diff_amt')}}" placeholder="Select Diff Amt" autocomplete="off" readonly>
                        ...
                        <div class="form-group">
                          ...
                          <label>Tax Code: 
                            ...
                            <div class="input-group">
                              ...
                              <input list="TaxcodeList"  id="tax_code" name="taxcode" class="form-control  pull-left" value="" placeholder="Select Tax" oninput="this.value = this.value.toUpperCase()"  autocomplete="off" readonly onchange="taxCodeonChnage()">
              ...
              <div class="row" style="display: flex;">
                  ...
                  <div class="col-md-1">
                    ...
                    <input class="credittotldesn inputboxclr" type="hidden" name="TotalBasciAmt" id="basicTotal" readonly="" style="margin-top: 3px;">
         ...
         <center> <button class="btn btn-success" type="button" id="submitdata" disabled><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;&nbsp; Save</button>
            ...
            success:function(data){
              ...
              var data1 = JSON.parse(data);
                ...
                if(data1.data== ''){
                    ...
                    if(data1.datavrno == ''){
                      $('#vrseqnum').val(data1.data[0].LAST_NO); $('#getVrNo').val(data1.data[0].LAST_NO); }else{
                      var calvrno =  parseInt(data1.data[0].LAST_NO) + parseInt(1); $('#vrseqnum').val(calvrno);
                      $('#getVrNo').val(calvrno);
                    }
                ...
                if (data1.response == 'error') {
                  ...
                  if(data1.data== ''){
                    ...
                    $.each(data1.data, function(k, getData){
                      ...
                      $("#billNoList").append($('<option>',{

                        value:startyear[0]+' '+getData.SERIES_CODE+' '+getData.PARTYBILLNO,

                        'data-xyz':getData.PARTYBILLNO,
                           text:startyear[0]+' '+getData.SERIES_CODE+' '+getData.PARTYBILLNO
  ...
  function CalculateTax(taxid){
    ...
    if(taxOnModel){
      ...
      $.ajax({
              ...
              url:"{{ url('/get-a-field-calc-for-credit-note-woitem') }}",
                   ...
                   //console.log('Get Data => ',data1);
                    if (data1.response == 'error') {
                      ...
                      $("#submitdata").prop('disabled',false);
                       ...
                       // var basicheadval = parseFloat($('#diff_amt').val());
...
<script type="text/javascript">
  ...
  $(".addmore").on('click',function(){
      ...
      $.ajax({
          ...
          url:"{{ url('get-item-by-condition-in-add-more-purchase-order') }}",

          method : "POST",

          type: "JSON",

          data: {account_code: account_code,contractNo:contractNo,quotationNo:quotationNo,tax_code:tax_code,stateCode:stateCode},
...
<script type="text/javascript">
  ...
  function getItmByBillNo(){
      ...
      $.ajax({
          ...
          url:"{{ url('/get-item-by-billno-data') }}",
          ...
          data: {bill_no: bill_no},
           ...
           success:function(data){
            ...
            //console.log(data);
                ...
                console.log('itemdata',data1.bill_data);
                if (data1.response == 'error') {
                  ...
                  if(data1.data ==''){
                    ...
                    $('#party_ref_date').val('');
                      ...
                      $("#bill_date").val(data1.bill_data.PARTYBILLDATE);
...
//console.log(data1.data_pur_bill);
                if (data1.response == 'error') {
                    ...
                    if(data1.data_pur_bill==''){
                       ...
                       $('#qty'+ItemId).val(data1.data_pur_bill.quantity);

                      $('#A_qty'+ItemId).val(data1.data_pur_bill.Aquantity);

                      $('#rate'+ItemId).val(data1.data_pur_bill.rate);
                      $('#basic'+ItemId).val(data1.data_pur_bill.basic_amt);
    ...
    $("#submitdata").click(function(event) {
      ...
      if(found == 0 && grandAmt < 0){
          ...
          $.ajax({
              ...
              url: "{{ url('/finance/save-debit-note-transaction-woitem') }}",
             ...
             //  alert(data);return false;
               ...
               var url = "{{url('/finance/transaction/view-debit-note-transaction')}}"
