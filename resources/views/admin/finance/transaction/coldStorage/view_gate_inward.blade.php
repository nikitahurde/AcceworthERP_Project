...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="{{ url('/transaction/ColdStorage/View-gate-inward-transaction') }}">Gate Inward</a></li>

      <li class="active"><a href="{{ url('/transaction/ColdStorage/View-gate-inward-transaction') }}">View Gate Inward</a></li>
        ...
        <div class="box box-primary Custom-Box">
          ...
          <div class="box-header with-border" style="text-align: center;">
            ...
            <div class="box-tools pull-right">
              ...
              <a href="{{ url('/transaction/ColdStorage/add-gate-inward-transaction') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Gate Inward</a>
    ...
    $(document).ready(function(){
      ...
      var t = $("#example").DataTable({
        ...
        ajax:{
            ...
            url : "{{ url('/transaction/ColdStorage/View-gate-inward-transaction') }}"
