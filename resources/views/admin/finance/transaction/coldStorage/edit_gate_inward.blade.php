        ...
        <div class="box box-primary Custom-Box">
          ...
          <div class="box-header with-border" style="text-align: center;">
            ...
            <div class="box-tools pull-right">
              ...
              <a href="{{ url('/transaction/ColdStorage/View-gate-inward-transaction') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Vehicle Entry</a>
          ...
          <div class="box-body">
            ...
            <form action="{{ url('transaction/ColdStorage/Update-gate-inward-transaction') }}" method="POST" >
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control transdatepicker" name="datetime" id="dateTime" value="{{ $classData->DATETIME }}" placeholder="Enter Date">
                    ...
                    <label>
                     ...
                     Vehicle Number : 
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="vehicle_number" value="{{ $classData->VEHICLE_NUMBER }}" placeholder="Enter Vehicle Number" maxlength="15" id="vehicle_number">
                  ...
                  <div class="form-group">
                    ...
                    <label> Series Code : <span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                        ...
                        <input list="seriesList" class="form-control" name="series_code" value="{{ $classData->SERIES_CODE }}" id="series_code" placeholder="Enter Series Code" autocomplete="off" readonly>
                  ...
                  <div class="form-group">
                    ...
                    <label>Plant Code: <span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                        ...
                        <input list="PlantcodeList" class="form-control" id="Plant_code" name="plant_code" placeholder="Select Plant" maxlength="11" value="<?php echo $classData->PLANT_CODE;?>" autocomplete="off">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="driver_name" id="driver_name" value="{{ $classData->DRIVER_NAME }}" placeholder="Enter Driver Name" maxlength="40">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="driver_id" value="{{ $classData->DRIVER_ID }}" placeholder="Enter Driver ID"  id="driver_id">
                  ...
                  <div class="form-group">
                    ...
                    <label> Mobile Number : <span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="mobile_number" id="mobile_number" value="{{ $classData->MOBILE_NUMBER }}" placeholder="Enter Mobile Number" maxlength="10">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="radio" class="optionsRadios1" name="vehicle_type" value="EMPTY" <?php if($classData->VEHICLE_TYPE=='EMPTY'){ echo 'checked';} else{ echo '';} ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;EMPTY &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                      <input type="radio" class="optionsRadios1" name="vehicle_type" value="LOAD" <?php if($classData->VEHICLE_TYPE=='LOAD'){ echo 'checked';} else{ echo '';} ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LOAD
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <label> Vehicle Entry Block : <span class="required-field"></span> </label>

                    <div class="input-group">

                      <input type="radio" class="optionsRadios1" name="vehicle_block" value="YES" <?php if($classData->VEHICLE_BLOCK=='YES'){ echo 'checked';} else{ echo '';} ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;YES &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                      <input type="radio" class="optionsRadios1" name="vehicle_block" value="NO" <?php if($classData->VEHICLE_BLOCK=='NO'){ echo 'checked';} else{ echo '';} ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NO
