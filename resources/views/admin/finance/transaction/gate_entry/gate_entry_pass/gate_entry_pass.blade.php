...
<script src="{{ URL::asset('public/dist/js/controller/GatePassReturnController.js') }}" ></script> 


<script type="text/javascript">

	var gatepassreturn = new GatePassReturn();
 ...
 <script type="text/javascript">
    ...
    var itemurl = "<?php echo url('get-item-data-details'); ?>";
  	 ...
  	 var submitdataurl = "<?php echo url('/finance/save-gate-entry-return'); ?>";

     var viewaurl = "<?php echo url('/finance/view-gatepassreturn-msg'); ?>";
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <div class="box-tools pull-right">
                ...
                <a href="{{ url('/Transaction/GateEntry/View-Gate-Pass') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Gate Entry Pass</a>
                  ...
                  <div class="tab-pane fade in active" id="tab1info">
                        ...
                        <div class="form-group">
                          ...
                          <label>Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control transdatepicker" name="vr" id="vr_date" value="{{ $vrDate }}" placeholder="Select Date" autocomplete="off" onchange="gatepassreturn.vrDate()">
                        ...
                        <div class="form-group">
                          ...
                          <label>Plant Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="PlantcodeList" class="form-control" id="Plant_code" name="plantcode" placeholder="Select Plant" maxlength="11" value="<?php if($plcount == 1){echo $plant_list[0]->PLANT_CODE;}?>" readonly autocomplete="off" onchange="gatepassreturn.PlantCode(Plantcodeurl)">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <input list="AccountList"  id="account_code" name="AccCode" class="form-control  pull-left" placeholder="Select Department" onchange="GetAccCode()"> 
                        ...
                        <div class="form-group">
                          ...
                          <label> Employee Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="empList" class="form-control" name="emp_code" id="emp_code" placeholder="Enter Employee Code"  onchange="gatepassreturn.EmpCode()">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <label>Gate Pass Type : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="typeList" class="form-control" name="gp_type"  id="gp_type" placeholder="SELECT TYPE" autocomplete="off">

                              <datalist id="typeList">

                                <option value="RGP" data-xyz="RETURNABLE">RGP-RETURNABLE</option>

                                <option value="NRGP" data-xyz="RETURNABLE">NRGP-NON RETURNABLE</option>
                            ...
                            <small id="empName" class="showcodename"></small>
                            <small id="gptype_err" style="color: red;"></small>
                        ...
                        <div class="form-group">
                          ...
                          <label> Store Issue : <span class="required-field" id="requiredstar"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="issueList" class="form-control" name="store_issue" value="" id="store_issue" placeholder="Enter Account Code" autocomplete="off" onchange="gatepassreturn.getItemByIssueNo(1,getissueurl)">
                            ...
                            <small id="empName" class="showcodename"></small>
                            <small id="issueno_err" style="color:red;"></small>
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <label>Work Order No : <span class="required-field" id="requiredstarbtn"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="orderList" class="form-control" name="order_no" value="" id="order_no" placeholder="Enter Employee Code" autocomplete="off" onchange="gatepassreturn.getItemByOrderNo(1,getordernumurl)">
                              ...
                              <datalist id="orderList">
                                ...
                                <option value="<?= $getdata[0]; ?> <?= $row->SERIES_CODE ?> <?= $row->VRNO ?>"></option>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control partyrefdatepicker" name="party_ref_d" id="party_ref_date" value="{{ old('vr_date')}}" placeholder="Select Party Ref Date" autocomplete="off" onchange="gatepassreturn.PartyRefDate()">
            ...
            <form id="salesordertrans">
              ...
              <div class="table-responsive">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                  ...
                  <input type="hidden" name="issuenum" id="rqnumbyissue">
                  <input type="hidden" name="ordernum" id="rqnumbyorder">
                  <input type="hidden" name="totalbasic" id="totalbasic">
                  <input type="hidden" name="gpType" id="gpType">
                  ...
                  <tr class="useful">
                    ...
                    <td class="tdthtablebordr">
                      <div class="input-group">
                        <input list="ItemList1" class="inputboxclr SetInCenter" style="width: 90px;margin-bottom: 5px;" id='ItemCodeId1' name="item_code[]"  onchange="gatepassreturn.ItemCodeGet(1,itemcodeurl,quaitemurl);"  oninput="this.value = this.value.toUpperCase()" readonly />
                       ...
                       <button type="button" class="btn btn-primary btn-xs showdetail viewbtnitem" id="viewItemDetail1" data-toggle="modal" data-target="#view_detail1" onclick="gatepassreturn.showItemDetail(1,itemurl)"><i class="fa fa-info" aria-hidden="true" style="font-size: 13px;"></i> </button>
    ...
    color: #5d9abd;
      ...
      <br>
        ...
        <p class="text-center">
          ...
          <button class="btn btn-success" type="button" id="submitdata" onclick="gatepassreturn.submitdata(submitdataurl)" disabled><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;&nbsp; Save</button>
...
<script src="{{ URL::asset('public/dist/js/viewjs/gatepassreturn.js') }}" ></script>
  
 
 <script type="text/javascript">
   
  $('#gp_type').on('input',function(){
   ...
   if(gp_type==''){
     ...
     document.getElementById("gptype_err").innerHTML = 'The gate pass type field is required.';
     $('#gp_type').css('border-color','#ff0000').focus();
     
     }else{
      $('#gp_type').css('border-color','#d2d6de');
      $('#store_issue').css('border-color','#ff0000').focus();
      document.getElementById("gptype_err").innerHTML = '';
...
*/ // $('#ItemCodeId1').prop('readonly',false);
 ...
 // $("#emp_code").prop('readonly',false);
      ...
      $.ajax({
            ...
            url:'<?php echo url('get-employe-data-by-department'); ?>',
