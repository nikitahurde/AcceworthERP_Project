...
<style>
  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <small><b>Gate Entry Purchase Details</b></small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/view-mast-dealer') }}">Gate Entry Purchase</a></li>

            <li class="active"><a href="{{ url('/view-mast-dealer') }}">View Gate Entry Purchase</a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Gate Entry Purchase</h3>

                  <div class="box-tools pull-right">

          <a href="{{ url('/Transaction/GateEntry/Gate-Entry-Purchase') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add GateEntry Pur</a>
...
<script type="text/javascript">
  ...
  //  console.log('d',d.id);
    ...
    return '<table border="0" class="table table-bordered table-striped table-hover chieldtblecls" id="childData_'+d.GRNGATEHID+'" style="padding-left:50px;">'+
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/Transaction/GateEntry/View-Gate-Entry-Purchase') }}"
       ...
       columns: [
          ...
          { data:"",className:'details-control',
            ...
            return '<button id="showchildtable" onclick="showchildtable('+full.VRNO +','+full.GRNGATEHID+')"><i class="fa fa-plus" id="minus'+full.VRNO+''+full.GRNGATEHID+'" title="Edit"></i></button>'
          }
         },
         ...
         {  
            render: function (data, type, full, meta){
                      ...
                      var deletebtn ='<a href="edit-dealer/'+btoa(full['GRNGATEHID'])+'/'+btoa(enableBtn)+'" class="btn btn-warning btn-xs" title="edit" disabled><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" onclick="return dealerDelete('+full['GRNGATEHID']+');" disabled><i class="fa fa-trash" title="Delete"></i></button>';
