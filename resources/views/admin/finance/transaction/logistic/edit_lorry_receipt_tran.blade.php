...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/form-mast-fleet') }}">Update Lorry Receipt</a></li>
      ...
      <div class="col-sm-12">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">Update Lorry Receipt</h2>
                          ...
                          <label>Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                             ...
                             <?php 
                              ...
                              <input type="text" class="form-control transdatepicker" name="vr_date" id="vr_date" value="<?= $tripLorryData[0]->VRDATE ?>" placeholder="Select Date" autocomplete="off" onchange="vrDate()" >
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="deliveryList" class="form-control" name="trip_no" id="trip_no"  value="<?= $tripLorryData[0]->TRIP_NO ?>" placeholder="Enter Trip No" onchange="getTripDetials()" autocomplete="off" readonly />
                          ...
                          <datalist id="deliveryList">
                            ...
                            <option value="<?= $newVrNo; ?>" data-xyz="<?= $newVrNo; ?>"><?= $newVrNo ?> - <?= $key->VEHICLE_NO ?> - <?= $key->ACC_NAME ?>- <?= $key->TO_PLACE ?></option>
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input list="vehicleList" class="form-control" name="vehicle_no" id="vehicle_no" value="<?= $tripLorryData[0]->VEHICLENO ?>" placeholder="Enter Vehicle No" maxlength="13" oninput="this.value = this.value.toUpperCase()" autocomplete="off" onchange="getTripDetials()" readonly>
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input list="seriesList1"  id="series_code" name="series_code" class="form-control  pull-left" value="<?= $tripLorryData[0]->SERIES_CODE ?>" placeholder="Select Series" oninput="this.value = this.value.toUpperCase()" autocomplete="off" onchange="getvrnoBySeries();" readonly>
                        ...
                        <div class="form-group">
                          ...
                          <label> Series Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="series_name" value="<?= $tripLorryData[0]->SERIES_NAME ?>" id="seriesName" placeholder="Enter Series Name" value="" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Plant Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="PlantcodeList" class="form-control" id="Plant_code" name="plant_code" placeholder="Select Plant" maxlength="11" value="<?= $tripLorryData[0]->PLANT_CODE ?>" readonly autocomplete="off" onchange="PlantCode()">
                        ...
                        <div class="form-group">
                          ...
                          <label> Plant Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="plant_name" value="<?= $tripLorryData[0]->PLANT_NAME ?>" id="plantname" placeholder="Enter Profit Plant Name" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Customer Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="AccountList"  id="account_code" name="AccCode" class="form-control  pull-left" value="<?= $tripLorryData[0]->ACC_CODE ?>" placeholder="Select Customer" readonly=""> 
                        ...
                        <div class="form-group">
                          ...
                          <label> Customer Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="acctname" value="<?= $tripLorryData[0]->ACC_NAME ?>" id="accountName" placeholder="Enter Department Name" readonly autocomplete="off">
        ...
        <div class="col-md-12">
         ...
         <!--   <div class="table-responsive">
           ...
           <table class="table table-responsive">
            ...
            <?php $srno=1; foreach($tripLorryData as $key) { 

               $invc_date =   date('d-m-Y',strtotime($key->INVC_DATE));
               $do_date   =   date('d-m-Y',strtotime($key->DO_DATE));
               $lr_date   =   date('d-m-Y',strtotime($key->LR_DATE));
               $wagon_date =   date('d-m-Y',strtotime($key->WAGON_DATE));
               $ewaybill_date =   date('d-m-Y',strtotime($key->EWAYB_VALIDDT));

              ?>
               
              <tr>
               <td><input style='padding: 0px;width: 90px;' type='text' class='inputboxclr'  name='invoice_no[]' value='<?= $key->INVC_NO ?>' id='invoice_no<?= $srno ?>'  autocomplete='off'/><input style='padding: 0px;width: 90px;' type='hidden' name='body_id[]' id='body_id<?= $srno ?>' class='inputboxclr'  value='<?= $key->TRIPBID ?>' readonly=''/><input style='padding: 0px;border:none' class='inputboxclr cpCddata' type='hidden' value='<?= $key->CP_CODE ?>' name='cp_code[]' id='cp_code<?= $srno ?>' readonly=''/></div><div class='box10 texIndbox1'><input style='padding: 0px;border:none' class='inputboxclr' type='hidden' value='<?= $key->CP_NAME ?>' name='cp_name[]' id='cp_name<?= $srno ?>' readonly=''/><input type='hidden' style='padding: 0px;width: 20px;text-align: right;' name='unit_M[]' value='<?= $key->UM ?>' id='UnitM<?= $srno ?>' class='inputboxclr AddM'><input type='hidden' id='qtyget<?= $srno ?>' class='totlqty'><input type='hidden' id='Cfactor<?= $srno ?>'></td>
               <td><input style='padding: 0px;width: 90px;' type='text'  value='<?= $invc_date ?>' name='invoice_date[]'  class='datepicker inputboxclr clr' id='invoice_date<?= $srno ?>'   autocomplete='off'/></td>
               <td><input style='padding: 0px;width: 90px;text-align:right;' type='text' name='do_no[]' id='do_no<?= $srno ?>' class='inputboxclr'  value='<?= $key->DO_NO ?>' /></td>
               <td><input style='padding: 0px;width: 90px;text-align:right;' class='inputboxclr datepicker' type='text'  value='<?= $do_date ?>' name='do_date[]' id='do_date<?= $srno ?>'   /></td>
               <td><input style='padding: 0px;width: 90px;' class='inputboxclr' type='text' value='<?= $key->ITEM_CODE ?>' name='item_code[]' id='item_code<?= $srno ?>' /></td>
               <td><input style='padding: 0px;width: 90px;' class='inputboxclr' type='text' value='<?= $key->ITEM_NAME ?>' name='item_name[]' id='item_name<?= $srno ?>'/></td>
               <td><input style='padding: 0px;width: 85px;text-align:right;' type='text' class='inputboxclr' name='lr_no[]'  id='lr_no<?= $srno ?>' value='<?= $key->LR_NO ?>' autocomplete='off'/></td>
               <td><input class='datepicker inputboxclr'  type='text' value='<?= $lr_date ?>' name='lr_date[]'  id='lr_date"+srno+"' style='padding: 0px;width: 85px;text-align:right;' autocomplete='off' onchange='getfsoRate("+srno+");'/></td>
               <td><input style='padding: 0px;width: 85px;' type='text' class='inputboxclr' value='<?= $key->WAGON_NO ?>' name='wagon_no[]' id='wagon_no<?= $srno ?>'   autocomplete='off'/></td>
               <td><input style='padding: 0px;width: 85px;' type='text' value='<?= $wagon_date ?>'  name='wagon_date[]'  class='datepicker inputboxclr' id='wagon_date<?= $srno ?>' autocomplete='off'/></td>
               <td><input style='padding: 0px;width: 70px;text-align: right;' type='text' class='getqtytotal'  id='qty<?= $srno ?>'  value='<?= $key->QTY ?>'  name='qty[]' oninput='Getqunatity(<?= $srno ?>)'   /></td>
               <td><input style='padding: 0px;width: 85px;' type='text' class='inputboxclr' value='<?= $key->DELIVERY_NO ?>' name='delivery_no[]' id='delivery_no<?= $srno ?>'   autocomplete='off'/></td>
               <td><input style='padding: 0px;width: 85px;text-align:right;' type='text' class='inputboxclr' value='<?= $key->TARE_WEIGHT ?>' name='tare_weight[]' id='tare_weight<?= $srno ?>' oninput='netWeightCal(<?= $srno ?>)'   autocomplete='off'/></td>
               <td><input style='padding: 0px;width: 85px;text-align:right;' type='text' class='inputboxclr' value='<?= $key->GROSS_WEIGHT ?>' name='gross_weight[]' id='gross_weight<?= $srno ?>'   autocomplete='off'/></td>
               <td><input style='padding: 0px;width: 85px;text-align:right;' type='text' class='inputboxclr' value='<?= $key->NET_WEIGHT ?>' name='net_weight[]' oninput='netWeight(<?= $srno ?>)' id='net_weight<?= $srno ?>'    autocomplete='off'/></td>
               <td><input style='padding: 0px;width: 85px;text-align:right;' type='text' class='inputboxclr' value='<?= $key->EBILL_NO ?>' name='ewaybill_no[]' id='ewaybill_no<?= $srno ?>'   autocomplete='off' oninput='getEwayBillInfo(<?= $srno ?>)' /></td>
               <td><input style='padding: 0px;width: 85px;' type='text' class='inputboxclr datepicker' value='<?= $ewaybill_date ?>' name='ewaybill_date[]' id='ewaybill_date<?= $srno ?>'   autocomplete='off' /></td>
               <td><input style='padding: 0px;width: 85px;text-align: right;' type='text' class='inputboxclr'  id='material_value<?= $srno ?>' name='material_value[]' value="<?= $key->MATERIAL_VAL ?>" autocomplete='off' /></td>
          ...
          <div class="box-body">
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                      ...
                      <input type ="hidden" name="accCode" id="getAccCode" value="<?= $tripLorryData[0]->ACC_CODE ?>">
                      <input type ="hidden" name="accName" id="getAccName" value="<?= $tripLorryData[0]->ACC_NAME ?>">
                      <input type ="hidden" name="pfctCode" id="getPfctCode">
                      <input type ="hidden" name="pfctName" id="getPfctName">
                      <input type ="hidden" name="plantCode" id="getPlantCode" value="<?= $tripLorryData[0]->PLANT_CODE ?>">
                      <input type ="hidden" name="plantName" id="getPlantName" value="<?= $tripLorryData[0]->PLANT_NAME ?>">
                      <input type ="hidden" name="seriesCode" id="getSeriesCode" value="<?= $tripLorryData[0]->SERIES_CODE ?>">
                      <input type ="hidden" name="seriesName" id="getSeriesName" value="<?= $tripLorryData[0]->SERIES_NAME ?>">
                      <input type ="hidden" name="VehilceNum" id="getVehilceNum" value="<?= $tripLorryData[0]->VEHICLENO ?>">
                      <input type ="hidden" name="TripNum" id="getTripNum" value="<?= $tripLorryData[0]->TRIP_NO ?>">
                      <input type ="hidden" name="VrDate" id="getVrDate" value="<?= $tripLorryData[0]->VRDATE ?>">
                        ...
                        <div class="form-group">
                          ...
                          <label> Route Code : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="routeList" class="form-control" name="route_code" value="<?= $tripLorryData[0]->ROUTE_CODE ?>"  id="route_code" placeholder="Enter Route Code" autocomplete="off"  onchange="getRouteLocation()">
                        ...
                        <div class="form-group">
                          ...
                          <label> Route Name : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="route_name" value="<?= $tripLorryData[0]->ROUTE_NAME ?>" id="route_name" placeholder="Enter Route Name" autocomplete="off" readonly>
               ...
               <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="fromplaceList" class="form-control" name="from_place" id="from_place"  value="<?= $tripLorryData[0]->FROM_PLACE ?>" placeholder="Enter From Place" autocomplete="off" readonly="" />
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="toplaceList"  id="to_place" name="to_place" class="form-control pull-left" value="<?= $tripLorryData[0]->TO_PLACE ?>" placeholder="Enter To Place" autocomplete="off" readonly="">
                   ...
                   <div class="col-md-1">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="trip_day" id="trip_day"  value="<?= $tripLorryData[0]->TRIP_DAY ?>" placeholder="Enter Trip Days" autocomplete="off" readonly="">
                   ...
                   <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="off_days" id="off_days"  value="<?= $tripLorryData[0]->OFF_DAY ?>" placeholder="Enter Off Days" autocomplete="off" readonly="">
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="transportList" class="form-control" name="transporter_code"  value="<?= $tripLorryData[0]->TRANSPORT_CODE ?>" id="transporter_code" placeholder="Enter Transporter" autocomplete="off" onchange="getRate()" readonly="">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="transporter_name" id="transporter_name"  value="<?= $tripLorryData[0]->TRANSPORT_NAME ?>" placeholder="Enter Transporter" autocomplete="off" readonly="">
                             ...
                             <div class="col-md-2">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" name="driver_name" id="driver_name"  value="<?= $tripLorryData[0]->DRIVER_NAME ?>" placeholder="Select Driver Name " autocomplete="off" readonly="" />
                             ...
                             <div class="col-md-2">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" name="mobile_no" id="mobile_no"  value="<?= $tripLorryData[0]->DRIVER_MOBILE ?>" placeholder="Enter Mobile No"  autocomplete="off"  readonly=""/>
                 			...
                 			<div class="col-md-2">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" name="licence_no" id="licence_no"  value="<?= $tripLorryData[0]->LICENCE_NO ?>" placeholder="Enter Licence No"  autocomplete="off" />
                              ...
                              <div class="col-md-2">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" name="driver_add" id="driver_add"  value="<?= $tripLorryData[0]->DRIVER_ADD ?>" placeholder="Enter Driver Add"  autocomplete="off" />
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" name="remark" id="remark"  value="<?= $tripLorryData[0]->head_remark ?>" placeholder="Enter Remark"  autocomplete="off" />
               ...
               <!--  <div class="row">
                 ...
                 <p class="text-center">
                    ...
                    <button class="btn btn-success btn-sm" type="button" id="submitdata" onclick="submitData(0)"><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;&nbsp; Save</button>
                    ...
                    <button class="btn btn-success" type="button" id="submitdatapdf" onclick="submitData(1)"><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;&nbsp; Save &amp; Download Pdf</button>
...
function getTripDetials(){
 ...
 $.ajaxSetup({
     ...
     $.ajax({
          ...
          data: {trip_no: trip_no,vehicle_no:vehicle_no,series_code:series_code},
                ...
                $('#errorItem').html("<p style='color:red'>"+ data1.message +"</p>");
                 ...
                 /* if(data1.data_inward=='' || data1.data_inward==null){
                  ...
                  $('#itemTable').empty();
                   ...
                   var  sf = "<div class='totlsetinres'>Total : <input type='text' value='"+total.toFixed(3)+"' style='padding: 0px;width: 85px;text-align: right;' readonly id='basicTotal'/></div>";
