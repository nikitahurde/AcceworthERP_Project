          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <div class="box-tools pull-right">
                ...
                <a href="{{ url('/Transaction/Logistic/View-Vehicle-Gate-Inward') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Vehicle Gate Inward</a>
                          ...
                          <label>Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <?php 
                                ...
                                $vrDate    = date("d-m-Y H:i:s", strtotime($fromDate));  
                              ...
                              <input type="text" class="form-control ArrDate" name="vr_date" id="vr_date" value="{{ $vrDate }}" placeholder="Select Date" autocomplete="off">
                      ...
                      <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input list="vehicleList" class="form-control" name="vehicle_plan_no" id="vehicle_plan_no" placeholder="Enter Vehicle Plan No" maxlength="15" autocomplete="off" value="{{ $vehicle_plan_no }}" onchange="getplanDetails(this.value)">
                        ...
                        <div class="form-group">
                          ...
                          <label> Transporter Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="accList" class="form-control" name="acc_code"  id="acc_code" placeholder="Enter Account Code" value="{{ $acc_code }}" autocomplete="off" readonly="">
                        ...
                        <div class="form-group">
                          ...
                          <label> Transporter Name : <span class="required-field"></span></label>
                            ...
                            <div class="input-group tooltips">
                              ...
                              <input type="text" class="form-control" name="acc_name" id="acc_name" placeholder="Enter Account Name" value="{{ $acc_name }}" autocomplete="off" readonly="">
                       ...
                       <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input list="vehicleList" class="form-control" name="vehicle_no" id="vehicle_no" placeholder="Enter Vehicle No" value="{{ $vehicle_no }}" maxlength="15" autocomplete="off" onchange="getTruckDetails(this.value)" readonly="">
                       ...
                       <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="from_place" id="from_place" placeholder="Enter From Place" value="{{ $from_place }}" autocomplete="off" readonly="">
                         ...
                         <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="to_place" id="to_place" placeholder="Enter To Place" autocomplete="off" value="{{ $to_place }}" readonly="">
                         ...
                         <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="driver_name" id="driver_name" placeholder="Enter Driver Name" value="{{ $driver_name }}" autocomplete="off">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="driver_license_no" id="driver_license_no" value="{{ $driver_ls_no }}" placeholder="Enter License No" autocomplete="off">
                           ...
                           <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control transdatepicker" name="driver_license_ex_dt" id="driver_license_ex_dt" value="{{ $driver_ex_dt }}" placeholder="Enter License Dt" autocomplete="off">
                     ...
                     <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="driver_address" id="driver_address" value="{{ $driver_add }}" placeholder="Enter Driver Address" autocomplete="off">
                           ...
                           <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="remark" id="remark"  placeholder="Enter remark" autocomplete="off" value="{{ $remark }}">
              ...
              var data1 = JSON.parse(data);
                ...
                if (data1.response == 'error') {
                  ...
                  if(data1.data==''){
                     ...
                     $("#rate").val(data1.data.RATE);
                     $("#fporder_no").val(data1.data.FRIGHT_ORDER);
                     $("#dorder_no").val(data1.data.DELIVERY_NO);
                     $("#item_code").val(data1.data.ITEM_CODE);
                     $("#qty").val(data1.data.QTY);
                     $("#um_code").val(data1.data.UM);
                  }
...
<script type="text/javascript">
  ...
  function submitAllData(){
       ...
       $.ajaxSetup({
        ...
        var submitdataurl = "<?php echo url('/Transaction/Logistic/Update-Vehicle-Gate-Inward'); ?>";
