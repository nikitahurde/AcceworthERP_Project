          ...
          <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <datalist id="deliveryList">
                            ...
                            <option value="<?= $newVrNo ?>~<?= $key->TRIPHID ?>" data-xyz="<?= $key->TRIPHID ?>"><?= $key->VRDATE ?> - <?= $newVrNo ?> - <?= $key->VEHICLENO ?> - <?= $key->ACC_NAME ?>- <?= $key->TO_PLACE ?></option>
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input list="vehicleList" class="form-control" name="vehicle_no" id="vehicle_no" value="" placeholder="Enter Vehicle No"  oninput="this.value = this.value.toUpperCase()"  onchange="getTripDetials()" autocomplete="off">
                            <datalist id="vehicleList">
                              
                              <?php foreach ($trip_list as $key) { ?>
                                
                              <option value="<?= $key->VEHICLENO ?>~<?= $key->TRIPHID ?>" data-xyz="<?= $key->TRIPHID ?>"><?= $key->VRDATE ?> - <?= $key->VEHICLENO ?> - <?= $key->ACC_NAME ?> - <?= $key->TO_PLACE ?></option>
                   ...
                   <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="transportList" class="form-control" name="transporter_code"   id="transporter_code" placeholder="Enter Transporter" autocomplete="off" onchange="getRate()" readonly="">
                ...
                <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="trip_date" id="trip_date" placeholder="Enter Trip Date" autocomplete="off" readonly="" />
                ...
                <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="lr_date" id="lorry_date" placeholder="Enter Lr Date" autocomplete="off" readonly="" />
                   ...
                   <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="ack_date" class="form-control ArrDate"  id="ack_date"  value="{{ $CurrentDate }}" placeholder="Enter Ack Date" autocomplete="off" >
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="delivery_dt" class="form-control datepicker"  id="delivery_dt" onchange="getDeliveryDate()" placeholder="Enter Trip Achive Date" autocomplete="off" readonly>
                  ...
                  <div class="input-group">
                      <input type="text" name="trip_day" id="trip_day" class="form-control" placeholder="Day" readonly="" style="text-align: right;">
              ...
              <div class="row">
                <div class="col-md-2">
                  ...
                  <div class="input-group">
                      <input type="text" name="vehicle_owner" id="vehicle_owner" class="form-control" placeholder=" Vehicle Owner" readonly="">
...
<section class="content" style="margin-top: -13%;" id="bodyId">
          ...
          <div class="box-body">
            ...
            <!-- <form id="salesordertrans">
              ...
              <div class="table-responsive">
                ...
                <?php $srno = 1; $count = count($penalty_list); foreach($penalty_list as $row)  { 
                  ...
                  <tr class="useful">
                   ...
                   <!--  <td class="tdthtablebordr">
                    ...
                    <td class="tdthtablebordr" >
                        <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter"  id='slip_no<?= $srno ?>' name="slip_no[]" style="width: 90px;margin-top: 0px;" placeholder='Slip No'/>
                    </td>

                     <td class="tdthtablebordr" >
                        <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter datepicker"  id='slip_date<?= $srno ?>' name="slip_date[]" style="width: 90px;margin-top: 0px;" placeholder='Slip Date' />
                    </td>
                    ...
                    <td class="tdthtablebordr" >
                        ...
                        <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter moneyformate"  id='remark<?= $srno ?>' name="remark[]" placeholder='Remark' style="width: 120px;margin-top: 0px;" />
                     ...
                     <td class="tdthtablebordr">
                      ...
                      <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter getqtytotal quantityC moneyformate"  <?php echo $addAmtClass;?> id='amount<?= $srno ?>' name="amount_exp[]" oninput='Getqunatity(<?= $srno ?>)'style="width: 90px;margin-top: 0px;" autocomplete="off" placeholder='Amount'/>
 ...
 -->
                  ...
                  <div class="col-md-1">
                    ...
                    <input class="credittotldesn inputboxclr" type="text" name="TotalCredit" id="basicTotal" value='0' readonly="" style="margin-top: 3px;width: 90px;margin-left:69px;">
                          ...
                          <div class="col-md-4">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <select class="form-control" name="party_stamp" id="party_stamp"  value="" placeholder="Enter Party Stamp"  autocomplete="off">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" name="trip_freight_amt" id="trip_freight_amt"  value="0" placeholder="Enter Trip Freight Amt"  autocomplete="off"  style="text-align: right;"/>
                               ...
                               <div class="col-md-4">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" name="add_less_chrg" id="add_less_chrg"  value="0" placeholder="Enter Add/Less Charges"  autocomplete="off" style="text-align: right;"/>
                               ...
                               <div class="col-md-4">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" name="basic_amt" id="basic_amt"  value="0" placeholder="Enter Basic Amount"  autocomplete="off" style="text-align: right;"/>
                              ...
                              <div class="row">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" name="less_advance" id="less_advance"  value="0" placeholder="Enter Warai Recipt Date"  autocomplete="off" style="text-align: right;"/>
                              ...
                              <div class="col-md-4">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" name="net_amount" id="net_amount"  value="0" placeholder="Enter Net Amount"  autocomplete="off" style="text-align: right;"/>
        ...
        <div class="box box-success Custom-Box">
          ...
          <div class="box-body">
                 ...
                 <p class="text-center">
                    ...
                    <button class="btn btn-success btn-sm" type="button" onclick="submitData(1)" id="submitNDown" disabled=""><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;&nbsp; Save &amp; Download</button>
              ...
              if (data1.response == 'error') {
                ...
                $('#errorItem').html("<p style='color:red'>"+ data1.message +"</p>");
                  ...
                  $("#off_day").val(data1.data[0].OFF_DAY);
                   ...
                   var headtbl = "<div class='box-row'><div class='box10 texIndbox1 itemdetailshead'>ITEM CODE</div><div class='box10 texIndbox1 itemdetailshead'>ITEM REMARK</div><div class='box10 texIndbox1 itemdetailshead'>DO NO</div><div class='box10 texIndbox1 itemdetailshead'>LR NO</div><div class='box10 texIndbox1 itemdetailshead'>DELIVERY NO</div><div class='box10 texIndbox1 itemdetailshead'>INVOICE NO</div><div class='box10 texIndbox1 itemdetailshead'>MATERIAL AMT</div><div class='box10 texIndbox1 itemdetailshead'>LR QTY</div><div class='box10 texIndbox1 itemdetailshead'>NET WEIGHT</div><div class='box10 texIndbox1 itemdetailshead'>RECD QTY</div><div class='box10 texIndbox1 itemdetailshead'>SHORTAGE QTY</div></div>";
            ...
            //console.log(data1);
              ...
              if (data1.response == 'error') {
                ...
                if(vehicle_type=='VEHICLENO' || vehicle_type=='LR_NO'){
                 ...
                 var lorry_date = data1.data[0].LR_DATE;
                  ...
                  var lr_date =  date.getDate() + "-" + (month.toString().length > 1 ? month : "0" + month) + "-" +  date.getFullYear();
                   ...
                   var vr_date = new Date(vr_date);
                  var vr_month = vr_date.getMonth() + 1;
                          
                  var VrDate =  vr_date.getDate() + "-" + (vr_month.toString().length > 1 ? vr_month : "0" + vr_month) + "-" +  vr_date.getFullYear();
                  ...
                  console.log('ackment_date',ackment_date);
                 ...
                 //console.log('day diff',day_diff);
                  ...
                  $("#do_no1").prop('readonly',false);
                   ...
                   var headtbl = "<div class='box-row' style='padding:2px;'><div class='box10 texIndbox1 itemdetailshead'>ITEM CODE</div><div class='box10 texIndbox1 itemdetailshead'>ITEM REMARK</div><div class='box10 texIndbox1 itemdetailshead'>DO NO</div><div class='box10 texIndbox1 itemdetailshead'>LR NO</div><div class='box10 texIndbox1 itemdetailshead'>DELIVERY NO</div><div class='box10 texIndbox1 itemdetailshead'>INVOICE NO</div><div class='box10 texIndbox1 itemdetailshead'>MATERIAL AMT</div><div class='box10 texIndbox1 itemdetailshead'>ISSUED QTY</div><div class='box10 texIndbox1 itemdetailshead'>LR QTY</div><div class='box10 texIndbox1 itemdetailshead'>RECD QTY</div><div class='box10 texIndbox1 itemdetailshead'>SHORTAGE QTY</div></div>";

                   $('#itemTable').append(headtbl);

                   console.log('DELIVERY_NO',data1.data[0].DELIVERY_NO);
                    var srno =1;
                   ...
                   $.each(data1.data, function(k, getData) {
                      ...
                      if(getData.SHORTAGE_QTY){
                        var shortage_qty = getData.SHORTAGE_QTY;
                      }else{
                        var shortage_qty = '0.000';
                          }
                     if(getData.MATERIAL_VAL){
                        var materialValue = getData.MATERIAL_VAL;
                      }else{
                        var materialValue = '0.000';
                        }
                      if(getData.DELIVERY_NO==null || getData.DELIVERY_NO==''){

                        var deliveryNo = '';
                      }else{
                        var deliveryNo = getData.DELIVERY_NO;
                     ...
                     shrtqty_total += parseFloat(shortage_qty);




                    var tableData = "<div class='box-row'><div class='box10 texIndbox1'><input style='padding: 0px;border:none;' type='hidden' value='"+getData.TRIPBID+"' name='bodyId[]' id='bodyId"+srno+"' readonly=''/><input style='padding: 0px;border:none;' type='text' value='"+getData.ITEM_CODE+"' name='item_code[]' id='item_code"+srno+"' readonly=''/></div><div class='box10 texIndbox1'><input style='padding: 0px;border:none;' type='text' value='"+getData.ITEM_NAME+"' name='item_name[]' id='item_name"+srno+"' readonly=''/></div><div class='box10 texIndbox1'><input style='padding: 0px;width: 85px;border:none;' type='text' value='"+getData.DO_NO+"' name='do_name[]'  id='do_name"+srno+"' readonly=''/></div><div class='box10 texIndbox1'><input style='padding: 0px;width: 85px;border:none;' type='text' value='"+getData.LR_NO+"' name='lr_no[]'  id='lr_no"+srno+"' readonly=''/></div><div class='box10 texIndbox1'><input style='padding: 0px;width: 85px;border:none;' type='text' value='"+deliveryNo+"' name='delivery_no[]' id='delivery_no"+srno+"' readonly=''/></div><div class='box10 texIndbox1'><input style='padding: 0px;width: 85px;border:none;' type='text' value='"+getData.INVC_NO+"' name='invc_no[]' id='invc_no"+srno+"' readonly=''/></div><div class='box10 texIndbox1'><input style='padding: 0px;width: 85px;text-align: right;border:none;' type='text' value='"+materialValue+"' name='material_value[]' id='material_value"+srno+"' readonly=''/></div><div class='box10 texIndbox1'><input style='padding: 0px;width: 85px;text-align: right;border:none;' type='text' value='"+getData.QTY+"'  id='issue_qty"+srno+"' name='issue_qty[]' readonly=''/></div><div class='box10 texIndbox1'><input style='padding: 0px;width: 85px;text-align: right;border:none;' type='text' value='"+getData.NET_WEIGHT+"'  id='net_weight"+srno+"' name='net_weight[]' readonly=''/></div><div class='box10 texIndbox1 clr' id='divrecd_qty"+srno+"'><input style='padding: 0px;width: 85px;text-align: right;border:none;' type='text' class='inputboxclr clr getlrqtytotal' value='"+getData.RECD_QTY+"' name='recd_qty[]' id='recd_qty"+srno+"' oninput='getShortagQty("+srno+")' autocomplete='off'/></div><div class='box10 texIndbox1'><input style='padding: 0px;width: 91px;text-align: right;border:none;' type='text' value='"+shortage_qty+"' name='shortage_qty[]' id='shortage_qty"+srno+"' readonly=''/></div></div>";
                ...
                //alert(late_delivery_charges);
                        ...
                        if(owner=='MARKET' || owner=='SELF'){
                           ...
                           for (var m = 1; m <= penalty_count; m++) {
                                     ...
                                     if(penalty_decs=='Shortage Recovery'){
                                      ...
                                      if(penalty_decs=='Late LR Submission Charges'){
                                     ...
                                     if(penalty_decs=='Late Del Charges'){
                                       ...
                                       $("#amount"+m).val('-'+late_delivery_charges.toFixed(2));
                          ...
                          if(isNaN(bTotal)){
                            ...
                            $("#trip_freight_rate").val(0.00);
                            $("#basic_amt").val(0.00);
                            $("#less_advance").val(0.00);
                            $("#net_amount").val(0.00);
                          }else{
                            ...
                            $("#trip_freight_amt").val(valzero);
                            $("#basic_amt").val(valzero);
                            $("#less_advance").val(valzero);
                            $("#net_amount").val(valzero);
                          }
                  ...
                  var amount      = parseFloat(less_advance)  - parseFloat(freight_amt);
                 ...
                 $('#net_amount').val(amount.toFixed(2));
                     ...
                     $('#trip_freight_qty').val(0);
                     $('#trip_freight_rate').val(0);
...
<script type="text/javascript">
  ...
  function getShortagQty(recdQty){
    ...
    if(parseFloat(recd_qty) > parseFloat(net_qty)){
     ...
     gr_a1mt =0;
       $(".getqtytotal").each(function () {
          ...
          $("#add_less_chrg").val(gr_a1mt.toFixed(2));
           ...
           console.log('freight_amt',freight_amt);
