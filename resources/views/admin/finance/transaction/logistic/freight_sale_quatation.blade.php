            ...
            <div class="box-header with-border">
              ...
              <div class="col-md-4">
                <div class="box-tools pull-right">
                  ...
                  <a href="{{ url('Transaction/Logistic/view-freight-sale-Quatation') }}" class="btn btn-primary btn-sm" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Freight Sale.</a>
              ...
              <div class="tab-content">
                  <div class="tab-pane fade in active" id="tab1info">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2 rfclass" id="rfblock1">

                        <div class="form-group">

                          <label id="Lrfhead1"></label>

                            <div class="input-group">

                              <input type="text" class="form-control" name="InpNameOneRf" value="" id="rfhead1" placeholder="" autocomplete="off">
                       ...
                       <div class="col-md-2 rfclass" id="rfblock2">

                        <div class="form-group">

                          <label id="Lrfhead2"></label>

                            <div class="input-group">


                              <input type=text class="form-control" name="rfInpnameTwo" value="" id="rfhead2" placeholder="" autocomplete="off">
                       ...
                       <div class="col-md-2 rfclass" id="rfblock3">

                        <div class="form-group">

                          <label id="Lrfhead3"></label>

                            <div class="input-group">

                             

                              <input type="text" class="form-control" name="rfInpnameThree" value="" id="rfhead3" placeholder="" autocomplete="off">
                       ...
                       <div class="col-md-2 rfclass" id="rfblock4">

                        <div class="form-group">

                          <label id="Lrfhead4"></label>

                            <div class="input-group">

                              
                              <input type="text" class="form-control" name="rfInpnameFour" value="" id="rfhead4" placeholder="" autocomplete="off">
                      ...
                      <div class="row">
                       ...
                       <div class="col-md-2 rfclass" id="rfblock5">

                        <div class="form-group">

                          <label id="Lrfhead5"></label>

                            <div class="input-group">

                            

                              <input type="text" class="form-control" name="rfInpnameFive" value="" id="rfhead5" placeholder="" autocomplete="off" >
          ...
          <div class="box-body">
              ...
              <div class="table-responsive">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                  ...
                  <input type ="hidden" name="pfctNaame" id="getPfctName">
                  ...
                  <tr class="useful">
                    ...
                    <td class="tdthtablebordr" style="width: 25px;">
                      <div class="input-group">
                        <input list="vehciletypeList1" class="inputboxclr" style="width: 100px;" id='vehicle_type1' onchange="getVehicleTypeNm(1)" name="vehicle_type[]"   oninput="this.value = this.value.toUpperCase()"  />
                          ...
                          <input type="hidden" id="vehicleTypeName1" value="" name='vehicleTypeName[]'>
                      </div>
                      <small id='vehicleTypeNmErr1'></small>
          ...
          <div>
            ...
            <p class="text-center">
              ...
              <button class="btn btn-warning btn-sm" type="button" id="CancleBtn" onclick="location.reload();"><i class="fa fa-refresh" aria-hidden="true"></i>&nbsp;&nbsp; Cancel</button>
               ...
               <button class="btn btn-success" type="button" id="submitdatapdf" onclick="submitData(1)"><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;&nbsp; Save & Download</button>
...
<script type="text/javascript">
  ...
  function getVehicleTypeNm(srNo){

      var vehicleType =  $('#vehicle_type'+srNo).val();
      var xyz = $('#vehciletypeList'+srNo+' option').filter(function() {

      return this.value == vehicleType;

      }).data('xyz');

      var msg = xyz ?  xyz : 'No Match';

      console.log('vel Type ',msg);

      if(msg=='No Match'){
       
        $('#vehicleTypeNmErr'+srNo).html('*Vehicle Type Field Is Required');
        $('#vehicleTypeName'+srNo).val('');

      }else{

        $('#vehicleTypeNmErr'+srNo).html('');
        $('#vehicleTypeName'+srNo).val(msg);
                ...
                //  $("#vehicle_type"+srno).val(data1.data[0].VEHICLE_TYPE);
                  ...
                  $.each(data1.data, function(k, getData){
                    ...
                    $("#vehciletypeList"+srno).append($('<option>',{
                      ...
                      value:getData.WHEEL_CODE,

                      'data-xyz':getData.WHEEL_NAME,
                      text:getData.WHEEL_NAME+' - '+getData.WHEEL_CODE+'] ',
      ...
      var trcount=$('table tr').length;
         ...
         // $('.overlay-spinner').removeClass('hideloader');
          ...
          $.ajax({
              ...
              url: "<?php echo url('/Transaction/Logistic/save-freight-sale-Quatation'); ?>",
              ...
              console.log(data1);
                ...
                //   var responseVar =false;
                 ...
                 //     var url = "{{ url('Transaction/Logistic/view-freight-sale-Quatation') }}"
              ...
              var url = "{{ url('/Transaction/Logistic/View-fsq-Plan-msg') }}"
              setTimeout(function(){ window.location = url+'/'+responseVar;  });
          ...
          success:function(data){
           ...
           //console.log('data1',data1);
              ...
              if (data1.response == 'error') {
                ...
                $('#errorItem').html("<p style='color:red'>"+ data1.message +"</p>");
                  ...
                  if (data1.data == '') {
                    ...
                    if(data1.data[0].RFHEAD1){
                      ...
                      $("#Lrfhead1").html(data1.data[0].RFHEAD1);
                      $('#rfblock1').removeClass('rfclass');
                    }else{
                      $('#rfblock1').addClass('rfclass');
                    }

                    if(data1.data[0].RFHEAD2){

                      $("#Lrfhead2").html(data1.data[0].RFHEAD2);
                      $('#rfblock2').removeClass('rfclass');
                    }else{
                      $('#rfblock2').addClass('rfclass');
                    }

                    if(data1.data[0].RFHEAD3){

                      $("#Lrfhead3").html(data1.data[0].RFHEAD3);
                      $('#rfblock3').removeClass('rfclass');
                    }else{
                      $('#rfblock3').addClass('rfclass');
                    }

                    if(data1.data[0].RFHEAD4){

                      $("#Lrfhead4").html(data1.data[0].RFHEAD4);
                      $('#rfblock4').removeClass('rfclass');
                    }else{
                      $('#rfblock4').addClass('rfclass');
                    }

                    if(data1.data[0].RFHEAD4){

                      $("#Lrfhead5").html(data1.data[0].RFHEAD5);
                      $('#rfblock5').removeClass('rfclass');
                    }else{
                      $('#rfblock5').addClass('rfclass');
                    }
                  }
                ...
                console.log('config data',data1.data);
               // console.log('config data',data2.data);
