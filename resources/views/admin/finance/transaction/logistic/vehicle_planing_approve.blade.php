...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="{{ url('/report/purchase/purchase-indent-report') }}">Add Payment Advice - Market</a></li>
  ...
  <section class="content" style="min-height: 150px;margin-bottom: -26px;">
    ...
    <div class="box box-primary Custom-Box">
      ...
      <div class="box-header with-border" style="text-align: center;">
        ...
        <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Add Payment Advice - Market</h2>
      ...
      <table id="TransportBillTable" class="table table-bordered table-striped table-hover">
        ...
        <thead class="theadC">
          ...
          <tr>
            ...
            <th class="text-center">Adavance Percent/rate</th>
  ...
  function load_data_query(from_date='',to_date=''){
      ...
      $('#TransportBillTable').DataTable({
        ...
        footerCallback: function ( row, data, start, end, display ) {
                ...
                $( api.column(10).footer() ).html('<small class="texttotal" id="settextfot">Total :- </small>').css('text-align','right');

                $( api.column(11).footer() ).html('<small id="basicTotalAmt"></small><br><small id="nextAmtTot"></small><input type="hidden" id="totlFreightAmt" name="totlFreightAmt" value="">');

                console.log(api.column(11));
