...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/form-mast-fleet') }}">Add  Supplementary Lorry Receipt </a></li>
      ...
      <div class="col-sm-12">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">Add Supplementary LR</h2>

              <div class="box-tools pull-right showinmobile">

                <a href="{{ url('/Transaction/Logistic/View-lorry-receipt-trans') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Supplementary LR</a>
                  ...
                  <div class="box-tools pull-right">
                    ...
                    <a href="{{ url('/Transaction/Logistic/View-lorry-receipt-trans') }}" class="btn btn-primary btn-sm" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Supplementary LR</a>
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input list="vehicleList" class="form-control" name="vehicle_no" id="vehicle_no" value="{{ $vehicle_no }}" placeholder="Enter Vehicle No" maxlength="13" oninput="this.value = this.value.toUpperCase()" autocomplete="off" onchange="getTripDetials()" >
...
function getTripDetials(){
 ...
 $.ajaxSetup({
     ...
     $.ajax({
          ...
          url:"{{ url('get-trip-details-by-trip-no-for-suppl') }}",
            ...
            console.log(data1);
              ...
              if (data1.response == 'error') {
                ...
                $('#errorItem').html("<p style='color:red'>"+ data1.message +"</p>");
                 ...
                 // console.log('headid',data1.data[0].TRIPHID);
                  ...
                  $('#itemTable').empty();
                   ...
                   var headtbl = "<div class='box-row'><div class='box10 texIndbox1'>INVOICE NO</div><div class='box10 texIndbox1'>INVOICE DATE</div><div class='box10 texIndbox1'>DO NO</div><div class='box10 texIndbox1'>DO DATE</div><div class='box10 texIndbox1'>ITEM CODE</div><div class='box10 texIndbox1'>REMARK</div><div class='box10 texIndbox1'>LR NO</div><div class='box10 texIndbox1'>LR DATE</div><div class='box10 texIndbox1'>WAGON NO</div><div class='box10 texIndbox1'>WAGON DATE</div><div class='box10 texIndbox1'>LR QTY</div><div class='box10 texIndbox1'>DELIVERY NO</div><div class='box10 texIndbox1'>GROSS WEIGHT</div><div class='box10 texIndbox1'>TARE WEIGHT</div><div class='box10 texIndbox1'>NET WEIGHT</div><div class='box10 texIndbox1'>E-WAY BILL NO</div><div class='box10 texIndbox1'>E-WAY BILL Date</div><div class='box10 texIndbox1'>MATERIAL VALUE</div></div>";
                   ...
                   var  sf = "<div class='totlsetinres'>Total : <input type='text' value='"+total.toFixed(3)+"' style='padding: 0px;width: 85px;text-align: right;' readonly/></div>";
