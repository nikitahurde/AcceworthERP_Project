...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <h1>
           Delivery Order Change Destination
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/logistic/cancel-delivery-order-quantity') }}"> Change D.O. Destination</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Delivery Order Change Destination </h2>
  ...
  function updateDoDestination(){
    ...
    var to_place   =  $('#to_place').val();
        ...
        $.ajax({
            ...
            url:"{{ url('/transaction/update-delivery-order-destination') }}",

            method : "POST",

            type: "JSON",

            data: {acc_code:acc_code,do_no:do_no,cust_no:cust_no,to_place:to_place},
...
<script type="text/javascript">
  ...
  function load_data_query(acc_code='',cust_no='',do_no=''){
    ...
    // console.log('cust_no',cust_no);
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/logistic/get-data-change-dest-delivery-order") }}',
            data: {acc_code:acc_code,cust_no:cust_no,do_no:do_no,}
          },
          columns: [
  ...
  $(document).ready(function() {
    ...
    $('#btnsearch').click(function(){
          ...
          if (acc_code!='' || cust_no=='' || do_no=='') {

            $('#PurchaseIndentReportTable').DataTable().destroy();

            load_data_query(acc_code,cust_no,do_no);
