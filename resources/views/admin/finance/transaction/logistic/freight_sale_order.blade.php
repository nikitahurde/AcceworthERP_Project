                        ...
                        <div class="form-group">
                          ...
                          <label> Sale Quotation No </label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="quotationList" class="form-control" name="quotation_no" value="" id="quotation_no" placeholder="Enter Sale Quotation No" autocomplete="off" onchange="funQuotation('saleQuoNo')">
                        ...
                        <div class="form-group">
                          ...
                          <label> Valid From Date : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type=text class="form-control fromdatepicker" name="valid_from_date" value="" id="valid_from_date" placeholder="Enter Refrence Date" autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label> Valid To Date : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type=text class="form-control todatepicker" name="valid_to_date" value="" id="valid_to_date" placeholder="Enter Refrence Date" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="col-md-2">
                       ...
                       <div class="col-md-2" style="margin-top: 11px;">
                          <button type="submit" class="btn btn-primary btn-sm" id="importbtn" style="line-height: 1.5;font-size: 12px;">&nbsp;&nbsp;<i class="fa fa-download" aria-hidden="true"></i>&nbsp;&nbsp;IMPORT&nbsp;&nbsp;</button>
                        </div>
                  ...
                  <div id="dfg" class="table-responsive" style="padding-top: 5px;">
                   ...
                   <div class="modalspinner hideloaderOnModl"></div>
                    ...
                    <p class="text-center">
                      ...
                      <button class="btn btn-warning btn-sm-class" type="button" id="CancleExcelBtn" onclick="location.reload();"><i class="fa fa-refresh" aria-hidden="true"></i>&nbsp;&nbsp;Cancel&nbsp;&nbsp;</button>
              ...
              <div class="table-responsive">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                  ...
                  <tr class="useful">
                    ...
                    <td class="tdthtablebordr" style="width: 25px;">
                      <div class="input-group">
                        <input list="vehciletypeList1" class="inputboxclr" style="width: 100px;" id='vehicle_type1' name="vehicle_type[]"  onchange='getVehicleType(1);'  oninput="this.value = this.value.toUpperCase()"  />

                          <datalist id="vehciletypeList1">

                            <?php foreach($vehicletype_list as $key) { ?>

                              <option value='<?php echo $key->WHEEL_CODE?>' data-xyz ="<?php echo $key->WHEEL_NAME; ?> ~ <?php echo $key->FREIGHTTYPE_NAME; ?>" ><?php echo $key->WHEEL_NAME ; echo " [".$key->WHEEL_CODE."]" ; ?></option>

                            <?php } ?>

                          </datalist><br>

                          <input type="hidden" name="wheelCode[]" id="wheelCode1" value="">
...
<script type="text/javascript">
  ...
  function getVehicleType(num){

        var wheel_code =  $('#vehicle_type'+num).val();
        //alert(wheel_code);

      var xyz = $('#vehciletypeList'+num+' option').filter(function() {
      ...
      var msg = xyz ?  xyz : 'No Match';
        ...
        var splitType = msg.split('~');

        var wheel_code = splitType[0];
        var vehicle_type = splitType[1];

        //alert(vehicle_type);return false;
      ...
      if(msg=='No Match'){
         ...
         $('#wheelCode'+num).val(wheel_code);
         $('#vehicleType'+num).val(vehicle_type);
...
<script type="text/javascript">
  function getRouteLocation(srno) {
    ...
    var valid_to_date = $("#valid_to_date").val();
      ...
      $("#getvalidfrmDate").val(valid_from_date);
      $("#getvalidtoDate").val(valid_to_date);
...
<script type="text/javascript">
  ...
  function funQuotation(fieldType){

    if(fieldType == 'saleQuoNo'){

      var val = $('#quotation_no').val();
     
      var xyz = $('#quotationList option').filter(function() {
      ...
      if(msg == 'No Match'){
        ...
        var quotation_no = splitData[0];
        var fsqHeadid    = splitData[2];
        $('#fsq_hid').val(fsqHeadid);
        $('#Quo_no').val(quotation_no);
        $('#SaleNo').val(fsqHeadid);
         
      }

    }else if(fieldType == 'ACCOUNTNO'){

      var val = $('#account_code').val();
      ...
      if(msg == 'No Match'){
        $('#account_code,#fsq_hid,#quotation_no').val('');
        $('#quotationList').empty();
      }else{
        $('#fsq_hid,#quotation_no').val('');
        $('#quotationList').empty();
      }
      ...
      var customercode = $('#account_code').val();
  ...
  $.ajax({
    ...
    url: "{{ url('/Transaction/Logistic/Freight-Sale-Quatationgetdata') }}",

    data: {fsqHeadid:fsqHeadid,customercode:customercode,fieldType:fieldType}, 
    ...
    success: function (data) {
     //console.log('data',data);
      ...
      if(data1.response=='error'){
        ...
        console.log('data1.data_fsqNoList',data1.data_fsqNoList);
        ...
        if(fieldType == 'ACCOUNTNO'){
          ...
          $("#quotationList").empty();
          $.each(data1.data_fsqNoList, function(k, getData){
            ...
            $("#quotationList").append($('<option>',{
              ...
              'data-xyz':startyear[0]+' '+getData.SERIES_CODE+' '+getData.FSQHID,
          ...
          $('#ref_no').val(data1.dataquotation[0].REF_NO).pro;
          $('#ref_date').val(data1.dataquotation[0].REF_DATE);
          $('#valid_from_date').val(data1.dataquotation[0].VALID_FROM_DT);
          $('#valid_to_date').val(data1.dataquotation[0].VALID_TO_DT);

          console.log('else if',data1.dataquotation);
            $('#totalRow').val(data1.dataquotation.length);

            $('#tbledata').empty();

            var headData="<tr><th style='width: 10%;'><input class='check_all'type='checkbox' onclick='select_all()'/></th><th style='width: 10%;''> Sr.No.</th><th>Route Code</th><th>Route Name</th><th>From Place</th><th>To Place</th><th>Vehicle Type</th><th>Rate Basis</th><th>Rate</th></tr>";

            $('#tbledata').append(headData);

            var slNo = 1;
            $.each(data1.dataquotation, function(k,getData){
             // if(slNo == 1){
             ...
             //  }
              ...
              var bodyData ="<tr><td class='tdthtablebordr'><input type='checkbox' class='case'/></td><td class='tdthtablebordr'><span id='snum"+slNo+"'>"+slNo+".</span></td><td class='tdthtablebordr' style='width: 25px;'><div class='input-group'><input list='routeList"+slNo+"' class='inputboxclr' style='width: 120px;' id='route_code"+slNo+"' name='route_code[]'value='"+getData.ROUTE_CODE+"'</td>"+"<td class='tdthtablebordr' style='width: 25px;'><div class='input-group'><input type='text' class='inputboxclr' style='width: 220px;' id='route_name"+slNo+"' name='route_name[]'value='"+getData.ROUTE_NAME+"'></td>"+"<td class='tdthtablebordr' style='width: 25px;'><div class='input-group'><input list='fromplaceList"+slNo+"' class='inputboxclr' style='width: 130px;' id='from_place"+slNo+"' name='from_place[]'value='"+getData.FROM_PLACE+"'</td>"+"<td class='tdthtablebordr' style='width: 25px;'><div class='input-group'><input list='toplaceList"+slNo+"' class='inputboxclr' style='width: 130px;' id='to_place"+slNo+"' name='to_place[]' value='"+getData.TO_PLACE+"'</td>"+"<td class='tdthtablebordr' style='width: 25px;'><div class='input-group'><input list='vehciletypeList"+slNo+"' class='inputboxclr' style='width: 100px;' id='vehicle_type"+slNo+"' name='vehicle_type[]' value='"+getData.VEHICLE_TYPE+"'id='vehciletypeLis"+slNo+"'></td>"+"<td class='tdthtablebordr tooltips' style='width: 25px;'><input list='ratebasisList"+slNo+"' class='inputboxclr getAccNAme' style='width: 108px;' id='rate_basis"+slNo+"' name='rate_basis[]' value='"+getData.RATE_BASIS+"'autocomplete='off'/><small class='tooltiptextitem tooltiphide' id='itemNameTooltip+"+slNo+"'></small><br></td>"+"<td class='tdthtablebordr tooltips' style='width: 25px;'><input type='text' class='debitcreditbox dr_amount inputboxclr getqtytotal quantityC moneyformate'  oninput='Getqunatity()' style='width: 100px;margin-bottom: 5px;' id='rate"+slNo+"' name='rate[]' value='"+getData.RATE+"'autocomplete='off'/><small class='tooltiptextitem tooltiphide' id='itemNameTooltip"+slNo+"'></small><br></td></tr>";
