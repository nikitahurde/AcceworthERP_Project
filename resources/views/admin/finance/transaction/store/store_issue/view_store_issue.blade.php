...
<style>
  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <small><b>Store Issue Details</b></small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/view-mast-dealer') }}">Store Issue</a></li>

            <li class="active"><a href="{{ url('/view-mast-dealer') }}">View Store Issue</a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Store Issue</h3>

                  <div class="box-tools pull-right">

          <a href="{{ url('/Transaction/Store/Store-Issue') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Store Issue</a>
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/Transaction/Store/View-Store-Issue') }}"
   ...
   function showchildtable(vrno,tblid){
            var vrno,tblid;
             ...
             $.ajax({
              ...
              url:"{{ url('view-purchase-store-issue-chield-row-data') }}",
               ...
               success:function(data){
                  ...
                  if (data1.response == 'error') {
                      ...
                      var enableBtn = 'enable';
                      var deletebtn ='<a href="edit-store-issue/'+btoa(objrow.SREQHID)+'/'+btoa(objrow.SREQBID)+'/'+btoa(objrow.VRNO)+'" class="btn btn-warning btn-xs" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" onclick="return pindentDelete('+objrow.SREQBID+');"><i class="fa fa-trash" title="Delete"></i></button>';
                      ...
                      var deletebtn ='<a class="btn btn-warning btn-xs" title="edit" disabled><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" disabled><i class="fa fa-trash" title="Delete"></i></button>';
                               ...
                               $('#childData_'+tableid).append('<tr><td class="text-center">'+srNo+'</td><td><p>'+objrow.ITEM_NAME+' </p><p style="line-height: 2px;">( '+objrow.ITEM_CODE+')</p></td><td class="text-right">'+objrow.QTYISSUED+' '+objrow.UM+'</td><td class="text-right">'+objrow.AQTYISSUED+' '+objrow.AUM+'</td></tr>');
                              srNo++;
                             });
