...
<script type="text/javascript">
 ...
 <script type="text/javascript">
     ...
     var viewaurl = "<?php echo url('/finance/transaction/store/view-store-requistion'); ?>";
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <div class="box-tools pull-right">
                ...
                <a href="{{ url('/finance/transaction/store/view-store-requistion') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Store Req.</a>
                        ...
                        <div class="form-group">
                          ...
                          <label>Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control transdatepicker" name="vr" id="vr_date" value="{{ $getStoreRequ[0]->VRDATE }}" placeholder="Select Date" autocomplete="off" onchange="requisition.vrDate()">  
                        ...
                        <div class="form-group">
                          ...
                          <label> T Code : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="tran" value="{{ $getStoreRequ[0]->TRAN_CODE }}" id="transcode" placeholder="Enter Transaction Head" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <span class="input-group-addon" style="padding: 1px 7px;">
                              ...
                              <input list="seriesList1"  id="series_code" name="series" class="form-control  pull-left" value="{{ $getStoreRequ[0]->SERIES_CODE }}" placeholder="Select Series" oninput="this.value = this.value.toUpperCase()" autocomplete="off">
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="vro" value="{{ $getStoreRequ[0]->VRNO }}" placeholder="Enter Vr No" id="vrseqnum" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Plant Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="PlantcodeList" class="form-control" id="Plant_code" name="plantcode" placeholder="Select Plant" maxlength="11" value="{{ $getStoreRequ[0]->PLANT_CODE }}" readonly autocomplete="off" onchange="requisition.PlantCode(Plantcodeurl)">
                        ...
                        <div class="form-group">
                          ...
                          <label>Department Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="AccountList"  id="account_code" name="AccCode" class="form-control  pull-left" value="{{ $getStoreRequ[0]->DEPT_CODE }}" placeholder="Select Department" oninput="this.value = this.value.toUpperCase()"  autocomplete="off" 
                        ...
                        <div class="form-group">
                          ...
                          <label> Employee Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="emplList" class="form-control" name="emp_code" value="{{ $getStoreRequ[0]->EMP_CODE }}" id="emp_code" placeholder="Enter Employee Code" autocomplete="off" onchange="requisition.EmpCode()">
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="party_ref" value="" id="party_rf_no" placeholder="Enter Party Ref No" maxlength="30" autocomplete="off">
            ...
            <form id="salesordertrans">
              ...
              <div class="table-responsive">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                  ...
                  <?php $sr=1;$rowCount = count($getStoreRequ);$qtyTot=0; foreach ($getStoreRequ as $rows) {
                   ...
                   <?php if($sr==1){ ?>
                      ...
                      <input type="hidden" id="totRow" value="{{$rowCount}}">
                   ...
                   <?php } ?>
                    ...
                    <tr class="useful">
                      ...
                      <td class="tdthtablebordr">
                        ...
                        <input type="hidden" id="storeReq_headid" value="<?php echo $rows->SREQHID; ?>">
                        <input type="hidden" id="storeReq_bodyid" value="<?php echo $rows->bodyid; ?>">
                        <input type="hidden" id="storeReq_bodyid" value="<?php echo $rows->VRNO; ?>">
                      </td>

                      <td class="tdthtablebordr">
                        <div class="input-group">
                          <input list="ItemList<?php echo $sr; ?>" class="inputboxclr SetInCenter" style="width: 90px;margin-bottom: 5px;" id='ItemCodeId<?php echo $sr; ?>' name="item_code[]" value="{{ $rows->ITEM_CODE }}"  onchange="requisition.ItemCodeGet(<?php echo $sr; ?>,itemcodeurl,quaitemurl);"  oninput="this.value = this.value.toUpperCase()" />
                        ...
                        <button type="button" class="btn btn-primary btn-xs showdetail viewbtnitem" id="viewItemDetail<?php echo $sr; ?>" data-toggle="modal" data-target="#view_detail1" onclick="requisition.showItemDetail(<?php echo $sr; ?>,itemcodeurl)"><i class="fa fa-info" aria-hidden="true" style="font-size: 13px;"></i> </button>
                        <div><p id="stockavlble<?php echo $sr; ?>" class="badge" style="background-color:#25b6bd;"></p>
                        </div>
                        <input type="hidden" name="stockavlblevalue" id="stockavlblevalue<?php echo $sr; ?>">
                      ...
                      <td class="tdthtablebordr tooltips">
                        ...
                        <div><p id="batchno<?php echo $sr; ?>" class="badge" style="background-color:#25b6bd;">Batch No : <?php if($rows->BATCH_NO){ echo $rows->BATCH_NO; }else{echo '-';}?></p>
                         </div>
                         <input type="hidden" name="batch_no[]" value="{{$rows->BATCH_NO}}" id="batch_no<?php echo $sr; ?>">
                      ...
                      <td class="tdthtablebordr">
                        ...
                        <div style="display: inline-flex;border: none;margin-top: -3%;">
                          ...
                          <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter getqtytotal quantityC moneyformate" value="{{$rows->QTYRECD}}"  id='qty<?php echo $sr; ?>' name="qty[]" oninput='Getqunatity(<?php echo $sr; ?>)'style="width: 80px" readonly />
                          <input type="hidden" id="qtyget<?php echo $sr; ?>" class="totlqty">
                          <input type="text" name="unit_M[]" id="UnitM<?php echo $sr; ?>" value="{{$rows->UM}}" class="inputboxclr SetInCenter AddM" readonly>

                          <input type="hidden" id="Cfactor<?php echo $sr; ?>">

                        </div>
                        <div><small id="errmsgqty<?php echo $sr; ?>"></small></div>
                      ...
                      <td class="tdthtablebordr">
                        ...
                        <div style="display: inline-flex;border: none;margin-top: -3%;">
                          ...
                          <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter"  id='A_qty<?php echo $sr; ?>' value="{{$rows->AQTYRECD}}" name="Aqty[]"  style="width: 80px" readonly />

                          <input type="text" name="add_unit_M[]" id="AddUnitM<?php echo $sr; ?>" value="{{$rows->AUM}}"  class="inputboxclr SetInCenter AddM" readonly>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
      ...
      $(window).on('load',function(){
       var rowget =  $('#totRow').val();
        for(var q=0;q<rowget;q++){
          var id= q+1;
