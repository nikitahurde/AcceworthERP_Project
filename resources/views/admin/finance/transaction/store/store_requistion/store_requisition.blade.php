...
<script src="{{ URL::asset('public/dist/js/controller/StoreRequisitionController.js') }}" ></script> 
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <div class="box-tools pull-right">
                ...
                <a href="{{ url('Transaction/Store/View-Store-Requistion') }}" class="btn btn-primary" style="margin-right: 10px;line-height: 1;padding: 2px 4px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Store Req.</a>
                          ...
                          <label>Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                             ...
                             <?php 
                              ...
                              <input type="text" class="form-control transdatepicker" name="vr" id="vr_date" value="{{ $vrDate }}" placeholder="Select Date" autocomplete="off" onchange="requisition.vrDate()">
                        ...
                        <div class="form-group">
                          ...
                          <label>Plant Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="PlantcodeList" class="form-control" id="Plant_code" name="plantcode" placeholder="Select Plant" maxlength="11" value="<?php if($plcount == 1){echo $plant_list[0]->PLANT_CODE;}?>" readonly autocomplete="off" onchange="requisition.PlantCode(Plantcodeurl)">
                        ...
                        <div class="form-group">
                          ...
                          <label>Department Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              onchange="requisition.GetAccCode(accCodeurl)"> 
                        ...
                        <div class="form-group">
                          ...
                          <label> Employee Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="emplList" class="form-control" name="emp_code" value="" id="emp_code" placeholder="Enter Employee Code" autocomplete="off" onchange="requisition.EmpCode()" readonly="">
                            ...
                            <small id="emp_err" style="color: red;" class="form-text text-muted"> </small>
                        ...
                        <div class="form-group">
                          ...
                          <label> Employee Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="empName" value="" id="empName" placeholder="Enter Employee  Name" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label> Cost Center Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="costList" class="form-control" name="cost_center_code" value="" id="cost_center_code" placeholder="Enter Cost Center Code" autocomplete="off" readonly="">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                  ...
                  <tr class="useful">
                    ...
                    <td class="tdthtablebordr" style="width: 25px;">
                      <div class="input-group">
                        <input list="ItemList1" class="inputboxclr SetInCenter" style="margin-top: 5px;" id='ItemCodeId1' name="item_code[]"  onchange="requisition.ItemCodeGet(1,itemcodeurl,quaitemurl);"  oninput="this.value = this.value.toUpperCase()" readonly />
                       ...
                       <button type="button" class="btn btn-primary btn-xs showdetail viewbtnitem" id="viewItemDetail1" data-toggle="modal" data-target="#view_detail1" onclick="requisition.showItemDetail(1,itemcodeurl)"><i class="fa fa-info" aria-hidden="true" style="font-size: 13px;"></i> </button>
                    ...
                    <td class="tdthtablebordr tooltips">
                      ...
                      <input type="text" class="inputboxclr getAccNAme" style="width: 100%;margin-bottom: 5px;" id='Item_Name_id1' name="item_name[]" readonly />

                      <small class="tooltiptextitem tooltiphide" id="itemNameTooltip1"></small><br>

                      <textarea id="remark_data1" rows="1" style="width: 100%;margin-bottom: 2%;" class="" name="remark[]" placeholder="Enter Description" readonly></textarea>
  ...
  font-size: 16px;
    ...
    color: #5d9abd;
      ...
      <br>
        ...
        <button type="button" class='btn btn-danger delete' id="deletehidn" style="line-height: 1;padding: 2px 4px;" disabled><i class="fa fa-minus" aria-hidden="true" style="font-size: 9px;"></i>&nbsp; Delete</button>
        ...
        <p class="text-center">
          ...
          <button class="btn btn-success" type="button" id="submitdata" style="line-height: 1;padding: 2px 4px;" onclick="requisition.submitdata(submitdataurl)" disabled><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;&nbsp; Save</button>

          <button class="btn btn-warning" type="button" id="CancleBtn" onclick="location.reload();" style="line-height: 1;padding: 2px 4px;"><i class="fa fa-refresh" aria-hidden="true"></i>&nbsp;&nbsp; Cancel</button>
            ...
            <div class="modal-content" style="border-radius: 5px;">
              ...
              <div class="modal-body table-responsive">
                <div class="boxer" id="">
                  ...
                  <div class="box-row">
                    <div class="box10 texIndbox1" style="width: 20%;">Item Name/Item Code</div>
                    <div class="box10 rateIndbox" style="width: 10%;">HSN Code</div>
                    <div class="box10 rateIndbox" style="width: 10%;">Tax Code</div>
                    <div class="box10 rateBox" style="width: 10%;">Item Detail</div>
                    <div class="box10 amountBox" style="width: 10%;">Item Type</div>
                    <div class="box10 amountBox" style="width: 10%;">Item Group</div>
                    <div class="box10 amountBox" style="width: 10%;">Item Class</div>
                    <div class="box10 amountBox" style="width: 15%;">Item Category</div>
                  </div>
