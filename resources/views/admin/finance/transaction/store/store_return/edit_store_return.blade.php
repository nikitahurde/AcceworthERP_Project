          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <div class="box-tools pull-right">
                ...
                <a href="{{ url('/finance/transaction/store/view-store-return') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Store Return</a>
                        ...
                        <div class="form-group">
                          ...
                          <label>Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control transdatepicker" name="vr" id="vr_date" value="{{ $getStoreReturn[0]->vr_date}}" placeholder="Select Date" autocomplete="off" onchange="storereturn.vrDate()">
                        ...
                        <div class="form-group">
                          ...
                          <label> T Code : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="tran" value="{{ $getStoreReturn[0]->tran_code}}" id="transcode" placeholder="Enter Transaction Head" readonly autocomplete="off">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input list="seriesList1"  id="series_code" name="series" class="form-control  pull-left" value="{{ $getStoreReturn[0]->series_code}}" placeholder="Select Series" oninput="this.value = this.value.toUpperCase()" autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label> Series Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="tran" value="{{ $getStoreReturn[0]->series_name}}" id="seriesName" placeholder="Enter Series Name" value="" readonly autocomplete="off">
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="vro" value="{{ $getStoreReturn[0]->vr_no}}" placeholder="Enter Vr No" id="vrseqnum" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Plant Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="PlantcodeList" class="form-control" id="Plant_code" name="plantcode" placeholder="Select Plant" maxlength="11" value="{{ $getStoreReturn[0]->plant_code}}" readonly autocomplete="off" onchange="storereturn.PlantCode(Plantcodeurl)">
                        ...
                        <div class="form-group">
                          ...
                          <label> Plant Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="plantname" value="{{ $getStoreReturn[0]->plant_name}}" id="plantname" placeholder="Enter Profit Plant Name" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Profit Center Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="profitList"  id="profitctrId" name="pfct" class="form-control  pull-left" value="{{ $getStoreReturn[0]->pfct_code}}" placeholder="Select Profit Center Code" oninput="this.value = this.value.toUpperCase()" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label> Profit Center Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="pfctname" value="{{ $getStoreReturn[0]->pfct_name}}" id="pfctName" placeholder="Enter Profit Center Name" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Department Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="AccountList"  id="account_code" name="AccCode" class="form-control  pull-left" value="{{ $getStoreReturn[0]->dept_code}}" placeholder="Select Department" oninput="this.value = this.value.toUpperCase()"  autocomplete="off" 
                              onchange="storereturn.GetAccCode(accCodeurl)" readonly > 
                        ...
                        <div class="form-group">
                          ...
                          <label> Department Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="acctname" value="{{ $getStoreReturn[0]->dept_name}}" id="accountName" placeholder="Enter Department Name" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label> Employee Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="emplList" class="form-control" name="emp_code" value="{{ $getStoreReturn[0]->emp_code}}" id="emp_code" placeholder="Enter Employee Code" autocomplete="off" onchange="storereturn.EmpCode()" readonly="">
            ...
            <form id="salesordertrans">
              ...
              <div class="table-responsive">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                  ...
                  <?php $sr=1;$rwCount=count($getStoreReturn);$qtyTot=0; foreach ($getStoreReturn as $rows) { 
                      $qtyTot += $rows->issue_qty_recvd;
                    ?>

                    <?php if($sr ==1){ ?>
                        <input type="hidden" id="rowTot" value="{{$rwCount}}">
                    <?php } ?>
                    ...
                    <tr class="useful">
                      ...
                      <td class="tdthtablebordr">
                        ...
                        <div class="input-group">
                          ...
                          <input list="ItemList<?php echo $sr; ?>" class="inputboxclr SetInCenter" style="width: 90px;margin-bottom: 5px;" id='ItemCodeId<?php echo $sr; ?>' name="item_code[]" value="{{$rows->item_code}}"  onchange="storereturn.ItemCodeGet(<?php echo $sr; ?>,itemcodeurl,quaitemurl)" oninput="this.value = this.value.toUpperCase()" readonly />
                        ...
                        <button type="button" class="btn btn-primary btn-xs showdetail viewbtnitem" id="viewItemDetail1" data-toggle="modal" data-target="#view_detail<?php echo $sr; ?>" onclick="storereturn.showItemDetail(<?php echo $sr; ?>,itemcodeurl)"><i class="fa fa-info" aria-hidden="true" style="font-size: 13px;"></i> </button>
                      ...
                      <td class="tdthtablebordr">
                        ...
                        <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter moneyformate"  id='req_qty<?php echo $sr; ?>' value="{{$rows->issue_qty_recvd}}" name="req_qty[]" style="width: 80px" readonly />
                      ...
                      <td class="tdthtablebordr">
                        ...
                        <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter"  id='req_A_qty<?php echo $sr; ?>' name="req_Aqty[]" value="{{$rows->issue_aq_recvd}}" style="width: 80px" readonly />
                      ...
                      <td class="tdthtablebordr">
                        ...
                        <div style="display: inline-flex;border: none;margin-top: -3%;">
                          ...
                          <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter getqtytotal quantityC moneyformate"  id='qty<?php echo $sr; ?>' name="qty[]" value="{{$rows->return_qty}}" oninput='Getqunatity(<?php echo $sr; ?>)'style="width: 80px"/>

                          <input type="hidden" id="qtyget<?php echo $sr; ?>" class="totlqty">
                          <input type="text" name="unit_M[]" id="UnitM<?php echo $sr; ?>" value="{{$rows->return_qty_um}}" class="inputboxclr SetInCenter AddM" readonly>
                      ...
                      <td class="tdthtablebordr">
                        ...
                        <div style="display: inline-flex;border: none;margin-top: -3%;">
                          ...
                          <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter"  id='A_qty<?php echo $sr; ?>' value="{{$rows->return_aqty}}" name="Aqty[]"  style="width: 80px" />

                          <input type="text" name="add_unit_M[]" id="AddUnitM<?php echo $sr; ?>" value="{{$rows->return_qty_aum}}"  class="inputboxclr SetInCenter AddM" readonly>
    ...
    color: #5d9abd;
      ...
      <br>
        ...
        <p class="text-center">
          ...
          <button class="btn btn-success" type="button" id="submitdata" onclick="storereturn.submitdata(submitdataurl)" ><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;&nbsp; Save</button>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $(window).on('load',function(){
        var totRow = $('#rowTot').val();

        for(var e=0;e<totRow;e++){
            var id= e+1;
