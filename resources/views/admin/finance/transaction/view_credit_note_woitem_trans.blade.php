...
.datebill{
  ...
  <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <a href="{{ url('/finance/transaction/credit-note-woitem-transaction') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Credit Note Trans</a>
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/finance/transaction/view-credit-note-woitem-transaction') }}"
