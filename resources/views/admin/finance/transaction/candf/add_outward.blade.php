...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="{{ url('/form-mast-fleet') }}">Create Dispatch Outward</a></li>
      ...
      <div class="col-sm-12">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">Create Dispatch Outward</h2>

              <div class="box-tools pull-right showinmobile">
                <a href="{{ url('/transaction/CandF/view-outward-trans') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Create Dispatch Outward</a>
              </div>

              <div class="box-tools pull-right">
                <a href="{{ url('/transaction/CandF/view-outward-trans') }}" class="btn btn-primary btn-sm" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Create Dispatch Outward</a>
              </div>
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input list="vehicleList" id="vehicle_no" name="vehicle_no" class="form-control  pull-left" value="{{ old('vehicle_no')}}" placeholder="Enter Vehicle No" onchange="getTripDeatils();" autocomplete="off">

                    <datalist id="vehicleList">
                              
                      <?php foreach ($vehicleNo_list as $key) { ?>
                        
                      <option value="<?= $key->VEHICLE_NO ?>~<?= $key->TRIP_NO ?>~<?= $key->CFOUTWARDID ?>" data-xyz="<?= $key->VEHICLE_NO ?>"><?= $key->VEHICLE_NO ?> ~ <?= $key->TRIP_NO ?></option>
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="series_code" name="series_code" class="form-control  pull-left" value="{{ old('series_code')}}" readonly placeholder="Enter Series Code">
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="series_name" name="series_name" class="form-control  pull-left" value="{{ old('series_name')}}" readonly placeholder="Enter Series Name">
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="plant_code" name="plant_code" class="form-control pull-left" value="{{ old('plant_code')}}" readonly placeholder="Enter Plant Code">
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input tye="text" id="plant_name" name="plant_name" class="form-control  pull-left" value="{{ old('plant_name')}}" readonly placeholder="Enter Plant Name">
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input tye="text" id="pfct_code" name="pfct_code" class="form-control  pull-left" value="{{ old('pfct_code')}}" readonly placeholder="Enter Pfct Code">
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="pfct_name" name="pfct_name" class="form-control  pull-left" value="{{ old('pfct_name')}}" readonly placeholder="Enter Pfct Name">
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="customer_code" name="customer_code" class="form-control  pull-left" value="{{ old('customer_code')}}" readonly placeholder="Enter Customer Code">
                     <input type="hidden" id="tran_code" name="tran_code" class="form-control  pull-left" value="" >
                     <input type="hidden" id="rake_no" name="rake_no" class="form-control  pull-left" value="" >
                     <input type="hidden" id="rake_date" name="rake_date" class="form-control  pull-left" value="" >
                     <input type="hidden" id="place_date" name="place_date" class="form-control  pull-left" value="" >
                     <input type="hidden" id="vr_date" name="vr_date" class="form-control  pull-left" value="" >
                     <input type='hidden' class='inputboxclr'  name='trip_type' id='trip_type' value='' autocomplete='off' readonly />
                    <!--  <input type='hidden' class='inputboxclr'  name='inwardId' id='inwardId' value='' autocomplete='off' readonly /> -->
                     ...
                     <input type='hidden' class='inputboxclr'  name='trip_headid' id='trip_headid' value='' autocomplete='off' readonly />
                    ...
                    <input type='hidden' class='inputboxclr'  name='trip_vehicleModel' id='trip_vehicleModel' value='' autocomplete='off' readonly />
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="custmoer_name" name="custmoer_name" class="form-control  pull-left" value="{{ old('custmoer_name')}}" readonly placeholder="Enter Customer Name">
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input list="addList" id="custmoer_add" name="custmoer_add" class="form-control  pull-left" value="{{ old('custmoer_add')}}" placeholder="Enter Customer Add" autocomplete="off">
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <label for="exampleInputEmail1">Wayment Weight : <span class="required-field"></span></label>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="wayment_weight" name="wayment_weight" class="form-control  pull-left" value="" placeholder="Enter wayment_weight" oninput="getweymentWeight(this.value)" autocomplete="off">
               ...
               <input type="hidden" id="vrnols" name='VrNo' value="">
               <input type="hidden" id="fy_code" name='fyCode' value="">
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                      ...
                      <input type="hidden" name="tri_days" id="tri_days" value="">
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                      ...
                      <input type="text"  id="to_place" name="to_place" class="form-control pull-left" value="" placeholder="Enter To Place" autocomplete="off">
                      ...
                      <input type="hidden"  id="sr_flag" name="sr_flag" class="form-control pull-left" value="" placeholder="Enter To Place" autocomplete="off">
              ...
              <div class="col-md-3">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                      ...
                      <textarea type="text" id="lr_remark" name="lr_remark" class="form-control pull-left" value="" placeholder="Enter LR Remark" autocomplete="off" cols="25" rows="1"></textarea>
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="mobile_no" id="mobile_no"  placeholder="Enter Mobile No"  autocomplete="off" />
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="vehicle_type" id="vehicle_type"  placeholder="Enter Vehicle Type"  autocomplete="off" />

                    <input type="hidden" name="getEntryVrNo" id="getEntryVrNo" value="">
                    <input type="hidden" name="vehicle_type_name" id="vehicle_type_name" value="">
...
function getweymentWeight(value){


    var lsqtytotal = $("#basicTotal").val();
    var dataCount  = $("#data_count").val();
    ...
    //console.log('count',dataCount);
      ...
      for(var i = 1; i <= dataCount; i++) {
          ...
          var Weight_qty =  parseFloat(lsqty) * 100 / parseFloat(lsqtytotal);


          var lsqty_total =  Math.round((parseFloat(value) * parseFloat(Weight_qty) / 100)*100000)/100000;
          //var lsqty_total =  parseFloat(value) * parseFloat(Weight_qty) / 100;

           // lsqty_total = lsqty_total.toFixed(3);

            total_weight += lsqty_total;

            
        //var lsqtyTotal =  Math.round(lsqty_total * 1000) / 1000;

          
            //console.log('lsqty_total',lsqtyTotal);
           
         $("#net_qty"+i).val(lsqty_total.toFixed(3));

          
           
      }

      var totalnetWeight = total_weight;

        $("#total_net").val(totalnetWeight.toFixed(3));

     //console.log('weyment_value',weyment_value.toFixed(3));
  ...
  function getTripDeatils(){
    ...
    var cfTblId = splitData[2];

    console.log('trip_no',tripno);
    ...
    $.ajax({
       ...
       // url:"{{ url('get-outward-dispatch-against-vehicle') }}",
        ...
        method : "POST",
        type: "JSON",
        data: {vehicleNo: vehicleNo,tripno:tripno,cfTblId:cfTblId},
        ...
        success:function(data){
            ...
            if (data1.response == 'error') {
              ...
              if(data1.data_vehicle_type == '' || data1.data_vehicle_type ==null){
                  ...
                  $('#vehicle_type_name').val(data1.data_vehicle_type.WHEEL_TYPE_NAME);
            ...
            console.log('accADDRESS',data1.data_accAddress);
              ...
              if(data1.data_outward == ''){
                ...
                $("#trip_vehicleModel").val(data1.data_outward[0].MODEL);
                $("#tripNo").val(data1.data_outward[0].TRIP_NO);
                $("#tri_days").val(data1.data_outward[0].TRIPDAY);
                ...
                $('#tbledata').empty();
				        ...
				        var headtbl = "<tr><th style='width: 10px;'> Sr.No.</th><th>CP CODE</th><th>CP NAME</th><th>INVOICE NO</th><th>INVOICE DATE</th><th>DO NO</th><th>DO DATE</th><th>BATCH NO</th><th>ITEM CODE</th><th>ITEM NAME</th><th>REMARK</th><th>LR NO</th><th>LR DATE</th><th>WAGON NO</th><th>WAGON DATE</th><th>RAKE NO</th><th>LOADING SLIP QTY</th><th>ISSUED QTY</th><th>AQTY</th><th>TARE WEIGHT</th><th>GROSS WEIGHT</th><th>NET WEIGHT</th><th>DELIVERY NO</th><th>E-WAY BILL NO</th><th>E-WAY BILL DATE</th><th>MATERIAL VALUE</th></tr>";
                ...
                $.each(data1.data_outward, function(k, getData) {
                  ...
                  var dateform = new Date(formDate);
                  var mo = new Intl.DateTimeFormat('en', { month: 'numeric', month: '2-digit' }).format(dateform);
                  var da = new Intl.DateTimeFormat('en', { day: '2-digit' }).format(dateform);

                  var currentDate =da+'-'+mo+'-'+year;
                  console.log('currentDate',currentDate);


                  var stdRate =  getData.STDRATE;
                  var qty     =  getData.QTY;
                  totalsqty  +=  parseFloat(getData.QTY);
                  totanetqty  +=  parseFloat(getData.NET_WEIGHT);
                  totalsAqty  +=  parseFloat(getData.AQTY);

                  var mate_value =  parseFloat(stdRate) * parseFloat(qty);

                   var invDt = getData.INVOICE_DATE;
                  if(invDt=='0000-00-00'){
                    var invoiceDate = currentDate;
                  }else{
                    var splitDt = invDt.split('-');
                    var invoiceDate = splitDt[2]+'-'+splitDt[1]+'-'+splitDt[0];
                  }

                  var do_DATE = getData.ORDER_DATE;
                  if(do_DATE=='0000-00-00' || do_DATE=='' || do_DATE==null){
                    var doDate = currentDate;
                  }else{
                    var splitdo = do_DATE.split('-');
                  ...
                  "<td><input type='text' style='padding: 0px;width: 90px;' class='inputboxclr'  name='cp_name[]' id='cp_name"+srno+"' value='"+getData.CP_NAME+"' autocomplete='off' readonly /><input type='text' style='padding: 0px;width: 90px;' class='inputboxclr'  name='cp_add[]' id='cp_add"+srno+"' value='"+getData.CP_ADD+"' autocomplete='off' readonly /></td>"+
                  ...
                  "<td><input style='padding: 0px;' class='inputboxclr' type='text' value='"+getData.REMARK+"' name='item_remark[]'  id='item_remark"+srno+"' /></td>"+
                   "<td><input style='padding: 0px;width: 85px;text-align: right;' type='text' class='inputboxclr' name='lr_no[]'  id='lr_no"+srno+"' value='"+lr_no+"' autocomplete='off' /><input style='padding: 0px;width: 85px;text-align: right;' type='hidden' class='inputboxclr' name='uniqLrNo[]'  id='uniqLrNo"+srno+"' value='"+lr_slno+"' autocomplete='off'/></td>"+
                  ...
                  "<td><input style='padding: 0px;width: 70px;text-align: right;text-align: right;' type='text' class='inputboxclr' readonly id='qty"+srno+"' value='"+getData.QTY+"' name='qty[]' style='width: 80px;' /><input style='padding: 0px;width: 70px;text-align: right;text-align: right;' type='hidden' class='inputboxclr' id='lspercent"+srno+"' value='' name='lspercent[]' style='width: 80px;' /><input style='padding: 0px;width: 70px;text-align: right;text-align: right;' type='hidden' class='inputboxclr' id='unit_M"+srno+"' value='"+getData.UM+"' name='unit_M[]' style='width: 80px;' /><input style='padding: 0px;width: 70px;text-align: right;text-align: right;' type='hidden' class='inputboxclr' id='qty_Arecd"+srno+"' value='' name='qty_Arecd[]' style='width: 80px;' /></td>"+
                  "<td><input style='padding: 0px;width: 70px;text-align: right;' type='text' class='inputboxclr' id='issue_qty"+srno+"' value='"+getData.QTY+"' name='issue_qty[]' style='width: 80px;' oninput='getShortagQty("+srno+")' readonly/></td>"+
                  ...
                  "<td><input style='padding: 0px;width: 70px;text-align: right;' type='text' class='inputboxclr' id='tare_qty"+srno+"' value='' name='tare_qty[]' style='width: 80px;'/></td>"+
                  "<td><input style='padding: 0px;width: 70px;text-align: right;' type='text' class='inputboxclr' id='gross_qty"+srno+"' value='' name='gross_qty[]' style='width: 80px;'/></td>"+
                  "<td><input style='padding: 0px;width: 70px;text-align: right;' type='text' class='inputboxclr' id='net_qty"+srno+"' value='"+getData.QTY+"' name='net_qty[]' style='width: 80px;' readonly/></td>"+
                ...
                srno++;});/* /. each loop */
                   ...
                   var tabletd = "<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><input class='inputboxclr' type='text' value='"+totalsqty.toFixed(3)+"' style='padding: 0px;width: 70px;text-align: right;' readonly id='lsqtyTotal'/></td><td><input class='inputboxclr' type='text' value='"+totalsqty.toFixed(3)+"' style='padding: 0px;width: 70px;text-align: right;' readonly id='issuedTotal'/></td><td><input class='inputboxclr' type='text' value='"+totalsAqty.toFixed(3)+"' style='padding: 0px;width: 70px;text-align: right;' readonly id='issuedTotal'/></td><td></td><td></td><td><input class='inputboxclr' type='text' value='"+totanetqty.toFixed(3)+"' style='padding: 0px;width: 70px;text-align: right;' readonly id='total_net'/></td><td></td><td></td><td></td><td></td></tr>";
                   $('#tbledata').append(tabletd);


                   var  sf = "<div class='totlsetinres'><input type='hidden' value='"+totalsqty.toFixed(3)+"' style='padding: 0px;width: 70px;text-align: right;' readonly id='basicTotal'/></div>";
...
/* --------------- START : SUBMIT DATA ------------ */
  ...
  function submitLoadingSlipTrans(pdfFlag){
    ...
    $.ajax({
        ...
        url: "{{ url('/transaction/CandF/outward-dispatch-submit') }}",
  ...
  $(".addmore").on('click',function(){
	...
	var srno = $('table tr').length;
	 ...
	 var data ="<tr><td><input type='checkbox' class='case' id='firstrow"+srno+"' onclick='checkcheckbox("+srno+");'/>"+srno+"</td>"+
        ...
        "<td><input style='padding: 0px;width: 90px;border:none' type='hidden' name='body_id[]' id='body_id"+srno+"' class='inputboxclr'  value='' /><input style='padding: 0px;width: 90px;border:none' type='hidden' name='vrno[]' id='vrno"+srno+"' class='inputboxclr'  value='' /><input style='padding: 0px;width: 90px;border:none' type='hidden' name='slno[]' id='slno"+srno+"' class='inputboxclr'  value='' /><input type='text' style='padding: 0px;width: 90px;' class='inputboxclr'  name='invoice_no[]' id='invoice_no"+srno+"' value='' autocomplete='off'  /></td>"+
