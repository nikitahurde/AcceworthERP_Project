                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <?php 
                        ...
                        $VR_DATE      = date("d-m-Y", strtotime($outward_data[0]->VRDATE));  
                    ...
                    <input type="text" name="transaction_date" id="transaction_date" class="form-control datepicker" placeholder="Enter Date" value="<?= $VR_DATE ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="customer_code" name="customer_code" class="form-control  pull-left" value="<?= $outward_data[0]->ACC_CODE ?>" readonly placeholder="Enter Customer Code">
                     ...
                     <input type="hidden" id="cf_gateid" name='cf_gateid' value="<?= $outward_data[0]->CFGATEID ?>">
                     ...
                     <input type='hidden' class='inputboxclr'  name='trip_comp' id='trip_comp' value='<?= $outward_data[0]->REFTRIP_COMPCODE ?>' autocomplete='off' readonly />
                     <input type='hidden' class='inputboxclr'  name='trip_fycode' id='trip_fycode' value='<?= $outward_data[0]->REFTRIP_FYCODE ?>' autocomplete='off' readonly />
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="wayment_weight" name="wayment_weight" class="form-control  pull-left" value="<?= $outward_data[0]->WEYMENT_WEIGHT ?>" placeholder="Enter wayment_weight" oninput="getweymentWeight(this.value)" autocomplete="off">
        ...
        <div class="box box-warning Custom-Box">
          ...
          <div class="box-body table-responsive">
            ...
            <div class="">
              ...
              <?php $srno=1; $totalsqty=0;$totalsAqty=0;$totanetqty=0; foreach($outward_data as $key) { 


                      $totalsqty  = floatval($totalsqty) + floatval($key->QTY);
                      $totalsAqty  = floatval($totalsAqty) + floatval($key->AQTY);
                      $totanetqty  = floatval($totanetqty) + floatval($key->NET_WEIGHT);

                      $data_count = count($outward_data);
                  ...
                  <td><input style='padding: 0px;width: 70px;text-align: right;text-align: right;' type='text' class='inputboxclr' readonly id='qty<?= $srno; ?>' value='<?= $key->QTY ?>' readonly name='qty[]' style='width: 80px;' /><input style='padding: 0px;width: 70px;text-align: right;text-align: right;' type='hidden' class='inputboxclr' id='unit_M<?= $srno; ?>' value='<?= $key->UM ?>' name='unit_M[]' style='width: 80px;' /><input style='padding: 0px;width: 70px;text-align: right;text-align: right;' type='hidden' class='inputboxclr' id='qty_Arecd<?= $srno; ?>' value='<?= $key->AQTY ?>' name='qty_Arecd[]' style='width: 80px;' />
                  </td>
                  <td><input style='padding: 0px;width: 70px;text-align: right;' type='text' class='inputboxclr' id='issue_qty<?= $srno; ?>' value='<?= $key->QTYISSUED ?>' name='issue_qty[]' style='width: 80px;' oninput="totalvalCalculation(<?= $srno; ?>,'Q')" readonly/>
                  ...
                  <td><input style='padding: 0px;width: 70px;text-align: right;' type='text' class='inputboxclr' id='tare_qty<?= $srno; ?>' value='<?= $key->TARE_WEIGHT ?>' name='tare_qty[]' style='width: 80px;'/>
                  </td>
                  <td><input style='padding: 0px;width: 70px;text-align: right;' type='text' class='inputboxclr' id='gross_qty<?= $srno; ?>' value='<?= $key->GROSS_WEIGHT ?>' name='gross_qty[]' style='width: 80px;'/>
                  </td>
                  <td><input style='padding: 0px;width: 70px;text-align: right;' type='text' class='inputboxclr' id='net_qty<?= $srno; ?>' value='<?= $key->NET_WEIGHT ?>' name='net_qty[]' style='width: 80px;' readonly/>
                  </td>
              ...
              <tr><input type="hidden" name="data_count" id="data_count" value="<?= $data_count ?>"><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><input type="text" name="lsqtyTotal" id="lsqtyTotal" value="<?= $totalsqty ?>" style='padding: 0px;width: 85px;text-align: right;'></td><td><input type="text" name="issuedTotal" id="issuedTotal" value="<?= $totalsqty ?>" style='padding: 0px;width: 85px;text-align: right;'></td><td><input type="text" name="lsAqtyTotal" id="lsAqtyTotal" value="<?= $totalsAqty ?>" style='padding: 0px;width: 85px;text-align: right;'></td><td></td><td></td><td><input class='inputboxclr'  type='text' value='<?= $totanetqty ?>' style='padding: 0px;width: 85px;text-align: right;' readonly id='total_net'/></td><td></td><td></td><td></td><td></td></tr>

              

              </table>
              <input type="hidden" name="basicTotal" id="basicTotal" value="<?= $totalsqty ?>">
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="hidden" name="trip_vehicleModel" id="trip_vehicleModel" value="<?= $outward_data[0]->VEHICLE_MODEL ?>">
...
function getweymentWeight(value){
    ...
    //console.log('count',dataCount);
      ...
      for(var i = 1; i <= dataCount; i++) {
          ...
          var lsqty_total =  Math.round((parseFloat(value) * parseFloat(Weight_qty) / 100)*100)/100;
