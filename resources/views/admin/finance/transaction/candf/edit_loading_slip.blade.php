              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input list="vehicleList" id="vehicle_no" name="vehicle_no" class="form-control  pull-left" value="{{$classData[0]->VEHICLE_NO}}" placeholder="Enter Vehicle No" onchange="getDeatilOfLoadingPlan();" readonly autocomplete="off">
        ...
        <div class="box box-warning Custom-Box">
          ...
          <div class="box-body">
            ...
            <div class="table-responsive">
              <?php $roWCount = count($classData);?>
              <input type="hidden" id="totalExistRow" value="{{$roWCount}}">
              ...
              <?php $slno=1; foreach($classData as $row){ ?>

                <tr>
                  <td class="tdthtablebordr">
                    <input type="checkbox" class="case" id="firstrow{{$slno}}" onclick="checkcheckbox({{$slno}});"/>
                    <input type="hidden" id="tempItemSave{{$slno}}" value=""></td>

                  <td>{{$slno}}<input type="hidden" class="rowCountCls" name="rowCount[]" id="rowCount{{$slno}}" value="{{$slno}}"></td>

                  <td class="tdthtablebordr">
                    <input type="text" value="{{$row->CP_CODE}}" name="cp_code[]" readonly class="inputboxclr readonlyField" id="cp_code{{$slno}}" autocomplete="off"/>
                    <input type="hidden" class="cpCddata" value="" id="lrGenInfo{{$slno}}">
                    <input type="hidden" value="1" name="uniqLrNo[]" id="uniqLrNo{{$slno}}">
                  </td>

                  <td class='tdthtablebordr'>
                    <input type="text" value="{{$row->CP_NAME}}" name="cp_name[]" readonly class="inputboxclr readonlyField" id="cp_name{{$slno}}" autocomplete="off"/>
                  </td>

                  <td class='tdthtablebordr'>
                    <input type="text" value="{{$row->ITEM_CODE}}" name="item_code[]" readonly class="inputboxclr readonlyField" id="item_code{{$slno}}" autocomplete="off"/>
                  </td>

                  <td class='tdthtablebordr'>
                    <input type="text" value="{{$row->ITEM_NAME}}" name="item_name[]" readonly class="inputboxclr readonlyField" id="item_name{{$slno}}" autocomplete="off"/>
                  </td>

                  <td class="tdthtablebordr">
                    <input list="batchList{{$slno}}" value="{{$row->BATCH_NO}}" name="batch_no[]" onchange="getInwardDetails({{$slno}},'BATCH')" class="inputboxclr" id="batch_no{{$slno}}" autocomplete="off"/>
                    <datalist id="batchList{{$slno}}"></datalist>
                    <input type="hidden" id="batchSlno{{$slno}}" name="batchSlno[]">
                    <input type="hidden" id="tblHeadId{{$slno}}" name="tblHeadId[]">
                  </td>

                  <td class="tdthtablebordr">
                    <input list="orderNoList{{$slno}}" value="{{$row->ORDER_NO}}" name="sale_order_no[]" onchange="getInwardDetails({{$slno}},'ORDERNO')" class="inputboxclr" id="sale_order_no{{$slno}}" autocomplete="off"/>
                    <datalist id="orderNoList{{$slno}}">
                      
                    </datalist>
                  </td>

                  <td class="tdthtablebordr">
                    <input type="text" value="{{$row->WAGON_NO}}" name="wagon_no[]"  class="inputboxclr readonlyField" readonly id="wagon_no{{$slno}}" autocomplete="off"/>
                  </td>

                  <td class="tdthtablebordr">
                    <input type="text" value="{{$row->LOCATION_CODE}}" name="locatn_code[]"  class="inputboxclr readonlyField" readonly id="locatn_code{{$slno}}" autocomplete="off"/>
                  </td>

                  <td class="tdthtablebordr">
                    <input type="text" value="{{$row->LOCATION_NAME}}" name="locatn_name[]"  class="inputboxclr readonlyField" readonly id="locatn_name{{$slno}}" autocomplete="off"/>
                  </td>

                  <td class="tdthtablebordr">
                    <input type="text" value="{{$row->AQTY}}" name="aquantity[]" oninput="totalvalCalculation({{$slno}},'A')"  class="inputboxclr numerRight aqtyval" id="aquantity{{$slno}}" autocomplete="off"/>
                  </td>

                  <td class="tdthtablebordr">
                    <input type="text" value="{{$row->AUM}}" name="aum[]"  class="inputboxclr readonlyField" readonly id="aum{{$slno}}" autocomplete="off"/>
                  </td>

                  <td class="tdthtablebordr">
                    <input type="text" value="{{$row->QTY}}" name="quantity[]" oninput="totalvalCalculation({{$slno}},'Q')" class="inputboxclr numerRight qtyVal" id="quantity{{$slno}}" autocomplete="off"/>
                    <input type="hidden" name="cFactor" value="{{$row->CFACTOR}}" id="cFactor{{$slno}}">
                  </td>

                  <td class="tdthtablebordr">
                    <input type="text" value="{{$row->UM}}" name="um[]"  class="inputboxclr readonlyField" readonly id="um{{$slno}}" autocomplete="off"/>
                    <input type="hidden" name="doTRPTCode[]" id="doTRPTCode{{$slno}}">
                    <input type="hidden" name="doTRPTName[]" id="doTRPTName{{$slno}}">
                  </td>
