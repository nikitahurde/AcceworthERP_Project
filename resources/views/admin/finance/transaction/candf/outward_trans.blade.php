  ...
  <section class="content">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="transaction_date" id="transaction_date" class="form-control datepicker" value="{{ old('transaction_date')}}" placeholder="Enter Transaction Date">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="depotList"  id="depot_code" name="depot_code" class="form-control  pull-left" value="{{ old('depot_code')}}" placeholder="Select Depot Code" oninput="this.value = this.value.toUpperCase()">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="accountList" id="account_code" name="account_code" class="form-control  pull-left" value="{{ old('account_code')}}" placeholder="Select Account Code" oninput="this.value = this.value.toUpperCase()">
                ...
                <div class="col-md-4">
                  ...
                  <label for="exampleInputEmail1">Area Code : <span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                          ...
                          <input list="areaList" id="area_code" name="area_code" class="form-control  pull-left" placeholder="Select Area Code" value="{{ old('area_code')}}" oninput="this.value = this.value.toUpperCase()">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="hidden" id="TrNoHide" value="">

                          <input type="hidden" name="checkTrNo" id="checkTrNo" value="">

                          <input type="text" class="form-control" id="transaction_no" name="transaction_no" placeholder="Enter Transaction No" value="" readonly="">

                      </div>

                       <small id="showError" style="color: red;"></small>
                       <small id="transerror" style="color: red;"></small>
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" id="invoice_no" name="invoice_no" placeholder="Enter Invoice No" value="{{ old('invoice_no')}}" oninput="this.value = this.value.toUpperCase()">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" id="item" name="item" placeholder="Enter Item " value="{{ old('item')}}" oninput="this.value = this.value.toUpperCase()">
    ...
    <!--  <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control vehiclenumup" name="vehicle_no" id="vehicle_no" placeholder="Enter Vehicle No" value="{{ old('vehicle_no')}}" oninput="this.value = this.value.toUpperCase()">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" id="transport_code" name="transport_code" placeholder="Enter Transport" value="{{ old('transport_code')}}" oninput="this.value = this.value.toUpperCase()">
              ...
              <div class="row">
               ...
               <div class="box-footer" id="trbtn" style="text-align: center;">

               <button type="submit" class="btn btn-primary disblebtn" id="SubmitBtn"><i class="fa fa-floppy-o" aria-hidden="true"></i> &nbsp;&nbsp;Save</button>
...
@include('admin.include.footer')
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      var trno = parseInt($("#checkTrNo").val());
      console.log(trno);
      if(trno==0){
            $("#transerror").html('Please Genrate Transaction Number');
           
            $("#SubmitBtn" ).addClass('trnoclass');
            $("#SubmitBtn" ).addClass('pointer-events-none');
        }else{

          $("#showError").html('');
            $("#SubmitBtn" ).removeClass('trnoclass');
      ...
      var getTrNo = parseInt($('#TrNoHide').val());

      if (getTrNo == 0) {

        $("#showError").html('Please Check Transaction No.');
