                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <select name="vehicle_type" id="vehicle_type" style="border-color: lightgray;width: 101%;" onchange="getVehicleList();" disabled>
                    ...
                    <label>
                     ...
                     Vehicle Number : 
                      ...
                      <div class="input-group">
                        ...
                        <input list="vehicleNoList" class="form-control" name="vehicle_number" value="{{ $classData->VEHICLE_NUMBER }}" placeholder="Enter Vehicle Number" maxlength="15" id="vehicle_number" autocomplete="off" oninput="getTripNoOrVehicle('VEHICLE')" readonly>
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input list="tripNoList" class="form-control" name="trip_no" value="{{ $classData->TRIP_NO }}" placeholder="Enter Trip No" maxlength="15" id="trip_no" onchange="getTripNoOrVehicle('TRIP')" readonly autocomplete="off">
