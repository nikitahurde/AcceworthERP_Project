...
<div class="content-wrapper">
 ...
 -->
              <!-- <div class="box-tools pull-right">
                ...
                <a href="{{ url('Transaction/Logistic/View-Rack-Trans') }}" class="btn btn-primary btn-sm" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Rack Trans.</a>
              ...
              <div class="row">
                ...
                <div class="col-md-4 box-tools text-right">
                   ...
                   <a href="{{ url('Transaction/Logistic/View-Rack-Trans') }}" class="btn btn-primary btn-sm" style=""><i class="fa fa-eye"></i>&nbsp;&nbsp;View Rake Trans.</a>
                </div>
              </div>
        ...
        <div class="panel with-nav-tabs panel-info">
         <!--  <div class="panel-heading">
                        ...
                        <div class="form-group">
                          ...
                          <label>Plant Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="PlantcodeList" class="form-control" id="Plant_code" name="plantcode" placeholder="Select Plant" maxlength="11" value="<?php if($plcount == 1){echo $plant_list[0]->PLANT_CODE;}?>"  autocomplete="off" onchange="PlantCode()">
                     ...
                     <form name="data-form" id="data-form" enctype="multipart/form-data">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="col-md-2" style="margin-top: 7px;">
                          <button type="submit" class="btn btn-primary btn-sm-class" id="importbtn" disabled="">&nbsp;&nbsp;<i class="fa fa-download" aria-hidden="true"></i>&nbsp;&nbsp;IMPORT RAKE&nbsp;&nbsp;</button>
                        </div>
          ...
          <div class="col-md-12">
              ...
              <center><spam id='cityMisMatch' style="color: red;"></spam></center>
            </div>
          <div class="row" id="indicate_msg" style="display:none;">
            ...
            <div class="col-md-12">
              ...
              <button class="btn btn-warning btn-sm" style="padding: 2px 6px !important;
                ...
                font-size: 9px !important;"><i class="fa fa-pencil" style="font-size: 13px;padding-top: 2px;" aria-hidden="true" title="ACC CODE"></i></button><span style="margin-left: 5px;margin-bottom: 2px;font-size: small;font-weight: bold;white-space: nowrap;color: #444;"> IF QTY UPDATE </span>
    ...
    <div class="box box-primary Custom-Box">
            ...
            <div class="box-body">
                ...
                <form id="bodyformId">
                  ...
                  <div id="dfg" class="table" style="padding-top: 5px;">
                    ...
                    <table id="example" class="table display nowrap table-bordered table-striped table-hover" style="overflow-x: scroll;">
                        ...
                        <div class="col-md-12">
                          <center> <span id='cp_count' style="background-color: #f39c12;font-weight: bold;padding: 2px 2px 2px 2px;"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id='sp_count'style="background-color: #f39c12;font-weight: bold;padding: 2px 2px 2px 2px;"></span></center>
                        </div>
                      ...
                      <thead>
                        ...
                        <tr>
                           ...
                           <th class="text-center">ITEM/CP NAME</th>
                           <th class="text-center">SP CODE</th>
...
<div class="modal fade" id="AccModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <!--  ADD NEW ITEM MODAL -->
  ...
  <section class="content" style="margin-top: -10%;display: none;" id="bodyId">
            ...
            <form id="salesordertrans">
              ...
              <div class="table-responsive">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                  ...
                  <input type ="hidden" name="excelCode" id="excelCode">
              ...
              <div class="modal-content" style="border-radius: 5px;">
                            ...
                            <div class="form-group">
                              ...
                              <label> Allocated Qty : </label>
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="hidden" class="form-control" name="orderbatch_No" value="" id="orderbatch_No" placeholder="Enter Allocated Qty" autocomplete="off">
                                  <input type="hidden" name="umfactor" value="" id="umfactor" autocomplete="off">
                  ...
                  <div class="modal-footer" style="text-align:center;">
                      ...
                      <button type="button" class="btn btn-primary btn-sm" onclick="GetAllctQTY()">Ok</button>
                       <button type="button" class="btn btn-info btn-sm" id="proceedbtn" onclick="updatedAllctQTY()" disabled>Proceed</button>
                  </div>
              </div>
          </div>
        </div>
      ...
      if(vrseqno == ''){
       ...
       var account_code =  $("#account_code").val();
        ...
        if(rake_no==''){
           ...
           $('#rake_no').css('border-color','#d2d6de');
      ...
      var placement_date = $("#placement_date").val();
       ...
       var xyz = $('#doExcelList option').filter(function() {
          ...
          if(msg =='No Match'){
            ...
            $('#excelCode').val(excel_code);
            $('#excelName').val(msg);
            $('#rakeNo').val(rake_no);
            $('#rakeDate').val(rake_date);
            $('#placeDate').val(placement_date);
 ...
 function submitData(){
    ...
    var data = $("#salesordertrans,#bodyformId").serialize();
          ...
          $.ajax({
              ...
              url: "<?php echo url('/finance/save-rack-trans'); ?>",
              ...
              if(data1.response=='error'){
                  var responseVar =false;
                    ...
                    var url = "{{ url('/Transaction/view-rack-trans-msg') }}"
           ...
           if(files.length > 0){
             ...
             fd.append('do_excel_code',do_excel_code);
               ...
               $.ajax({
                ...
                url: "<?php echo url('/finance/rack-do-import'); ?>",
                type : "POST",
                data : fd,
                contentType: false,
                processData: false,
                ...
                success:function (data) {
                 ...
                 if(itemacc_count > 0 || allocqty_count > 0){
                  ...
                  var cpdocount = data.cp_do_count;

                  var spdocount = data.sp_do_count;
                  ...
                  $("#cp_count").html('CP COUNT'+' - '+cpdocount);
                  $("#sp_count").html('SP COUNT'+' - '+spdocount);
                    ...
                    var t = $("#example").DataTable({
                         ...
                         columnDefs: [
                          ...
                          ajax:{
                            ...
                            url : "{{ url('/Transaction/Logistic/View-Rack-Order-Details') }}",
                     ...
                     columns: [
                        ...
                        { 
                          render: function (data, type, full, meta){
                                  ...
                                  if(full['ACC_STATUS']=='YES' && full['ITEM_STATUS']=='YES' && full['DO_EXIST_STATUS']=='NO'){
                                      ...
                                      var accDbtn ='<button type="button" class="btn btn-warning btn-sm" style="font-size: 10px; padding: 2px 2px;" data-toggle="modal" onclick="return showAcc('+full['ID']+',\''+full['COL1']+'\');" data-tip="ACC CODE"><i class="fa fa-user-circle" aria-hidden="true" title="ACC CODE"></i></button>';
                                      ...
                                      var accDbtn ='<button type="button" class="btn btn-primary btn-sm" title="edit" style="font-size: 10px; padding: 2px 2px;" onclick="return showItem('+full['ID']+',\''+full['COL16']+'\');" data-tip="ITEM CODE"><i class="fa fa-list-alt" aria-hidden="true" title="ITEM CODE"></i></button>';
                         ...
                         {  
                          render: function (data, type, full, meta){
                                    ...
                                    if(full['SP_STATUS']=='YES'){

                                       var spDbtn ='<button type="button" class="btn btn-warning btn-sm" style="font-size: 10px; padding: 2px 2px;" data-toggle="modal" onclick="return showCpCode('+full['ID']+',\''+full['COL3']+'\');" data-tip="SP CODE"><i class="fa fa-user-circle" aria-hidden="true" ></i></button></button>';
                          ...
                          render: function (data, type, full, meta){
                                  ...
                                  if(full['DO_EXIST_STATUS']=='NO' && full['DO_UPDATE_STATUS']=='0'){
                                     ...
                                     var accDbtn ='<button type="button" class="btn btn-primary btn-sm" style="font-size: 10px; padding: 2px 2px;" data-toggle="modal" onclick="return showAllcQty('+full['ID']+','+full['COL22']+','+full['COL9']+',\''+full['COL12']+'\');">&nbsp;&nbsp;<i class="fa fa-pencil" aria-hidden="true"></i></button>';
                        ...
                        { 
                          data:"COL1",className:"text-center",
                           render: function (data, type, full, meta){
                                  ...
                                  var col1 = full['COL1']+'<span id="soldParty'+full['DT_RowIndex']+'" style="display:none;">'+full['COL1']+'</span><input type="hidden"  value="'+full['COL1']+'" name="column1[]"/></br><button type="button" onclick="copySoldParty('+full['DT_RowIndex']+')" class="btn btn-primary btn-xs" style="line-height: 0.5;font-size: 10px;" title="COPY SOLD TO PARTY NAME">Copy</button>';
                        ...
                        { data:"COL3",className:"text-center",
                          ...
                          render: function (data, type, full, meta){
                                  ...
                                  var col3 = full['COL3']+'<span id="shipParty'+full['DT_RowIndex']+'" style="display:none;">'+full['COL3']+'</span><input type="hidden" value="'+full['COL3']+'" name="column3[]"/></br><button type="button" onclick="copyshipParty('+full['DT_RowIndex']+')" title="COPY SHIP TO PARTY NAME" class="btn btn-primary btn-xs" style="line-height: 0.5;font-size: 10px;">Copy</button>';
                        ...
                        { data:"COL23",className:"text-center",
                          ...
                          render: function (data, type, full, meta){
                              ...
                              var cfactor = full['COL23'];

                              if(cfactor){

                                 var cf_value = parseFloat(cfactor).toFixed(2);
                              }else{
                                var cf_value = '0';
                              }
                                  ...
                                  var col22 = cf_value+'<input type="hidden" value="'+cf_value+'" name="column23[]"/>';
                   ...
                   "fnRowCallback": function(nRow, aData,data, type, full, meta) {
                        ...
                        if((aData['ITEM_STATUS']=='YES' && aData['DO_EXIST_STATUS']=='NO') || (aData['ACC_STATUS']=='YES' && aData['DO_EXIST_STATUS']=='NO') || (aData['SP_STATUS']=='YES' && aData['DO_EXIST_STATUS']=='NO') || (aData['CITY_STATUS']=='YES')) {
...
function copySoldParty(num) 
  {
    var element = $("#soldParty"+num).html();
    var $temp = $('<input>');
    $("body").append($temp);
    $temp.val($("#soldParty"+num).text()).select();
    document.execCommand("copy");
    $temp.remove();
  }

  function copyshipParty(num) 
  {
    var element = $("#shipParty"+num).html();
    var $temp = $('<input>');
    $("body").append($temp);
    $temp.val($("#shipParty"+num).text()).select();
    document.execCommand("copy");
    $temp.remove();
  }
</script>
...
<script type="text/javascript">
  ...
  function showCpCode(id,acc_Name){
  ...
  function showAcc(id,acc_Name){
   ...
   // console.log('acc_name',acc_Name);
    ...
    for(var i = 1; i <= excelcount; i++) {
      ...
      if(table_col == 'CP_NAME' || table_col == 'SP_NAME'){
...
<script type="text/javascript">
  ...
  function showAllcQty(id,qty,dono,batchNo){
    ...
    for(var i = 1; i <= excelcount; i++) {
     ...
     var order_no = dono;
     var batch_No = batchNo;


      $.ajax({

            url:"{{ url('get-old-qty-for-donumber-rake-qty-update') }}",

            method : "POST",

            type: "JSON",

            data: {order_no:order_no,batch_No:batch_No},
            ...
            success:function(data){
              ...
              var data1 = JSON.parse(data);
                ...
                if (data1.response == 'error') {
                 ...
                 // console.log(data1.data_do_qty);


                  $("#old_qty").val(data1.data_do_qty.QTY);
...
<script type="text/javascript">
  ...
  function showAllcQty1(id,qty,dono,batchNo){
...
<script type="text/javascript">
   ...
   function updatedAllctQTY(){

     var allc_qty      =   $("#allc_qty").val();
     var order_no         =   $("#donoqty").val();
     var tblcoldo      =   $("#tblcoldo").val();
     var batch_No      =   $("#orderbatch_No").val();
     var temptableidDo =   $("#temptableidDo").val();
     var umfactor =   $("#umfactor").val();;
     ...
     $.ajaxSetup({
      ...
      $.ajax({
            ...
            url:"{{ url('update-allctedqty-from-order-number') }}",

            method : "POST",

            type: "JSON",

            data: {order_no: order_no,allc_qty:allc_qty,tblcoldo:tblcoldo,temptableidDo:temptableidDo,batch_No:batch_No,umfactor:umfactor},
              ...
              var data1 = JSON.parse(data);
                ...
                if (data1.response == 'error') {
                 ...
                 $('#proceedbtn').prop('disabled', true);
                  ...
                  submitbtnEnable(new_data_count,itemacc_count,allocqty_count);
    ...
    var batch_No    =   $("#orderbatch_No").val();
     ...
     $.ajaxSetup({
      ...
      $.ajax({
            ...
            url:"{{ url('get-allctedqty-from-order-number') }}",
              ...
              var data1 = JSON.parse(data);
                ...
                if (data1.response == 'error') {
                  ...
                  $('#errorItem').html("<p style='color:red'>"+ data1.message +"</p>");
                    ...
                    var cfactor = data1.data_do_qty.CFACTOR;
                    ...
                    if(allc_qty >= old_do_qty){
                      ...
                      $("#umfactor").val(cfactor);
                      $("#allcqtyerr").html('');

                    }else if(allc_qty < old_do_qty){

                           $("#allcqtyerr").html('Order qty already done').css('color','red');
                           $("#proceedbtn").prop('disabled',true);
...
<script type="text/javascript">
  ...
  function submitbtnEnable(new_data_count,itemacc_count,allocqty_count){


      console.log('new_data_count',new_data_count);
      console.log('new_data_count',itemacc_count);
      console.log('allocqty_count',allocqty_count);
  ...
  function getItemValue(){
   ...
   var  itemName =  explode[1];
    ...
    $.ajax({
          ...
          url:"{{ url('update-item-code-to-rake') }}",

          method : "POST",

          type: "JSON",

          data: {itemCode: itemCode,itemName:itemName,temptableid:temptableid,tblcol:tblcol,itemAliseName:itemAliseName},
...
<script type="text/javascript">
  ...
  function getAccValue(){
   ...
   // alert(accAliseName);return false;
   ...
   var tblcol = $("#tblcol").val();
   var tblcol2 = $("#tblcolsp").val();

  // alert(tblcol);
    //alert(tblcol2);return false;
   ...
   //alert(tblcol);
    ...
    $.ajax({
          ...
          url:"{{ url('update-acc-code-to-delivery-order-for-rake') }}",

          method : "POST",

          type: "JSON",

          data: {accCode: accCode,accName:accName,accAliseName:accAliseName,temptableid:temptableid,tblcol:tblcol},
        ...
        success:function(data){
          ...
          if (data1.response == 'error') {
            ...
            if(data1.data == ''){
                ...
                console.log(data1.data[0].CITYNAME);
