...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="Active"><a href="{{ URL('Master/Infrastructure/Add-Project-Master')}}">Add Project Budget </a></li>
      <li class="Active"><a href="{{ URL('Master/Infrastructure/Add-Project-Master')}}">View Project Budget </a></li>
    </ol>
  </section>
  <!-- Main content -->
      ...
      <div class="col-xs-12">
        <div class="box box-primary Custom-Box">
          <div class="box-header with-border" style="text-align: center;">
            <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">View Project Budget</h3>
            <div class="box-tools pull-right">
              <a href="{{ url('Transaction/Infrastructure/Add-project-budget-tranasction') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add  Project Budget</a>
            </div>
          </div><!-- /.box-header -->
            ...
            <table id="example" class="table table-bordered table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Plant Amount</th>    
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
      ...
      ajax:{
        url : "{{ url('Transaction/Infrastructure/view-project-budget-tranasction') }}"
      },
      searching : true,
      columns: [
        { data: "PROJECT_CODE" },
        ...
        {  
          render: function (data, type, full, meta){
           ...
           /* var deletebtn ='<input type="hidden" id="deleteinput_'+full['PROJECT_CODE']+'" value="'+full['PROJECT_CODE']+'"><a href="#" disabled id="getId"class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a>|<button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return dleteitemType(\''+full['PROJECT_CODE']+'\','+full['DT_RowIndex']+');"><i class="fa fa-trash" title="Delete"></i></button>';*/

            var deletebtn ='<input type="hidden" id="deleteinput_'+full['PROJECT_CODE']+'" value="'+full['PROJECT_CODE']+'"><a href="#" disabled id="getId"class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a>|<button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" disabled><i class="fa fa-trash" title="Delete"></i></button>';
            return deletebtn;
...
<script type="text/javascript">
  ...
  function dleteitemType(itemtype,rowId){
    ...
    $.ajax({
      url:"{{ url('Transaction/Infrastructure/Delete-project-budget-tranasction') }}",
      method : "POST",
      type: "JSON",
      data: {getval:getval},
      success:function(data){
