      ...
      <div class="col-sm-12">
        ...
        <div class="box-body">
           <!--  <form action="{{ url('/Transaction/PaymentAdvice/Emp-payment-Advice')}}" method="POST" enctype="multipart/form-data"> -->
              ...
              <div class="form-group">
                  ...
                  <label> T Code : </label>
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="tracode" value="{{$paymentAdvice_list->TRAN_CODE}}" id="transcode" placeholder="Enter Transaction Head" readonly>


                          <input type="hidden" class="form-control" name="paymentId" value="{{$paymentAdvice_list->ID}}" id="paymentId">
              ...
              <div class="form-group">
                ...
                <label> Vr No: </label>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control rightcontent" name="vr_num" value="{{$paymentAdvice_list->VRNO}}" placeholder="Enter Vr No" id="vrseqnum" readonly>
                  ...
                  <label>Series Code: 
                    ...
                    <div class="input-group">
                      ...
                      <div class="input-group-addon">
                        ...
                        <input list="seriesList"  id="series_code" name="seriescode" class="form-control  pull-left " value="{{$paymentAdvice_list->SERIES_CODE}}" placeholder="Select Series" autocomplete="off">
                  ...
                  <label>Series Name: 
                    ...
                    <div class="input-group">
                      ...
                      <div class="input-group-addon">
                        ...
                        <input type="text"  id="seriesName" name="seriesName" class="form-control" value="{{$paymentAdvice_list->SERIES_NAME}}" placeholder="Series Name" readonly>
              ...
              <div class="form-group">
                ...
                <label>Plant Code: <span class="required-field"></span></label>
                  ...
                  <div class="input-group">
                      ...
                      <input list="plantcodelist"  id="plantCode" name="plantCode" class="form-control  pull-left" value="{{$paymentAdvice_list->PLANT_CODE}}" placeholder="Select Plant Code" autocomplete="off">
              ...
              <div class="form-group">
                ...
                <label>Plant Name: <span class="required-field"></span></label>
                  ...
                  <div class="input-group">
                      ...
                      <input id="plantName" name="plantName" class="form-control  pull-left" value="{{$paymentAdvice_list->PLANT_NAME}}" placeholder="Plant Name" readonly="" >
                  </div>
              ...
              <div class="form-group">
                ...
                <label>Pfct Code: <span class="required-field"></span></label>
                  ...
                  <div class="input-group">
                      ...
                      <input id="profitcen_code" name="profitcen_code" class="form-control  pull-left" value="{{$paymentAdvice_list->PFCT_CODE}}" placeholder="Select Profit Center Code" readonly>
              ...
              <div class="form-group">
                  ...
                  <label>PFCT Name: 
                    ...
                    <div class="input-group">
                      ...
                      <input  id="profitcenter_name" name="profitcenter_name" class="form-control  pull-left sereiswidth" value="{{$paymentAdvice_list->PFCT_NAME}}" placeholder="Select Series" readonly>
                    </div>
              ...
              <div class="form-group">
                ...
                <label>Account Code: <span class="required-field"></span></label>
                  ...
                  <div class="input-group">
                      ...
                      <input list="accCList"  id="accCodId" name="acc_code" class="form-control  pull-left" value="{{$paymentAdvice_list->ACC_CODE}}" placeholder="Select Account Code" autocomplete="off">
              ...
              <div class="form-group">
                ...
                <label>Account Name: <span class="required-field"></span></label>
                  ...
                  <div class="input-group">
                      ...
                      <input  id="acc_name" name="acc_name" class="form-control  pull-left" value="{{$paymentAdvice_list->ACC_NAME}}" placeholder="Select Account Name" readonly="">
              ...
              <div class="form-group">
                ...
                <label>Payment Type: <span class="required-field"></span></label>
                  ...
                  <div class="input-group">
                      ...
                      <input list="pmttypeList"  id="pmt_type" name="pmt_type" class="form-control  pull-left" value="{{$paymentAdvice_list->PAYMENT_TYPE}}" placeholder="Select Payment Type" oninput="funPayType()" autocomplete="off">
              ...
              <div class="form-group">
                ...
                <label>Amount: <span class="required-field"></span></label>
                  ...
                  <div class="input-group">
                      ...
                      <input id="dr_amount" name="dr_amount" class="form-control  pull-left" value="{{$paymentAdvice_list->DR_AMT}}" placeholder="Amount" autocomplete="off">
            ...
            <div id="loanDiv" <?php if($paymentAdvice_list->PAYMENT_TYPE == 'Loan'){echo 'style="display:block;"';}  else{
              ...
              <div class="form-group">
                ...
                <label>EMI: <span class="required-field"></span></label>
                  ...
                  <div class="input-group">
                      ...
                      <input   id="emiAmount" name="emiAmount" class="form-control  pull-left" value="{{$paymentAdvice_list->EMI_AMOUNT}}" placeholder="EMI Amount" oninput="funEMIAmt()" autocomplete="off" >
              ...
              <div class="form-group">
                ...
                <label>Tenure: <span class="required-field"></span></label>
                  ...
                  <div class="input-group">
                      ...
                      <input   id="tenure" name="tenure" class="form-control  pull-left" value="{{$paymentAdvice_list->TENURE}}" placeholder="EMI Amount" readonly>
            ...
            <div class="row">
              <div class="text-center">
               <button type="button" class="btn btn-success" onclick="funSaveData()">Update</button>
              </div>
            </div>
      ...
      if(pmt_type == 'Loan'){
       ...
       $.ajaxSetup({
        ...
        $.ajax({
            ...
            url: "{{ url('/Transaction/PaymentAdvice/Update-Emp-payment-Advice') }}",

            data: {todayDate:todayDate,transcode:transcode,vr_num:vr_num,series_code,series_code,seriesName:seriesName,plantCode:plantCode,plantName:plantName,profitcen_code:profitcen_code,profitcenter_name:profitcenter_name,accCodId:accCodId,acc_name:acc_name,pmt_type:pmt_type,dr_amount:dr_amount,emiAmount:emiAmount,tenure:tenure,paymentId:paymentId}, // here $(this) refers to the ajax object not form
           ...
           success: function (data) {
            ...
            if(obj.response == 'success'){
              ...
              var url ="/Transaction/TravelRequisition/success-message/"+getName;
