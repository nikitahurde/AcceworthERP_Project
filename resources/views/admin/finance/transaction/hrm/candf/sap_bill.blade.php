                 ...
                 <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="depotList"  id="depot_code" name="depot_code" class="form-control  pull-left" value="{{ old('depot_code')}}" placeholder="Select Depot" oninput="this.value = this.value.toUpperCase()">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="accountList" id="account_code" name="account_code" class="form-control  pull-left" value="{{ old('account_code')}}" placeholder="Select Customer" oninput="this.value = this.value.toUpperCase()">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="areaList" id="area_code" name="area_code" class="form-control  pull-left" value="{{ old('area_code')}}" placeholder="Select Area / Destination" oninput="this.value = this.value.toUpperCase()">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="transList" id="transport_code" name="transport_code" class="form-control  pull-left" value="{{ old('transport_code')}}" placeholder="Select Transporter" oninput="this.value = this.value.toUpperCase()">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" id="vehicle_no" name="vehicle_no" placeholder="Enter Vehicle No" value="{{ old('vehicle_no')}}" oninput="this.value = this.value.toUpperCase()">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <!-- <input type="text" class="form-control" id="item_code" name="item_code" placeholder="Enter Item"> -->
                         ...
                         <input list="itemList" id="item_code" name="item_code" class="form-control  pull-left" value="{{ old('item_code')}}" placeholder="Select Item" oninput="this.value = this.value.toUpperCase()">
           ...
           success:function(data){
                ...
                if (data1.response == 'error') {
                 ...
                 console.log(data1.data[0]);
                  ...
                  $('#unitAum').val(data1.data[0].AUM_CODE);
