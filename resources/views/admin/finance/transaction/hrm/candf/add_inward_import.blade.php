      ...
      <div class="box-body">
          ...
          <div class="row">
            ...
            <div class="col-md-2">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input list="rakeNoList" class="form-control" name="rake_no" value="" placeholder="Enter Rake No" maxlength="15" id="rake_no">
            ...
            <div class="col-md-2" style="margin-top: 10px;">
              ...
              <button class="btn btn-success" type="button" id="submitdata" onclick="submitImportInward()"><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;&nbsp; Import Rake Tran</button>
