        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <div class="box-tools pull-right showinmobile">
                <a href="{{ url('/Transaction/Logistic/View-lorry-receipt-trans') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Create Dispatch Outward</a>
              </div>

              <div class="box-tools pull-right">
                <a href="{{ url('/Transaction/Logistic/View-lorry-receipt-trans') }}" class="btn btn-primary btn-sm" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Create Dispatch Outward</a>
              </div>
              ...
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" id="wayment_weight" name="wayment_weight" class="form-control  pull-left" value="" placeholder="Enter wayment_weight" oninput="getweymentWeight(this.value)">
  ...
  function getweymentWeight(value){
    ...
    //console.log('count',dataCount);
      ...
      for(var i = 1; i <= dataCount; i++) {
        ...
        $("#total_net").val(total_weight.toFixed(3));
            ...
            console.log('accADDRESS',data1.data_accAddress);
              ...
              if(data1.data_outward == ''){
                ...
                $.each(data1.data_outward, function(k, getData) {
                  ...
                  "<td><input style='padding: 0px;width: 70px;text-align: right;' type='text' class='inputboxclr' id='net_qty"+srno+"' value='"+getData.QTY+"' name='net_qty[]' style='width: 80px;'/></td>"+
                ...
                srno++;});/* /. each loop */
                   ...
                   var tabletd = "<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><input class='inputboxclr' type='text' value='"+totalsqty.toFixed(3)+"' style='padding: 0px;width: 70px;text-align: right;' readonly id='basicTotal'/></td><td></td><td></td><td></td><td></td><td><input class='inputboxclr' type='text' value='' style='padding: 0px;width: 85px;text-align: right;' readonly id='total_net'/></td><td></td><td></td><td></td><td></td></tr>";
