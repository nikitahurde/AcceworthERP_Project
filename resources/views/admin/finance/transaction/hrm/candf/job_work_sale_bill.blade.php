...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="{{ url('/report/purchase/purchase-indent-report') }}">Job Work Sale Bill</a></li>
  ...
  <section class="content" style="min-height: 150px;margin-bottom: -26px;">
    ...
    <div class="box box-primary Custom-Box">
      ...
      <div class="box-header with-border" style="text-align: center;">
        ...
        <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Job Work Sale Bill</h2>
        ...
        <div class="modal-header">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <h5 class="modal-title settaxcodemodel" style="text-align: center;" id="exampleModalLabel">Simulation Job Work Sale Bill</h5>
    ...
    if(msg=='No Match'){
      ...
      $("#vrDate").val(vr_date);
        ...
        $.ajax({
          ...
          url:"{{ url('/finance/get-post-code-by-account-code-jbitem-salebill') }}",
      ...
      $('#TransportBillTable').DataTable({
        ...
        footerCallback: function ( row, data, start, end, display ) {
         ...
         // scrollX: true,
          ...
          ajax:{
            url:'{{ url("/transaction/CandF/job-work-sale-bill-search-data") }}',
          ...
          columns: [
            ...
            { 
              ...
              'render': function (data, type, full, meta){
                         return full['DT_RowIndex']+'<input type="checkbox" name="flit_id[]" onclick="clickCheck()" class="flitClass" value="'+full['SORDERHID']+'" style="display:none;" checked>';
                     }
            },
            {
                data:'ACC_CODE',
...
<script type="text/javascript">
  function submitBillGenerateData(){
    ...
    $.ajaxSetup({
        ...
        var submitdataurl = "<?php echo url('/transaction/CandF/save-job-work-sale-bill-data-jwitem'); ?>";
              ...
              success: function (data) {
                ...
                console.log(data);
                    ...
                    if(data1.response == 'error') {
                      ...
                      var url = "{{url('/transaction/CandF/view-job-work-sale-bill-msg')}}"
  ...
  function billSimulation(){
      ...
      // return false;
       ...
       $.ajax({
          ...
          url:"{{ url('get-simulation-data-for-job-work-sale-bill') }}",
