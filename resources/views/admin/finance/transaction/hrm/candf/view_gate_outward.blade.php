...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="{{ url('/transaction/CandF/view-gate-outward-transaction-cf') }}">Gate Outward</a></li>

      <li class="active"><a href="{{ url('/transaction/CandF/view-gate-outward-transaction-cf') }}">View Gate Outward</a></li>
        ...
        <div class="box box-primary Custom-Box">
          ...
          <div class="box-header with-border" style="text-align: center;">
            ...
            <div class="box-tools pull-right">
              ...
              <a href="{{ url('/transaction/CandF/add-gate-outward-transaction-cf') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Gate Outward</a>
    ...
    $(document).ready(function(){
      ...
      var t = $("#example").DataTable({
        ...
        ajax:{
            ...
            url : "{{ url('/transaction/CandF/view-gate-outward-transaction-cf') }}"
