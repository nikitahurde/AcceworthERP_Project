                  ...
                  <div class="panel-body">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane fade in active" id="tab1info">
                       ...
                       <form action="{{ url('/Transaction/LeaveApplication/leave-application-save') }}" method="POST" enctype="multipart/form-data">
                       ...
                       <div class="row">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <?php $CurrentDate =date("d-m-Y"); ?>
                                 ...
                                 <input type="text" class="form-control  fydatepicker rightcontent" name="leave_date" id="leave_date"value="{{$CurrentDate}}" >

                              </div>
                              <small id="emailHelp" class="form-text text-muted">

                                {!! $errors->first('leave_date', '<p class="help-block" style="color:red;">:message</p>') !!}
                          ...
                          <div class="col-md-4">
                            ...
                            <div class="form-group">
                              ...
                              <input list="empList" id="empcode" name="empcode" class="form-control  pull-left Employee FormTextFirstUpper" value="" placeholder="Enter Employee" autocomplete="off">
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input list="desgList" id="emp_designation" name="emp_designation" class="form-control  pull-left EmpDesignation FormTextFirstUpper" value="" placeholder="Enter Designation" autocomplete="off">


                            <datalist id='desgList'>
                              <?php foreach($designation_list as $key) { ?>

                              <option value='<?= $key->DESIG_CODE ?>' data-xyz='<?= $key->DESIG_NAME ?>'>{{ $key->DESIG_CODE }} = {{ $key->DESIG_NAME }}</option>
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input id="function" name="function" class="form-control  pull-left" value="" placeholder="Function" autocomplete="off">
                              </div>
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input class="form-control" list="leaveList" id="leave_list" placeholder="Type to search..." name="leaveList" autocomplete="off">
                          ...
                          <div class="col-md-3"> 
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="" id="fromto" name="fromto" class="form-control  pull-left" value="" placeholder="From To" autocomplete="off">
                              </div>

                               <small id="emailHelp" class="form-text text-muted">

                              {!! $errors->first('fromto', '<p class="help-block" style="color:red;">:message</p>') !!}
                          ...
                          <div class="col-md-2">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input id="noOfDay" name="noOfDay" class="form-control  pull-left" value="" placeholder="No. Of Day"  autocomplete="off" readonly>
                              </div>
                          ...
                          <div class="col-md-4"> 
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <textarea rows="1" cols="0" id="reason" name="reason" class="form-control  pull-left" value="" placeholder="Reason" autocomplete="off"></textarea>
                              </div>
                          ...
                          <div class="col-md-4"> 
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" id="contact_details" name="contact_details" class="form-control  pull-left Number" value="" placeholder="Contact" autocomplete="off">
                              </div>
                             </div>
...
<script type="text/javascript">
  ...
  $("#emp_designation").bind('change', function () {  
