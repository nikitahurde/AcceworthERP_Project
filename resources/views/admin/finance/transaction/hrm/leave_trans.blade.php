  ...
  <section class="content-header">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">
          ...
          <a href="{{ url('/finance/form-transaction-mast') }}"> Leave Transaction</a>
      ...
      <div class="col-sm-12">
        ...
        <div class="box box-primary Custom-Box">
          ...
          <div class="box-header with-border" style="text-align: center;">
            ...
            <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Leave Transaction</h2>
                  ...
                  <div class="panel-body">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane fade in active" id="tab1info">
                       ...
                       <form action="{{ url('/Transaction/Leave/transaction-employee-leave-save') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                              ...
                              <label> T Code : </label>
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="tranCode" value="{{$trans_list}}" id="transcode" placeholder="Enter Transaction Head" readonly >
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input list="emp_list" id="emp_code" name="emp_code" class="form-control  pull-left" value="{{old('empname')}}" placeholder="Employee Code" autocomplete="off" oninput="funEmpname()">
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input list="plant_list" class="form-control" id="plant_code" name="PlantCode" placeholder="Select Plant" maxlength="11" value="{{old('PlantCode')}}" autocomplete="off" oninput="funPlantcode()" readonly>
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input  class="form-control" id="plantName" name="plantName" placeholder="Plant Name" value="{{old('plantName')}}" readonly>
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input id="designation" name="designation" class="form-control  pull-left" value="{{old('designation')}}" placeholder="Designation"  readonly>
                           ...
                           <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input list="leave_list" id="type_of_leave" name="type_of_leave" class="form-control  pull-left" value="{{old('type_of_leave')}}" placeholder="Select Leave" autocomplete="off" oninput="funLeavelist()">
                           ...
                           <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" id="from_date" name="from_date" class="form-control  pull-left transdatepicker" value="{{old('from_date')}}" placeholder="From Date" onchange="fromdate()" autocomplete="off">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" id="to_date" name="to_date" class="form-control  pull-left transdatepicker" value="{{old('to_date')}}" onchange="todate()" placeholder="To Date" autocomplete="off">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" id="no_of_days" name="no_of_days" class="form-control  pull-left" value="{{old('no_of_days')}}" placeholder="No Of Days" readonly>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <label>Reason of leave :  <span class="required-field"></span>
                              ...
                              <div class="input-group">
                                ...
                                <textarea type="text" id="reason_leave"  rows="1" name="reason_leave" class="form-control  pull-left" value="" placeholder="Reason Leave" >{{old('reason_leave')}}</textarea autocomplete="off">
                              </div>
                          ...
                          <div class="col-md-3">
                              <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <input type="text" id="contact_details" name="contact_details" class="form-control  pull-left" value="{{old('contact_details')}}" placeholder="Contact Details" autocomplete="off" >
                                   </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <div class="input-group-addon">
                                   ...
                                   <input type="text" id="approved" name="approved" class="form-control  pull-left" value="{{old('approved')}}" placeholder="Approved" autocomplete="off" >
                                   </div>
                        ...
                        <div class="row">
                            ...
                            <button type="submit" class="btn btn-info" style="margin-top: 12px;width: 130px;" id="nextbtn" >Save &nbsp;&nbsp;<i class="fa fa-save" aria-hidden="true"></i></button>
        ...
        $.ajax({
            ...
            success: function (data) {
              ...
              if (obj.response == 'success') {
                   ...
                   $('#designation').val(obj.data.DESIG_CODE);
