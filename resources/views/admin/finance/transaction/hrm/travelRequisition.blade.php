                          ...
                          <div class="col-md-2">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input class="form-control"  id="grade_code" placeholder="Grade" name="grade_code" autocomplete="off" value="" readonly>

                                <input  type="hidden" id="grade_name" placeholder="Grade" name="grade_name" value="">
                    ...
                    <table class="table tdthtablebordr" border="1" cellspacing="0" id="tblTravel">
                      ...
                      <tr class="useful">
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input type='text' name='travelReqDate[]' id='travelReqDate1' value='' class='travelReqDate' style="width:120px;margin-bottom: 5px;" autocomplete="off">
                       ...
                       <td class="tdthtablebordr" style='padding-top: 2%;'>
                         ...
                         <input id="tPicker1" type="text" name="tPicker[]" class="tPicker" style="width:120px;margin-bottom: 5px;" autocomplete="off">
                       ...
                       <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input type="text" name='placeFrom[]' id='placeFrom1' class="" style="width:120px;margin-bottom: 5px;" autocomplete="off">
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input type="text" name='placeTo[]' id='placeTo1' class="" style="width:120px;margin-bottom: 5px;" autocomplete="off">
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input list="transportlist" type="text" name='mode[]' id='mode1' class="" style="width:125px;margin-bottom: 5px;" autocomplete="off">
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <textarea rows="1" type="text" name='travelRemarks[]' id='travelRemarks1' class="" style="width:120px;margin-bottom: 5px;" autocomplete="off"></textarea>
                    ...
                    <table class="table tdthtablebordr" border="1" cellspacing="0" id="tblAccommo">
                      ...
                      <tr class="useful">
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <input type='text' name='place_id[]' id='place_id1' value=''style="width:120px;margin-bottom: 5px;" autocomplete="off">
                       ...
                       <td class="tdthtablebordr" style='padding-top: 2%;'>
                         ...
                         <input list="hotellist" id="hotel_id1" name="hotel_id[]" type="text" style="width:120px;margin-bottom: 5px;" autocomplete="off" >
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          <input id="FromDate1" name="FromDate[]" style="width:130px;" type="" value="" class="FromDate" autocomplete="off">
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          <input type="text" name='dtTo[]' id='dtTo1' class="FromDate" style="width:130px;margin-bottom: 5px;" autocomplete="off">
                        ...
                        <td class="tdthtablebordr" style='padding-top: 2%;'>
                          ...
                          <textarea rows="1" type="text" name='tblAccoremark[]' id='tblAccoremark1' class="" style="width:120px;margin-bottom: 5px;" autocomplete="off"></textarea>
...
function funPurTravel(){
 ...
 $("#hotel_id1").bind('change', function () {  
...
$(".addmore").on('click',function(){
      ...
      data +="<td class='tdthtablebordr' style='padding-top: 2%;'><input type='text' name='travelReqDate[]' id='travelReqDate"+i+"' value=''class='travelReqDate' style='width: 120px; margin-bottom: 5px; z-index: 0;'autocomple='off'><small id='travelReqDateErr"+i+"'></small></td><td class='tdthtablebordr' style='padding-top: 2%;'><input id='tPicker"+i+"' type='text' name='tPicker[]' class='tPicker'  style='width:120px;margin-bottom: 5px;'><small id='tPickerErr"+i+"'></small></td><td class='tdthtablebordr' style='padding-top: 2%;'><input type='text' name='placeFrom[]' id='placeFrom"+i+"' class='' style='width:120px;margin-bottom: 5px;'><small id='placeFromErr"+i+"'></small></td><td class='tdthtablebordr' style='padding-top: 2%;'><input type='text' name='placeTo[]' id='placeTo"+i+"' class='' style='width:120px;margin-bottom: 5px;'autocomple='off'><small id='placeToErr"+i+"'></small></td><td class='tdthtablebordr' style='padding-top: 2%;'><input list='transportlist' type='text' name='mode[]' id='mode"+i+"' class='' style='width:120px;margin-bottom: 5px;' autocomple='off'><datalist id='transportlist'></datalist><small id='modeErr"+i+"'></small></td><td class='tdthtablebordr' style='padding-top: 2%;'><textarea rows='1' type='text' name='travelRemarks[]' id='travelRemarks"+i+"' class='' style='width:120px;margin-bottom: 5px;''></textarea></td></tr>";
