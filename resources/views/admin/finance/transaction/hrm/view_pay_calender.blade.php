  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="#"> Pay Calendar</a></li>

            <li class="active"><a href="#">View Pay Calendar</a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">View Pay Calendar</h3>

                  <div class="box-tools pull-right">

          <a href="{{ url('/Master/Setting/pay-calender') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Pay Calendar</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <form action="#" method="post">
            ...
            <input type="hidden" name="payCal" id="payCal" value="">
            <input type="hidden" name="tblName" id="tblName" value="PAY_CALENDER">
            <input type="hidden" name="tblName2" id="tblName2" value="">
            <input type="hidden" name="colName" id="colName" value="MONTH_YR">
            <input type="hidden" name="colNameTwo" id="colNameTwo" value="FY_CODE">
            <input type="hidden" name="colNameThree" id="colNameThree" value="COMP_CODE">
    ...
    var t = $("#example").DataTable({
     footerCallback: function ( row, data, start, end, display ) {
        ...
        buttons:  [
                    {
                      ...
                      title: ' MASTER PAY CALENDER'+$("#headerexcelDt").val(),
                      filename: 'MASTER_PAY_CALENDER_'+$("#headerexcelDt").val(),
                    }
                  ],
       ajax:{

        url : "{{ url('/Master/Setting/view-pay-calender') }}"
       ...
       columns: [
         ...
         { data: "MONTH_YR",className:"text-left" },
         {  
           render: function (data, type, full, meta){
            ...
            if(plant_code == '' || plant_code == null){
              ...
              return full['PLANT_CODE'];
            }
           }
         },
          {  
           render: function (data, type, full, meta){
            var plant_code = full['PLANT_NAME'];
            if(plant_code == '' || plant_code == null){
              return '----';
            }else{
              return full['PLANT_NAME'];
            }
           }
         },
         { data: "MONTH_DAYS",className:"text-right" },
         { data: "HOLIDAYS",className:"text-right" },
         { data: "WORK_DAYS",className:"text-right" },
         {  
            render: function (data, type, full, meta){

              var flag ='employee';
              var enableBtn = 'enable';
              var deletebtn ='<input type="hidden" id="deleteinput" value="\''+full['MONTH_YR']+'\'"><a href="edit-pay-calender/'+btoa(full['MONTH_YR'])+'" class="btn btn-warning btn-xs actionBTN" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs actionBTN" data-toggle="modal" onclick="return getId(\''+full['MONTH_YR']+'\','+full['DT_RowIndex']+');" ><i class="fa fa-trash" title="Delete"></i></button>';
