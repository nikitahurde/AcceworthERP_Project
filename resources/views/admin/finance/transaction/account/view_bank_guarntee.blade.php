  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/view-mast-dealer') }}">Bank Gurantee</a></li>

            <li class="active"><a href="{{ url('/view-mast-dealer') }}">View Bank Gurantee</a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Bank Gurantee</h3>

                  <div class="box-tools pull-right">

          <a href="{{ url('/Transaction/Account/Bank-Guarantee-Tran') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Bank Gurantee</a>
