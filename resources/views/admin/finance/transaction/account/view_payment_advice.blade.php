  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;">Payment Advice</h2>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3" style="margin-top: 12px;">
                              ...
                              <div class="">
                               ...
                               <button type="button" class="btn btn-primary" name="searchdata" id="btnsearch" value="btnsearch" style="padding: 2px 2px;"><i class="fa fa-search" aria-hidden="true"></i> &nbsp;&nbsp;Search</button>

                                <button type="button" style="padding: 2px 2px;" class="btn btn-default" name="searchdata" id="ResetId"><i class="fa fa-reply" aria-hidden="true"></i> &nbsp;&nbsp;Reset</button>
              ...
              columns: [
                ...
                {    data:'ACC_NAME',
                    render:function(data, type, full, meta){
                      ...
                      return full['ACC_NAME']+'('+full['ACC_CODE']+')';
