...
<table class="table table-bordered partyDetail" style="margin-bottom: 0px;">
    ...
    <tr>
      <th style="text-align: center;font-size: 13px;"> <?php echo strtoupper($data030[0]->VRTYPE); ?> VOUCHER -  <?php echo $data030[0]->SERIES_NAME; ?> </th>
    </tr>
</table>
...
<table id="InwardDispatch" class="table table-bordered" style="margin-bottom: 0px;">
      ...
      <?php $sr_no=1;$totalDr=0;$totalCr=0; foreach($data030 as $key) {
       ...
       ?>
        ...
        <tr style="padding-top: 20%;">
          ...
          <td class="bodyTextS" style="width: 63%;">
            <?php 
              if($key->ACC_CODE){
                $PCODE = $key->ACC_CODE;
                $PNAME = $key->ACC_NAME;
            ...
            {{ $PNAME }} ( {{$PCODE}} )<br>{{$key->PARTICULAR}}</td>
    ...
    <tr class="list-item total-row">
        <th colspan="2" class="tableitem removeSpacetax" style="text-align: left;"> 
          <span class="">Total : &nbsp; </span>
          <span>Rs. <?php echo $cramtInWord; ?></span>
        </th>
