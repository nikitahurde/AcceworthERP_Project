          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <div class="box-tools pull-right">
                ...
                <a href="{{ url('/Transaction/Account/View-Renew-Bank-Guarantee-Tran') }}" class="btn btn-primary btn-sm" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Vehicle Renew Bank</a>
...
.with-nav-tabs.panel-info .nav-tabs > li.dropdown .dropdown-menu > .active > a:focus {
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <form action="{{ url('save-renew-bank-guarntee-transaction') }}" method="POST" enctype="multipart/form-data">
                       ...
                       <div class="col-md-2">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input list="bgNumber" class="form-control" name="bg_num" value="" placeholder="Enter Vr No" id="bg_num" autocomplete="off" onchange="getBgData()">

                            <datalist id='bgNumber'>
                              <?php foreach($bgnum_list as $key) { ?>
                               
                                  <option value="<?= $key->BG_NO ?>"><?= $key->BG_NO ?></option>
                               <?php  } ?>
                              <option value=""></option>
                            </datalist>
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="new_bg_num" value="" placeholder="Enter Bg Num" id="new_bg_num" autocomplete="off">
                          ...
                          <small id="emailHelp" class="form-text text-muted">
                            ...
                            {!! $errors->first('new_bg_num', '<p class="help-block" style="color:red;">:message</p>') !!}
                      ...
                      <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                             ...
                             <small id="mmrefgl_code_err" style="color: red;"></small>
  ...
  function getBgData() {
    ...
    var bgNumber = $("#bg_num").val();
     ...
     $.ajaxSetup({
            ...
            url:"{{ url('get-old-bank-guarntee-tran') }}",

            method : "GET",

            type: "JSON",

            data: {bgNumber: bgNumber},
              ...
              console.log(data1);
                if (data1.response == 'error') {
                  ...
                  if(data1.data == ''){
                      ...
                      $("#bg_type").val(data1.data[0].BGTYPE_CODE);
                      $("#bg_type_name").val(data1.data[0].BGTYPE_NAME);
                      ...
                      $("#amount").val(data1.data[0].AMOUNT);
                      $("#tenure").val(data1.data[0].TENURE);
                      $("#maturity_date").val(data1.data[0].MATURITY_DATE);
                      $("#gp_days").val(data1.data[0].DP_DAYS);
                      $("#particuler").val(data1.data[0].PARTICULER);
                      $("#sr_code").val(data1.data[0].SR_CODE);
                      $("#sr_name").val(data1.data[0].SR_NAME);
                      $("#cp_code").val(data1.data[0].CP_CODE);
                      $("#cp_name").val(data1.data[0].CP_NAME);
                      $("#margin_money").val(data1.data[0].MARGIN_MONEY);
                      $("#termscondition").val(data1.data[0].TERM_AND_COND);
                      $("#mmrefgl_code").val(data1.data[0].REF_GL_CODE);
                      $("#mmrefgl_name").val(data1.data[0].REF_GL_NAME);
                      $("#gl_tran_id").val(data1.data[0].GL_TRAN_ID);
