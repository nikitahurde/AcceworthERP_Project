          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <div class="box-tools pull-right">
                ...
                <a href="{{ url('/finance/transaction/view-sales-order-transaction') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Transaction</a>
                        ...
                        <div class="form-group">
                          ...
                          <label>Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control transdatepicker rightcontent" name="vr" id="vr_date" value="{{ $Date }}" placeholder="Select Date" autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Account Name: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input  id="AccountText" name="AccountText" class="form-control  pull-left" value="" placeholder="Select Account Name" readonly="">
                        ...
                        <div class="form-group">
                          ...
                          <label>Profit Center Name: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input  id="profitText" name="profitText" class="form-control  pull-left" value="" placeholder="Select Profit Center Name" readonly="">
                        ...
                        <div class="form-group">
                          ...
                          <label>Plant Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="PlantcodeList" class="form-control" id="Plant_code" name="plantcode" placeholder="Select Plant" maxlength="11" readonly autocomplete="off" >
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input list="seriesList1"  id="series_code" name="series" class="form-control  pull-left" value="{{ old('series_code')}}" placeholder="Select Series" oninput="this.value = this.value.toUpperCase()" readonly autocomplete="off">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input  id="seriesText" name="seriesText" class="form-control  pull-left" value="" placeholder="Select Series Name" readonly="">
                        ...
                        <div class="form-group">
                          ...
                          <label>Tax Code: 
                            ...
                            <div class="input-group">
                              ...
                              <input list="TaxcodeList"  id="tax_code" name="taxcode" class="form-control  pull-left" value="{{ old('taxcode')}}" placeholder="Select Tax" oninput="this.value = this.value.toUpperCase()" readonly autocomplete="off">
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="party_ref" id="party_rf_no" placeholder="Enter Party Ref No" maxlength="30">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control partyrefdatepicker" name="party_ref_d" id="party_ref_date" value="{{ old('vr_date')}}" placeholder="Select Party Ref Date">
                            ...
                            <div class="form-group">
                              ...
                              <label>Consine Code : <span class="required-field"></span></label>
                                ...
                                <div class="input-group">
                                  ...
                                  <input list="consineList"  id="consine_code" name="consine" class="form-control pull-left" value="{{ old('consine')}}" placeholder="Select consine" oninput="this.value = this.value.toUpperCase()">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="Rfhead_1" placeholder="Enter Rfhead1" maxlength="30" id="rfhead1" oninput="rfheadget(1)">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="Rfhead_4" placeholder="Enter Rfhead4" maxlength="30" id="rfhead4" oninput="rfheadget(4)">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="Rfhead_5" placeholder="Enter Rfhead5" maxlength="30" id="rfhead5" oninput="rfheadget(5)">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                  ...
                  <tr class="useful">
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter"  id='qty1' name="qty[]" onclick="showbtn(1)" onkeyup="CalAQty(1)" style="width: 80px" readonly />
                    ...
                    <td>
                        ...
                        <input type="hidden" class="setGrandAmnt" id="get_grand_num1">
...
<script src="{{ URL::asset('public/dist/js/viewjs/sales_order_trans.js') }}" ></script>
                      ...
                      $("#CalcTax1").prop('disabled',false);
                        ...
                        //  console.log('countI',countI);
                         ...
                         if(butn != 'Ok' || butn =='undefined'){
                          ...
                          var tblData = "<button type='button' class='btn btn-primary ' style='width: 27%;' data-dismiss='modal' id='ApplyOkbtn"+taxid+"' onclick='OkGetGransVal("+taxid+","+dataI+","+countI+");'>Ok</button>";
...
<script type="text/javascript">
  ...
  function OkGetGransVal(aplyid,datacount,countercount){
      ...
      var data = $("#salesordertrans").serialize();
        ...
        $.ajax({
            ...
            success: function (data) {
             ...
             /*window.location.href = "{{ url('/finance/transaction/view-sales-order-transaction') }}";*/

              var url = "{{url('finance/view-sales_order-msg')}}"
