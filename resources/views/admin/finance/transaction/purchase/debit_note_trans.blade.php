          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <div class="box-tools pull-right">
                ...
                <a href="{{ url('/Transaction/Purchase/View-Debit-Note-Trans') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Debit Note</a>
                ...
                if (data1.response == 'error') {
                  ...
                  if(data1.data== ''){
                    ...
                    $.each(data1.data, function(k, getData){
                      ...
                      var taxData = '<input type="radio" class="taxcodeset" id="bill_no_purchase" onclick="getItmByBillNo()"name="bill_no_purchase" value="'+startyear[0]+' '+getData.SERIES_CODE+' '+getData.PARTYBILLNO+'"><label for="html">'+startyear[0]+' '+getData.SERIES_CODE+' '+getData.PARTYBILLNO+'</label><br>';
