  ...
  <section class="content-header">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">
          ...
          <a href="{{ url('/Transaction/Purchase/Good-Reciept-Note-Trans') }}"> Purchase Good Reciept Note </a>
        ...
        <div class="box box-primary Custom-Box">
          ...
          <div class="box-header with-border" style="text-align: center;">
            ...
            <div class="box-tools pull-right">
                ...
                <a href="{{ url('/Transaction/Purchase/view-Good-Reciept-Note-Trans') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Grn</a>
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input list="seriesList1"  id="series_code" name="series" class="form-control  pull-left" value="<?php if($secount == 1){echo $series_list[0]->SERIES_CODE;} ?>" placeholder="Select Series" oninput="this.value = this.value.toUpperCase()" readonly autocomplete="off" onchange="getvrnoBySeries()">
                              ...
                              <input type="hidden" id="seriesStockFlag" name="seriesStockFlag">
                              <input type="hidden" id="seriesGl" name="seriesGlCode">
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input list="PlantcodeList" class="form-control" id="Plant_code" name="plantcode" value="<?php if($plCount==1){echo $plant_list[0]->PLANT_CODE;} ?>" placeholder="Select Plant" maxlength="11" autocomplete="off">
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input  class="form-control" id="plantText" name="plantText" value="<?php if($plCount==1){echo $plant_list[0]->PLANT_NAME;} ?>" placeholder="Select Plant" maxlength="11" readonly autocomplete="off">
                          ...
                          <div class="col-md-4">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <?php $getacccount = count($acc_list); ?>
                                <input list="AccountList"  id="account_code" name="AccCode" class="form-control  pull-left" value="<?php if($getacccount==1){echo $acc_list[0]->ACC_CODE;} ?>" placeholder="Select Vendor" oninput="this.value = this.value.toUpperCase()" autocomplete="off" onchange="getpurOrderNum()">
                          ...
                          <div class="col-md-4">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input  id="AccountText" name="AccountText" class="form-control  pull-left" value="<?php if($getacccount==1){echo $acc_list[0]->ACC_NAME;} ?>" placeholder="Select Vendor" readonly autocomplete="off">
                          ...
                          <div class="col-md-3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input list="TaxcodeList"  id="tax_code" name="taxcode" class="form-control  pull-left" value="<?php if($taxCount == 1){echo $tax_code_list[0]->tax_code;}else{echo old('taxcode');} ?>" placeholder="Select Tax" onchange="getitmByTax();" oninput="this.value = this.value.toUpperCase()" readonly autocomplete="off">
            ...
            <form id="grntrans">
              ...
              <div class="table-responsive">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                  ...
                  <input type ="hidden" name="account_name" value="<?php if($getacccount==1){echo $acc_list[0]->ACC_NAME;} ?>" id="getAcc_Name">
                  ...
                  <input type ="hidden" name="series_name" value="<?php if($secount == 1){echo $series_list[0]->SERIES_NAME;} ?>" id="getSeriesName">
                  ...
                  <input type ="hidden" name="seriesGl" id="getseriesGl">
              ...
              if (data1.response == 'error') {
                ...
                $('#errorItem').html("<p style='color:red'>"+ data1.message +"</p>");
                  ...
                  if(data1.data == ''){
                    ...
                    $('#seriesStockFlag').val(data1.data[0].STOCK_FLAG);
...
<script type="text/javascript">
  ...
  function CalculateTax(taxid){
    ...
    if(taxOnModel == ''){
      ...
      var itemGlCd     = $('#itemglCode'+taxid).val();
          ...
          data: {ItemCode: ItemCode,taxCode:taxCode},
           ...
           success:function(data){
                ...
                if (data1.response == 'error') {
                    ...
                    console.log('data-hsn',data1.data_hsn);
                    ...
                    if(data1.data_hsn==''){
                      ...
                      if(batchCheck == 'YES'){
                         ...
                         console.log('barctRefNo',barctRefNo);
    ...
    var foundItm = valueitm.find(function (element) {
     ...
     if(foundItm == ''){
          ...
          $.ajax({
              ...
              url: "{{ url('/Transaction/Purchase/Save-Good-Reciept-Note') }}",
              ...
              success: function (data) {
                ...
                if (data1.response == 'error') {
                  ...
                  var url = "{{url('Transaction/Purchase/View-Good-Reciept-Note-Msg')}}"
                  ...
                  if(downloadFlg == 1){
                    ...
                    var fileN = 'GRN_'+fyCd[0]+''+seriesCd+''+vrNo;
...
/* -------- simulation ------------- */
  ...
  function simulationcal(){
      ...
      $.ajax({
              ...
              url:"{{ url('get-simulation-data-for-grn') }}",

              method : "POST",

              type: "JSON",

              data: {itmeCode: itmeCode,taxIndCode:taxIndCode,rateIndex:rateIndex,taxAmount:taxAmount,taxGl:taxGl,taxRowC_byItem:taxRowC_byItem,seriesGl:seriesGl,totalTaxRC:totalTaxRC,glByItem:glByItem,grAmtByItm:grAmtByItm,itmWiseGl:itmWiseGl},
                      ...
                      $('#errorItem').html("<p style='color:red'>"+ data1.message +"</p>");
                        ...
                        if(data1.data_sim==''){
                          ...
                          $.each(data1.data_sim, function(k, getData) {
                            ...
                            var bodyData = "<div class='box-row tooltips'><div class='box10 texIndbox'><small class='tooltipcoderef' >"+getData.CODE_NAME+"</small>"+getData.IND_GL_CODE+"</div> <div class='box10 texIndbox'>"+getData.glName+"</div> <div class='box10 rateIndbox'>"+getData.DR_AMT+"</div> <div class='box10 rateBox'>"+getData.CR_AMT+"</div></div>";

                            $('#siml_body').append(bodyData);

                          });

                          var footerData = "<div class='box-row'><div class='box10 texIndbox'></div> <div class='box10 texIndbox'><b>Total</b></div> <div class='box10 rateIndbox'><b>"+drTotal.toFixed(2)+"</b></div> <div class='box10 rateBox'><b>"+crTotal.toFixed(2)+"</b></div></div>";
