        ...
        <div class="col-sm-12">
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Credit Note Transaction</h2>

              <div class="box-tools pull-right">

                <a href="{{ url('/Transaction/Purchase/View-Credit-Note-Trans') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Credit Note</a>
                        ...
                        <div class="form-group">
                          ...
                          <label>Tax Code: 
                            ...
                            <div class="input-group">
                              ...
                              <input list="TaxcodeList"  id="tax_code" name="taxcode" class="form-control  pull-left" value="" placeholder="Select Tax" oninput="this.value = this.value.toUpperCase()" readonly onchange="getItemCode(1)" autocomplete="off">
          ...
          <div class="modal-dialog modal-sm" role="document" style="margin-top: 5%;">
            ...
            <div class="modal-content" style="border-radius: 5px;">
              ...
              <div class="modal-footer" style="text-align: center;">
                ...
                <button type="button" id="billmodalitem" class="btn btn-primary" data-dismiss="modal" style="padding-left: 25px;padding-right: 25px;" onclick="showBillNo(1)" disabled="">Ok</button>
...
<script type="text/javascript">
  ...
  function showBillNo(bill_no){

   //var bill_no = $("#bill_no_purchase"+bill_no).val();
    ...
    $("#submitdata").click(function(event) {
      ...
      if(found == 0 && grandAmt < 0){
          ...
          $.ajax({
              ...
              url: "{{ url('/finance/save-credit-note-transaction') }}",
             ...
             //  alert(data);return false;
               ...
               var url = "{{url('/Transaction/Purchase/View-Credit-Note-Trans')}}"
