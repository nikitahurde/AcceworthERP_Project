...
.boxer {
  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <small><b>Contract Transaction Details</b></small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/Transaction/Purchase/View-Contract-Trans') }}">Transaction</a></li>

            <li class="active"><a href="{{ url('/Transaction/Purchase/View-Contract-Trans') }}">View Purchase Contract</a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">View Contract Trans</h3>

                  <div class="box-tools pull-right">

          <a href="{{ url('/Transaction/Purchase/Purchase-Contract-Trans') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Contract Trans</a>
 ...
 <div class="modal fade" id="contractDeleteM" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog modal-sm" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <form action="{{ url('/Transaction/Purchase/Delete-Purchase-Contract-Trans') }}" method="post">
...
<script type="text/javascript">
  ...
  function format ( d ) {
    ...
    return '<table border="0" class="table table-bordered table-striped table-hover chieldtblecls" id="childData_'+d.PCNTRHID+'" style="padding-left:50px;">'+
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/Transaction/Purchase/View-Contract-Trans') }}"
       ...
       columns: [
          ...
          { data:"",className:'details-control',
            ...
            return '<button id="showchildtable" onclick="showchildtable('+full.VRNO+','+full.PCNTRHID+','+full.DT_RowIndex+')"><i class="fa fa-plus" id="minus'+full.DT_RowIndex+'" title="Edit"></i></button>'
          }
         },
        ...
        {  
          ...
          {  
            render: function (data, type, full, meta){
              ...
              if((found == undefined) && (foundQty == undefined)){
                ...
                return  '<a  class="btn btn-success btn-xs"><i class="fa fa-check" aria-hidden="true"></i> Order Genrated</a>';
              }
            }
          },
          {  
            render: function (data, type, full, meta){
              ...
              if((found == undefined) && (foundQty == undefined)){
                  /*var deletebtn ='<a href="Edit-Contract-Trans/'+btoa(full['prchid'])+'/'+btoa(full['PCNTRBID'])+'/'+btoa(full['VRNO'])+'" class="btn btn-warning btn-xs" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" onclick="return contractDelete('+full['prchid']+');"><i class="fa fa-trash" title="Delete"></i></button>';
                  return deletebtn;*/
          ...
          },
          {
            render:function(data, type, full, meta){
              ...
              return '<button class="btn btn-success pdfbtndn" type="button" id="pdfDown" onclick="downloadPDF('+full['DT_RowIndex']+','+full['PCNTRHID']+','+full['VRNO']+',\''+full['TRAN_CODE']+'\');"><i class="fa fa-download" aria-hidden="true"></i></button>';
            }
          }
    ...
    function showchildtable(vrno,tblid,srnoRow){
            var vrno,tblid,srnoRow;
             ...
             $.ajax({
              ...
              url:"{{ url('view-purchase-contract-chield-row-data') }}",
    ...
    function downloadPDF(uniqNo,headId,vrno,tCode){
      ...
      $.ajax({
        ...
        success:function(data){
          ...
          var fileN = 'PCNTR_'+fyCd[0]+''+seriesCd+''+vrNo;
...
<script type="text/javascript">
    ...
    function CalculateTax(pcHeadID,pcBodyID,taxCode,itemCode,srnoRw,srno){
      ...
      var headConId = pcHeadID;
      var bodyConId = pcBodyID;
      ...
      $.ajax({
          ...
          data: {tax_code: tax_code,headConId:headConId,bodyConId:bodyConId,ItemCode:ItemCode},
