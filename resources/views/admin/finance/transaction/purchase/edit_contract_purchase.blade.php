                        ...
                        <div class="form-group">
                          ...
                          <label>Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control transdatepicker rightcontent" name="vr" id="vr_date" value="{{ $getPQuo[0]->VRDATE }}" placeholder="Select Date" autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label> T Code : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="tran" value="{{ $getPQuo[0]->TRAN_CODE }}" id="transcode" placeholder="Enter Transaction Head" readonly autocomplete="off">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input list="seriesList1"  id="series_code" name="series" class="form-control  pull-left" value="{{ $getPQuo[0]->SERIES_CODE }}" placeholder="Select Series" oninput="this.value = this.value.toUpperCase()" autocomplete="off" maxlength="6" onchange="getvrnoBySeries()">
                        ...
                        <div class="form-group">
                          ...
                          <label> Series Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="tran" value="{{ $getPQuo[0]->SERIES_NAME }}" id="seriesName" placeholder="Enter Series Name" readonly autocomplete="off">
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control rightcontent" name="vro" value="{{ $getPQuo[0]->VRNO }}" placeholder="Enter Vr No" id="vrseqnum" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Plant Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="PlantcodeList" class="form-control" id="Plant_code" name="plantcode" placeholder="Select Plant" maxlength="11" value="{{ $getPQuo[0]->PLANT_CODE }}" autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label> Plant Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="plantname" value="{{$pfct_data[0]->PLANT_NAME}}" id="plantname" placeholder="Enter Profit Plant Name" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Profit Center Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="profitList"  id="profitctrId" name="pfct" class="form-control  pull-left" value="{{ $getPQuo[0]->PLANT_CODE }}" placeholder="Select Profit Center Code" oninput="this.value = this.value.toUpperCase()"  autocomplete="off" readonly>
                        ...
                        <div class="form-group">
                          ...
                          <label> Profit Center Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="pfctname" value="{{$pfct_data[0]->PFCT_NAME}}" id="pfctName" placeholder="Enter Profit Center Name" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Vendor Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="AccountList"  id="account_code" name="AccCode" class="form-control  pull-left" value="{{ $getPQuo[0]->ACC_CODE }}" onchange="getBYAccCode()" placeholder="Select Vendor" oninput="this.value = this.value.toUpperCase()"  autocomplete="off"> 
                        ...
                        <div class="form-group ">
                          ...
                          <label> Vendor Name : </label>
                            ...
                            <div class="input-group tooltips">
                              ...
                              <input type="text" class="form-control" name="acctname" value="{{ $getPQuo[0]->ACC_NAME }}" id="accountName" placeholder="Enter Vendor Name" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Consignor/Delevory From: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="shipTAdd"  id="shipTAddr" class="form-control  pull-left" value="{{$getPQuo[0]->CPCODE}}" placeholder="Select Consignor/Delevory From" oninput="this.value = this.value.toUpperCase()" onchange="gettaxByStatCd();" autocomplete="off"> 
                        ...
                        <div class="form-group">
                          ...
                          <label>Cost Center Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="Costcode_List" class="form-control" id="costCent_code" name="costCent_code" placeholder="Select Cost Center Code" maxlength="55" value="{{ $getPQuo[0]->COST_CENTER }}"  autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label> Cost Center Name : </label>
                            ...
                            <div class="input-group tooltips">
                              ...
                              <input type="text" class="form-control" name="costcname" value="{{ $getPQuo[0]->COST_NAME }}" id="costcenName" placeholder="Enter Cost Center Name" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label> Quotation No : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="qtnCompList" class="form-control" name="" value="{{$getPQuo[0]->PQCSHID}}" id="Quotn_compare_no" placeholder="Enter Quotation No" autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Tax Code: 
                            ...
                            <div class="input-group">
                              ...
                              <input list="TaxcodeList"  id="tax_code" name="taxcode" class="form-control  pull-left" value="{{ $getPQuo[0]->TAX_CODE }}" placeholder="Select Tax" oninput="this.value = this.value.toUpperCase()" readonly autocomplete="off" onchange="getitmByTax();">
                        ...
                        <div class="form-group">
                          ...
                          <label>Due Days: 
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" id="due_days" name="due_days" class="form-control  pull-left Number" value="{{ $getPQuo[0]->DUEDAYS }}" placeholder="Enter Due Days" autocomplete="off" style="text-align: end;">
                        ...
                        <div class="form-group">
                          ...
                          <label>Due Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control rightcontent" name="due_date" id="due_date" value="{{ $getPQuo[0]->DUEDATE }}" placeholder="Select Due" autocomplete="off" readonly>
    ...
    <div class="row">
            ...
            <form id="salesordertrans">
              ...
              <div class="table-responsive">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                  ...
                  <?php $srNo=1;$total=0; $dataCount= count($getPQuo); foreach ($getPQuo as $pcntrData) {
                   ?>
                      <?php if($srNo==1){ ?>
                      <input type='hidden' value="{{$dataCount}}" id="rowCountEx" />
                    <?php } ?>
                      <tr class="useful">
                        
                        <td class="tdthtablebordr">
                          <input type='checkbox' class='case' id="cBocID1" onclick="checkcheckbox(<?php echo $srNo;?>);" />
                        </td>
                        ...
                        <td class="tdthtablebordr">
                          <div class="input-group">
                            <input type="text" class="inputboxclr SetInCenter showhideItm" style="width: 90px;margin-bottom: 5px;" id='Item_CodeId<?php echo $srNo;?>' name="item_codeQc[]" value="{{$pcntrData->ITEM_CODE}}" onclick="ShowItemCode(<?php echo $srNo;?>);"  oninput="this.value = this.value.toUpperCase()" readonly />

                            <input list="Item_List<?php echo $srNo;?>" class="inputboxclr SetInCenter prefitmSelect" style="width: 90px;margin-bottom: 5px;" id='ItemCodeId<?php echo $srNo;?>' name="item_codeAll[]" onchange="ItemCodeGet(<?php echo $srNo;?>);taxIntaxrate(<?php echo $srNo;?>);"  oninput="this.value = this.value.toUpperCase()">

                            <datalist id="Item_List<?php echo $srNo;?>">
                              <option selected="selected" value="">-- Select --</option>
                            ...
                            <input type="hidden" id="selectItem<?php echo $srNo;?>">

                            <input type="hidden" id="idsun<?php echo $srNo;?>">

                            <input type="hidden" id="pQtnHeadId<?php echo $srNo;?>" name="pur_QtnHeadId[]" value="{{$pcntrData->PQTNHID}}">
                            <input type="hidden" id="pQtnBodyId<?php echo $srNo;?>" name="pur_qtnbodyid[]" value="{{$pcntrData->PQTNBID}}">
                            <input type="hidden" id="pQtnNo<?php echo $srNo;?>" name="qtnNos[]">
                            <input type="hidden" id="qcNo<?php echo $srNo;?>" value="{{$pcntrData->PQCSHID}}" name="qtn_compNo[]">
                            <input type="hidden" id="itmGetCode<?php echo $srNo;?>" name="item_code[]" value="{{$pcntrData->ITEM_CODE}}">
                            <input type="hidden" id="getlevel<?php echo $srNo;?>" name="levelI[]">
                          ...
                          <div class="divhsn" id="showHsnCd<?php echo $srNo;?>">HSN : {{$pcntrData->HSN_CODE}}</div>
                          <input type="hidden" id="hsn_code<?php echo $srNo;?>" value="{{$pcntrData->HSN_CODE}}" name="hsn_code[]">
                          <input type="hidden" id="taxByItem<?php echo $srNo;?>" name="tax_byitem[]" value="{{$pcntrData->TAX_CODE}}">
                          <input type="hidden" id="taxratebytax<?php echo $srNo;?>" value="{{$pcntrData->TAX_CODE}}">
                          <input type="hidden" id="pur_qtn_head_id<?php echo $srNo;?>" >
                          <input type="hidden" id="purqtn_body_id<?php echo $srNo;?>" >
                          <input type="hidden" id="purqtn_head_id<?php echo $srNo;?>" >
                          <input type="hidden" id="purb_id_fpurtax<?php echo $srNo;?>" >
                        </td>

                        <td class="tdthtablebordr tooltips">

                          <input type="text" class="inputboxclr getAccNAme" style="width: 190px;margin-bottom: 5px;" id='Item_Name_id<?php echo $srNo;?>' name="item_name[]" value="{{$pcntrData->ITEM_NAME}}" readonly />

                          <div class="tooltiptextitem tooltiphide" id="itemNameTooltip<?php echo $srNo;?>"></div>

                          <textarea id="remark_data<?php echo $srNo;?>" rows="1" style="width: 190px;margin-bottom: 2%;" class="" name="remark[]" placeholder="Enter Description" readonly>{{$pcntrData->PARTICULAR}}</textarea>
                        ...
                        <td class="tdthtablebordr">
                          ...
                          <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter"  id='qty<?php echo $srNo;?>' name="qty[]" value="{{$pcntrData->QTYRECD}}"  oninput="CalAQty(<?php echo $srNo;?>)" style="width: 80px;" readonly />

                          <input type="text" name="unit_M[]" id="UnitM<?php echo $srNo;?>" class="inputboxclr AddM SetInCenter" value="{{$pcntrData->UM}}" readonly >

                          <input type="hidden" id="Cfactor<?php echo $srNo;?>">
                          <input type="hidden" id="balQtyByItem<?php echo $srNo;?>">

                          </div>

                          <div style="display: inline-flex;border:  none;margin-top: 6%;">
                                <button type="button" class="btn btn-primary btn-xs tolrancehide" id="tolranceshow<?php echo $srNo;?>" data-toggle="modal" data-target="#view_tolrance<?php echo $srNo;?>" onclick="tolranceDetail(<?php echo $srNo;?>)" style="padding: 0px 3px 0px 3px;margin-bottom: 3px;font-size: 11px;">Tolerance</button>
                            
                          </div>

                          <div id="appliedtolrnbtn<?php echo $srNo;?>"></div>
                          <div id="cancelbtolrntn<?php echo $srNo;?>"></div>

                          <input type="hidden" name="tolerence_index[]" id="settolrnceIndex<?php echo $srNo;?>">
                          <input type="hidden" name="tolerence_rate[]" id="setTolrnceRate<?php echo $srNo;?>">
                          <input type="hidden" name="tolerence_value[]" id="setTolrnceValue<?php echo $srNo;?>">
                        ...
                        <td class="tdthtablebordr">
                          ...
                          <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter"  id='A_qty<?php echo $srNo;?>' name="Aqty[]" value="{{$pcntrData->AQTYRECD}}"  style="width: 80px" readonly />

                          <input list="aumList<?php echo $srNo;?>" name="add_unit_M[]" id="AddUnitM<?php echo $srNo;?>" class="inputboxclr SetInCenter AddMList" value="{{$pcntrData->AUM}}" onchange="changeAum(<?php echo $srNo;?>)">

                          <datalist id="aumList<?php echo $srNo;?>">
                        ...
                        <td class="tdthtablebordr">
                          ...
                          <input type='text' class="debitcreditbox inputboxclr cr_amount SetInCenter" oninput="calculateBasicAmt(<?php echo $srNo;?>)" id='rate<?php echo $srNo;?>' name="rate[]" value="{{$pcntrData->RATE}}" style="width: 80px" readonly/>
                          <input type="hidden" id="qnrate<?php echo $srNo;?>">
                        </td>

                        <td class="tdthtablebordr">

                           <input type="text" name="basic_amt[]" id="basic<?php echo $srNo;?>" class="form-control basicamt" value="{{$pcntrData->BASICAMT}}" style="width: 110px;margin-top: 14%;height: 22px;" readonly>
                        ...
                        <td>
                          ...
                          <input type="hidden" class="setGrandAmnt" id="get_grand_num<?php echo $srNo;?>" name="crAmtPerItm[]">
                          <div style="margin-top: 23%;">
                            <small id="taxnotfound<?php echo $srNo;?>" class="label label-danger"></small>
                          </div>
                          <button type="button" class="btn btn-primary btn-xs tdsratebtn" id="CalcTax<?php echo $srNo;?>" data-toggle="modal" data-target="#tds_rate_model<?php echo $srNo;?>" onclick="CalculateTax(<?php echo $srNo;?>); getGrandTotal(<?php echo $srNo;?>);" disabled="">Calc Tax </button>
                          <div id="aplytaxOrNot<?php echo $srNo;?>" class="aplynotStatus">0</div>
                        ...
                        <td>
                          ...
                          <button type="button" class="btn btn-primary btn-xs tdsratebtn" id="qua_paramter<?php echo $srNo;?>" data-toggle="modal" data-target="#quality_parametr<?php echo $srNo;?>" onclick="qty_parameter(<?php echo $srNo;?>)" disabled="" style="padding-bottom: 0px;padding-top: 0px;">Quality Parametr </button>
      ...
      <br>
        ...
        <p class="text-center">
          ...
          <button class="btn btn-success" type="button" id="submitDown" onclick="submitAllData(1);" ><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;&nbsp; Save & Download</button>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
      ...
      $( window ).on( "load", function() {
          ...
          var existRwCn = $('#rowCountEx').val();

          for(var q=0;q<existRwCn;q++){
            var srNo = q+1;
        ...
        $.ajax({
            ...
            success: function (data) {
              ...
              if(downloadFlg == 1){
                ...
                link.href = data.url;
                link.download = 'Contract Transaction.pdf';
...
<script>
  ...
  function gettaxByStatCd(){

    var shipAddr     = $('#shipTAddr').val();
    var account_code = $('#account_code').val();
    ...
    $.ajax({
            ...
            data: {shipAddr: shipAddr,account_code:account_code,plstateCode:plstateCode},
