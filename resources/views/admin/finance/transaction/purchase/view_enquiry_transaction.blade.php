...
<script type="text/javascript">
  ...
  //  console.log('d',d.id);
    ...
    return '<table border="0" class="table table-bordered table-striped table-hover chieldtblecls" id="childData_'+d.PENQHID+'" style="padding-left:50px;">'+
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/Transaction/Purchase/View-Purchase-Enquiry-Trans') }}"
                  ...
                  if (data1.response == 'error') {
                      ...
                      if(data1.data==''){
                        ...
                        $.each(objrow, function (i, objrow) {
                          ...
                          $('#childData_'+tableid).append('<tr><td class="text-right removeextraSInC">'+srNo+'</td><td class="removeextraSInC">'+objrow.ITEM_NAME+' <p>( '+objrow.ITEM_CODE+')</p></td><td class="text-right removeextraSInC"><button type="button" class="btn btn-info notification" id="veiwPdetail_'+tblid+'_'+srNo+'" data-toggle="modal" data-target="#viewPartyDetail_'+tblid+'_'+srNo+'" onclick="showAllParty('+objrow.VRNO+','+objrow.PENQHID+','+objrow.PENQBID+','+tblid+','+srNo+')"><small class="viewaccnot"><center>View</center></small><span class="badge" id="accCount'+objrow.PENQHID+'_'+srNo+'">'+accCount.length+'</span></button></td><td class="text-right removeextraSInC">'+objrow.VRNO+'</td><td class="text-right removeextraSInC">'+objrow.QTYRECD+'</td><td class="text-right removeextraSInC">'+objrow.AQTYRECD+' <div class="modal fade" id="viewPartyDetail_'+tblid+'_'+srNo+'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><div class="modal-dialog modal-md" role="document" style="margin-top: 5%;"><div class="modal-content" style="border-radius: 5px;"><div class="modal-header"><div class="row"><div class="col-md-12"><h5 class="modal-title modltitletext" id="exampleModalLabel">Account Detail</h5></div></div></div><div class="modal-body table-responsive"><div class="boxer" id="allAccData'+tblid+'_'+srNo+'"></div><div class="modal-footer" style="text-align: center;"><button type="button" class="btn btn-primary" data-dismiss="modal" style="padding-left: 25px;padding-right: 25px;">Ok</button></div></div></div></div> </td> </tr>');
                              srNo++;
                        });
