...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">
          <a href="{{ url('/finance/transaction/purchase-order-transaction') }}"> Credit Note Transaction</a>
        </li>
        ...
        <div class="col-sm-12">
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">Credit Note Wo Item Transaction</h2>

              <div class="box-tools pull-right">

                <a href="{{ url('/Transaction/Purchase/View-Credit-Note-Woitem-Trans') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Credit Note Wo Item</a>
                        ...
                        <div class="form-group">
                          ...
                          <label>Tax Code: 
                            ...
                            <div class="input-group">
                              ...
                              <input list="TaxcodeList"  id="tax_code" name="taxcode" class="form-control  pull-left" value="" placeholder="Select Tax" oninput="this.value = this.value.toUpperCase()" readonly autocomplete="off" onchange="taxCodeonChnage()">
...
<script src="{{ URL::asset('public/dist/js/viewjs/credit_note_trans.js') }}" ></script>
    ...
    $("#submitdata").click(function(event) {
      ...
      if(found == 0 && grandAmt < 0){
          ...
          $.ajax({
              ...
              url: "{{ url('/finance/save-credit-note-transaction-woitem') }}",
