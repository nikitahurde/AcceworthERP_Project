...
.boxer {
  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <h1>
            Job Work Order Transaction
           <!--  < ?php echo ucwords($form_name) ?>  -->

          <!--   <small><b>< ?php echo $form_number; ?></b></small> -->

          <small><b>Job Work Order Trans Details</b></small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/Transaction/Purchase/View-Purchase-Order-Trans') }}">Job Work Order</a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">View Job Work Order Trans</h3>

                  <div class="box-tools pull-right">

          <a href="{{ url('/Transaction/Purchase/Job-Work-Order') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Job Work Order Trans</a>
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/Transaction/Purchase/View-Job-Work-Order-Trans') }}"
       ...
       {  
            render: function (data, type, full, meta){
              ...
              if(found == undefined){
                  var deletebtn ='<a href="Edit-Job-Work-Order/'+btoa(full['PORDERHID'])+'" class="btn btn-warning btn-xs" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" onclick="return porderDelete('+full['podrHid']+');"><i class="fa fa-trash" title="Delete"></i></button>';
                  return deletebtn;
              }else{
            ...
            if (data1.response == 'error') {
                ...
                if(data1.data==''){
                  ...
                  $.each(data1.data, function(k, getData) {
                    ...
                    var bodyData = "<div class='box-row'><div class='box10 texIndbox'>"+getData.TAXIND_CODE+" ( "+getData.TAXIND_NAME+" )</div><div class='box10 texIndbox'>"+getData.RATE_INDEX+"</div><div class='box10 amountRightAl'>"+getData.TAX_RATE+"</div><div class='box10 amountRightAl'>"+TAXAMT+"</div></div>"
