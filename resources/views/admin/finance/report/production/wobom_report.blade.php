              ...
              <div class="row">
               ...
               <div class="col-sm-4">
                   ...
                   <div class="form-group">
                      ...
                      <label for="exampleInputEmail1">BOM Type :</label>
                      ...
                      <div class="input-group">
                          ...
                          <datalist id="accountList">
                            ...
                            <option value='BOM' data-xyz ="BOM" >BOM</option>
                              <option value='WBOM' data-xyz ="BOM" >WBOM</option>
...
<script type="text/javascript">
  ...
  $('#btnpdf').click(function(){
          ...
          var head_table = 'wo_production_heads';
          
          var body_table =  'wo_production_bodies';
