...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-order-report') }}">Bom Rep.</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;">Bom Report</h2>
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                   ...
                   <div class="form-group">
                      ...
                      <label for="exampleInputEmail1">BOM Type :<span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="typeList" id="bom_type" name="bom_type" class="form-control  pull-left"  placeholder="Select Account" autocomplete="off">
                          ...
                          <datalist id="typeList">
                            ...
                            <option value='WBOM' data-xyz ="WBOM" >BOM</option>
                              <option value='WOBOM' data-xyz ="WOBOM" >WBOM</option>
...
load_data_query()
  function load_data_query(recNoId= '', recNoValueId='',lastUpId='',lastUpValueId='',VrNoId='',VrNoValueId='',SeriesNoId= '', SeriesNoValueId='',AccCodeId='',AccCodeValueId='',AmountId='',AmountValueId='',OtherDetailsId='',OtherDetValueId='',bank_code= '', acct_code='',from_date='',to_date='',vr_num='',bom_type=''){
    //  alert(acct_code);
    ...
    $('#ProceedBtnId').click(function(){
     ...
     console.log('recNoValueId ',recNoValueId);
      ...
      if (recNoId!='' || recNoValueId!='' || lastUpId!='' || lastUpValueId!='' || VrNoId!='' || VrNoValueId!='' || SeriesNoId!='' || SeriesNoValueId!='' || AccCodeId!='' || AccCodeValueId!='' || AmountId!='' || AmountValueId!='' || OtherDetailsId!='' || OtherDetValueId!='' || from_date == '' || to_date =='' || bank_code=='' || acct_code=='' || vr_num=='') {
          ...
          load_data_query(recNoId,recNoValueId,lastUpId,lastUpValueId,VrNoId,VrNoValueId,SeriesNoId,SeriesNoValueId,AccCodeId,AccCodeValueId,AmountId,AmountValueId,OtherDetailsId,OtherDetValueId,bank_code,acct_code,from_date,to_date,vr_num,bom_type);
    ...
    $('#btnsearch').click(function(){
          ...
          if (bank_code!='' || acct_code!='' || from_date!='' || to_date!='' || vr_num!='' || recNoId=='' || recNoValueId=='' || lastUpId=='' || lastUpValueId=='' || VrNoId=='' || VrNoValueId=='' || SeriesNoId=='' || SeriesNoValueId=='' || AccCodeId=='' || AccCodeValueId=='' || AmountId=='' || AmountValueId=='' || OtherDetailsId=='' || OtherDetValueId=='') {
            ...
            if(bom_type==''){
              ...
              $('#show_err_bom_type').html('Please select bom type').css('color','red');
                return false;

            }else{
              $('#show_err_bom_type').html('');
            }
...
<script type="text/javascript">
  ...
  $('#btnpdf').click(function(){
          ...
          var head_table = 'production_heads';
          
          var body_table =  'production_bodies';
