...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ url('/report/account/month-wise-summary-report') }}">Month Wise Summary </a></li>
    ...
    <section class="content">
      ...
      <div class="box box-primary Custom-Box">
        ...
        <div class="box-header with-border" style="text-align: center;">
          ...
          <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;"> Month Wise Summary </h2>
     ...
     //console.log('currDt',currDt);
      $('#createDoTbl').DataTable({
          ...
          buttons:  [
                      {
                        extend: 'excelHtml5',
                        title: 'MONTH WISE SUMMARY '+$("#excelDt").val(),
                        filename: 'MONTH_WISE_SUMMARY_OF_BANK_RECO_'+$("#excelDt").val(),
                      }
                    ],
          info: true,
          ajax:{
            url:'{{ url("/report/account/get-data-month-wise-summary-report") }}',
...

            {
              ...
              render: function (data) {
                  ...
                  if(data=='0000-00-00'){
                    ...
                    var bankDt = date.getDate() + "-" + (month.toString().length > 1 ? month : "0" + month) + "-" +  date.getFullYear();
                  }

                  return bankDt+'<input type="hidden" name="vrDt[]" id="vrDtId" value="'+newVrDt+'">';
              }
        ...
        //     },
            {
              ...
              render: function (data, type, full, meta){
                ...
                if (full['ACCCODE']!=null || full['ACCCODE']!='') {

                  var accGlCd = full['ACCCODE']; 
