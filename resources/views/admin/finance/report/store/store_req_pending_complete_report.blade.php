...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <h1>
            ...
            Store Req. Pending/Complete/All
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/store/store-requistion-pending-complete-report') }}">Store Req. Pending/Complete/All</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Store Req. Pending/Complete/All Report</h2>
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                      ...
                      <label for="exampleInputEmail1">Requistion No. :</label>
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="reqNoList" id="requistionNo" name="requistionNo" class="form-control  pull-left" value="{{ old('requistionNo')}}" placeholder="Select Requistion No" autocomplete="off">



                          <datalist id="reqNoList">

                            <option selected="selected" value="">-- Select --</option>

                            @foreach ($SREQHEAD as $key)
                            ...
                            <?php 
                              ...
                              $reqNo = $fyBeg.' '.$getSeries.' '.$getVRNO;
                            ?>

                            <option value='<?php echo $reqNo; ?>'   data-xyz ="<?php echo $reqNo; ?>" ><?php echo $reqNo; ?></option>
...
<script type="text/javascript">
  ...
  function load_data_query(requistionNo='',item_code='',from_date='',to_date='',ReportTypes=''){

    console.log('requistionNo',requistionNo);
    ...
    console.log('ReportType',ReportTypes);
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/report/store/store-req-pending-complete-all-report") }}',
            data: {requistionNo:requistionNo,item_code:item_code,from_date:from_date,to_date:to_date,ReportTypes:ReportTypes}
          },
          columns: [
  ...
  $(document).ready(function() {
    ...
    $('#btnsearch').click(function(){
          ...
          if (from_date!='' || to_date!='' || requistionNo=='' || item_code=='' || ReportTypes=='') {
            ...
            load_data_query(requistionNo,item_code,from_date,to_date,ReportTypes);
