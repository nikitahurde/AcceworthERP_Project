...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-order-report') }}">Store Return Rep.</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;">Store Return Report</h2>
  ...
  function load_data_query(recNoId= '', recNoValueId='',lastUpId='',lastUpValueId='',VrNoId='',VrNoValueId='',SeriesNoId= '', SeriesNoValueId='',AccCodeId='',AccCodeValueId='',AmountId='',AmountValueId='',OtherDetailsId='',OtherDetValueId='',bank_code= '', acct_code='',from_date='',to_date='',vr_num='',store_action=''){
    ...
    console.log('AmountValueId',AmountValueId);*/
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-from-query-store-return") }}',
                ...
                return false;
                            ...
                            $.ajaxSetup({
                             ...
                             $.ajax({
                                ...
                                url:"{{ url('/finance/store/store-return-pdf') }}",
