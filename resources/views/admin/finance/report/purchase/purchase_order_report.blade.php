...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-order-report') }}">Purchase Order Rep.</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Purchase Order Report</h2>
                      ...
                      <div class="input-group">
                          ...
                          <datalist id="vrnoList">
                            ...
                            <?php 
                              ...
                              $getNeVrNo = $getFy[1].' '.$seriesCode.' '.$vrNo;
                            ?>

                            <option value='<?php echo $getNeVrNo;?>'><?php echo $getNeVrNo; ?></option>
                  ...
                  <div class="col-md-8">
                    ...
                    <div style="margin-top:2%;margin-bottom:5%;">
                     ...
                     <button type="button" class="btn btn-primary" name="searchdata" id="btnsearch" style="padding: 5px;"><i class="fa fa-search" aria-hidden="true"></i> &nbsp;&nbsp;Search</button>
                      ...
                      <button class="btn btn-primary" id="PindReprtExl"  onclick="excelReportBtn('month')"><i class="fa fa-file-excel-o" aria-hidden="true"></i> <b>Monthly Summary</b></button>
 ...
 <script type="text/javascript">
  ...
  function excelReportBtn(type){
    ...
    var to_date    = $("#to_date").val();
      ...
      window.location.href = "{{ url('/report/purchase/purchase-order/purchase-order-report-excel/') }}"+'/'+from_date+'/'+to_date+'/'+vrn+'/'+item_code+'/'+seriesCodeOperator+'/'+seriesCodeValue+'/'+plantCodeOperator+'/'+plantCodeValue+'/'+profitCenterOperator+'/'+profitCenterValue+'/'+accCodeOperator+'/'+accCode+'/'+costCetOperator+'/'+costCetCode+'/'+QtyOperator+'/'+QtyValue+'/'+ReportTypes+'/'+type;
...
load_data_query()
  function load_data_query(seriesCodeOperator= '', seriesCodeValue='',plantCodeOperator='',plantCodeValue='',profitCenterOperator='',profitCenterValue='',accCodeOperator= '', accCode='',costCetOperator='',costCetCode='',QtyOperator='',QtyValue='',from_date='',to_date='',item_code= '', vr_num='',ReportTypes=''){
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-from-query-purchase-order") }}',
