...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-indent/indent-cancel') }}">Cancel Indent</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Cancel Indent </h2>
...
<script type="text/javascript">
  ...
  function load_data_query(IndentNo='',item_code='',from_date='',to_date=''){
    ...
    console.log('to_date',to_date);
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-cancel-indent") }}',
            data: {IndentNo:IndentNo,item_code:item_code,from_date:from_date,to_date:to_date}
          },
          columns: [
            ...
            },
            {
              ...
              render: function (data, type, full, meta){
                ...
                if(full['PENQHID']==0 && full['PENQBID']==0){
                  ...
                  var itemName = '<a href="cancel-indent/'+btoa(full['PINDHID'])+'/'+btoa(full['PINDBID'])+'"><small class="label label-danger"> <i class="fa fa-times" aria-hidden="true"></i> &nbsp; Cancel Indent </small></a>';
  ...
  $(document).ready(function() {
    ...
    $('#btnsearch').click(function(){
          ...
          $('#IndentNo').prop('readonly', 'true');
          $('#item_code').prop('readonly', 'true');


          if (from_date!='' || to_date!='' || IndentNo=='' || item_code=='' ) {
            ...
            load_data_query(IndentNo,item_code,from_date,to_date);
