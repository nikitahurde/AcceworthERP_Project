...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-enquery-report') }}">Purchase Enquery Rep.</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Purchase Enquery Report</h2>
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="vrnoList" id="vr_num" name="vr_num" class="form-control  pull-left" value="{{ old('vr_num')}}" placeholder="Select Vr Number" autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="itemList" id="item_code" name="item_code" class="form-control  pull-left" value="{{ old('acc_code')}}" placeholder="Select Item" autocomplete="off">
                     ...
                     <small id="show_err_item_code"></small>
               ...
               <div class="col-sm-2"></div>
                ...
                <div class="col-md-8">
                  ...
                  <div style="text-align:center;">
                    ...
                    <button  class="btn btn-primary" name="searchdata" id="btnsearch" style="padding: 5px;"><i class="fa fa-search" aria-hidden="true"></i> &nbsp;&nbsp;Search</button>

                    <button  class="btn btn-default" name="searchdata" id="ResetId"><i class="fa fa-reply" aria-hidden="true"></i> &nbsp;&nbsp;Reset</button>

                    <button class="btn btn-success" data-toggle="modal" data-target="#QueryModal"><i class="fa fa-hourglass" aria-hidden="true"></i> &nbsp;&nbsp;Query</button>

                    <button class="btn btn-primary" id="pEnqReprtExl" onclick="excelReportBtn()" ><i class="fa fa-file-excel-o" aria-hidden="true"></i> <b>Excel</b></button>
...
<table id="PurchaseIndentReportTable" class="table table-bordered table-striped table-hover">
          ...
          <section>
            <div class="row">
              ...
              <tbody>
                ...
                <tr>
                  <th>4</th>
                  <td class='QueryTableTd'>Account Code :</td>
                  <td style="text-align: center;">
                      <select id="accCodeOperator" name="accCodeOperator" style="width: 70%;font-size: initial;" onchange="accCodeQueryOperator(this.value)">
                        <option value=''>--Select--</option>
                        <option value='='>=</option>
                        <option value='=='>==</option>
                        <option value='!='>!=</option>
                  ...
                  <td style="text-align: center;">
                    <input list="accCodeList" id="accCodeValue" name="accCodeValue" class="pull-left" placeholder="Select Account" autocomplete="off" readonly style="margin-left: 15%;" onchange="accCodeQueryValue(this.value)">
  ...
  <input type="hidden" value="" name="accCodeOperators" id="accCodeOperators">
  <input type="hidden" value="" name="accCodeValues" id="accCodeValues">
...
<script type="text/javascript">
  ...
  function excelReportBtn(){
    ...
    var accCodeValues      =  $('#accCodeValues').val();
    if (accCodeValues == '') {
      accCodeValue = 0;
    }else{
      accCodeValue = accCodeValues;
    }
   ...
   var pageName = 'purchaseIndent';
    ...
    window.location.href = "{{ url('/report/purchase/purchase-indent/purchase-enquery-report-excel/') }}"+'/'+from_date+'/'+to_date+'/'+item_code+'/'+vr_num+'/'+plantCodeOperator+'/'+plantCodeValue+'/'+seriesCodeOperator+'/'+seriesCodeValue+'/'+profitCenterOperator+'/'+profitCenterValue+'/'+accCodeOperator+'/'+accCodeValue+'/'+QtyOperator+'/'+QtyValue;
 ...
 <script type="text/javascript">
  ...
  function accCodeQueryOperator(getVal){

    var qtyValue =  $('#accCodeValue').val();
  ...
  function accCodeQueryValue(accCodeValue){
...
load_data_query()
  function load_data_query(plantCodeOperator= '', plantCodeValue='',seriesCodeOperator='',seriesCodeValue='',profitCenterOperator='',profitCenterValue='',accCodeOperator= '', accCodeValue='',QtyOperator='',QtyValue='',from_date='',to_date='',item_code='',vr_num=''){
          ...
          columns: [
            ...
            },
            {
              ...
              render: function (data, type, full, meta){
                ...
                console.log('getBtb ',data['PENQHID']);
                var GetBtn = '<button type="button" class="btn btn-info btn-xs notification" id="veiwPdetail_'+full['DT_RowIndex']+'" data-toggle="modal" data-target="#viewPartyDetail_'+full['DT_RowIndex']+'" onclick="showAllParty('+full['DT_RowIndex']+','+data['PENQHID']+','+data['PENQBID']+','+data['VRNO']+')" style="padding-bottom: 0px;padding-top: 0px;">View</button><div class="modal fade" id="viewPartyDetail_'+full['DT_RowIndex']+'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><div class="modal-dialog modal-md" role="document" style="margin-top: 5%;"><div class="modal-content" style="border-radius: 5px;"><div class="modal-header"><div class="row"><div class="col-md-12"><h5 class="modal-title modltitletext" id="exampleModalLabel">Account Detail</h5></div></div></div><div class="modal-body table-responsive"><div class="boxer" id="allAccData'+full['DT_RowIndex']+'"></div><div class="modal-footer" style="text-align: center;"><button type="button" class="btn btn-primary" data-dismiss="modal" style="padding-left: 25px;padding-right: 25px;">Ok</button></div></div></div></div>';
                return GetBtn;
              }
            ...
            },
            {
              data:null,
              render: function (data, type, full, meta){
                var qcBtn = '<button type="button" class="btn btn-primary btn-xs" id="CalcTax1" data-toggle="modal" data-target="#quality_parametr'+full['DT_RowIndex']+'" onclick="qty_parameter('+full['DT_RowIndex']+')" style="padding-bottom: 0px;padding-top: 0px;font-size:12px;">Quality Parametr </button>';
                var qpdomModel = "<div class='modal fade' id='quality_parametr"+full['DT_RowIndex']+"' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'><div class='modal-dialog' role='document' style='margin-top: 5%;'><div class='modal-content' style='border-radius: 5px;'><div class='modal-header'><div class='row'><div class='col-md-12'><h5 class='modal-title modltitletext' style='padding-bottom: 0px;padding-top: 0px;' id='exampleModalLabel' >Qaulity Parameter</h5></div></div></div><div class='modal-body table-responsive'><div class='boxer' id='qua_par_"+full['DT_RowIndex']+"'></div></div><div class='modal-footer'><center><small style='text-align: center;' id='footer_ok_btn"+full['DT_RowIndex']+"'></small><small style='text-align: center;' id='footer_quality_btn"+full['DT_RowIndex']+"'></small></center></div></div></div></div>";
  ...
  $(document).ready(function() {
    ...
    $('#ProceedBtnId').click(function(){
     ...
     var accCodeValue         =  $('#accCodeValue').val();
     ...
     var QtyValue             =  $('#QtyValue').val();
      ...
      $('#accCodeValues').val(accCodeValue);
     ...
     var vr_num = '';
      ...
      if (plantCodeOperator!='' || plantCodeValue!='' || seriesCodeOperator!='' || seriesCodeValue!='' || profitCenterOperator!='' || profitCenterValue!='' || accCodeOperator!='' || accCodeValue!='' || QtyOperator!='' || QtyValue!='' || from_date!='' || to_date!='' || item_code!='' || vr_num!='') {
            

          $('#PurchaseIndentReportTable').DataTable().destroy();

          load_data_query(plantCodeOperator,plantCodeValue,seriesCodeOperator,seriesCodeValue,profitCenterOperator,profitCenterValue,accCodeOperator,accCodeValue,QtyOperator,QtyValue,from_date,to_date,item_code,vr_num);
    ...
    $('#btnsearch').click(function(){
          ...
          if (plantCodeOperator!='' || plantCodeValue!='' || seriesCodeOperator!='' || seriesCodeValue!='' || profitCenterOperator!='' || profitCenterValue=='' || accCodeOperator=='' || accCodeValue=='' || QtyOperator=='' || QtyValue=='' || from_date=='' || to_date=='' || item_code=='' || vr_num=='') {
            ...
            if(item_code==''){
                $('#show_err_item_code').html('Please select Item code').css('color','red');
                return false;
              }
   ...
   var pageName = 'purchaseEnquery';
    ...
    $.ajaxSetup({
        ...
        $.ajax({
            ...
            data: {ItemCode:ItemCode,pageName:pageName}, // here $(this) refers to the ajax object not form
...
function showAllParty(srNo,headid,bodyId,vrNo){

      var headid,bodyId,vrNo;
        ...
        $.ajax({
              ...
              url:"{{ url('/get-vendor-for-enquiry-report') }}",
                 ...
                 // console.log(data1);
                  ...
                  if (data1.response == 'error') {
                      ...
                      if(data1.data==''){
                        ...
                        $('#allAccData'+srNo).empty();
                        var headData = '<div class="box-row" id="appendbody'+srNo+'"><div class="box10 texIndbox1">Sr.No.</div><div class="box10 rateIndbox">Acc Code</div><div class="box10 rateIndbox">Acc Name</div></div></div>';
                      $('#allAccData'+srNo).append(headData);
                        ...
                        $.each(obj_row, function (i, obj_row) {
                            ...
                            srac++;
                            $('#allAccData'+srNo).append(bodyData);
                        });
                      }
