...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-indent/indent-pending-complete-report') }}">Indent Pending/Complete/All</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Indent Pending/Complete/All Report</h2>
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                      ...
                      <label for="exampleInputEmail1">Indent No. :</label>
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="indentNo" id="IndentNo" name="IndentNo" class="form-control  pull-left" value="{{ old('IndentNo')}}" placeholder="Select Indent Number" autocomplete="off">



                          <datalist id="indentNo">

                            <option selected="selected" value="">-- Select --</option>

                            @foreach ($PINDENT as $key)
                            ...
                            <?php 
                              ...
                              $indentNo = $fyBeg.' '.$getSeries.' '.$getVRNO;
                            ?>

                            <option value='<?php echo $indentNo; ?>'   data-xyz ="<?php echo $indentNo; ?>" ><?php echo $indentNo; ?></option>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="plantCodeList" id="plantCode" name="plantCode" class="form-control  pull-left" value="{{ old('plantCode')}}" placeholder="Select Plant" autocomplete="off">
...
<script type="text/javascript">
  ...
  function load_data_query(IndentNo='',plantCode='',item_code='',from_date='',to_date='',ReportTypes=''){
    ...
    console.log('ReportType',ReportTypes);
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-pending-complete-indent") }}',
            data: {IndentNo:IndentNo,plantCode:plantCode,item_code:item_code,from_date:from_date,to_date:to_date,ReportTypes:ReportTypes}
          },
          columns: [
  ...
  $(document).ready(function() {
    ...
    $('#btnsearch').click(function(){
          ...
          if (from_date!='' || to_date!='' || plantCode=='' || IndentNo=='' || item_code=='' || ReportTypes=='') {
            ...
            load_data_query(IndentNo,plantCode,item_code,from_date,to_date,ReportTypes);
