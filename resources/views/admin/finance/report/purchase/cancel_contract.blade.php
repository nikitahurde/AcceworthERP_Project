...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-contract/contract-cancel') }}">Cancel Contract</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Cancel Contract </h2>
...
<script>
  function updateContractQty(chid,cbid,aumfac,srno,recqty,rate,issuedQty,cancelQty){
    ...
    var item_code   =  $('#item_code').val();
        ...
        $.ajax({
            ...
            url:"{{ url('/update-contract-cancel-qty') }}",

            method : "POST",

            type: "JSON",

            data: {PCNTRHID:PCNTRHID,PCNTRBID:PCNTRBID,AUMFACT:AUMFACT,CANCELQTY:CANCELQTY,QTYRECD:QTYRECD,RATE:RATE,QTYISSUED:QTYISSUED,QTYCANCEL:QTYCANCEL},
  ...
  function load_data_query(ContractNo='',item_code='',from_date='',to_date=''){
    ...
    console.log('to_date',to_date);
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-cancel-contract") }}',
