...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <h1>
            ...
            Purchase Quotation Monthly Report
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Purchase Quotation Monthly Report</h2>
 ...
 //alert(code);return false;
   ...
   if(codes == ''){
    ...
    $.ajaxSetup({
      ...
      window.location.href = "{{ url('/report/purchase/purchase-monthly-quatation/purchase-monthly-quatation-excel/') }}"+'/'+from_date+'/'+to_date+'/'+code;
  ...
  function load_data_query(from_date='',to_date='',code=''){
   ...
   /* var column_titles = table.column_titles.map(function(header) {
     ...
     //$('#example').DataTable().destroy();
      ...
      $.ajax({
      url: '{{ url("/get-data-from-query-monthly-purchase-quotation") }}',
