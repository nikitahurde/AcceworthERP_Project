...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-order-report') }}">Purchase Bill Rep.</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Purchase Bill Report</h2>
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <datalist id="vrnoList">
                            ...
                            <option value='<?php echo $key->VRNO?>'><?php echo $key->VRNO; ?></option>
...
<script type="text/javascript">
  ...
  function excelReportBtn(getExcelName){
    ...
    if(getExcelName == 'tax_excel'){
      ...
      window.location.href = "{{ url('/report/purchase/purchase-bill/purchase-bill-report-excel/') }}"+'/'+from_date+'/'+to_date+'/'+vrn+'/'+item_code+'/'+seriesCodeOperator+'/'+seriesCodeValue+'/'+plantCodeOperator+'/'+plantCodeValue+'/'+profitCenterOperator+'/'+profitCenterValue+'/'+accCodeOperator+'/'+accCode+'/'+costCetOperator+'/'+costCetCode+'/'+QtyOperator+'/'+QtyValue;
...
load_data_query()
  function load_data_query(seriesCodeOperator='',seriesCodeValue='',plantCodeOperator='',plantCodeValue='',profitCenterOperator='',profitCenterValue='',accCodeOperator='',accCode='',costCetOperator='',costCetCode='',QtyOperator='',QtyValue='',from_date='',to_date='',item_code='',vr_num=''){
    //  alert(acct_code);
  ...
  $(document).ready(function() {
    ...
    var vr_num = '';
      ...
      if (seriesCodeOperator!='' || seriesCodeValue!='' || plantCodeOperator!='' || plantCodeValue!='' || profitCenterOperator!='' || profitCenterValue!='' || accCodeOperator!='' || accCode!='' || costCetOperator!='' || costCetCode!='' || QtyOperator!='' || QtyValue!='' || from_date!='' || to_date!='' || item_code == '' || vr_num =='') {
            

          $('#PurchaseIndentReportTable').DataTable().destroy();

          load_data_query(seriesCodeOperator,seriesCodeValue,plantCodeOperator,plantCodeValue,profitCenterOperator,profitCenterValue,accCodeOperator,accCode,costCetOperator,costCetCode,QtyOperator,QtyValue,from_date,to_date,item_code,vr_num);
    ...
    $('#btnsearch').click(function(){
          ...
          if (bank_code!=''  || from_date!='' || to_date!='' || vr_num!='' || plantCodeOperator=='' || plantCodeValue=='' || seriesCodeOperator=='' || seriesCodeValue=='' || profitCenterOperator=='' || profitCenterValue=='' || QtyOperator=='' || QtyValue=='' || AccCodeId=='' || accCodeOperator=='' || accCode=='' || item_code=='') {
            ...
            if(item_code==''){
                $('#show_err_acct_code').html('Please select item code').css('color','red');
                return false;
              }
...
function showCalTax(srNo,headid,bodyId){
      ...
      var headid,bodyId;
      var tblName = 'PBILL_TAX';
      var tblName1 = 'PBILL_HEAD';
      var headIdName = 'PBILLHID';
      var bodyIdName = 'PBILLBID';
                ...
                return false;
                            ...
                            $.ajaxSetup({
                             ...
                             $.ajax({
                                ...
                                url:"{{ url('/report/purchase-bill/pdf') }}",
