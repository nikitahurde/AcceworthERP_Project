...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-order/order-cancel') }}">Cancel Order</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Cancel Order </h2>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="OrderNoList" id="OrderNo" name="OrderNo" class="form-control  pull-left" value="{{ old('OrderNo')}}" placeholder="Select Order Number" autocomplete="off">
                          ...
                          <datalist id="OrderNoList">
                            ...
                            <?php 
                              ...
                              $orderNo = $fyBeg.' '.$getSeries.' '.$getVRNO;
                            ?>

                            <option value='<?php echo $orderNo; ?>'   data-xyz ="<?php echo $orderNo; ?>" ><?php echo $orderNo; ?></option>
...
<script>
  function updateOrderQty(orhid,orbid,aumfac,srno,recqty,rate,taxcode,issuedQty,cancelQty){
    ...
    var item_code   =  $('#item_code').val();
        ...
        $.ajax({
            ...
            url:"{{ url('/update-order-cancel-qty') }}",

            method : "POST",

            type: "JSON",

            data: {PORDERHID:PORDERHID,PORDERBID:PORDERBID,AUMFACT:AUMFACT,CANCELQTY:CANCELQTY,QTYRECD:QTYRECD,TAXCODE:TAXCODE,RATE:RATE,QTYISSUED:QTYISSUED,QTYCANCEL:QTYCANCEL},
            ...
            success:function(data){
              ...
              if (data1.response == 'Qty Error') {
                  ...
                  $("#QtyAlertModal").modal('show');
                   ...
                   /*console.log('calTax ',data1.calTax);
                  console.log('basic ',data1.data);*/
                  // $('#taxBlcAmt_'+getSrNo+'_'+1).val(data1.data);
                  // getGrandTotal(getSrNo,data1.calTax,data1.data,PORDERHID,PORDERBID);

                  $('#PurchaseIndentReportTable').DataTable().destroy();

                  load_data_query(OrderNo,item_code,from_date,to_date);

                  //$('#getMsg_'+getSrNo).html('Qty Updated...!');
...
<script type="text/javascript">
  ...
  function load_data_query(OrderNo='',item_code='',from_date='',to_date=''){
    ...
    console.log('to_date',to_date);
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-cancel-order") }}',
            data: {OrderNo:OrderNo,item_code:item_code,from_date:from_date,to_date:to_date}
          },
          columns: [
            ...
            },
            {
                render: function (data, type, full, meta){
                  ...
                  var REMANINGQTY = full['QTYRECD'] - full['QTYISSUED'];
  ...
  $(document).ready(function() {
    ...
    $('#btnsearch').click(function(){
          ...
          if (from_date!='' || to_date!='' || OrderNo=='' || item_code=='' ) {
