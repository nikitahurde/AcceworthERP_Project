...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-grn/grn-pending-complete-report') }}">GRN Pending/Complete/All</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> GRN Pending/Complete/All Report</h2>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="GrnNoList" id="GrnNo" name="GrnNo" class="form-control  pull-left" value="{{ old('GrnNo')}}" placeholder="Select GRN Number" autocomplete="off">
...
<script type="text/javascript">
  ...
  function load_data_query(GrnNo='',accCode='',item_code='',from_date='',to_date='',ReportTypes=''){
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-pending-complete-grn") }}',
            data: {GrnNo:GrnNo,accCode:accCode,item_code:item_code,from_date:from_date,to_date:to_date,ReportTypes:ReportTypes}
          },
          columns: [
            ...
            },
            {
                ...
                render: function (data, type, full, meta){
                  ...
                  var itemName = '<div>'+full['QTYRECED']+' <small class="label label-success">'+full['UM_CODE']+'</small></div>';
                  return itemName;
            ...
            },
            {
              ...
              render: function (data, type, full, meta){
                ...
                }else if(full['PBILLHID']!=0 && full['PBILLBID']!=0){
  ...
  $(document).ready(function() {
    ...
    $('#btnsearch').click(function(){
          ...
          if (from_date!='' || to_date!='' || accCode=='' || GrnNo=='' || item_code=='' || ReportTypes=='') {
            ...
            load_data_query(GrnNo,accCode,item_code,from_date,to_date,ReportTypes);
