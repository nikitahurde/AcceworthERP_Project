...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-quotation/quotation-pending-complete-report') }}">Quotation Pending/Complete/All</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Quotation Pending/Complete/All Report</h2>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="quotationNoList" id="quotationNo" name="quotationNo" class="form-control  pull-left" value="{{ old('quotationNo')}}" placeholder="Select Indent Number" autocomplete="off">
...
<script type="text/javascript">
  ...
  function load_data_query(quotationNos='',accCode='',item_code='',from_date='',to_date='',ReportTypes=''){

    console.log('quotationNos',quotationNos);
    ...
    var qcsNo = quotationNos.split(' ');

    var quotationNo = qcsNo[1];
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-pending-complete-quotation") }}',
          ...
          columns: [
            ...
            },
            {
                ...
                var result = full['FY_CODE'].split('-');

                var fyNew = result[0];

                var itemName = '<p>'+fyNew+'</p>'+'<p style="line-height:2px;">'+full['PQCSNO']+'<input type="hidden" id="ItemCodeId'+full['DT_RowIndex']+'" value="'+fyNew+'"></p>';
                return itemName;
