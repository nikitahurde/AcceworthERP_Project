...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-quotation/quotation-cancel') }}">Cancel Quotation</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Cancel Quotation </h2>
...
<script>
  function updateQuotationQty(qcshid,qcsbid,srno,recqty,rate,qtyIssue,qtyCancel){

    var PQCSHID     = qcshid;
    var PQCSBID     = qcsbid;
    var QTYRECD     = recqty;
    var QTYISSUED   = qtyIssue;
    var RATE        = rate;
    var CANCELQTY   = $('#cancelQty_'+srno).val();
    var QTYCANCEL   = qtyCancel;
    var getSrNo     = srno;
    ...
    var item_code   =  $('#item_code').val();
        ...
        $.ajax({
            ...
            url:"{{ url('/update-quotation-cancel-qty') }}",

            method : "POST",

            type: "JSON",

            data: {PQCSHID:PQCSHID,PQCSBID:PQCSBID,CANCELQTY:CANCELQTY,QTYRECD:QTYRECD,RATE:RATE,QTYISSUED:QTYISSUED,QTYCANCEL:QTYCANCEL},
  ...
  function getGrandTotal(rowno,taxD,basic,PqheadId,PqBodyId){
      
      var amtAr = [];
      var pqTax = [];
      amtAr.push(null);
      amtAr.push(basic);
      var pqTaxB = taxD[0].PQTNTID;
      pqTax.push(pqTaxB);
      ...
      $.ajaxSetup({
        ...
        $.ajax({
            ...
            url:"{{ url('/update-quotation-cancel-cal-tax-amt') }}",

            method : "POST",

            type: "JSON",

            data: {PqheadId:PqheadId,PqBodyId:PqBodyId,amtAr:amtAr,pqTax:pqTax},
  ...
  function load_data_query(QuotationNo='',item_code='',from_date='',to_date=''){
    ...
    console.log('to_date',to_date);
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-cancel-quotation") }}',
          ...
          columns: [
            ...
            },
            {
                ...
                var itemName = '<p>'+full['SERIES_CODE']+'</p>'+'<p style="line-height:2px;">'+full['PQCSNO']+'<input type="hidden" id="ItemCodeId'+full['DT_RowIndex']+'" value="'+full['PQCSNO']+'"></p>';
                return itemName;
