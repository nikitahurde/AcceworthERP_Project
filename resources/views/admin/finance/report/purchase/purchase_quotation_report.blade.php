...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-quotation-report') }}">Purchase Quotation Rep.</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Purchase Quotation Report</h2>
            ...
            <div class="box-body">
                ...
                <div class="col-md-3">
                 ...
                 <div class="col-md-3">
                   ...
                   <div class="form-group">
                      ...
                      <label for="exampleInputEmail1">QC No :</label>
                      ...
                      <div class="input-group">
                          ...
                          <datalist id="accountList">
                            ...
                            @foreach ($qc_list as $key)

                            

                            <option value='<?php echo $key->PQCSHID?>'   data-xyz ="<?php echo $key->PQCSHID; ?>" ><?php echo $key->PQCSHID; ?></option>
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="itemList" id="vr_num" name="vr_num" class="form-control  pull-left rightcontent" value="{{ old('trans_code')}}" placeholder="Enter vr no" autocomplete="off">
              ...
              <div class="row">
               ...
               <button type="button" class="btn btn-success" data-toggle="modal" data-target="#QueryModal" id="queryBtn"><i class="fa fa-hourglass" aria-hidden="true"></i> &nbsp;&nbsp;Query</button> 
...
<script type="text/javascript">
 ...
 function plantQueryOperator(getVal){
  ...
  function excelReportBtn(type){
   ...
   var item_codes = $("#vr_num").val();
   var acct_codes = $("#acct_code").val();
   ...
   var plantCodeOperators    =  $('#plantCodeOperators').val();
    ...
    $.ajaxSetup({
      ...
      window.location.href = "{{ url('/report/purchase/purchase-quotation/purchase-quotation-report-excel/') }}"+'/'+item_code+'/'+acct_code+'/'+plantCodeOperator+'/'+plantCodeValue+'/'+seriesCodeOperator+'/'+seriesCodeValue+'/'+profitCenterOperator+'/'+profitCenterValue+'/'+accCodeOperator+'/'+accCode+'/'+QtyOperator+'/'+QtyValue+'/'+from_date+'/'+to_date+'/'+ReportTypes+'/'+type;
...
load_data_query()
  function load_data_query(plantCodeOperator= '', plantCodeValue='',seriesCodeOperator='',seriesCodeValue='',profitCenterOperator='',profitCenterValue='',QtyOperator= '', QtyValue='',accCodeOperator='',accCode='',bank_code= '', acct_code='',from_date='',to_date='',vr_num='',ReportTypes=''){
    ...
    console.log('vr_num',vr_num);
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-from-query-purchase-quotation") }}',
            data: {plantCodeOperator:plantCodeOperator,plantCodeValue:plantCodeValue,seriesCodeOperator:seriesCodeOperator,seriesCodeValue:seriesCodeValue,profitCenterOperator:profitCenterOperator,profitCenterValue:profitCenterValue,QtyOperator:QtyOperator,QtyValue:QtyValue,accCodeOperator:accCodeOperator,accCode:accCode,bank_code:bank_code,acct_code:acct_code,vr_num:vr_num,from_date:from_date,to_date:to_date,ReportTypes:ReportTypes}
          },
          columns: [
            ...
            },
            {
              render: function (data, type, full, meta){
                ...
                var itemName = '<p>'+full['ITEM_NAME']+'</p>'+'<p style="line-height:2px;">('+full['ITEM_CODE']+')<input type="hidden" id="ItemCodeId'+full['DT_RowIndex']+'" value="'+full['ITEM_CODE']+'"><input type="hidden" id="PurQuoHeadId'+full['DT_RowIndex']+'" value="'+full['PQCSHID']+'"><input type="hidden" id="PurQuoBodyId'+full['DT_RowIndex']+'" value="'+full['PQCSBID']+'"></p>';
                return itemName;
            ...
            },
            {
              ...
              render: function (data, type, full, meta){
                ...
                console.log('getBtb ',data['PQCSHID']);
                var GetBtn = '<button type="button" class="btn btn-primary btn-xs notification" id="veiwPdetail_'+full['DT_RowIndex']+'" data-toggle="modal" data-target="#viewPartyDetail_'+full['DT_RowIndex']+'" onclick="showCalTax('+full['DT_RowIndex']+','+data['PQTNHID']+','+data['PQTNBID']+')" style="padding-bottom: 0px;padding-top: 0px;margin-top: 5%;">Calc. Tax</button><button type="button" class="btn btn-primary btn-xs notification" id="veiwQuaParDetails_'+full['DT_RowIndex']+'" data-toggle="modal" data-target="#viewQualityParDetail_'+full['DT_RowIndex']+'" onclick="showQuaParDetails('+full['DT_RowIndex']+','+data['PQTNHID']+','+data['PQTNBID']+')" style="padding-bottom: 0px;padding-top: 0px;margin-top: 3%;">Quality Para.</button><div class="modal fade" id="viewPartyDetail_'+full['DT_RowIndex']+'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><div class="modal-dialog modal-md" role="document" style="margin-top: 5%;"><div class="modal-content" style="border-radius: 5px;"><div class="modal-header"><div class="row"><div class="col-md-12"><h5 class="modal-title modltitletext" id="exampleModalLabel">Tax / Charges / etc Calculation <br> Tax Code - <span id="showTaxCode"></span></h5></div></div></div><div class="modal-body table-responsive"><div class="boxer" id="getCalTaxData'+full['DT_RowIndex']+'"></div><div class="modal-footer" style="text-align: center;"><button type="button" class="btn btn-primary" data-dismiss="modal" style="padding-left: 25px;padding-right: 25px;">Ok</button></div></div></div></div></div><div class="modal fade" id="viewQualityParDetail_'+full['DT_RowIndex']+'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><div class="modal-dialog modal-md" role="document" style="margin-top: 5%;"><div class="modal-content" style="border-radius: 5px;"><div class="modal-header"><div class="row"><div class="col-md-12"><h5 class="modal-title modltitletext" id="exampleModalLabel"> Qaulity Parameter <span id="showItemName"></span> <br> [ <span id="showItemCode"></span> ]</h5></div></div></div><div class="modal-body table-responsive"><div class="boxer" id="getQuaParData'+full['DT_RowIndex']+'"></div><div class="modal-footer" style="text-align: center;"><button type="button" class="btn btn-primary" data-dismiss="modal" style="padding-left: 25px;padding-right: 25px;">Ok</button></div></div></div></div>';
  ...
  $(document).ready(function() {
    ...
    $('#ProceedBtnId').click(function(){
     ...
     var vr_num = '';
      ...
      if (plantCodeOperator!='' || plantCodeValue!='' || seriesCodeOperator!='' || seriesCodeValue!='' || profitCenterOperator!='' || profitCenterValue!='' || QtyOperator!='' || QtyValue!='' || accCodeOperator!='' || accCode!='' || from_date == '' || to_date =='' || bank_code=='' || acct_code=='' || vr_num=='' || ReportTypes!= '') {
            

          $('#PurchaseIndentReportTable').DataTable().destroy();

          load_data_query(plantCodeOperator,plantCodeValue,seriesCodeOperator,seriesCodeValue,profitCenterOperator,profitCenterValue,QtyOperator,QtyValue,accCodeOperator,accCode,bank_code,acct_code,from_date,to_date,vr_num,ReportTypes);
    ...
    $('#btnsearch').click(function(){
          ...
          if (bank_code!='' || acct_code!='' || from_date!='' || to_date!='' || vr_num!='' || plantCodeOperator=='' || plantCodeValue=='' || seriesCodeOperator=='' || seriesCodeValue=='' || profitCenterOperator=='' || profitCenterValue=='' || QtyOperator=='' || QtyValue=='' || AccCodeId=='' || accCodeOperator=='' || accCode=='' || ReportTypes=='') {
  ...
  function showCalTax(srNo,headid,bodyId){
      ...
      var headid,bodyId;
        ...
        $.ajax({
              ...
              url:"{{ url('/get-calTax-for-enquiry-reports') }}",
    ...
    function showQuaParDetails(srNo,headid,bodyId){
        ...
        var pageName = 'purchaseQuotation';
        var ItemCode = '';
                ...
                return false;
                            ...
                            $.ajaxSetup({
                             ...
                             $.ajax({
                                ...
                                url:"{{ url('/report/purchase-quotation/pdf') }}",
