...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-grn/grn-cancel') }}">Cancel GRN</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Cancel GRN </h2>
                ...
                <div class="col-md-3">
                 ...
                 <div class="col-md-3">
                    ...
                    <div class="form-group">
                      ...
                      <label for="exampleInputEmail1">Grn No. :</label>
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="GrnNoList" id="GrnNo" name="GrnNo" class="form-control  pull-left" value="{{ old('GrnNo')}}" placeholder="Select Order Number" autocomplete="off">
                          ...
                          <datalist id="GrnNoList">
                            ...
                            <?php 
                              ...
                              $GrnNo = $fyBeg.' '.$getSeries.' '.$getVRNO;
                            ?>

                            <option value='<?php echo $GrnNo; ?>'   data-xyz ="<?php echo $GrnNo; ?>" ><?php echo $GrnNo; ?></option>
...
<script>
  function updateGrnQty(grnhid,grnbid,aumfac,srno,recqty,rate,taxcode,cancelQty){
    ...
    var item_code   =  $('#item_code').val();
        ...
        $.ajax({
            ...
            url:"{{ url('/update-grn-cancel-qty') }}",

            method : "POST",

            type: "JSON",

            data: {GRNHID:GRNHID,GRNBID:GRNBID,AUMFACT:AUMFACT,CANCELQTY:CANCELQTY,QTYRECD:QTYRECD,TAXCODE:TAXCODE,RATE:RATE,QTYCANCEL:QTYCANCEL},
            ...
            success:function(data){
              ...
              if (data1.response == 'error') {
                  ...
                  load_data_query(GrnNo,item_code,from_date,to_date);
  ...
  function getGrandTotal(rowno,taxD,basic,GrnheadId,GrnBodyId){
      
      var amtAr = [];
      var pcTax = [];
      amtAr.push(null);
      amtAr.push(basic);
      var pcTaxB = taxD[0].GRNTID;
      pcTax.push(pcTaxB);
      ...
      $.ajaxSetup({
        ...
        $.ajax({
            ...
            url:"{{ url('/update-grn-cancel-cal-tax-amt') }}",

            method : "POST",

            type: "JSON",

            data: {GrnheadId:GrnheadId,GrnBodyId:GrnBodyId,amtAr:amtAr,pcTax:pcTax},
...
<script type="text/javascript">
  ...
  function load_data_query(GrnNo='',item_code='',from_date='',to_date=''){
    ...
    console.log('to_date',to_date);
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-cancel-grn") }}',
            data: {GrnNo:GrnNo,item_code:item_code,from_date:from_date,to_date:to_date}
          },
          columns: [
            ...
            },
            {
                render: function (data, type, full, meta){
                  ...
                  var finalQty = full['QTYRECD'] - full['QTYCANCEL'];
  ...
  $(document).ready(function() {
    ...
    $('#btnsearch').click(function(){
          ...
          $('#GrnNo').prop('readonly', 'true');
          $('#item_code').prop('readonly', 'true');


          if (from_date!='' || to_date!='' || GrnNo=='' || item_code=='' ) {
