...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/logistic/do-pending/pending-complete-report') }}">Order Pending/Complete/All</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> D.O Pending/Complete/All Report</h2>
                   ...
                   <div class="form-group">
                    ...
                    <label for="exampleInputEmail1"> From Date : </label>
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="from_date" id="from_date" class="form-control fromDatePc rightcontent" placeholder="Select Transaction Date" value="" autocomplete="off">
                 ...
                 <div class="col-md-3">
                   ...
                   <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="to_date" id="to_date" class="form-control toDatePc rightcontent" placeholder="Select Transaction Date" value="" autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="orderNoList" id="orderNo" name="orderNo" class="form-control  pull-left" value="" placeholder="Select Order Number" autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="AccCodeList" id="accCode" name="accCode" class="form-control  pull-left" value="" placeholder="Select Account No." autocomplete="off">
...
<script type="text/javascript">
  ...
  function load_data_query(orderNo='',accCode='',item_code='',from_date='',to_date='',ReportTypes=''){
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-pending-complete-order") }}',
            data: {orderNo:orderNo,accCode:accCode,item_code:item_code,from_date:from_date,to_date:to_date,ReportTypes:ReportTypes}
          },
          columns: [
            ...
            },
            {
                ...
                render: function (data, type, full, meta){
                  ...
                  var itemName1 = '<div>'+ full['QTYRECD']+' <small class="label label-success">'+full['UM']+'</small></div>';
                  return itemName1;
            ...
            },
            {
                ...
                var itemName = '<div>'+full['QTYISSUED']+'</div>';
                return itemName;
            ...
            },
            {
                ...
                var itemName = '<div>'+full['QTYCANCEL']+'</div>';
                return itemName;
            ...
            },
            {
              ...
              render: function (data, type, full, meta){
                ...
                }else if(full['GRNHID']!=0 && full['GRNBID']!=0){
  ...
  $(document).ready(function() {
    ...
    $('#btnsearch').click(function(){
          ...
          if (from_date!='' || to_date!='' || accCode=='' || orderNo=='' || item_code=='' || ReportTypes=='') {
            ...
            load_data_query(orderNo,accCode,item_code,from_date,to_date,ReportTypes);
