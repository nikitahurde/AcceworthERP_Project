...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <h1>
            ...
            Gate Inward
            <small> : Pending Report Details</small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/reports/logistic/pending-gate-inward') }}">Gate Inward Pending Report</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Gate Inward Pending Report </h2>
