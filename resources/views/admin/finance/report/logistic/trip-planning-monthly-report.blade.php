...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/logistic/trip-planning/monthly-trip-planning-report') }}">Trip-Planning Monthly Report</a></li>
...
<section class="content">
    ...
    <div class="box box-primary Custom-Box">
        ...
        <div class="box-header with-border" style="text-align: center;">
          ...
          <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Trip-Planning Monthly Report</h2>
        ...
        <div class="box-body">
                ...
                <div class="col-md-3">
                   ...
                   <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="to_date" id="to_date" class="form-control toDatePc rightcontent" placeholder="Select Transaction Date" value="{{$vrDate}}" autocomplete="off">
        	...
        	<div class="box-body" style="margin-top: 1%;">
                ...
                <table id="tripPlanReportTbl" class="table table-bordered table-striped table-hover">
                  <thead class="theadC">
                    ...
                    <tr>
                      ...
                      <th class="text-center">Transpoter Name/Code</th>
...
function load_data_query(vehicleType= '', from_date='',to_date='',Consinee='',transpAgent='',from_place='',to_place=''){
      ...
      $('#tripPlanReportTbl').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-trip-planning-report") }}',
            data: {vehicleType:vehicleType,from_date:from_date,to_date:to_date,Consinee:Consinee,transpAgent:transpAgent,from_place:from_place,to_place:to_place}
          },
          columns: [
...
/* ..........START : Search Button Click ......... */
    ...
    $('#ProceedBtnId').click(function(){
		...
		console.log('transpAgent',transpAgent);
        ...
        $("#to_date").prop('readonly',true);        
      	...
      	if (vehicleType=='' || from_date=='' || to_date=='' || Consinee=='' || transpAgent=='' || from_place=='' || to_place=='') {
	        ...
	        load_data_query(vehicleType,from_date,to_date,Consinee,transpAgent,from_place,to_place);
