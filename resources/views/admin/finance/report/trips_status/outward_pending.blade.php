  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="Active"><a href="{{ URL('/Dashboard/Trips-status')}}">Pending Outward - Trips</a></li>



            <li class="Active"><a href="{{ URL('/Dashboard/Trips-status')}}">View Pending Outward- Trips</a></li>
            ...
            <div class="col-xs-12">
              ...
              <div class="box box-primary Custom-Box">
                ...
                <div class="box-header with-border" style="text-align: center;">
                  ...
                  <h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme">View Pending Outward - Trips</h3>
   ...
   buttons: [
                {
                  ...
                  title: 'PENDING_OUTWARD'+$("#headerexcelDt").val(),
                  filename: 'PENDING_OUTWARD'+$("#headerexcelDt").val(),
                  footer: true
                }
    ],

  ajax:{
        url:'{{ url("/Trips/pending-outward-trip-status") }}',
