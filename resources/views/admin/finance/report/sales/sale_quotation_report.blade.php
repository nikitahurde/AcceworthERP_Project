...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-quotation-report') }}">Sales Quotation Rep.</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Sales Quotation Report</h2>
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="vrNoList" id="vr_num" name="vr_num" class="form-control  pull-left rightcontent" value="{{ old('vr_num')}}" placeholder="Enter Vr. No" autocomplete="off">
  ...
  function excelReportBtn(type){
   ...
   var pageName = 'purchaseIndent';
    ...
    $.ajaxSetup({
      ...
      window.location.href = "{{ url('/report/sale/sale-quotation/sale-quotation-report-excel/') }}"+'/'+item_code+'/'+vr_num+'/'+plantCodeOperator+'/'+plantCodeValue+'/'+seriesCodeOperator+'/'+seriesCodeValue+'/'+profitCenterOperator+'/'+profitCenterValue+'/'+accCodeOperator+'/'+accCode+'/'+QtyOperator+'/'+QtyValue+'/'+from_date+'/'+to_date+'/'+ReportTypes+'/'+type;
  ...
  function load_data_query(plantCodeOperator= '', plantCodeValue='',seriesCodeOperator='',seriesCodeValue='',profitCenterOperator='',profitCenterValue='',QtyOperator= '', QtyValue='',accCodeOperator='',accCode='',bank_code= '',from_date='',to_date='',vr_num='',item_code='',ReportTypes=''){
    ...
    console.log('AmountValueId',AmountValueId);*/
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-from-query-sales-quotation") }}',
          ...
          columns: [
            ...
            },
            {
                ...
                render: function (data, type, full, meta){
                  ...
                  var party = full['ACC_NAME']+' '+'('+full['ACC_CODE']+')';
                  return party;
...
/*getQuaParData*/
  $(document).ready(function() {
    ...
    $('#btnsearch').click(function(){
          ...
          if (bank_code!='' || acct_code!='' || from_date!='' || to_date!='' || vr_num!='' || plantCodeOperator=='' || plantCodeValue=='' || seriesCodeOperator=='' || seriesCodeValue=='' || profitCenterOperator=='' || profitCenterValue=='' || QtyOperator=='' || QtyValue=='' || AccCodeId=='' || accCodeOperator=='' || accCode=='' || item_code=='' || ReportTypes=='') {
