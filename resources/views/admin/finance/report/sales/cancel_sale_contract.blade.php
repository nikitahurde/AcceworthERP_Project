...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/sales/sale-contract/sale-contract-cancel-report') }}">Cancel Sales Contract</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Cancel Sales Contract </h2>
   ...
   <div class="box-body" style="margin-top: -2%;">
       ...
       <button type="button" id="btnpdf" class="btn btn-danger btn-sm" style="margin-left: 71px !important;
                margin-bottom: -49px !important;"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Pdf 
...
<script>
  function updateContractQty(schid,scbid,srno,issuedqty,rate,orderQty,cancelQty){
    ...
    var item_code   =  $('#item_code').val();
        ...
        $.ajax({
            ...
            url:"{{ url('/update-sale-contract-cancel-qty') }}",

            method : "POST",

            type: "JSON",

            data: {SCNTRHID:SCNTRHID,SCNTRBID:SCNTRBID,CANCELQTY:CANCELQTY,QTYISSUED:QTYISSUED,RATE:RATE,ORDERQTY:ORDERQTY,QTYCANCEL:QTYCANCEL},
            ...
            success:function(data){
              ...
              if (data1.response == 'Qty Error') {
                  ...
                  load_data_query(ContractNo,item_code,from_date,to_date);
...
<script type="text/javascript">
  ...
  function load_data_query(ContractNo='',item_code='',from_date='',to_date=''){
    ...
    console.log('to_date',to_date);
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-cancel-sale-contract") }}',
            data: {ContractNo:ContractNo,item_code:item_code,from_date:from_date,to_date:to_date}
          },
          columns: [
            ...
            },
            {
                ...
                render: function (data, type, full, meta){
                  ...
                  var REMANINGQTY = full['QTYISSUED'] - full['ORDERQTY'];
  ...
  $(document).ready(function() {
    ...
    $('#btnsearch').click(function(){
          ...
          if (from_date!='' || to_date!='' || ContractNo=='' || item_code=='' ) {
