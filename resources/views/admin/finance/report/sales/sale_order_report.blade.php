...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-order-report') }}">Sales Order Rep.</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Sales Order Report</h2>
  ...
  //alert(vr_num);return false;
   ...
   var pageName = 'purchaseIndent';
    ...
    $.ajaxSetup({
      ...
      window.location.href = "{{ url('/report/sale/sale-order/sale-order-report-excel/') }}"+'/'+item_code+'/'+vr_num+'/'+plantCodeOperator+'/'+plantCodeValue+'/'+seriesCodeOperator+'/'+seriesCodeValue+'/'+profitCenterOperator+'/'+profitCenterValue+'/'+accCodeOperator+'/'+accCode+'/'+QtyOperator+'/'+QtyValue+'/'+from_date+'/'+to_date+'/'+ReportTypes+'/'+type;
  ...
  function load_data_query(plantCodeOperator= '', plantCodeValue='',seriesCodeOperator='',seriesCodeValue='',profitCenterOperator='',profitCenterValue='',QtyOperator= '', QtyValue='',accCodeOperator='',accCode='',bank_code= '',from_date='',to_date='',vr_num='',item_code='',ReportTypes=''){
    ...
    console.log('AmountValueId',AmountValueId);*/
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-from-query-sales-order") }}',
          ...
          columns: [
            ...
            },
            {
              ...
              render: function (data, type, full, meta){
                ...
                }else if(full['SCHALLANHID']!=0 && full['SCHALLANBID']!=0){
