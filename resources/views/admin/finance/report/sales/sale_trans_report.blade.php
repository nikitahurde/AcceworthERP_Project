...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-quotation-report') }}">Sales Trans Rep.</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Sales Trans Report</h2>
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="itemList" id="item_code" name="item_code" class="form-control  pull-left rightcontent" value="{{ old('item_code')}}" placeholder="Enter vr no" autocomplete="off">
                          ...
                          <datalist id="itemList">
                            ...
                            <option value='<?php echo $key->ITEM_CODE?>'   data-xyz ="<?php echo $key->ITEM_NAME; ?>" ><?php echo $key->ITEM_CODE ; ?><?php echo $key->ITEM_NAME ; ?></option>
               ...
               <button type="button" class="btn btn-primary" name="searchdata" id="btnsearch"><i class="fa fa-search" aria-hidden="true"></i> &nbsp;&nbsp;Search</button>
                ...
                <button type="button" class="btn btn-default" name="searchdata" id="ResetId"><i class="fa fa-reply" aria-hidden="true"></i> &nbsp;&nbsp;Reset</button>
                 ...
                 <button type="button" class="btn btn-success" data-toggle="modal" data-target="#QueryModal"><i class="fa fa-hourglass" aria-hidden="true"></i> &nbsp;&nbsp;Query</button> 
                  ...
                  <button type="button" class="btn btn-danger" name="searchdata" onclick="excelReportBtn('month')" ><i class="fa fa-calendar" aria-hidden="true"></i> &nbsp;&nbsp;Month Summary</button>
...
//alert(vr_nums);return false;
   ...
   var pageName = 'purchaseIndent';
    ...
    $.ajaxSetup({
      ...
      window.location.href = "{{ url('/report/sale/sale-bill/sale-bill-report-excel/') }}"+'/'+item_code+'/'+vr_num+'/'+plantCodeOperator+'/'+plantCodeValue+'/'+seriesCodeOperator+'/'+seriesCodeValue+'/'+profitCenterOperator+'/'+profitCenterValue+'/'+accCodeOperator+'/'+accCode+'/'+QtyOperator+'/'+QtyValue+'/'+from_date+'/'+to_date+'/'+type;
...
load_data_query()
  function load_data_query(plantCodeOperator= '', plantCodeValue='',seriesCodeOperator='',seriesCodeValue='',profitCenterOperator='',profitCenterValue='',QtyOperator= '', QtyValue='',accCodeOperator='',accCode='',bank_code= '',from_date='',to_date='',vr_num='',item_code=''){
...
*/
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-from-query-sales-trans") }}',
            data: {plantCodeOperator:plantCodeOperator,plantCodeValue:plantCodeValue,seriesCodeOperator:seriesCodeOperator,seriesCodeValue:seriesCodeValue,profitCenterOperator:profitCenterOperator,profitCenterValue:profitCenterValue,QtyOperator:QtyOperator,QtyValue:QtyValue,accCodeOperator:accCodeOperator,accCode:accCode,bank_code:bank_code,vr_num:vr_num,item_code:item_code,from_date:from_date,to_date:to_date}
          },
          columns: [
            ...
            },*/   
            {
              ...
              render: function (data, type, full, meta){
                ...
                /*console.log('getBtb ',data['sale_quotation_head_id']);*/
  ...
  $(document).ready(function() {
   ...
   $('#ProceedBtnId').click(function(){
     ...
     var vr_num = '';
      ...
      if (plantCodeOperator!='' || plantCodeValue!='' || seriesCodeOperator!='' || seriesCodeValue!='' || profitCenterOperator!='' || profitCenterValue!='' || QtyOperator!='' || QtyValue!='' || accCodeOperator!='' || accCode!='' || from_date == '' || to_date =='' || bank_code=='' || vr_num=='' || item_code=='') {
            

          $('#PurchaseIndentReportTable').DataTable().destroy();

          load_data_query(plantCodeOperator,plantCodeValue,seriesCodeOperator,seriesCodeValue,profitCenterOperator,profitCenterValue,QtyOperator,QtyValue,accCodeOperator,accCode,bank_code,from_date,to_date,vr_num,item_code);
    ...
    $('#btnsearch').click(function(){
          ...
          if(bank_code!=''  || from_date!='' || to_date!='' || vr_num!='' || plantCodeOperator=='' || plantCodeValue=='' || seriesCodeOperator=='' || seriesCodeValue=='' || profitCenterOperator=='' || profitCenterValue=='' || QtyOperator=='' || QtyValue=='' || AccCodeId=='' || accCodeOperator=='' || accCode=='' || item_code=='') {
