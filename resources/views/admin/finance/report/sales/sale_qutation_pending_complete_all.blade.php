...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <h1>
            ...
            Quotation Pending/Complete/All
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/sales/sale-quotation/sale-quotation-pending-complete-report') }}">Quotation Pending/Complete/All</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Sale Quotation Pending/Complete/All Report</h2>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="quotationNoList" id="quotationNo" name="quotationNo" class="form-control  pull-left" value="{{ old('quotationNo')}}" placeholder="Select Quotation Number" autocomplete="off">
                ...
                <div class="col-md-6">
                    ...
                    <div class="" style="margin-top:6%;">
                     ...
                     <button type="button" class="btn btn-primary" name="searchdata" id="btnsearch"><i class="fa fa-search" aria-hidden="true"></i> &nbsp;&nbsp;Search</button>
                      ...
                      <button class="btn btn-primary" id="PindReprtExl"  onclick="excelReportBtn()" disabled=""><i class="fa fa-file-excel-o" aria-hidden="true"></i> <b>Excel</b></button>
...
<table id="PurchaseIndentReportTable" class="table table-bordered table-striped table-hover">
  <thead class="theadC">
    ...
    <tr>
      ...
      <th class="text-center">Issuced Qty</th>
...
<script type="text/javascript">
  ...
  function load_data_query(quotationNo='',accCode='',item_code='',from_date='',to_date='',ReportTypes=''){
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/report/sales/sale-quotation/sale-quotation-pending-complete-all-report") }}',
            data: {quotationNo:quotationNo,accCode:accCode,item_code:item_code,from_date:from_date,to_date:to_date,ReportTypes:ReportTypes}
          },
          columns: [
            ...
            },
            {
                ...
                var itemName = '<div>'+full['QTYISSUED']+' <small class="label label-success">'+full['UM']+'</small></div>';
                return itemName;
            ...
            },
            {
                ...
                var finalQty = full['QTYISSUED'] - full['QTYRECD'] - full['QTYCANCEL'];
  ...
  $(document).ready(function() {
    ...
    $('#btnsearch').click(function(){
          ...
          if (from_date!='' || to_date!='' || accCode=='' || quotationNo=='' || item_code=='' || ReportTypes=='') {
            ...
            load_data_query(quotationNo,accCode,item_code,from_date,to_date,ReportTypes);
