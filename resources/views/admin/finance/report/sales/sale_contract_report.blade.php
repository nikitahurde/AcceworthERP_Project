...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-quotation-report') }}">Sales Contract Rep.</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Sales Contract Report</h2>
  ...
  function excelReportBtn(type){
   ...
   var pageName = 'purchaseIndent';
    ...
    $.ajaxSetup({
      ...
      window.location.href = "{{ url('/report/sale/sale-contract/sale-contract-report-excel/') }}"+'/'+item_code+'/'+vr_num+'/'+plantCodeOperator+'/'+plantCodeValue+'/'+seriesCodeOperator+'/'+seriesCodeValue+'/'+profitCenterOperator+'/'+profitCenterValue+'/'+accCodeOperator+'/'+accCode+'/'+QtyOperator+'/'+QtyValue+'/'+from_date+'/'+to_date+'/'+ReportTypes+'/'+type;
  ...
  function load_data_query(plantCodeOperator= '', plantCodeValue='',seriesCodeOperator='',seriesCodeValue='',profitCenterOperator='',profitCenterValue='',QtyOperator= '', QtyValue='',accCodeOperator='',accCode='',bank_code= '',from_date='',to_date='',vr_num='',item_code='',ReportTypes=''){
    ...
    var getdate = getday+''+getMonth+''+getYear;
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-from-query-sales-contract") }}',
  ...
  $(document).ready(function() {
    ...
    $('#ResetId').click(function(){
      ...
      $('#accountText').html('');
            ...
            $("#PindReprtExl").prop('disabled',true);
  ...
  function showCalTax(srNo,headid,bodyId){
      ...
      var headid,bodyId;
        ...
        $.ajax({
              ...
              url:"{{ url('/get-calTax-for-salecont-reports') }}",
    ...
    function showQuaParDetails(srNo,headid,bodyId){
        ...
        $.ajax({
              ...
              url:"{{ url('/get-qua-sale-cont-reports') }}",
