...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <h1>
            ...
            Sales Quotation Monthly Report
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Sales Quotation Monthly Report</h2>
 ...
 //alert(code);return false;
   ...
   if(codes == ''){
    ...
    $.ajaxSetup({
      ...
      window.location.href = "{{ url('/report/sale/sale-monthly-quotation/sale-monthly-quotation-excel/') }}"+'/'+from_date+'/'+to_date+'/'+code;
...
/*getQuaParData*/
  $(document).ready(function() {
    ...
    $('#ProceedBtnId').click(function(){
            ...
            //alert(check_value);return false;
