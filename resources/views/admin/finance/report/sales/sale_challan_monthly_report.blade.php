...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-quotation-report') }}">Sales Challan Rep.</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Sales Challan Monthly Report</h2>
 ...
 //alert(code);return false;
   ...
   if(codes == ''){
    ...
    $.ajaxSetup({
      ...
      window.location.href = "{{ url('/report/sale/sale-monthly-challan/sale-monthly-challan-excel/') }}"+'/'+from_date+'/'+to_date+'/'+code;
  ...
  function load_data_query(from_date='',to_date='',code=''){
   ...
   /* var column_titles = table.column_titles.map(function(header) {
     ...
     //$('#example').DataTable().destroy();
      ...
      $.ajax({
      url: '{{ url("/get-data-from-query-monthly-sales-challan") }}',
