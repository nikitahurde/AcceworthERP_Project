...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/sales/sale-contract/sale-order-cancel-report') }}">Cancel Sales Order</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Cancel Sales Order </h2>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="OrderNoList" id="OrderNo" name="OrderNo" class="form-control  pull-left" value="{{ old('OrderNo')}}" placeholder="Select Contract Number" autocomplete="off">
...
<script>
  function updateOrderQty(sordhid,sordbid,srno,issuedqty,rate,challanQty,cancelQty){

    var SORDERHID   = sordhid;
    var SORDERBID   = sordbid;
    var QTYISSUED   = issuedqty;
    var RATE        = rate;
    var CANCELQTY   = $('#cancelQty_'+srno).val();
    var SCHALLANQTY = challanQty;
    ...
    var item_code   =  $('#item_code').val();
        ...
        $.ajax({
            ...
            url:"{{ url('/update-sale-order-cancel-qty') }}",

            method : "POST",

            type: "JSON",

            data: {SORDERHID:SORDERHID,SORDERBID:SORDERBID,CANCELQTY:CANCELQTY,QTYISSUED:QTYISSUED,RATE:RATE,SCHALLANQTY:SCHALLANQTY,QTYCANCEL:QTYCANCEL},
            ...
            success:function(data){
              ...
              if (data1.response == 'Qty Error') {
                  ...
                  getGrandTotal(getSrNo,data1.calTax,data1.data,PCNTRHID,PCNTRBID);*/
  ...
  function load_data_query(OrderNo='',item_code='',from_date='',to_date=''){
    ...
    console.log('to_date',to_date);
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/get-data-cancel-sale-order") }}',
