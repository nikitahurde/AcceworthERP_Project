...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/sales/sale-contract/sale-contract-pending-complete-report') }}">Order Pending/Complete/All</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Sale Order Pending/Complete/All Report</h2>
  ...
  function load_data_query(orderNo='',accCode='',item_code='',from_date='',to_date='',ReportTypes=''){
    ...
    console.log('ReportType',ReportTypes);
      ...
      $('#PurchaseIndentReportTable').DataTable({
          ...
          ajax:{
            url:'{{ url("/report/sales/sale-order/sale-order-pending-complete-all-report") }}',
          ...
          columns: [
            ...
            },
            {
                ...
                var itemName = '<div>'+full['AQTYISSUED']+' <small class="label label-success">'+full['AUM']+'</small></div>';
                return itemName;
