...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-quotation-report') }}">Sales Enquiry Rep.</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Sales Enquiry Report</h2>
            ...
            <div class="box-body">
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="vrNoList" id="vr_num" name="vr_num" class="form-control  pull-left rightcontent" value="{{ old('vr_num')}}" placeholder="Enter Vr. No">
              ...
              <div class="row">
               ...
               <button type="button" class="btn btn-success" data-toggle="modal" data-target="#QueryModal"><i class="fa fa-hourglass" aria-hidden="true"></i> &nbsp;&nbsp;Query</button>
                ...
                <button class="btn btn-primary" id="PindReprtExl"  onclick="excelReportBtn('excel')" disabled=""><i class="fa fa-file-excel-o" aria-hidden="true"></i>&nbsp;&nbsp;Excel</button>

              <!--    <button type="button" class="btn btn-danger" name="searchdata" onclick="excelReportBtn('month')"  style="padding: 5px;"><i class="fa fa-calendar" aria-hidden="true"></i> &nbsp;&nbsp;Month Summary</button> -->
...
//alert($vrnum);
   ...
   if(vrnum == ''){
     ...
     var  vr_num = vrnum.split(' ');
     var vr_nums = vr_num[2];
   }
   ...
   var pageName = 'purchaseIndent';
    ...
    $.ajaxSetup({
      ...
      window.location.href = "{{ url('/report/sale/sale-enquiry/sale-enquiry-report-excel/') }}"+'/'+item_code+'/'+vr_nums+'/'+plantCodeOperator+'/'+plantCodeValue+'/'+seriesCodeOperator+'/'+seriesCodeValue+'/'+profitCenterOperator+'/'+profitCenterValue+'/'+QtyOperator+'/'+QtyValue+'/'+from_date+'/'+to_date+'/'+ReportTypes+'/'+type;
...
load_data_query()
  function load_data_query(plantCodeOperator= '', plantCodeValue='',seriesCodeOperator='',seriesCodeValue='',profitCenterOperator='',profitCenterValue='',QtyOperator= '', QtyValue='',bank_code= '',from_date='',to_date='',vr_num='',item_code='',ReportTypes=''){
          ...
          columns: [
            ...
            },
            {
                ...
                render: function (data, type, full, meta){
                  ...
                  var getFy = fy.split('-');
                  var newFy = getFy[0];
                  var serice = full['SERIES_CODE'];
                  var vrno = full['VRNO'];

                  var vr_no = serice+'-'+newFy+' '+vrno;
                  return vr_no;
            ...
            },
            {
                ...
                render: function (data, type, full, meta){
                  ...
                  var party = full['ITEM_NAME']+' '+'('+full['ITEM_CODE']+')';
                  return party;
             ...
             
            {
              ...
              render: function (data, type, full, meta){
                ...
                var GetBtn = '<button type="button" class="btn btn-primary btn-xs notification" id="veiwPdetail_'+full['DT_RowIndex']+'" data-toggle="modal" data-target="#viewPartyDetail_'+full['DT_RowIndex']+'" onclick="showCalTax('+full['DT_RowIndex']+','+data['SQTNHID']+','+data['SQTNBID']+')" style="padding-bottom: 0px;padding-top: 0px;margin-top: 5%;">Calc. Tax</button> | <button type="button" class="btn btn-primary btn-xs notification" id="veiwQuaParDetails_'+full['DT_RowIndex']+'" data-toggle="modal" data-target="#viewQualityParDetail_'+full['DT_RowIndex']+'" onclick="showQuaParDetails('+full['DT_RowIndex']+','+data['SQTNHID']+','+data['SQTNBID']+')" style="padding-bottom: 0px;padding-top: 0px;margin-top: 3%;">Quality Para.</button> <div class="modal fade" id="viewPartyDetail_'+full['DT_RowIndex']+'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><div class="modal-dialog modal-md" role="document" style="margin-top: 5%;"><div class="modal-content" style="border-radius: 5px;"><div class="modal-header"><div class="row"><div class="col-md-12"><h5 class="modal-title modltitletext" id="exampleModalLabel">Tax / Charges / etc Calculation <br> Tax Code - <span id="showTaxCode"></span></h5></div></div></div><div class="modal-body table-responsive"><div class="boxer" id="getCalTaxData'+full['DT_RowIndex']+'"></div><div class="modal-footer" style="text-align: center;"> <button type="button" class="btn btn-primary" data-dismiss="modal" style="padding-left: 25px;padding-right: 25px;">Ok</button></div></div></div></div></div><div class="modal fade" id="viewQualityParDetail_'+full['DT_RowIndex']+'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"><div class="modal-dialog modal-md" role="document" style="margin-top: 5%;"><div class="modal-content" style="border-radius: 5px;"><div class="modal-header"><div class="row"><div class="col-md-12"><h5 class="modal-title modltitletext" id="exampleModalLabel"> Qaulity Parameter <span id="showItemCode"></span> <br> [ <span id="showItemName"></span> ]</h5></div></div></div><div class="modal-body table-responsive"><div class="boxer" id="getQuaParData'+full['DT_RowIndex']+'"></div><div class="modal-footer" style="text-align: center;"><button type="button" class="btn btn-primary" data-dismiss="modal" style="padding-left: 25px;padding-right: 25px;">Ok</button></div></div></div></div>';
  ...
  $(document).ready(function() {
    ...
    $('#ProceedBtnId').click(function(){
     ...
     var vr_num = '';
      ...
      if (plantCodeOperator!='' || plantCodeValue!='' || seriesCodeOperator!='' || seriesCodeValue!='' || profitCenterOperator!='' || profitCenterValue!='' || QtyOperator!='' || QtyValue!='' || from_date == '' || to_date =='' || bank_code=='' || vr_num=='' || item_code=='' || ReportTypes=='') {
            

          $('#PurchaseIndentReportTable').DataTable().destroy();

          load_data_query(plantCodeOperator,plantCodeValue,seriesCodeOperator,seriesCodeValue,profitCenterOperator,profitCenterValue,QtyOperator,QtyValue,bank_code,from_date,to_date,vr_num,item_code,ReportTypes);
    ...
    $('#btnsearch').click(function(){
          ...
          if (bank_code!='' ||  from_date!='' || to_date!='' || vr_num!='' || plantCodeOperator=='' || plantCodeValue=='' || seriesCodeOperator=='' || seriesCodeValue=='' || profitCenterOperator=='' || profitCenterValue=='' || QtyOperator=='' || QtyValue==''  ||  item_code=='' || ReportTypes=='') {
