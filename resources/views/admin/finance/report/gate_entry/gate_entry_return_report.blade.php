...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/purchase/purchase-order-report') }}">Gate Entry Rep.</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;">Gate Entry Return Report</h2>
              ...
              <div class="row">
               ...
               <div class="col-sm-4">
                   ...
                   <div class="form-group">
                      ...
                      <label for="exampleInputEmail1">Return Type :<span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="typeList" id="return_type" name="return_type" class="form-control  pull-left" value="{{ old('return_type')}}" placeholder="Select Account" autocomplete="off">
                          ...
                          <datalist id="typeList">
                            ...
                            <option value='RGP'   data-xyz ="RGP-RETURNABLE">RGP-RETURNABLE</option>
                            <option value='NRGP'   data-xyz ="RGP-RETURNABLE">NRGP-NON RETURNABLE</option>
                      ...
                      <small>  
                        ...
                        <div class="pull-left showSeletedName" id="accountText"></div>
                        <div id="show_err_return_type"></div>
...
<table id="PurchaseIndentReportTable" class="table table-bordered table-striped table-hover">
  <thead class="theadC">
    ...
    <tr>
      ...
      <th class="text-center">Return A-Qty</th>
...
load_data_query()
  function load_data_query(recNoId= '', recNoValueId='',lastUpId='',lastUpValueId='',VrNoId='',VrNoValueId='',SeriesNoId= '', SeriesNoValueId='',AccCodeId='',AccCodeValueId='',AmountId='',AmountValueId='',OtherDetailsId='',OtherDetValueId='',bank_code= '', acct_code='',from_date='',to_date='',vr_num='',return_type=''){
    //  alert(acct_code);
  ...
  $(document).ready(function() {
    ...
    $('#ProceedBtnId').click(function(){
     ...
     console.log('recNoValueId ',recNoValueId);
      ...
      if (recNoId!='' || recNoValueId!='' || lastUpId!='' || lastUpValueId!='' || VrNoId!='' || VrNoValueId!='' || SeriesNoId!='' || SeriesNoValueId!='' || AccCodeId!='' || AccCodeValueId!='' || AmountId!='' || AmountValueId!='' || OtherDetailsId!='' || OtherDetValueId!='' || from_date == '' || to_date =='' || bank_code=='' || acct_code=='' || vr_num=='') {
          ...
          load_data_query(recNoId,recNoValueId,lastUpId,lastUpValueId,VrNoId,VrNoValueId,SeriesNoId,SeriesNoValueId,AccCodeId,AccCodeValueId,AmountId,AmountValueId,OtherDetailsId,OtherDetValueId,bank_code,acct_code,from_date,to_date,vr_num,return_type);
    ...
    $('#btnsearch').click(function(){
          ...
          if (bank_code!='' || acct_code!='' || from_date!='' || to_date!='' || vr_num!='' || recNoId=='' || recNoValueId=='' || lastUpId=='' || lastUpValueId=='' || VrNoId=='' || VrNoValueId=='' || SeriesNoId=='' || SeriesNoValueId=='' || AccCodeId=='' || AccCodeValueId=='' || AmountId=='' || AmountValueId=='' || OtherDetailsId=='' || OtherDetValueId=='') {
            ...
            if(return_type==''){
               $('#show_err_return_type').html('Please select return type').css('color','red');
                return false;
            }else{
               $('#show_err_return_type').html('');
            }
                  ...
                  if (data1.response == 'error') {
                      ...
                      $('#getCalTaxData'+srNo).append(headData);
                        ...
                        $.each(obj_row, function (i, obj_row) {
                            ...
                            var bodyData = '<div class="box-row"><div class="box10 itmdetlheading"><span id="srnum">'+srac+'</span></div><div class="box10 itmdetlheading" style="text-align: left;"><span id="accCode">'+obj_row.TAXIND_NAME+'</span> </div><div class="box10 itmdetlheading"><span id="accName"> '+obj_row.RATE_INDEX+'</span></div><div class="box10 itmdetlheading" style="text-align: right;"><span id="accCode">'+obj_row.TAX_RATE+'</span> </div><div class="box10 itmdetlheading" style="text-align: right;"><span id="accCode">'+obj_row.TAX_LOGIC+'</span> </div></div>';
...
<script type="text/javascript">
  ...
  $('#btnpdf').click(function(){
          ...
          var head_table = 'gate_entry_return_heads';

          var body_table =  'gate_entry_return_bodies';
                ...
                return false;
                            ...
                            $.ajaxSetup({
                             ...
                             $.ajax({
                                ...
                                url:"{{ url('/finance/gate-entry/gate-entry-pdf') }}",
