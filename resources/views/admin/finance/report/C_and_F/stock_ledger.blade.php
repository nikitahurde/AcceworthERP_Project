...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/logistic/trip-planning/monthly-trip-planning-report') }}">Stock Ledger</a></li>
...
<section class="content">
    ...
    <div class="box box-primary Custom-Box">
        ...
        <div class="box-header with-border" style="text-align: center;">
          ...
          <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Stock Ledger</h2>
        ...
        <div class="box-body">
        	...
        	<div class="box-body" style="margin-top: 1%;">
                ...
                <table id="stockLedgerRtTbl" class="table table-bordered table-striped table-hover">
                  <thead class="theadC">

                    <tr>
                      <th class="text-center" >Vr Date</th>
                      <th class="text-center" >Rake No</th>
                      <th class="text-center" width="6%" >LR No</th>
                      <th class="text-center"  >Vehcile No</th>
                      ...
                      <th class="text-center" >Invoice Dt</th>
                      <th class="text-center" >EWB No</th>
                      <th class="text-center" width="6%">EWB Dt</th>
                      ...
                      <th class="text-center" >AQty-Issued</th>
                     </tr>
...
function load_data_query(rack_no= '',cust_no= '',item_code= '',wagon_no= ''){
  ...
  $('#stockLedgerRtTbl').DataTable({
        ...
        buttons:  [
                    {
                      ...
                      title: ' STOCK LEDGER'+$("#headerexcelDt").val(),
                      filename: 'STOCK_LEDGER_'+$("#headerexcelDt").val(),
                    }
                  ],
      ajax:{
        url:'{{ url("/get-data-stock-ledger-report") }}',

        data: {rack_no:rack_no,cust_no:cust_no,item_code:item_code,wagon_no:wagon_no},
      ...
      columns: [
        ...
        { data :'RAKE_NO',className:'text-left'},
        ...
        className:'text-right'},
        { data :'EWAY_BILL_NO',className:'text-left'},
         { data :'EWAY_BILL_DT',
          render: function (data) {
                var date = new Date(data);
                var month = date.getMonth() + 1;
        ...
        { data :'LENGTH',className:'text-right'},
...
$('#ProceedBtnId').click(function(){
  ...
  if(rack_no !='' || cust_no!='' || item_code!='' || wagon_no!=''){

    $('#stockLedgerRtTbl').DataTable().destroy();
    
    load_data_query(rack_no,cust_no,item_code,wagon_no);
