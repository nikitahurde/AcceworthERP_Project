...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/c_and_f/rake-report') }}"> Rake Report</a></li>
...
<section class="content">
    ...
    <div class="box box-primary Custom-Box">
        ...
        <div class="box-header with-border" style="text-align: center;">
          ...
          <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Rake Report</h2>
                ...
                <table id="rakeTable" class="table table-bordered table-striped table-hover" style="display:'';">
                  <thead class="theadC">
                    ...
                    <tr>
                      ...
                      <th class="text-center">Frome Place</th>
                      <th class="text-center">To Place</th>
                      <th class="text-center">E-Way Bill No</th>
                      <th class="text-center">E-Way Bill Date</th>
                    </tr>
...
load_data_query()
  ...
  function load_data_query(rackNo='',wagonNo='',consigneeCd='',item_code=''){
      ...
      console.log('consigneeCd',consigneeCd);
        ...
        footerCallback: function (row, data, start, end, display) {
            ...
            var amountTotal = api
                ...
                .reduce(function (a, b) {
                 ...
                 $( api.column(6).footer() ).html('Total :-').css('text-align','right');
        ...
        buttons:  [
                    {
                      ...
                      title: ' RACK REPORT'+$("#headerexcelDt").val(),
                      filename: 'RACK_PEPORT_'+$("#headerexcelDt").val(),
                    }
                  ],
         
          ajax:{
            url:'{{ url("/report/c_and_f/get-rake-report") }}',
            data: {rackNo:rackNo,wagonNo:wagonNo,consigneeCd:consigneeCd,item_code:item_code}
          },
          columns: [
            ...
            },
            {
                render: function (data, type, full, meta){
                  ...
                  var plantCdNm = plantCode+' - '+plantName;
            ...
            },
            {
                render: function (data, type, full, meta){
                  ...
                  var itemCdNm = itemCode+' - '+itemName;
...
$(document).ready(function() {
  ...
  $('#ProceedBtnId').click(function(){
    ...
    var splitecosig = consignee.split('-');
    var consigneeCd = splitecosig[0];

    var splitItem = itemCode.split('-');
    var item_code = splitItem[0];
          

    if(rackNo!= '' || wagonNo != '' || consignee!='' || itemCode!= ''){
        ...
        $('#errmsg').html('');
        load_data_query(rackNo,wagonNo,consigneeCd,item_code);
