...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/report/logistic/trip-planning/monthly-trip-planning-report') }}">GRN - Inward</a></li>
...
<section class="content">
    ...
    <div class="box box-primary Custom-Box">
        ...
        <div class="box-header with-border" style="text-align: center;">
          ...
          <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> GRN - Inward</h2>
                ...
                <table id="GrnInwordRtTbl" class="table table-bordered table-striped table-hover">
                  <thead class="theadC">
                    ...
                    <tr>
                      ...
                      <th class="text-center" width="5%" id="thRakeNo">Acc Code</th>
                      <th class="text-center" width="5%" id="thRakeNo">Acc Name</th>
                      ...
                      <th class="text-center" width="5%" id="">To Place</th>
                      <th class="text-center" width="5%" id="">DO No.</th>
...
function load_data_query(rack_no= '',cust_no= '',item_code= '',wagon_no= '',from_date= '', to_date= ''){
  ...
  $('#GrnInwordRtTbl').DataTable({
      ...
      footerCallback: function ( row, data, start, end, display ) {
        ...
        $( api.column(12).footer() ).html('Total :-').css('text-align','right');
        $( api.column(13).footer() ).html(receivQty);
        $( api.column(15).footer() ).html(a_receivQty);
        // $( api.column(12).footer() ).html(qtyissue);
        // $( api.column(14).footer() ).html(a_qtyissue);
        // $( api.column(8).footer() ).html(closeQty.toFixed(2));
        // $( api.column(10).footer() ).html(a_receivQty - a_qtyissue);
      ...
      buttons: [
                {
                  extend: 'excelHtml5',
                  title: 'grn_inward_'+curr_date+'_'+curr_time,
                  footer: true
                }
                ],
      ajax:{
        url:'{{ url("/get-data-grn-inward-report") }}',
      ...
      columns: [
        ...
        { data :'ACC_NAME',className:''},
        { data :'CP_CODE',className:''},
