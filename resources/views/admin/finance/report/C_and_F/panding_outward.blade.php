...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1>Panding Outward<small> View Details</small></h1>
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="{{ url('/report/c-and-f/gate-entry/panding-outward') }}">Panding Outward</a></li>

      <li class="active"><a href="{{ url('/report/c-and-f/gate-entry/panding-outward') }}">View Panding Outward</a></li>
    </ol>
  ...
  <section class="content">
    ...
    <div class="box box-primary Custom-Box">
      ...
      <div class="box-header with-border" style="text-align: center;">
        ...
        <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> View Panding Outward</h2>

        <div class="box-tools pull-right">

          <a href="{{ url('/Transaction/Account/Cash-Bank-Transaction') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Panding outward</a>
            ...
            <table id="example" class="table table-bordered table-striped table-hover" style="width: 100%">
              <thead>
                <th class="text-center">VEHICLE NUMBER</th>
        				<th class="text-center">VEHICLE IN TIME</th>
        				...
        				<th class="text-center">VEHICLE OUT TIME</th>
        				<th class="text-center">TOTAL IN HOURS</th>
  ...
  $(document).ready(function(){
      ...
      var t = $("#example").DataTable({
        ...
        buttons: [
                  {
                    extend: 'excelHtml5',
                    title: 'panding-outward'+curr_date+'_'+curr_time,
                    
                  }
                ],
        ajax:{

            url : "{{ url('/report/c-and-f/gate-entry/view-panding-outward') }}"
         ...
         },
         {
            className:'alignRightClass',
              render: function (data, type, full, meta){
                  ...
                  var firstFyCode = fyCode.split("-");

                   
                   var seriesCode = full['SERIES_CODE'];
                   var vrNo = full['VRNO'];
                   return firstFyCode[0]+' '+seriesCode+' '+vrNo;
            }  
