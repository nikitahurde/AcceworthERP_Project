...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/report/c_and_f/chamber-report') }}">C And F</a></li>
            
            <li class="active"><a href="{{ url('/report/c_and_f/chamber-report') }}"> Chamber report</a></li>
...
<section class="content">
    ...
    <div class="box box-primary Custom-Box">
        ...
        <div class="box-header with-border" style="text-align: center;">
          ...
          <h2 class="box-title animated bounceInLeft PageTitle" id="getPAgeTitleNAme" style="font-weight: 800;color: #5696bb;"> Chamber Report</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                      ...
                      <label for="exampleInputEmail1">Shall Plan Include :</label>
                      ...
                      <div class="input-group">
                          ...
                          <input list="custList" id="cust_no" name="cust_no" class="form-control  pull-left" value="" placeholder="Select Shall Plan" autocomplete="off">
          ...
          <div class="box-body" style="margin-top: 1%;">
            ...
            <table id="rakeTable" class="table table-bordered table-striped table-hover" style="display:'';">
                  <thead class="theadC">
                    ...
                    <tr>
                      <th class="text-center">CS CODE</th>
                      <th class="text-center">CS NAME</th>
                      <th class="text-center">CHAMBER CODE</th>
  ...
  function load_data_query(rackNo='',wagonNo='',consigneeCd='',item_code=''){
      ...
      $('#rakeTable').DataTable({
          ...
          buttons: [
                     {
                        extend: 'excelHtml5',
                        title: 'chamber_report_'+curr_date+'_'+curr_time,
                        footer: true
                      }
                    ],
         
          ajax:{
            url:'{{ url("/report/c-and-f/gate-entry/view-chamber-report") }}',
