...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/sendotpmail') }}">User Verify</a></li>
      ...
      <div class="col-sm-8">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">USER VERIFICATION</h2>
          ...
          <div class="box-body">
            ...
            <form action="{{ url('sendmailpassword') }}" method="POST" >
                       ...
                       User-Id : 
                        ...
                        <div class="input-group">
                          ...
                          <span class="input-group-addon"><i class="fa fa-building"></i></span>
                           ...
                           <input  type="text" class="form-control" name="user_id" id="user_id" value="{{old('user_id')}}" placeholder="Enter User Id">
                          ...
                          <small id="emailHelp" class="form-text text-muted">
                            ...
                            {!! $errors->first('user_id', '<p class="help-block" style="color:red;">:message</p>') !!}
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="email_id" id="email_id" value="{{old('email_id')}}" placeholder="Enter Email Id">
