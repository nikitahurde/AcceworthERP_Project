                        ...
                        <div class="form-group">
                          ...
                          <label> T Code : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="tran" value="{{ $purhase_quotation_head->tran_code }}" id="transcode" placeholder="Enter Transaction Head" readonly autocomplete="off">

                              <input type="hidden" id="transtaxCode" >

                          <input type="hidden" id="headidquo" value="{{ $purhase_quotation_head->id }}" name="headid">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input list="seriesList1"  id="series_code" name="series" class="form-control  pull-left" value="{{ $purhase_quotation_head->series_code  }}" placeholder="Select Series" oninput="this.value = this.value.toUpperCase()" autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label> Series Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="tran" value="{{ $series_name->series_name }}" id="seriesName" placeholder="Enter Series Name" readonly autocomplete="off">
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control rightcontent" name="vro" value="{{ $purhase_quotation_head->vr_no }}" placeholder="Enter Vr No" id="vrseqnum" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Plant Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="PlantcodeList" class="form-control" id="Plant_code" name="plantcode" placeholder="Select Plant" maxlength="11" value="{{ $purhase_quotation_head->plant_code }}" autocomplete="off" readonly>
                        ...
                        <div class="form-group">
                          ...
                          <label> Plant Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="plantname" value="{{ $plant_name->plant_name }}" id="plantname" placeholder="Enter Profit Plant Name" readonly autocomplete="off" >
                        ...
                        <div class="form-group">
                          ...
                          <label>Profit Center Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="profitList"  id="profitctrId" name="pfct" class="form-control  pull-left" value="{{ $purhase_quotation_head->pfct_code  }}" placeholder="Select Profit Center Code" oninput="this.value = this.value.toUpperCase()"  autocomplete="off" readonly>
                        ...
                        <div class="form-group">
                          ...
                          <label>Acc Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="AccountList"  id="account_code" name="AccCode" class="form-control  pull-left" value="{{ $purhase_quotation_head->acc_code }}" placeholder="Select Account" oninput="this.value = this.value.toUpperCase()"  autocomplete="off" readonly> 
                        ...
                        <div class="form-group">
                          ...
                          <label>Tax Code: 
                            ...
                            <div class="input-group">
                              ...
                              <input list="TaxcodeList"  id="tax_code" name="taxcode" class="form-control  pull-left" value="{{ $purhase_quotation_head->tax_code }}" placeholder="Select Tax" oninput="this.value = this.value.toUpperCase()" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Due Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control rightcontent" name="due_date" id="due_date" value="{{ $purhase_quotation_head->due_date }}" placeholder="Select Due" autocomplete="off" readonly>
            ...
            <form id="salesordertrans">
              ...
              <div class="table-responsive">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                 ...
                 <?php $srno=1; $incNo=1; $allcount = count($purchase_quotation_body); foreach($purchase_quotation_body as $row) { ?>
                  ...
                  <tr class="useful">
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input List="enquirynoList<?php echo $incNo;?>" class="debitcreditbox inputboxclr cr_amount SetInCenter" onchange="getenquiryNo('<?php echo $incNo;?>')" id='enquiryno<?php echo $incNo;?>' name="enquiry_no[]" value="{{ $row->enquiry_no }}"  style="width: 80px"/>

                        <datalist id="enquirynoList<?php echo $incNo;?>">
                        </datalist>
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type="text" id="taxByItem<?php echo $incNo;?>" name="tax_byitem[]">
             ...
             <!--  <div class="row">
              ...
              <div class="row" style="display: flex;">
                  ...
                  <div class="col-md-1">
                    ...
                    <input class="credittotldesn inputboxclr" type="text" name="TotalCredit" id="basicTotal" value="{{ $total }}" style="margin-top: 3px;">
               ...
               <div class="row" style="display: flex;">
                  ...
                  <div class="col-md-1">
                    ...
                    <input class="credittotldesn inputboxclr" type="text" name="TotalCredit" id="otherTotalAmt" readonly="" value="{{ number_format($othertotal,2) }}" style="margin-top: 3px;">
               ...
               <div class="row" style="display: flex;">
                  ...
                  <div class="col-md-1">
                    ...
                    <input class="credittotldesn inputboxclr" type="text" name="TotalCredit" id="allgrandAmt" readonly="" value="<?= number_format($grndtotal,2) ?>" style="margin-top: 3px;">
