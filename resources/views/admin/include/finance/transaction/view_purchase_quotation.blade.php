  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/view-mast-dealer') }}">Master Purchase Quotation</a></li>

            <li class="active"><a href="{{ url('/view-mast-dealer') }}">View Purchase Quotation</a></li>
        ...
        <section class="content">
          ...
          <a href="{{ url('/finance/transaction/purchase-quotation-transaction') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Purchase Quotation</a>
  ...
  <div class="modal-dialog modal-sm" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <form action="{{ url('/finance/delete-purchase-body-quotation') }}" method="post">
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/finance/view-purchase-quatation') }}"
               ...
               success:function(data){
                  ...
                  if (data1.response == 'error') {
                      ...
                      if(data1.data==''){
                         ...
                         var srNo=1;
                         var tableid = objrow[0].purchase_quotation_head_id;
                      ...
                      var deletebtn ='<a class="btn btn-warning btn-xs" title="edit" disabled><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" disabled><i class="fa fa-trash" title="Delete"></i></button>';
                        ...
                        var enableBtn = 'enable';
                      var deletebtn ='<a href="edit-purchase-quotation/'+btoa(objrow.purchase_quotation_head_id)+'" class="btn btn-warning btn-xs" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" onclick="return pquotationDelete('+objrow.id+');"><i class="fa fa-trash" title="Delete"></i></button>';
                    }
                               $('#childData_'+tableid).append('<tr><td class="text-center">'+srNo+'</td><td class="text-center">'+objrow.enquiry_no+'</td><td>'+objrow.item_name+' ( '+objrow.item_code+' )</td><td class="text-right">'+objrow.quantity+'</td><td class="text-right">'+objrow.Aquantity+'</td><td class="text-right">'+approval_btn1+'</td><td class="text-right">'+approval_btn+'</td><td class="text-right">'+deletebtn+'</td></tr>');
                              srNo++;
                             });
