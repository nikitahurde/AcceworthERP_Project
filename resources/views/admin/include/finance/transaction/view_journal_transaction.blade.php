     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <div class="box-tools pull-right">
                ...
                <a href="{{ url('/finance/transaction/journal-transaction') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Journal Trans</a>
...
<table id="InwardDispatch" class="table table-bordered table-striped table-hover">
  ...
  <thead class="theadC">
    ...
    <tr>
      ...
      <th class="text-center">Jr Date</th>

      <th class="text-center">Vr No</th>

      <th class="text-center">Gl/Acc Code</th>
    ...
    load_data();
        ...
        function load_data(accCode='',BankCode=''){
          ...
          $('#InwardDispatch').DataTable({
              ...
              ajax:{
                url:'{{ url("/finance/view-journal-transaction") }}',
