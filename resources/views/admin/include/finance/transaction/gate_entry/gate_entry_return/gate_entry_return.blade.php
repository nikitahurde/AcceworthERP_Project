          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <div class="box-tools pull-right">
                ...
                <a href="{{ url('/finance/transaction/gate-entry/view-gate-entry-return') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Gate Entry Return</a>
                        ...
                        <div class="form-group">
                          ...
                          <label>Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control transdatepicker" name="vr" id="vr_date" value="{{ $CurrentDate }}" placeholder="Select Date" autocomplete="off" onchange="gatepassreturn.vrDate()">
                        ...
                        <div class="form-group">
                          ...
                          <label>Department Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              onchange="gatepassreturn.GetAccCode(accCodeurl)" readonly > 
                        ...
                        <div class="form-group">
                          ...
                          <label> Employee Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="emplList" class="form-control" name="emp_code" value="" id="emp_code" placeholder="Enter Employee Code" autocomplete="off" onchange="gatepassreturn.EmpCode()">
                  ...
                  <tr class="useful">
                    ...
                    <td class="tdthtablebordr">
                      <div class="input-group">
                       ...
                       <button type="button" class="btn btn-primary btn-xs showdetail viewbtnitem" id="viewItemDetail1" data-toggle="modal" data-target="#view_detail1" onclick="gatepassreturn.showItemDetail(1,itemcodeurl)"><i class="fa fa-info" aria-hidden="true" style="font-size: 13px;"></i> </button>
