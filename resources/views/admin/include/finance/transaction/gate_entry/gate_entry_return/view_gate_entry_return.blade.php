...
<style>
  ...
  <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <a href="{{ url('/finance/transaction/gate-entry/gate-entry-return') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Gate Entry Return</a>
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/finance/transaction/gate-entry/view-gate-entry-return') }}"
               ...
               success:function(data){
                  ...
                  if (data1.response == 'error') {
                      ...
                      if(data1.data==''){
                         ...
                         var srNo=1;
                         var tableid = objrow[0].gate_entry_return_head_id ;
                      ...
                      var deletebtn ='<a class="btn btn-warning btn-xs" title="edit" disabled><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" disabled><i class="fa fa-trash" title="Delete"></i></button>';
                        ...
                        var enableBtn = 'enable';
                      var deletebtn ='<a href="edit-purchase-indent/'+btoa(objrow.gate_entry_return_head_id)+'" class="btn btn-warning btn-xs" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" onclick="return pindentDelete('+objrow.id+');"><i class="fa fa-trash" title="Delete"></i></button>';
                    }
