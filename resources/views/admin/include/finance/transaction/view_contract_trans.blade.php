...
@include('admin.include.sidebar')
  ...
  <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <a href="{{ url('/finance/transaction/contract-transaction') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Contract Trans</a>
 ...
 <div class="modal fade" id="contractDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog modal-sm" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <form action="{{ url('/finance/delete-purchase-body-contract') }}" method="post">
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/finance/transaction/view-contract-transaction') }}"
       ...
       columns: [
        ...
        {  
         ...
         { data: "tran_code",className:'text-right' },
               ...
               success:function(data){
                  ...
                  if (data1.response == 'error') {
                      ...
                      if(data1.data==''){
                         ...
                         var srNo=1;
                         var tableid = objrow[0].contract_head_id;
                      ...
                      var deletebtn ='<a class="btn btn-warning btn-xs" title="edit" disabled><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" disabled><i class="fa fa-trash" title="Delete"></i></button>';
                        ...
                        var enableBtn = 'enable';
                      var deletebtn ='<a href="edit-contract-trans/'+btoa(objrow.contract_head_id)+'" class="btn btn-warning btn-xs" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" onclick="return contractDelete('+objrow.id+');"><i class="fa fa-trash" title="Delete"></i></button>';
                    }
                               $('#childData_'+tableid).append('<tr><td class="text-center">'+srNo+'</td><td>'+objrow.item_name+' / '+objrow.item_code+'</td><td class="text-right">'+objrow.quantity+'</td><td class="text-right">'+objrow.Aquantity+'</td><td class="text-right">'+approval_btn1+'</td><td class="text-right">'+approval_btn+'</td><td class="text-right">'+deletebtn+'</td></tr>');
                              srNo++;
                             });
