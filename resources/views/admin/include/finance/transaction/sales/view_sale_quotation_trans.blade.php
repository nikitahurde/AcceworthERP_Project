  ...
  <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/view-mast-dealer') }}">Master  Sale Quotation</a></li>

            <li class="active"><a href="{{ url('/view-mast-dealer') }}">View  Sale Quotation</a></li>
        ...
        <section class="content">
          ...
          <a href="{{ url('finance/transaction/purchase-indent') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Sale Quotation</a>
