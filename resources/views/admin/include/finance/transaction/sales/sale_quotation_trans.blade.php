...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">
          <a href="{{ url('/transaction/sales/sales-quotation-transaction') }}"> Sales Quotation Transaction</a>
        </li>
                      ...
                      <div class="col-md-5">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input list="seriesList1"  id="series_code" name="series" class="form-control  pull-left" value="<?php if($seriesCount == 1){echo $series_list[0]->series_code; echo " [ ".$series_list[0]->series_name." ]";}else{echo old('series_code');} ?>" placeholder="Select Series" oninput="this.value = this.value.toUpperCase()" autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Plant Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="PlantcodeList" class="form-control" id="Plant_code" name="plantcode" placeholder="Select Plant" maxlength="55" value="<?php if($plcount == 1){echo $getplant[0]->plant_code;}?>" autocomplete="off" readonly>
                        ...
                        <div class="form-group">
                          ...
                          <label>Reverse Quotation: 
                            ...
                            <div class="input-group">
                              ...
                              <input list="revQuoList" id="revQuoNum" name="" class="form-control  pull-left Number" value="" placeholder="Enter Reverse Quotation" autocomplete="off" style="text-align: end;" onchange="saleQuo.reverseQuoIfYes(gateSaleQuoNo)">
                        ...
                        <div class="form-group">
                          ...
                          <label>Quotation No.: 
                            ...
                            <div class="input-group">
                              ...
                              <input list="QuoNoList" id="squotnNum" name="" class="form-control  pull-left Number" value="" placeholder="Enter Quotation No." autocomplete="off" style="text-align: end;" onchange="saleQuo.getItmBySaleQuoNo(gateItmData)">
    ...
    $("#HsnSameShow"+ItemId).modal({
      ...
      if(ItemCode){
            ...
            $.ajax({
                ...
                data: {ItemCode: ItemCode,taxCode:taxCode,accCode:accCode},
...
$(document).ready(function(){
    ...
    $("#Plant_code").change(function(){
        ...
        var plantcodeget =plantcode.split('[');
        var Plant_code = plantcodeget[0];
...
*/
          ...
          $.ajax({
              ...
              url: "{{ url('/finance/save-sale-quotation-trans') }}",
...
<script type="text/javascript">
  ...
  var getaccCode = $('#account_code').val();
 // alert(accCode);
  var splitcode = getaccCode.split('[');

  var accCode = splitcode[0];
