        ...
        <div class="col-sm-12">
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;"> Purchase Indent</h2>
...
.with-nav-tabs.panel-info .nav-tabs > li.dropdown .dropdown-menu > .active > a:focus {
                        ...
                        <div class="form-group">
                          ...
                          <label>Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control transdatepicker" name="vr" id="vr_date" value="{{ $CurrentDate }}" placeholder="Select Date" autocomplete="off" readonly>
                        ...
                        <div class="form-group">
                          ...
                          <label> T Code : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="tran" value="{{ $purhase_indent_head->tran_code }}" id="transcode" placeholder="Enter Transaction Head" readonly autocomplete="off">

                              <input type="hidden" name="headid" id="headid" value="{{ $purhase_indent_head->id }}">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input list="seriesList1"  id="series_code" name="series" class="form-control  pull-left" value="{{ $purhase_indent_head->series_code }}" placeholder="Select Series" oninput="this.value = this.value.toUpperCase()" autocomplete="off" readonly>
                      ...
                      <div class="col-md-2">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="vro" value="{{ $purhase_indent_head->vr_no }}" placeholder="Enter Vr No" id="vrseqnum" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Plant Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="PlantcodeList" class="form-control" id="Plant_code" name="plantcode" placeholder="Select Plant" maxlength="11" readonly autocomplete="off" value="{{ $purhase_indent_head->plant_code }}">
                        ...
                        <div class="form-group">
                          ...
                          <label>Profit Center Code: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="profitList"  id="profitctrId" name="pfct" class="form-control  pull-left" value="{{ $purhase_indent_head->pfct_code }}" placeholder="Select Profit Center Code" oninput="this.value = this.value.toUpperCase()" readonly autocomplete="off" value="{{ $purhase_indent_head->pfct_code }}">
                        ...
                        <div class="form-group">
                          ...
                          <label>Department Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="AccountList"  id="account_code" name="AccCode" class="form-control  pull-left" placeholder="Select Department" oninput="this.value = this.value.toUpperCase()"  autocomplete="off" readonly value="{{ $purhase_indent_head->dept_code }}"> 
                        ...
                        <div class="form-group">
                          ...
                          <label> Department Name : </label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="acctname" value="{{ $dept_name->dept_name }}" id="accountName" placeholder="Enter Department Name" readonly autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <label>Due Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control" name="due_date" id="due_date" value="{{ $purhase_indent_head->due_date }}" placeholder="Select Due" autocomplete="off" readonly>
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="party_ref" id="party_rf_no" placeholder="Enter Party Ref No" maxlength="30" autocomplete="off" readonly>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control partyrefdatepicker" name="party_ref_d" id="party_ref_date" value="{{ old('vr_date')}}" placeholder="Select Party Ref Date" autocomplete="off" readonly>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="Rfhead_1" placeholder="Enter Rfhead1" maxlength="30" id="rfhead1" oninput="rfheadget(1)" autocomplete="off" readonly>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="Rfhead_2" placeholder="Enter Rfhead2" maxlength="30" id="rfhead2" oninput="rfheadget(2)" readonly>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="Rfhead_3" id="rfhead3" placeholder="Enter Rfhead3" maxlength="30" oninput="rfheadget(3)" readonly>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="Rfhead_4" placeholder="Enter Rfhead4" maxlength="30" id="rfhead4" oninput="rfheadget(4)" autocomplete="off" readonly>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="Rfhead_5" placeholder="Enter Rfhead5" maxlength="30" id="rfhead5" oninput="rfheadget(5)" autocomplete="off" readonly>
  ...
  <section class="content" style="margin-top: -10%;">
          ...
          <div class="box-body">
            ...
            <form id="salesordertrans">
              ...
              <div class="table-responsive">
                ...
                <?php $total = 0;   $srno=1; $incNo =1; $allcount = count($purhase_indent_body); foreach($purhase_indent_body as $row)  { 
                  ...
                  <tr class="useful">
                    ...
                    <td class="tdthtablebordr">
                      <div class="input-group">
                        ...
                        <input list="ItemList<?php echo $incNo;?>" class="inputboxclr SetInCenter" style="width: 90px;margin-bottom: 5px;" id='ItemCodeId<?php echo $incNo;?>' name="item_code[]"  onchange="ItemCodeGet(<?php echo $incNo;?>);"  oninput="this.value = this.value.toUpperCase()"  value="{{ $row->item_code}}" />
                          ...
                          <button type="button" class="btn btn-primary btn-xs showdetail viewbtnitem" id="viewItemDetail<?php echo $incNo;?>" data-toggle="modal" data-target="#view_detail<?php echo $incNo;?>" onclick="showItemDetail(<?php echo $incNo;?>)">View </button>
                      </div>
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type="hidden" name="body_id[]" value="{{ $row->id }}">
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter getqtytotal quantityC moneyformate"  id='qty<?php echo $incNo;?>' name="qty[]" oninput='Getqunatity(<?php echo $incNo;?>)' onkeyup="CalAQty(<?php echo $incNo;?>)" style="width: 80px"  value="{{ $row->qty_recvd}}" />
                      <input type="hidden" id="qtyget<?php echo $incNo;?>" class="totlqty">
                      <input type="text" name="unit_M[]" id="UnitM<?php echo $incNo;?>" class="inputboxclr SetInCenter AddM" readonly value="{{ $row->um}}">
                     ...
                     <td class="tdthtablebordr">
                      ...
                      <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter"  id='A_qty<?php echo $incNo;?>' name="Aqty[]"  style="width: 80px" readonly value="{{ $row->aq_recvd}}"/>

                      <input type="text" name="add_unit_M[]" id="AddUnitM<?php echo $incNo;?>" class="inputboxclr SetInCenter AddM" readonly value="{{ $row->aum}}">
                    ...
                    <td>
                         ...
                         <small id="taxnotfound<?php echo $incNo;?>" class="label label-danger"></small>
                          ...
                          <input type="hidden" id='quaP_count<?php echo $incNo;?>' value="0" name="quaP_count[]" class="quaPcountrow">


                       <button type="button" class="btn btn-primary btn-xs tdsratebtn" id="CalcTax<?php echo $incNo;?>" data-toggle="modal" data-target="#quality_parametr<?php echo $incNo;?>" onclick="qty_parameter('<?= $row->item_code ?>','<?= $incNo ?>')"  style="padding-bottom: 0px;
    ...
    <small id="qPnotfountbtn<?php echo $incNo;?>" class="label label-danger"></small>
                   ...
                   <div class="modal fade" id="quality_parametr<?php echo $incNo;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog" role="document" style="margin-top: 5%;">
          ...
          <div class="modal-content" style="border-radius: 5px;">
            ...
            <div class="modal-body table-responsive">
                ...
                <div class="boxer" id="qua_par<?php echo $incNo;?>">
          ...
          <div class="modal-footer">
            ...
            <center><span style="text-align: center;" id="footer_qaulity_btn<?php echo $incNo;?>"></span>
            <span style="text-align: center;" id="footer_ok_btn<?php echo $incNo;?>"></span>
            </center>
      ...
      <!-- show modal when click on view btn after item select item -->
        ...
        <div class="modal fade" id="view_detail<?php echo $incNo;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content" style="border-radius: 5px;">
              ...
              <div class="modal-body table-responsive">
                <div class="boxer" id="">
                  ...
                  <div class="box-row">
                    <div class="box10 texIndbox1">Item Code</div>
                    <div class="box10 rateIndbox">Item Name</div>
                  ...
                  <div class="box-row">
                    <div class="box10 itmdetlheading">
                      <span id="itemCodeshow<?php echo $incNo;?>"> </span>
                    </div>
                    <div class="box10 itmdetlheading">
                      <span id="itemNameshow<?php echo $incNo;?>"> </span>
                    </div>
                    <div class="box10 itmdetlheading">
                      <span id="hsncodeshow<?php echo $incNo;?>"> </span>
                    </div>
                    <div class="box10 itmdetlheading">
                      <span id="taxcodeshow<?php echo $incNo;?>"> </span>
                    </div>
                    <div class="box10 itmdetlheading">
                      <span id="itemDetailshow<?php echo $incNo;?>"> </span>
                    </div>
                    <div class="box10 itmdetlheading">
                      <span id="itemtypeshow<?php echo $incNo;?>"> </span>
                    </div>
                    <div class="box10 itmdetlheading">
                      <span id="itemgroupshow<?php echo $incNo;?>"> </span>
                    </div>
                    <div class="box10 itmdetlheading">
                      <span id="itemclassshow<?php echo $incNo;?>"> </span>
                    </div>
                    <div class="box10 itmdetlheading">
                      <span id="itemcategoryshow<?php echo $incNo;?>"> </span>
                    </div>
                  </div>
      ...
      <!-- show modal when click on view btn after item select item -->
              ...
              <div class="row" style="display: flex;">
                  ...
                  <div class="col-md-6"></div>
                    ...
                    <?php  $totalqty = number_format($total,2) ?>

                  <div class="col-md-1">
                     <input type="hidden" id="allquaPcount" name="allquaPcount" value="0">
                    <input class="credittotldesn inputboxclr" type="text" name="TotalCredit" id="basicTotal" readonly="" style="margin-top: 3px;" value="{{ $totalqty }}">
                  </div>
 ...
 //   alert(headid);
    ...
    if(Plant_code){
      ...
      for(var q=1; q<=rowcountE; q++){
        ...
        $('#viewItemDetail'+q).removeClass('showdetail');
...
<script type="text/javascript">
  ...
  $(".addmore").on('click',function(){
    ...
    var vrType =  $('#vr_type').val();
      ...
      data +="<td class='tdthtablebordr'><div class='input-group'><input list='ItemList"+i+"' class='inputboxclr SetInCenter' style='width: 90px;margin-bottom: 5px;' id='ItemCodeId"+i+"' name='item_code[]' onchange='ItemCodeGet("+i+");' oninput='this.value = this.value.toUpperCase()'/><datalist id='ItemList"+i+"'><option selected='selected' value=''>-- Select --</option>@foreach ($help_item_list as $key)<option value='<?php echo $key->item_code?>' data-xyz ='<?php echo $key->item_name; ?>' ><?php echo $key->item_name ; echo ' ['.$key->item_code.']' ; ?></option>@endforeach</datalist></div></td> <td class='tdthtablebordr'><input type='text' class='inputboxclr getAccNAme' style='width: 190px;margin-bottom: 5px;' id='Item_Name_id"+i+"' name='item_name[]' readonly /><textarea id='remark_data"+i+"' rows='1' style='width: 190px;margin-bottom: 2%;' class='' name='remark[]' placeholder='Enter Description'></textarea></td> <td class='tdthtablebordr'><div style='display: inline-flex;border: none;margin-top: -3%;'><input type='text' class='debitcreditbox dr_amount getqtytotal inputboxclr SetInCenter quantityC moneyformate'  id='qty"+i+"' name='qty[]' oninput='Getqunatity("+i+")' onkeyup='CalAQty("+i+")' style='width: 80px' /><input type='hidden' id='qtyget"+i+"' class='totlqty'><input type='text' name='unit_M[]' id='UnitM"+i+"' class='inputboxclr SetInCenter AddM'><input type='hidden' ide='Cfactor"+i+"'></div></td><td class='tdthtablebordr'><div style='display: inline-flex;border: none;margin-top: -3%;'><input type='text' class='debitcreditbox dr_amount inputboxclr SetInCenter'  id='A_qty"+i+"' name='Aqty[]'  style='width: 80px' readonly /><input type='text' name='add_unit_M[]' id='AddUnitM"+i+"' class='inputboxclr SetInCenter AddM'></div></td><td><div style='margin-top: 12%;'><small id='taxnotfound"+i+"' class='label label-danger'></small></div><input type='hidden' id='quaP_count"+i+"' value='0' name='quaP_count[]' class='quaPcountrow'> <button type='button' class='btn btn-primary btn-xs tdsratebtn' id='CalcTax"+i+"' data-toggle='modal' data-target='#quality_parametr"+i+"' onclick='qty_parameter("+i+")' style='padding-bottom: 0px;padding-top: 0px;' disabled>Quality Parametr </button><div id='appliedbtn"+i+"'></div><div id='cancelbtn"+i+"'></div><small id='qPnotfountbtn"+i+"' class='label label-danger'></small> <div class='modal fade' id='quality_parametr"+i+"' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'><div class='modal-dialog' role='document' style='margin-top: 5%;'><div class='modal-content' style='border-radius: 5px;'><div class='modal-header'><div class='row'><div class='col-md-5'><div class='form-group'><input type='text' class='settaxcodemodel col-md-7' id='tax_code"+i+"' style='border: none; padding: 0px;' readonly></div></div><div class='col-md-6'><h5 class='modal-title modltitletext' style='padding-bottom: 0px;padding-top: 0px;' id='exampleModalLabel' >Qaulity Parameter</h5></div><div class='col-md-1'></div></div></div><div class='modal-body table-responsive'><div class='boxer' id='qua_par_"+i+"'></div></div><div class='modal-footer'><center><span style='text-align: center;' id='footer_qaulity_btn"+i+"'></span>&nbsp;&nbsp;<span style='text-align: center;' id='footer_ok_btn"+i+"'></span></center></div></div></div></div> </td>";
...
<script type="text/javascript">
  ...
  function ItemCodeGet(ItemId){
      ...
      if(msg=='No Match'){
        ...
        $('#vr_date,#series_code,#Plant_code,#account_code,#due_days').prop('readonly',true); 
            ...
            success: function (data) {
             ...
             // console.log(data1);
              ...
              if(data1.data==''){
                    ...
                    //console.log();
                  $("#itemCodeshow"+viewid).html(data1.data_hsn[0].item_code);
                  $("#itemNameshow"+viewid).html(data1.data_hsn[0].item_name);
  ...
  gr_amt =0;
       $(".getqtytotal").each(function () {
            ...
            //add only if the value is number
           //var qtyval =  parseFloat($('.getqtytotal').val().replace(',',''));
            if (!isNaN(this.value) && this.value.length != 0) {
                //gr_amt1 = parseFloat(qtyval);
                gr_amt += parseFloat(this.value);

                //total = gr_amt.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
...
<script type="text/javascript">
  function qty_parameter(item_code,qty){
   ...
   var ItemCode = $("#ItemCodeId"+qty).val();
    ...
    $.ajaxSetup({
        ...
        $.ajax({
            ...
            url: "{{ url('/finance/get-quality-parameter-by-item-update') }}",

            data: {item_code:item_code}, // here $(this) refers to the ajax object not form
