...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">
          <a href="{{ url('/finance/transaction/purchase-order-transaction') }}"> Purchase Purchase Indent</a>
        </li>
              ...
              <div class="table-responsive">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                  ...
                  <tr class="useful">
                    ...
                    <td class="tdthtablebordr">
                      <div class="input-group">
                        <input list="ItemList1" class="inputboxclr SetInCenter" style="width: 90px;margin-bottom: 5px;" id='ItemCodeId1' name="item_code[]"  onchange="ItemCodeGet(1);quaParaGet(1)"  oninput="this.value = this.value.toUpperCase()" readonly />
...
<script src="{{ URL::asset('public/dist/js/viewjs/purchase_indent.js') }}" ></script>
