  ...
  <section class="content">
      ...
      <div class="box box-primary Custom-Box">
                ...
                <div class="col-md-2">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="vro" value="<?php if($vrNumber==''){echo $last_num;}else{echo $last_num+1;} ?>" placeholder="Enter Vr No" id="vrseqnum" readonly autocomplete="off">
                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input  list="grnnoList" id="grnrvrno" name="" class="form-control  pull-left" value="" placeholder="Enter GRN No" autocomplete="off">
        ...
        <div class="box-body">
          ...
          <button type="submit" name="submit" value="submit" id="submitinpurchasebill" class='btn btn-success'>submit</button> 
          ...
          columns: [

            {
                ...
                'render': function (data, type, full, meta){
                  ...
                  return '<input type="checkbox" name="flit_id[]" class="pb_checkitm" value="'+full['grn_head_id'] +'/'+full['grnbodyid'] +'/'+full['item_code'] +'/'+full['DT_RowIndex']+'"><input type="hidden" name="grnheadid[]" id="grnheadid'+full['DT_RowIndex']+'" value="'+full['grn_head_id'] + '"><input type="hidden" name="grnbodyid[]"  id="grnbodyid'+full['DT_RowIndex']+'" value="'+full['grnbodyid'] + '"><input type="hidden" id="grnitmcode'+full['DT_RowIndex']+'" name="itmcode[]" class="" value="'+full['item_code'] + '"><input type="hidden" id="grntaxcode'+full['DT_RowIndex']+'" name="taxcode[]" class="" value="'+full['tax_code'] + '"><input type="hidden" id="grnbasicAmt'+full['DT_RowIndex']+'" name="grnbasicAmt[]" class="basicAmtC" value="'+full['basic_amt'] + '">';
                }
            },
            {
              data:'vr_no',
...
$(document).ready(function() {
    ...
    $('#submitinpurchasebill').on('click',function(){
      ...
      if(checkboxcount > 0){
        ...
        var checkitm=[];
          ...
          $.ajax({
            ...
            url:"{{ url('finance/save-purchase-transaction') }}",

            method : "POST",

            type: "JSON",

            data: {checkitm: checkitm,accCode:accCode,grnrvrno:grnrvrno,accountName:accountName,transcode:transcode,trans_date:trans_date,vrseqnum:vrseqnum,basicTotalAmt:basicTotalAmt,partyBillNo:partyBillNo},
