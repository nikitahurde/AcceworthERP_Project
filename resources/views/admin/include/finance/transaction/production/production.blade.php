        ...
        <div class="col-sm-12">
          ...
          <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;" id="getPAgeTitleNAme"> Production</h2>

              <div class="box-tools pull-right">

                <a href="{{ url('finance/transaction/production/view-production') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Production</a>
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input list="fgList1"  id="fg_code" name="fg_code" class="form-control  pull-left" value="" placeholder="Select Finishing Good Code" oninput="this.value = this.value.toUpperCase()" autocomplete="off">
