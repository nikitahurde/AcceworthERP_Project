                        ...
                        <div class="form-group">
                          ...
                          <label>Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control transdatepicker" name="vr" id="vr_date" value="{{ $CurrentDate }}" placeholder="Select Date" autocomplete="off" onchange="requisition.vrDate()">
              ...
              <div class="table-responsive">
                ...
                <table class="table tdthtablebordr" border="1" cellspacing="0" id="tbledata">
                  ...
                  <tr class="useful">
                    ...
                    <td class="tdthtablebordr">
                      <div class="input-group">
                        <!-- <input list="ItemList1" class="inputboxclr SetInCenter" style="width: 90px;margin-bottom: 5px;" id='ItemCodeId1' name="item_code[]"  onchange="requisition.ItemCodeGet(1,itemcodeurl,quaitemurl);"  oninput="this.value = this.value.toUpperCase()" readonly /> -->
                    ...
                    <td class="tdthtablebordr">
                      ...
                      <input type='text' class="debitcreditbox dr_amount inputboxclr SetInCenter getqtytotal quantityC moneyformate"  id='qty1' name="qty[]" oninput='requisition.Getqunatity(1)'style="width: 80px" readonly />
                      <input type="hidden" id="qtyget1" class="totlqty">
    ...
    color: #5d9abd;
      ...
      <br>
        ...
        <p class="text-center">
          ...
          <button class="btn btn-success" type="button" id="submitdata" onclick="requisition.submitdata(submitdataurl)" disabled><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;&nbsp; Save</button>
