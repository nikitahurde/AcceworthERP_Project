                        ...
                        <div class="form-group">
                          ...
                          <label>Date: <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control transdatepicker" name="vr" id="vr_date" value="{{ $CurrentDate }}" placeholder="Select Date" autocomplete="off" onchange="storereturn.vrDate()">
                        ...
                        <div class="form-group">
                          ...
                          <label> Employee Code : <span class="required-field"></span></label>
                            ...
                            <div class="input-group">
                              ...
                              <input list="emplList" class="form-control" name="emp_code" value="" id="emp_code" placeholder="Enter Employee Code" autocomplete="off" onchange="storereturn.EmpCode()" readonly="">
    ...
    color: #5d9abd;
      ...
      <br>
        ...
        <p class="text-center">
          ...
          <button class="btn btn-success" type="button" id="submitdata" onclick="storereturn.submitdata(submitdataurl)" disabled><i class="fa fa-floppy-o" aria-hidden="true"></i>&nbsp;&nbsp; Save</button>
