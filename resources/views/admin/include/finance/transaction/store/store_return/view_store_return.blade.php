...
<style>
  ...
  <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <a href="{{ url('finance/transaction/store/store-return') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Store Return</a>
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/finance/transaction/store/view-store-return') }}"
               ...
               success:function(data){
                  ...
                  if (data1.response == 'error') {
                      ...
                      if(data1.data==''){
                         ...
                         var srNo=1;
                         var tableid = objrow[0].store_return_head_id ;
                      ...
                      var deletebtn ='<a class="btn btn-warning btn-xs" title="edit" disabled><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" disabled><i class="fa fa-trash" title="Delete"></i></button>';
                        ...
                        var enableBtn = 'enable';
                      var deletebtn ='<a href="edit-purchase-indent/'+btoa(objrow.store_return_head_id)+'" class="btn btn-warning btn-xs" title="edit"><i class="fa fa-pencil" title="Edit"></i></a> | <button class="btn btn-danger btn-xs" data-toggle="modal" onclick="return pindentDelete('+objrow.id+');"><i class="fa fa-trash" title="Delete"></i></button>';
                    }
                               $('#childData_'+tableid).append('<tr><td class="text-center">'+srNo+'</td><td><p>'+objrow.item_name+' </p><p style="line-height: 2px;">( '+objrow.item_code+')</p></td><td class="text-right">'+objrow.return_qty+' '+objrow.return_qty_um+'</td><td class="text-right">'+objrow.return_aqty+' '+objrow.return_qty_aum+'</td><td class="text-right">'+deletebtn+'</td></tr>');
                              srNo++;
                             });
