...
<style>
  ...
  <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <a href="{{ url('/finance/transaction/sales-transaction') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Sales Trans</a>
   ...
   $(document).ready(function(){
    ...
    var t = $("#example").DataTable({
       ...
       ajax:{
        ...
        url : "{{ url('/finance/transaction/view-sales-transaction') }}"
   ...
   function showchildtable(vrno,tblid){
            var vrno,tblid;
             ...
             $.ajax({
              ...
              url:"{{ url('view-sale-chield-row-data') }}",
               ...
               success:function(data){
                  ...
                  if (data1.response == 'error') {
                      ...
                      if(data1.data==''){
                         ...
                         var srNo=1;
                         var tableid = objrow[0].sales_head_id;
