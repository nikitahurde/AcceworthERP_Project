...
class SaleMonthlyChallanExport implements FromCollection, WithHeadings,ShouldAutoSize,WithCustomStartCell,WithEvents
{
    /**
    ...
    */
    ...
    public function headings():array{
      ...
      //DB::enableQueryLog();
                  ...
                  $CNTR_BODY = DB::select("SELECT SCHALLAN_HEAD.VRDATE,SCHALLAN_HEAD.PFCT_CODE,SCHALLAN_HEAD.PLANT_CODE,SCHALLAN_HEAD.TRAN_CODE,MASTER_ACC.ACC_NAME AS ACC_NAME,SCHALLAN_BODY.* FROM SCHALLAN_HEAD LEFT JOIN SCHALLAN_BODY ON SCHALLAN_HEAD.SCHALLANHID = SCHALLAN_BODY.SCHALLANHID LEFT JOIN MASTER_ACC ON SCHALLAN_HEAD.ACC_CODE = MASTER_ACC.ACC_CODE WHERE 1=1 $strWhere");
