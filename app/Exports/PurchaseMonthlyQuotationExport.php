...
class PurchaseMonthlyQuotationExport implements FromCollection, WithHeadings,ShouldAutoSize,WithCustomStartCell,WithEvents
{
    /**
    ...
    */
    ...
    public function headings():array{
      ...
      //DB::enableQueryLog();
                  ...
                  $CNTR_BODY = DB::select("SELECT PQTN_HEAD.VRDATE,PQTN_HEAD.PFCT_CODE,PQTN_HEAD.PLANT_CODE,PQTN_HEAD.TRAN_CODE,MASTER_ACC.ACC_NAME AS ACC_NAME,PQTN_BODY.* FROM PQTN_HEAD LEFT JOIN PQTN_BODY ON PQTN_HEAD.PQTNHID = PQTN_BODY.PQTNHID LEFT JOIN MASTER_ACC ON PQTN_HEAD.ACC_CODE = MASTER_ACC.ACC_CODE WHERE 1=1 $strWhere");
