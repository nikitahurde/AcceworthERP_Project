...
class SaleMonthlyContractExport implements FromCollection, WithHeadings,ShouldAutoSize,WithCustomStartCell,WithEvents
{
    /**
    ...
    */
    ...
    public function headings():array{
      ...
      //DB::enableQueryLog();
                  ...
                  $CNTR_BODY = DB::select("SELECT SCNTR_HEAD.VRDATE,SCNTR_HEAD.PFCT_CODE,SCNTR_HEAD.PLANT_CODE,SCNTR_HEAD.TRAN_CODE,MASTER_ACC.ACC_NAME AS ACC_NAME,SCNTR_BODY.* FROM SCNTR_HEAD LEFT JOIN SCNTR_BODY ON SCNTR_HEAD.SCNTRHID = SCNTR_BODY.SCNTRHID LEFT JOIN MASTER_ACC ON SCNTR_HEAD.ACC_CODE = MASTER_ACC.ACC_CODE WHERE 1=1 $strWhere");
