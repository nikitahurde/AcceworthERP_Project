...
class SaleMonthlyOrderExport implements FromCollection, WithHeadings,ShouldAutoSize,WithCustomStartCell,WithEvents
{
    /**
    ...
    */
    ...
    public function headings():array{
      ...
      //DB::enableQueryLog();
                  ...
                  $CNTR_BODY = DB::select("SELECT SORDER_HEAD.VRDATE,SORDER_HEAD.PFCT_CODE,SORDER_HEAD.PLANT_CODE,SORDER_HEAD.TRAN_CODE,MASTER_ACC.ACC_NAME AS ACC_NAME,SORDER_BODY.* FROM SORDER_HEAD LEFT JOIN SORDER_BODY ON SORDER_HEAD.SORDERHID = SORDER_BODY.SORDERHID LEFT JOIN MASTER_ACC ON SORDER_HEAD.ACC_CODE = MASTER_ACC.ACC_CODE WHERE 1=1 $strWhere");
