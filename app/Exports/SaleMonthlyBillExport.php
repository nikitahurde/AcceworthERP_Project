...
class SaleMonthlyBillExport implements FromCollection, WithHeadings,ShouldAutoSize,WithCustomStartCell,WithEvents
{
    /**
    ...
    */
    ...
    public function headings():array{
      ...
      //DB::enableQueryLog();
                  ...
                  $CNTR_BODY = DB::select("SELECT SBILL_HEAD.VRDATE,SBILL_HEAD.PFCT_CODE,SBILL_HEAD.PLANT_CODE,SBILL_HEAD.TRAN_CODE,MASTER_ACC.ACC_NAME AS ACC_NAME,SBILL_BODY.* FROM SBILL_HEAD LEFT JOIN SBILL_BODY ON SBILL_HEAD.SBILLHID = SBILL_BODY.SBILLHID LEFT JOIN MASTER_ACC ON SBILL_HEAD.ACC_CODE = MASTER_ACC.ACC_CODE WHERE 1=1 $strWhere");
