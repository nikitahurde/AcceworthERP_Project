                          ...
                          <div class="col-md-4">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input list="AccountList"  id="account_code" name="AccCode" class="form-control  pull-left" value="<?php if($getacccount==1){echo $acc_list[0]->ACC_CODE;} ?>" placeholder="Select Account" oninput="this.value = this.value.toUpperCase()" autocomplete="off" onchange="getpurOrderNum()">
                          ...
                          <div class="col-md-4">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input  id="AccountText" name="AccountText" class="form-control  pull-left" value="<?php if($getacccount==1){echo $acc_list[0]->ACC_NAME;} ?>" placeholder="Select Account" readonly autocomplete="off">
              ...
              var data1 = JSON.parse(data);
                ...
                if (data1.response == 'error') {
                  ...
                  if(data1.tax_data == ''){
                      ...
                      $("#TaxcodeList").empty();
                      $.each(data1.tax_data, function(k, gettax){
        ...
        if(foundItm == ''){
          ...
          $.ajax({
              ...
              success: function (data) {
               ...
               window.location.href = "{{ url('/Transaction/Purchase/view-Good-Reciept-Note-Trans') }}";
                      ...
                      $('#errorItem').html("<p style='color:red'>"+ data1.message +"</p>");
                        ...
                        if(data1.data_sim==''){
                          ...
                          $.each(data1.data_sim, function(k, getData) {
                            ...
                            var bodyData = "<div class='box-row'><div class='box10 texIndbox'>"+getData.IND_GL_CODE+"</div> <div class='box10 texIndbox'>"+getData.glName+"</div> <div class='box10 rateIndbox'>"+getData.DR_AMT+"</div> <div class='box10 rateBox'>"+getData.CR_AMT+"</div></div>";
