...
Route::get('/prnpriview','FinanceMasterController@prnpriview');
  ...
  Route::get('/DEMO-FILE', 'ColdStorageTransController@demoCode');
...
/* ---------- start dashboard ---------*/
  ...
  Route::post('/dashboard/logistics/track-vehicle/sync-all-vehicle-etrans', 'DashboardController@getSyncAllVehicleeTrans');
...
/* --------------- for new cash bank -------------- */
  ...
  Route::post('/Transaction/Account/download-pdf-on-view-page', 'FinanceAccountTransController@donwloadPdfOnViewPage');

  Route::post('/account/cash-bank-transaction/update', 'FinanceAccountTransController@CashBankFormUpdate');

  Route::get('/view-cash-bank-updated-success-msg/{savedata}', 'FinanceAccountTransController@cashbank_update_success_msg');

  Route::get('/finance/Account/Edit-Cash-Bank/{compCd}/{fyCd}/{tranCd}/{seriesCd}/{vrNo}', 'FinanceAccountTransController@EditCashBank');

  Route::post('get-related-data-on-cash-bank-edit-mode', 'FinanceAccountTransController@LoadQueryOnEditCashBank');

/* --------------- for new cash bank -------------- */

/* ------------ START : POSTING PAYMENT ADVICE -----------*/
  
  Route::get('/transaction/account/add-posting-payment-advice', 'FinanceAccountTransController@AddPostingPayAdvice'); 

  Route::post('/Transaction/get-posting-data-against-account', 'FinanceAccountTransController@getPostingDataAgainstAcc');
  
  Route::post('/transaction/account/save-postng-payment-advice', 'FinanceAccountTransController@SavePostingPaymentAdvice');

  Route::get('/view-posting-payment-advice-success-msg/{savedata}', 'FinanceAccountTransController@postingPayAdv_success_msg');
  
/* ------------ END : POSTING PAYMENT ADVICE -----------*/

/* ----------- START : SISTER CONCERN ENTRY ---------- */
  
  Route::get('/transaction/account/sister-concern-entry-repair', 'FinanceAccountTransController@AddRepairEntry');

  Route::post('/Transaction/get-repair-data', 'FinanceAccountTransController@getRepairData');
  Route::post('/transaction/account/save-sister-concern-entry','FinanceAccountTransController@SaveSisterConcernEntry');
  Route::post('/get-series-against-company-of-acc','FinanceAccountTransController@GetSeriesListOfAccComp');

  Route::get('/transaction/account/sister-concern-save-msg/{savedata}', 'FinanceAccountTransController@SisterConcernSaveMsg');

  Route::post('/get-acc-code-list-against-ssTran-type-in-ss','FinanceAccountTransController@AccListForSSType');
  
  Route::post('/show-details-on-click-of-row-in-account-section-page','FinanceAccountTransController@ShowBodyDetailInAccSection');

/* ----------- END : SISTER CONCERN ENTRY ---------- */

 /* ~~~~~~~~~~~~~~~ START : BANK RECO. ~~~~~~~~~~~~~~~~ */

 
 Route::get('/transaction/account/add-bank-reconciliation', 'FinanceAccountTransController@bankReconciliation');
 Route::get('/transaction/account/get-data-on-bank-reconciliation', 'FinanceAccountTransController@getDataOnBankRecon');
 Route::post('/transaction/account/save-bank-reconciliation', 'FinanceAccountTransController@saveBankReconciliation');

 Route::get('/transaction/account/bank-reconciliation-statement', 'FinanceAccountTransController@bankReconciliationStatement');

 Route::post('/transaction/account/bank-reconciliation-statement-data', 'FinanceAccountTransController@bankReconciliationStatementData');
 Route::post('/get-details-against-type-in-bank-reconciliation-statement', 'FinanceAccountTransController@bankReconStatementDetails');
...
/* --------------- for pdc cheque cash -------------- */
 ...
 /* Route::get('/Transaction/Account/Pdc-Chq-Transaction', 'FinanceAccountTransController@PdcChqTransaction');
  Route::post('/save-pdc-cheque-transaction', 'FinanceAccountTransController@SavePdcChequeTran');*/

  /* --------------- for pdc cheque cash -------------- */

  Route::get('/Transaction/Account/Pdc-Chq-Transaction', 'FinanceAccountTransController@PdcChqTransaction');
  Route::post('/save-pdc-cheque-transaction', 'FinanceAccountTransController@SavePdcChequeTran');
  Route::get('/Transaction/Account/View-Pdc-Chq-Transaction', 'FinanceAccountTransController@ViewPdcChqTransaction');



/* --------------- for pdc cheque cash -------------- */

/* --------------- for bank guarntee  cash -------------- */


Route::get('/Transaction/Account/Bank-Guarantee-Tran', 'FinanceAccountTransController@AddBgTran');
Route::post('/save-bank-guarntee-transaction', 'FinanceAccountTransController@SaveBankGurnteeTran');
Route::get('/Transaction/Account/View-Bank-Guarantee-Tran', 'FinanceAccountTransController@ViewBankGurnteeTran');
...
Route::get('/Transaction/Account/Renew-Bank-Guarantee-Tran', 'FinanceAccountTransController@AddRenewBgTran');
Route::post('/save-renew-bank-guarntee-transaction', 'FinanceAccountTransController@SaveRenewBankGurnteeTran');
Route::get('/Transaction/Account/View-Renew-Bank-Guarantee-Tran', 'FinanceAccountTransController@ViewRenewBankGurnteeTran');
Route::get('/get-old-bank-guarntee-tran', 'FinanceAccountTransController@getDataOldBankGurntee');
/* --------------- for bank guarntee  cash -------------- */
...
/* ----------- start bill tracking -------- */
  ...
  Route::get('/transaction/Logistics/Bill-status-report', 'ReportLogisticsController@SalebillReport');

  Route::get('/get-data-logistics-sale-bill-report', 'ReportLogisticsController@getLogisticsSaleReport');
...
/* -------- start account master ------- */
    ...
    Route::get('/Master/generate-dyanamic-code', 'CommonFunction@GenerateCode');
...
/* ----- start glsch master -----*/
  ...
  Route::get('/Master/GL/List-GL-Schedule', 'GlController@GlSchList');
...
Route::get('/Master/Item/View-Item-Master-Excel', 'ItemController@itemMasterViewExcel');
...
Route::get('/Master/Item/List-Item-Schedule', 'ItemController@ListItemSch');
...
/* -------- start item um master --------- */
  ...
  Route::get('/Master/Item/get-data-ItemUM_Mast', 'ItemController@getdataItemUm');
...
/* ------ end storage location ----------*/
 ...
 /*--------------Item Batch Balance---------------------*/
   ...
   Route::get('/Master/Item/Add-Item-Batch-balance','ItemController@AddBatchBalance');

    Route::post('/Master/Item/Save-Item-Batch-balance','ItemController@SaveBatchBalance');
    
    Route::get('/Master/Item/View-Item-Batch-balance','ItemController@ViewBatchBalance');

    Route::get('/Master/Item/Edit-Item-Batch-balance/{id}','ItemController@EditBatchBalance');

    Route::post('/Master/Item/Editdata-Item-Batch-balance','ItemController@EditDataBatchBalance');

    Route::post('/Master/Item/Update-Item-Batch-balance','ItemController@updateBatchBalance');
   
    Route::post('/Master/Item/Delete-Item-Batch-balance','ItemController@DeleteBatchBalance');
...
/*----------- start : fleet truck wheel form ----------*/
 ...
 Route::get('/logistic/edit-fleet-transaction/{id}', 'LogisticController@EditFleetForm');
  ...
  Route::post('get-vehicle-freight-type', 'LogisticController@getFreightType');
...
/*----------- start : trip expense----------*/
 ...
 // Route::get('/logistic/edit-fleet-transaction/{id}', 'LogisticController@EditFleetForm');
  ...
  Route::get('/transaction/logistics/trip-exp-payment-advice', 'ReportMisController@tripExpPaymentAdvice');
...
/* -------- start: Driver Master ------------*/
  ...
  Route::get('/master/logistic/driver-master', 'LogisticController@driverMaster');
  Route::post('/master/logistic/save-driver-master', 'LogisticController@saveDriverMaster');
  Route::get('/master/logistic/view-driver-master', 'LogisticController@viewDriverMaster');
  Route::get('/master/logistic/edit-driver-mast/{emp_code}/{vehicle_no}', 'LogisticController@EditDriverMaster');

  Route::post('/master/logistic/update-driver-master', 'LogisticController@UpdateDriverMaster');
...
/* ______________ START COLD STORAGE TRANSACTION ______________ */
  ...
  /* ---------- START ORDER PLAN ------------ */
    ...
    Route::get('/transaction/ColdStorage/add-order-plan-transaction', 'ColdStorageTransController@AddOrderPlanCS');
    Route::get('/transaction/ColdStorage/View-order-plan-tran-msg/{savedata}', 'ColdStorageTransController@order_plan_savemsgCS');
    Route::get('/transaction/ColdStorage/view-order-plan-transaction', 'ColdStorageTransController@ViewOrderPlanCS');

    Route::post('/transaction/ColdStorage/Save-order-plan-transaction', 'ColdStorageTransController@SaveOrderPlanCS');
  ...
  /* ---------- START GATE INWARD -----------*/
    ...
    Route::get('/transaction/ColdStorage/Bilty-Report', 'ReportColdStorageController@BiltyReport');

    Route::get('/transaction/ColdStorage/Sale-bill-Report', 'ReportColdStorageController@SaleBillReport');

    Route::get('/transaction/Logistics/Daily-padta-report', 'ReportColdStorageController@dailyPadtaReport');

    Route::get('/transaction/Logistics/Daily-trip-plan-report', 'ReportColdStorageController@dailyTripPlan');

    Route::get('/get-data-daily-trip-plan', 'ReportColdStorageController@getdailyTripData');

    Route::get('/report/logistic/trip-planning/daily-trip-expense-report', 'ReportLogisticsController@ExpReport');

    Route::post('/get-data-daily-trip-expense-report', 'ReportLogisticsController@dailyExpenseReport');


    Route::get('/get-data-daily-padta-report', 'ReportColdStorageController@getDatadailyPadta');
    
    Route::get('get-data-sale-bill-report', 'ReportColdStorageController@getDataSalebill');
...
/* ------------ cold storage ajax ------------- */
  ...
  Route::post('/get-storage-space-from-order-plan', 'ColdStorageTransController@getPlanSpaceAgainstCustomer');
...
/* ------- START : TDS PAYMENT ALLOCATION --------*/
  ...
  Route::get('/transaction/account/InDirect-Direct-Tax/Tds-payment-allowcation','FinanceAccountTransController@TdsPaymentAllowcation');
  Route::get('/get-data-tdsCode','FinanceAccountTransController@getDataTdsCode');
  Route::post('/Transaction/Account/Indirect-direct/tds-payment/get-data-TdsGlCode','FinanceAccountTransController@getDataTdsGlCode');
  Route::post('/Transaction/Account/Indirect-direct/tds-payment/get-data-pmtVocherNo','FinanceAccountTransController@getDataPaymentVocherNo');
  Route::post('/Transaction/Account/Indirect-direct/tds-payment/get-data-proceedGetDataUpdate','FinanceAccountTransController@updateProceedIdGetData');
  Route::get('/get-data-view-tds-payment-allowcation', 'FinanceAccountTransController@getViewTdsPaymentAllowcation');

/* ------- END : TDS PAYMENT ALLOCATION --------*/

/* --------- start fleet transaction -------------*/
  
  Route::get('/logistic/fleet-transaction', 'FinanaceLogisticController@FleetTrnas');

  Route::get('/logistic/adhoc-advance-vehicle', 'FinanaceLogisticController@AddVehicleAdhocAdvance');
...
', 'FinanaceLogisticController@ExpenseDataBySuppl');
  ...
  Route::post('get-vehicle-routes-delivery-charge', 'FinanaceLogisticController@VehicleRoutesDeliveryChg');
   ...
   Route::post('get-ref-qty-for-ref-trip-no', 'FinanaceLogisticController@GeRefQtyRefTripNo');

  Route::post('get-Indicator-details', 'FinanaceLogisticController@IndicatorDetails');

   Route::post('/gl-code-for-employee-code', 'FinanaceLogisticController@getGlForEmployee');
...
/* --------- start suplimentry  trip transaction -------------*/
  ...
  Route::get('/logistic/change_vehicle-lr', 'LogisticController@NewSupplimentryTrnas');

  Route::get('/logistic/change_Consinee-lr', 'LogisticController@NewConsineeTrnas');
  Route::post('/get-data-for-ship-to-party-field', 'LogisticController@ShipToPartyFun');

   Route::post('/suplimentry-change_Consinee-trans-update', 'LogisticController@ConsineeTransUpdate');

  Route::post('/get-data-DoNo','LogisticController@getDataDoNo');
  Route::post('/get-data-newConsineeAddress','LogisticController@getDatanewConsineeAddress');
  

  Route::post('/get-data-from-trip-head', 'LogisticController@GetTripData');

  Route::post('/add-supplimentry_trans', 'LogisticController@UpdateTripData');
...
/* -------- start fleet challan receipt ------------- */
  ...
  Route::post('save-party-bil', 'FinanaceLogisticController@SaveInPartyBill');
...
/* --------- start trpt bill generate ----------- */
  ...
  Route::get('/logistic/transport-bill-posting', 'FinanaceLogisticController@TransporterPartyBill');
   ...
   Route::post('/lr-ack-transaction-Delete', 'FinanaceLogisticController@lrAcknowledgmentTransDelete');
  ...
  /* Route::post('pdf-donwload-when-view-transporter-bill-posting', 'LogisticController@GeneratePdfForTransportBill');*/
   ...
   Route::post('/logistics/view-sale-bill-transporter-chield-row-data', 'LogisticController@ViewChildTransporterSaleBill');
   Route::post('/Transaction/logistic/Delete-transporter-sale-bill', 'LogisticController@DeleteTransporterSaleBill');
  
/* --------- end trpt bill generate ----------- */



/* ---------- START : SALE BILL POSTING ---------*/


  Route::get('/logistic/sale-bill-provisional', 'PurchaseTransController@SaleBill');
  Route::get('/logistic/view-sale-bill-provisional', 'PurchaseTransController@ProvisionalSaleBillView');
  Route::post('/logistics/get-accCode-from-tranCode', 'PurchaseTransController@getAccCodeFromTranCode');
  Route::post('/logistics/get-data-from-lr-onsalebill', 'PurchaseTransController@getDataFromLrOnSaleBill');

  Route::post('/transition/get-plant-categoryfromplant-code', 'PurchaseTransController@getPlantCategoryFromPlantCode');
  Route::post('/transition/get-otherDetails-from-acc-code', 'PurchaseTransController@getOtherDetailsFromAccCode');
  Route::post('/logistics/save-sale-bill-logistics', 'PurchaseTransController@SaveSaleBill');

   Route::post('/logistics/get-taxcode-onlogistic-sale-bill', 'PurchaseTransController@TaxCodeOnSaleBill');

   Route::post('/logistics/check-stateOn-search-btn', 'PurchaseTransController@checkTaxCodeOnAccAndPlantState');

  Route::get('/logistics/temp-sale-bill-logistics-save/{savedata}', 'PurchaseTransController@DirectSaleBillLogisticsSaveMsgTemp');


  Route::get('/logistic/sale-bill-final', 'PurchaseTransController@SaleBillFinalLogistics');

  Route::post('/logistics/get-data-from-sbill-prov', 'PurchaseTransController@getDataFromSbillProvOnSaleBillFinal');

  Route::post('/transaction/logistics/save-final-sale-bill', 'PurchaseTransController@saveFinalSaleBill');

  Route::post('/get-simulation-data-for-final-sale-bill-logistic', 'PurchaseTransController@SimulationForFinalSaleBill');

  Route::get('/logistics/final-sale-bill-logistics-save/{savedata}', 'PurchaseTransController@FinalSaleBillLogisticsSaveMsgTemp');

  Route::post('/logistics/view-sale-bill-provisional-chield-row-data', 'PurchaseTransController@tempSaleBillChildView');

  Route::post('/logistic/provisional-bill/check-eproc-status-sale-bill-provisional', 'PurchaseTransController@eProcStatusCheck');

  Route::post('/logistic/provisional-bill/delete-sale-bill-provisional', 'PurchaseTransController@deleteSaleBillProvisional');

  Route::get('/logistic/view-sale-bill-final', 'PurchaseTransController@ViewSaleBillFinalLogistics');

  Route::post('/logistics/view-sale-bill-final-chield-row-data', 'PurchaseTransController@tempSaleBillFinalChildView');

  Route::post('/transaction/logistic/delete-sale-bill-final', 'PurchaseTransController@DeleteSaleBillFinalLogistics');

  Route::get('/logistic/view-sale-bill-final-msg/{deleteId}', 'PurchaseTransController@MsgSaleBillFinalLogistics');

  Route::post('/transaction/logistics/sale-bill/sale-bill-final-offline-pdf', 'PurchaseTransController@SaleBillFinalLogisticsOffLinePdf');


/* ---------- END : SALE BILL POSTING ---------*/



/* ---------- START : E - PROE STATUS ---------*/

Route::get('/logistic/e-proc-status', 'FinanaceLogisticController@AddEprocStatus');
Route::post('logistic/e-Proc-Status-import', 'FinanaceLogisticController@importEprocStatusExcel');
Route::post('/finance/save-eproc-status', 'FinanaceStoreController@SaveEprocStatus');
Route::get('/logistic/e-proc-status-success-msg/{savedata}', 'FinanaceStoreController@eproc_sueeccss_msg');

/* ---------- END : E - PROE STATUS ---------*/


/* ---------- START : Property Rental Utility ---------*/

Route::get('/transaction/property-rental-utility/add-billing-schedule', 'PurchaseTransController@AddBillingSchedule');

Route::get('/transaction/property-rental-utility/view-billing-schedule', 'PurchaseTransController@ViewBillingSchedule');

Route::post('/transaction/property-rental-utility/get-sale-order-for-rent', 'PurchaseTransController@getSaleOrderforRent');

Route::post('/transaction/property-rental-utility/get-sale-order-data', 'PurchaseTransController@getSaleOrderDataForBillingSchedule');

Route::post('/transaction/property-rental-utility/save-billing-schedule', 'PurchaseTransController@SaveBillingSchedule');

Route::get('/transaction/property-rental-utility/msg-billing-schedule/{msg}', 'PurchaseTransController@MsgBillingSchedule');

Route::post('/transaction/property-rental-utility/view-billing-schedule-body', 'PurchaseTransController@ViewBillingScheduleBody');

Route::get('/transaction/property-rental-utility/rent-bill-posting', 'PurchaseTransController@RentBillPosting');

Route::post('/transaction/property-rental-utility/get-pfct-state', 'PurchaseTransController@getPfctState');

Route::post('/transaction/property-rental-utility/get-taxcode-onrent-bill-posting', 'PurchaseTransController@RentBillPostingTaxCode');

Route::post('/transaction/property-rental-utility/get-itemcd-from-orderNo', 'PurchaseTransController@getItemCdFromOrderNo');

Route::post('/transaction/property-rental-utility/get-data-onRent-bill-posting', 'PurchaseTransController@getDataOnRentBillPosting');

Route::post('/transaction/property-rental-utility/rent-bill-posting-save', 'PurchaseTransController@SaveRentBillPosting');


Route::get('/transaction/property-rental-utility/rent-bill-posting-save-msg/{saveMsg}', 'PurchaseTransController@SaveRentBillPostingMsg');


/* ---------- END : Property Rental Utility ---------*/
...
/*start vehicle planing without item*/
  Route::get('/vehicle-planing-wo-item', 'FinanaceLogisticController@VehiclePlaningWoItem');
 
  Route::post('/finance/save-vehicle-plan-without-item', 'FinanaceLogisticController@SaveVehiclePlaningWoItem');
/*start vehicle planing without item*/
...
/* -------- start vehicle planing  ------------*/
  ...
  Route::get('Edit-trip-planing/{id}','FinanaceLogisticController@EditVehiclePlaning');
  Route::post('/logistic/trip-Planing-Update','FinanaceLogisticController@tripPlanningUpdate');
  Route::get('/logistic/trip-planning-update-msg/{saveData}','FinanaceLogisticController@tripPlanUpdateMsg');

  Route::post('/Transaction/loading-slip-submit', 'CandFTrnasController@TripPlanLoadingSlip');
  ...
  Route::post('/view-vehicle-plan-chield-row-data', 'FinanaceLogisticController@ViewChildVehiclePlan');
   ...
   Route::get('/approve-trip-payment-advice','FinanaceStoreController@ApproveVehiclePlaningView');

   Route::get('/create-expense-jv-self','FinanaceStoreController@CreateExpenseJvSelf');
   
   Route::get('/logistic/create-expense-jv', 'FinanaceStoreController@TripExpenseJv');

   Route::post('/logistic/save-expense-jv-self', 'FinanaceStoreController@SaveExpenseJvSelf');

   Route::get('/logistic/trip-planing-payment-advice', 'FinanaceStoreController@TripPlanPaymentAdvice');
   
   Route::post('/logistic/save-trip-plan-apprve-payment-advice', 'FinanaceStoreController@saveVehiclePaymentAdvice');
  ...
  Route::post('/update-acc-code-to-delivery-order', 'FinanaceLogisticController@updateAccCodebulkLorry');

  Route::post('/update-acc-code-to-delivery-order-for-rake', 'FinanaceLogisticController@updateAccCodeDeliveryOrderForRake');

  Route::post('/update-item-code-to-delivery-order', 'FinanaceLogisticController@updateItemCodeDeliveryOrder');

  
  Route::post('/update-data-to-sale-bill-eproc', 'FinanaceLogisticController@updateSaleBillProc');
  ...
  Route::post('/get-fso_rate-by-trip', 'FinanaceLogisticController@getFsoRate');

  Route::post('/get-min-gurantee-by-wheel_type_name', 'FinanaceLogisticController@getMinGurantee');

  Route::post('/get-vehicle-owner-by-vehicle-plan-wo-item', 'FinanaceLogisticController@getVehicleOwnerForWoItem');

  Route::post('/get-do-details-by-customer', 'FinanaceLogisticController@getDoNoDetaisl');
  Route::post('/get-do-details-by-customer-woitem', 'FinanaceLogisticController@getDoNoDetaislWoitem');

  Route::post('/get-lr-details-by-customer', 'FinanaceLogisticController@getLrNoDetails');

  Route::post('/get-cp-code-by-rake-acc-code', 'FinanaceLogisticController@getCpCodeByRakeAcc');


  Route::get('/get-do-details-by-acc_code', 'FinanaceLogisticController@getDoNoDetaislByAccCode');

   Route::post('/Get-Pfct-Code-Name-By-Plant-Vehicle-Plan', 'FinanaceLogisticController@PlantForVehicleNo');
  ...
  Route::post('/get-old-qty-for-donumber-qty-update', 'FinanaceLogisticController@getDeliveryOldQty');

  Route::post('/get-trip-no-for-update-trip', 'FinanaceLogisticController@getTripNoUpdate');

  Route::post('/get-old-qty-for-donumber-rake-qty-update', 'FinanaceLogisticController@getDeliveryOrderQtyRake');
  ...
  Route::get('/logistic/Change-Do-Destination', 'LogisticController@deliveryOrderChangeDest');

  Route::get('/logistic/Change-Trip-Destination', 'FinanaceLogisticController@tripChangeDest');

  Route::get('/logistic/get-data-cancel-delivery-order', 'LogisticController@deliveryOrderCancelQty');

  Route::get('/logistic/get-data-change-dest-delivery-order', 'LogisticController@deliveryOrderDestChange');

  Route::get('/logistic/get-data-change-dest-trip', 'FinanaceLogisticController@tripDestChange');
  ...
  Route::post('/transaction/update-delivery-order-destination', 'LogisticController@deliveryOrderChangeDestination');

  Route::post('/transaction/update-trip-destination', 'FinanaceLogisticController@tripChangeDestination');

  Route::post('/transaction/update-inward-do-destination', 'LogisticController@inwardDoChangeDestination');


  /*inward DO Destinantion*/
  Route::get('/logistic/Change-Inward-Do-Destination', 'LogisticController@InwrdDoChangeDest');
  Route::get('/logistic/get-data-change-dest-inward-do', 'LogisticController@InwardDoDestChange');
  Route::post('/transaction/update-inward-do-destination-inward', 'LogisticController@inwardDoChangeDestInward');
  /*inward DO Destinantion*/
...
/* -------- start ePOD Transaction  ------------*/
  ...
  Route::get('edit-epod-tranaction/{tripHid}/{epodStatus}','LogisticController@EditePODTran');
  ...
  Route::get('transaction/epod_update_msg/{savedata}', 'LogisticController@epod_update_msg');
...
/* -------- end ePOD Transaction  ------------*/
 ...
 /*logistic adhoc advance*/
   Route::post('/Transaction/Logistic/Save-Vehicle-Adhoc-Advance', 'FinanaceLogisticController@SaveVehicleAdhocAdvance');
 /*logistic adhoc advance*/
  ...
  Route::post('/Transaction/Logistic/Save-Vehicle-Gate-Inward', 'FinanaceLogisticController@SaveVehicleGateInward');
   ...
   Route::post('/Transaction/Logistic/Update-Vehicle-Gate-Inward', 'FinanaceLogisticController@UpdateVehicleGateInward');
    ...
    Route::post('/Transaction/Logistic/Delete-Vehicle-Gate-Inward', 'FinanaceLogisticController@DeleteVehicleGateInward');
  ...
  Route::post('/Transaction/Logistic/Save-Vehicle-Gate-Outward', 'FinanaceLogisticController@SaveVehicleGateOutward');
   ...
   Route::post('/Transaction/Logistic/Update-Vehicle-Gate-Outward', 'FinanaceLogisticController@UpdateVehicleGateOutward');
    ...
    Route::post('/Transaction/Logistic/Delete-Vehicle-Gate-Outward','FinanaceLogisticController@DeleteVehicleGateOutward');

  Route::get('/Transaction/View-vehicle-Gate-Outward-msg/{savedata}', 'FinanaceLogisticController@vehilce_inward_gate_msg');
  /*logidtic vehcile outward*/

  /*supplimentry logistic lorry receipt*/

   Route::get('/Transaction/Logistic/suppl-lorry-receipt-trans', 'FinanaceLogisticController@AddSupplLorryReceipt');
  ...
  Route::post('/Transaction/Logistic/delete-outward-lr-trans', 'FinanaceLogisticController@DeleteLorryReceipt');

   Route::post('/Transaction/Logistic/Update-lorry-receipt-trans', 'FinanaceLogisticController@UpdateLorryReceipt');

    Route::post('/Transaction/Logistic/get-trip-loading-slip-offline-pdf','FinanaceLogisticController@offlineTripLsPDF');
    
    Route::post('/Transaction/Logistic/get-lorry-offline-pdf','FinanaceLogisticController@offlineLrReceiptPDF');

    Route::post('/Transaction/Logistic/get-trip-expense-offline-pdf','FinanaceLogisticController@offlineTripExpReceiptPDF');
    
    Route::post('/Transaction/Logistic/get-lr-acknowledgment-offline-pdf','FinanaceLogisticController@offlineLRAckReceiptPDF');

    Route::post('/Transaction/Logistic/get-outward-lorry-offline-pdf','FinanaceLogisticController@offlineOutwardLrReceiptPDF');
  ...
  Route::post('/get-trip-details-by-trip-no-lr-ack', 'FinanaceLogisticController@getTripDetaislLrAck');

  Route::post('/get-trip-details-by-trip-no-for-suppl', 'FinanaceLogisticController@getTripDetaislforSupll');
  ...
  Route::get('/Transaction/Logistic/upload-ewb-data', 'FinanaceLogisticController@addEWBDetails');

  Route::get('/Transaction/Logistic/view-ewb-data', 'FinanaceLogisticController@veiwEWBDetails');
  
  Route::get('/Transaction/Logistic/save-ewb-data', 'FinanaceLogisticController@saveEWBDetails');
 ...
 /*lorry receipt ackonlogement*/
  ...
  //Route::get('/Transaction/Logistic/edit-lr-acknowledgment-trans/{tripid}', 'FinanaceLogisticController@EditLrAcnowledgment');
  Route::post('/Transaction/Logistic/Save-lr-acknowledgment-trans', 'FinanaceLogisticController@SaveLrAcnowledgment');

   Route::get('/Transaction/Logistic/edit-lr-acknowledgment-trans/{id}', 'FinanaceLogisticController@EditLrAcnowledgment');

   Route::post('/Transaction/Logistic/Update-lr-acknowledgment-trans', 'FinanaceLogisticController@UpdateEditLrAcnowledgment');
 ...
 /* delivery order*/
  ...
  Route::get('/Transaction/Logistic/View-Lorry-Receipt-Bulk-Details', 'FinanaceLogisticController@ViewLorryRecieptDetails');
 ...
 // Route::post('/finance/save-delivery-order', 'FinanaceLogisticController@SaveDeliveryOrder');
  ...
  Route::get('/Transaction/Logistic/View-Freight-Sale-Order-Details', 'FinanaceLogisticController@ViewFreightOrderDetails');

  Route::get('/Transaction/Logistic/View-Eproc-Data-Details', 'FinanaceLogisticController@ViewEprocDetails');

  Route::get('/Transaction/Logistic/View-Freight-Sale-Order-Details-excelview/{id}', 'FinanaceLogisticController@ViewFreightOrderDetailsExcel');
  ...
  Route::post('/Transaction/Logistic/Freight-Sale-Quatationgetdata', 'FinanaceLogisticController@getDatafreightsale');
  Route::get('/Transaction/Logistic/View-Freight-Sale-Order', 'FinanaceLogisticController@ViewFreightSaleOrder');
  Route::post('/transaction/logistic/freight-sale-quotation-vehicle-type-name', 'LogisticController@FreightSaleQuotationVelTypeName');
...
Route::post('/validate-city-name-by-sp-code', 'FinanaceLogisticController@validateCityName');

Route::post('/get-route-details-by-from-place', 'FinanaceLogisticController@getRouteDetailsByFromPlace');


Route::post('/get-trip-days-from-place-to-place', 'FinanaceLogisticController@getTripDaysByFromPlace');
...
/*STORE ISSUE*/
  ...
  Route::post('/get-item-by-issue-num', 'FinanaceStoreController@GetitemByIssuenum');
   ...
   Route::post('/get-requestion-details-from-requestion', 'FinanaceStoreController@GetRequistionDetails');
...
/* ------ start purchase quotation comparision transaction ------ */
  ...
  Route::get('/Transaction/Purchase/Purchase-Quo-Comparision-View', 'PurchaseTransController@PurchaseQuoComparisionView');
  Route::post('view-purchase-comparision-chield-row-data', 'PurchaseTransController@PurchaseQuoComparisionChildData');
...
/* ----------- start job work order --------------- */
  ...
  Route::get('/Transaction/Purchase/Edit-Job-Work-Order/{headID}', 'PurchaseTransController@EditJobWorkOrder');
...
/* --------- start Direct purchase transaction -------*/
 ...
 Route::post('/simulation-for-direct-purchase-bill', 'PurchaseTransController@simulationForDirectPB');
...
/* -------- start journal transaction ----- */
  ...
  Route::post('/Transaction/Account/download-pdf-on-view-page-journal', 'FinanceAccountTransController@DownLoadPDFOnViewPageJV');
...
/* ------------ START : C AND F AJAX FUNCTION -------------*/
  ...
  Route::post('/get-batch-no-details-against-customer', 'CandFTrnasController@getBatchDeatilsByAcc');
  ...
  Route::post('/get-data-for-loading-slip-n-plan-from-inward', 'CandFTrnasController@GetDataForLoadingPlanForInward');
...
/* -------- EXPORT LR EXCEL ----------*/
  ...
  Route::get('/transaction/outward-tran/export-lr-c-and-f', 'CandFTrnasController@ExportLrExcel');
  Route::get('/transaction/outward-tran/export-lr-data', 'CandFTrnasController@ExportLrDataInExcel');
...
/* ---------- start gate inward transaction candf ---------- */
  ...
  Route::get('/transaction/CandF/view-gate-outward-transaction-cf', 'CandFTrnasController@ViewGateOutwardCF');

  Route::get('/transaction/c-and-f/create-delivery-order', 'PurchaseTransController@createDeliveryOrder');
  Route::get('/transaction/candf/list-off-delivery-order-rake', 'PurchaseTransController@getDeliveryOrderRake');
  ...
  Route::post('/transaction/c-and-f/create-do/get-rakeFrom-order-no', 'PurchaseTransController@getRakeDataFromOrderNo');

  Route::post('/transaction/c-and-f/create-do/check-unique-rake', 'PurchaseTransController@checkUniqueRake');

  Route::get('/transaction/c-and-f/inward-import-rake-tran', 'CandFTrnasController@ImportInward');
  Route::post('/transaction/CandF/save-inward-import-tran', 'CandFTrnasController@SaveInwardImport');

  Route::get('/transaction/c-and-f/add-inward-physical-verification', 'CandFTrnasController@AddInwardPhysicalVerify');

  Route::post('/get-field-data-from-inword-for-physical-verification', 'CandFTrnasController@GetFieldListForInwardVerify');
  
  Route::post('/get-data-from-inward-for-physical-verification', 'CandFTrnasController@GetDataForInwardVerify');

  Route::post('/transaction-CandF-save-inward-physical-verify', 'CandFTrnasController@SaveInwardPhysicalVerify');

  Route::get('/candf/inward-physical-verification/save-msg/{saveMsg}', 'CandFTrnasController@inwardVerifyMsg');
...
/* ----------- start inward transaction -------- */
  ...
  Route::post('/transparent/delete-data-common', 'CommonFunction@deleteTransactionData');
  Route::get('/transaction/delete-data/{saveMsg}/{pageUrl}/{pageMsg}', 'CommonFunction@deleteMsg');
  ...
  Route::post('item-um-aum', 'CandFTrnasController@Item_UM_AUM');
   ...
   Route::post('get-vehicle-detials-for-adhoc-advance', 'FinanaceLogisticController@VehicleForAdhocAavnace');

   Route::post('/get-transport-code-name-by-cpcode', 'FinanaceLogisticController@getTranNameByCpCode');

   Route::post('/get-do-number-by-cpcode', 'FinanaceLogisticController@getDoNumberByCpCode');

   Route::post('/get-rake-number-by-cpcode', 'FinanaceLogisticController@getRakeNumberByCpCode');

   Route::post('/get-do-no-by-rake-no', 'FinanaceLogisticController@getDoNumberByRakeNo');

   Route::post('/get-wagon-no-by-do-no', 'FinanaceLogisticController@getWagonByDoNumber');

   Route::post('/get-item-name-by-wagon-no', 'FinanaceLogisticController@getItemNameByWagon');
...
/* --------- start outward transaction ---------*/
  ...
  Route::get('transaction/CandF/add-outward-trans', 'FinanaceLogisticController@OutwardTrans');
  
  Route::get('transaction/CandF/view-outward-trans', 'FinanaceLogisticController@viewOutwardTrans');

  Route::get('transaction/CandF/view-suppl-lr-trans', 'FinanaceLogisticController@viewSupplLrTrans');

  Route::get('transaction/CandF/Edit-outward-lorry/{tran_code}/{vrno}/{series}/{comp_code}/{fy_code}/{trpt_type}','FinanaceLogisticController@EditOutwardTrans');
  Route::post('transaction/CandF/delete-outward-lr-trans', 'FinanaceLogisticController@DeleteOutwardTransLr');


/* --------- APPROVE TRIP MARKET ---------- */

  Route::get('/logistic/trip-planning/aprove-trip-market', 'LogisticController@ApproveTripMarket');
  Route::post('/get-trip-details-from-trip', 'LogisticController@GetDetailsFromTrip');
  Route::post('/logistic/update-approve-trip-market', 'LogisticController@UpdateApproveTripMarket');
  Route::post('/get-rate-against-purchase-freight-order-number', 'LogisticController@GetRateFromFreightPurchase');
...
/* --------- APPROVE TRIP MARKET ---------- */
  ...
  Route::get('transaction/CandF/job-work-sale-bill', 'CandFTrnasController@jobWorkSaleBill');

  Route::get('transaction/CandF/job-work-sale-bill-search-data', 'CandFTrnasController@jobWorkSaleBillData');

  Route::post('transaction/CandF/save-job-work-sale-bill-data-jwitem', 'CandFTrnasController@SavejobWorkSaleBillData');

  Route::post('get-simulation-data-for-job-work-sale-bill', 'CandFTrnasController@simulationForJobWorkSaleBill');

  Route::get('/transaction/CandF/view-job-work-sale-bill', 'CandFTrnasController@ViewJobWorkSaleBill');

  Route::post('transaction/CandF/view-job-work-sale-bill-chield-row-data', 'CandFTrnasController@JobWorkSaleBilChieldRTowData');

  Route::get('/transaction/CandF/view-job-work-sale-bill-msg/{savedata}', 'CandFTrnasController@job_work_sale_bill_msg');
  ...
  Route::get('transaction/CandF/job-work-purchase-bill', 'CandFTrnasController@jobWorkPurchaseBill');

  Route::get('transaction/CandF/job-work-purcahse-bill-search-data', 'CandFTrnasController@jobWorkPurchaseBillData');

  Route::post('transaction/CandF/save-job-work-purchase-bill-data-jwitem', 'CandFTrnasController@SavejobWorkPurcahseBillData');

  Route::post('get-simulation-data-for-job-work-purchase-bill', 'CandFTrnasController@simulationForJobWorkPurchaseBill');

  Route::get('/transaction/CandF/view-job-work-purchase-bill', 'CandFTrnasController@ViewJobWorkPurchaseBill');

  Route::post('transaction/CandF/view-job-work-purchase-bill-chield-row-data', 'CandFTrnasController@JobWorkPurBillChieldRTowData');
  Route::get('/transaction/CandF/view-job-work-pur-bill-msg/{savedata}', 'CandFTrnasController@job_work_purchase_bill_msg');
  ...
  /* -----------------  START : C AND F BILL ------------------- */
    ...
    Route::get('transaction/CandF/c-and-f-bill-tran', 'CandFTrnasController@AddJSWBillTran');
    Route::get('/transaction/CandF/view-c-and-f-bill-tran', 'CandFTrnasController@ViewCandFBill');
    Route::post('fetch-data-on-c-and-f-bill-tran', 'CandFTrnasController@FetchDataForCandFBill');
    Route::get('transaction/c-and-f/search-bill-data', 'CandFTrnasController@CandFBillsearchData');
    Route::post('transaction/c-and-f/save-C-and-F-bill-tran', 'CandFTrnasController@SaveCandFBillTran');
    Route::post('transaction/c-and-f/simulation-for-c-and-f-bill', 'CandFTrnasController@simulationForCandFBill');
    Route::post('get-tax-code-from-sale-order-against-item', 'CandFTrnasController@getTaxAgainstItemFrSaleOrder');
    Route::get('/transaction/Logistic/c-and-f-bill-msg/{savedata}', 'CandFTrnasController@CandFSaveMsg');
    Route::post('/Transaction/Logistic/get-c-and-f-bill-offline-pdf','CandFTrnasController@offlineCandFbillPDF');
...
/* ---------- start create loading slip ------------ */
  ...
  Route::get('transaction/candf/Edit-loading-slip/{compCd}/{fyCd}/{tranCd}/{seriesCd}/{vrno}/{loadingpageStatus}', 'CandFTrnasController@EditLoadingSlipWithoutPlan');

  Route::post('transaction/CandF/update-loading-slip-without-plan', 'CandFTrnasController@UpdateLoadingSlipWihoutPlan');
  Route::post('transaction/CandF/delete-loading-slip-without-plan', 'CandFTrnasController@DeleteLoadingSlipWithoutPlan');
  ...
  Route::post('transaction/CandF/outward-dispatch-update', 'FinanaceLogisticController@UpdateOutwardDispatch');

  Route::post('get-details-in-loading-slip-against-vehicle', 'CandFTrnasController@getDataInloadingSlip');
  Route::post('get-inward-details-against-item-in-loading-slip', 'CandFTrnasController@getInwardDataOnLoading');

  Route::get('/transaction/candf/create-loading-slip-without-plan', 'CandFTrnasController@AddCreateLoadingSlipWOPlan');

  Route::post('transaction/CandF/submit-loading-slip-without-plan', 'CandFTrnasController@SaveLoadingSlipWihoutPlan');

/* ---------- end create loading slip ------------ */

/* --------- start create loading and plan ---------- */
  
  Route::get('/transaction/candf/create-loading-and-plan', 'CandFTrnasController@AddCreateLoadingAndPlan');
  Route::get('transaction/candf/loading-plan/save-msg/{saveData}', 'CandFTrnasController@loading_plan_msgCf');

  Route::post('transaction/CandF/loading-and-plan-submit', 'CandFTrnasController@SaveLoadingAndPlan');

/* --------- end create loading and plan ---------- */
...
Route::get('/Master/Setting/add-menu-url', 'SettingController@MenuUrl');

Route::get('/Master/Setting/view-menu-url', 'SettingController@ViewMenuUrl');

Route::post('/Master/Setting/Save-menu-url', 'SettingController@SaveMenuUrl');

Route::get('/Master/Setting/Edit-menu-url/{id}', 'SettingController@EditMenuUrl');

Route::post('/Master/Setting/Update-menu-url', 'SettingController@UpdateMenuUrl');
...
/* ------------ master cheque print ---------- */
  ...
  Route::get('/configration/Setting/printing-cheque/{bnf_Name}/{chqDate}/{cheLeafNo}/{amount}/{amtInword}/{updatedChqCol}', 'SettingController@printingCheque');
  Route::post('account/get-cash-bank-details-for-cheque-print', 'FinanceAccountTransController@GetCashBankInfoForChequePrint');

/* ------------ master cheque print ---------- */

  /* ~~~~~~~~~~~~~ START : API TEST ROUTE ~~~~~~~~~~~~~~~~~~~ */

  Route::get('/configration/test-api-config', 'DevControllerOne@testApi');

  Route::post('/test-api/get-api-data', 'DevControllerOne@getApiData');

  Route::post('/test-api/runAPI', 'DevControllerOne@runApiData');

  Route::post('/test-api/apiNotRun-mail-send', 'DevControllerOne@apiNotRunSendMail');
 ...
 /*New Fy Year */
  ...
  Route::get('/report-intrest-ledger','ReportMisController@ReportIntrestLedger');

  Route::get('/report-statement-of-acc','ReportMisController@ReportstatementofAcc');

  Route::get('/report/statement-of-acc-data', 'ReportMisController@statemantOfAccData');
  Route::get('/Report/Account/Print-statement-of-acc/{data}', 'ReportMisController@StatementOfAccPrintFun');
  ...
  Route::post('/Report/account/show-opening-balence','ReportMisController@getOpeningBalOfacc');
  ...
  Route::get('/report/stock-inventory/process-item-age','Stock_InventoryController@ProcessItemAge');
  
  Route::post('/report/stock-inventory/process-item-save','Stock_InventoryController@ProcessItemSave');
  Route::get('/report/item-age-analysis-report', 'Stock_InventoryController@ItemAgeAnalysisReport');
  Route::get('/reports/stock/stock-age-wise-analysis','Stock_InventoryController@stockAgeAnalysis');
  Route::get('/accont/report/stock/view-stock-wise-ageAnalysis', 'Stock_InventoryController@getItemTypeWiseAgeAnalysisData');
   Route::post('/stock-wise-ageanalysis-data', 'Stock_InventoryController@StockAgeBarGraph');
   Route::post('/get-data-from-item-age-para','Stock_InventoryController@GetItemAgeParaOfComp');
   Route::post('/Report/account/get-item-age-parameter-for-heading','Stock_InventoryController@getItemAgeParameter');

  Route::get('/report/stock-inventory/Daily-pa-Data','DevControllerOne@dailyPData');
  ...
  Route::post('get-payment-advice-on-cash-bank', 'FinanceAccountTransController@selectPayAdviceOnCashBank');
   ...
   Route::post('get-data-by-acc-code-for-pay-advice', 'FinanceAccountTransController@GetDataByAccCodeForPayAd');
    ...
    Route::post('/finance/get-post-code-by-account-code-jbitem-salebill', 'CommonFunction@get_postCodeByAccJbSaleBill');

    Route::post('/finance/get-post-code-by-account-code-jbitem-purbill', 'CommonFunction@get_postCodeByAccJbPurBill');
...
/* ------- end item master ------*/
 ...
 /*-----***** Start: Finance Report Section *****-----*/
    ...
    Route::get('/report/account/bank-reconciliation-report', 'ReportMisController@getBankReconReport');

    Route::get('/report/account/get-data-onBank-recon-report', 'ReportMisController@getDataOnBankReconReport');

    Route::post('/report/account/bank-reco-series-gl-code', 'ReportMisController@getGlOnSeriesBankRecon');
    Route::get('/report/account/month-wise-summary-report', 'ReportMisController@getMonthWiseSummary');

     Route::get('/report/account/get-data-month-wise-summary-report', 'ReportMisController@getDataOnMonthWiseSummaryReport');

     Route::post('/report/account/month-wise-summary-series-gl-code', 'ReportMisController@getMonthWiseSummaryreport');
...
Route::get('/Transaction/Purchase/Debit-Note-Trans', 'PurchaseTransController@DebitNoteTransaction');
  ...
  Route::post('finance/freight-sale-order-import', 'FinanaceLogisticController@importFreightSaleExcel');
...
/* --------- commom ajax ------ */
  ...
  Route::post('/get-account-list-against-acc-type', 'CommonFunction@GetAccListAgainstAccType');
  ...
  Route::post('/get-last-no-vr-sequence-by-series-new', 'CommonFunction@GetlastnoBySeriesNew');
  Route::post('/get-vr-sequence-by-series-in-ss', 'CommonFunction@GetlastnoBySeriesInSS');
  ...
  Route::post('/logistic/delete-trip-data-details', 'CommonFunction@DeleteTripData');
  Route::post('/show-details-on-click-of-row-in-view-page', 'CommonFunction@ShowDetailsOnclickOfRowInViewPage');
...
/* --------- commom ajax ------ */
  ...
  /* ~~~~~~~~~~~ Start : Transpoter Sale Bill ~~~~~~~~~~~~~~~ */

  Route::get('transaction/Logistic/transporter-sale-bill', 'LogisticController@TransporterSaleBill');

  Route::post('/finance/get-post-code-by-account-code-item-salebill', 'LogisticController@get_postCodeByAccSaleBill');

  Route::get('transaction/Logistic/transporter-sale-bill-search-data', 'LogisticController@TransporterSaleBillData');

  Route::post('transaction/Logistic/save-transporter-sale-bill-data-item', 'LogisticController@SaveTransporterSaleBillData');

  Route::get('/transaction/Logistic/view-transporter-sale-bill', 'LogisticController@viewTransporterSaleBill');

  Route::get('/transaction/Logistic/transporter-sale-bill-msg/{savedata}', 'LogisticController@trpt_sale_bill_msg');

  Route::post('get-simulation-data-for-transporter-sale-bill', 'LogisticController@simulationForTransSaleBill');
  
  Route::post('/transaction/logistics/transporter-sale-bill/transporter-sale-bill-offline-pdf', 'LogisticController@TransporterSaleBillOffLinePdf');
  

  /* ~~~~~~~~~~~ end : Transpoter Sale Bill ~~~~~~~~~~~~~~~ */
  ...
  /* ---------- Start Get Purchase Pending Routes ------------*/
    ...
    Route::get('/report/logistic/lorry-receipt', 'ReportMisController@lorry_Receipt');
    Route::get('/get-data-dispatch-lorry-receipt', 'ReportMisController@getDispatchLorryReceipt');


     Route::get('/REPORT/LOGISTIC/MIS-REPORT', 'ReportMisController@MISReport');
     
     Route::get('/report/get-data-from-lrack-bill-pending', 'ReportMisController@getMISReportData');
    ...
    */
    ...
    Route::get('/report/c_and_f/stock-ledger', 'ReportMisController@stock_ledger');
    Route::get('/report/c_and_f/grn-inward', 'ReportMisController@grn_inward');

    Route::get('/report/c_and_f/dispatch-outward', 'ReportMisController@dispatch_outward');

    Route::get('/report/c_and_f/rake-summary-report', 'ReportMisController@rake_report');
    Route::get('/report/c-and-f/rake-do-summary', 'ReportMisController@rake_do_summary');
    Route::get('/report/c-and-f/rake-stock-party-summary', 'ReportMisController@rake_stock_party_summary');
    Route::get('/report/c_and_f/rake-report', 'ReportMisController@rakeReport');
    Route::get('/report/c_and_f/rake-summary', 'ReportMisController@rakeSummaryReport');
    Route::get('/report/c_and_f/get-rake-report', 'ReportMisController@rakeReportData');

    Route::get('/report/c-and-f/gate-entry/view-panding-outward', 'DevControllerTwo@ViwePandingOutword');

    Route::get('/transaction/Logistics/Trip-compleation-status', 'DashboardController@TripCompleationReport');
    
    Route::get('/report/c-and-f/gate-entry/panding-outward', 'DevControllerTwo@PandingOutword');
    Route::get('/report/c-and-f/gate-entry/view-chamber-report', 'DevControllerTwo@viewChamberReport');

    Route::get('/report/c-and-f/gate-entry/chamber-report', 'DevControllerTwo@chamberReport');
    Route::get('/report/c-and-f/gate-entry/watermark-image', 'DevControllerTwo@waterMarkImage');
    ...
    Route::get('/reporte/dynamicQuery-save/{dynamicQuery}/{tranCode}/{reportName}/{user_name}/{fromdate}/{todate}/{queryName}/{queryNameWS}/{groupOneval}/{groupTwoval}/{groupThreeVal}/{dataColumn}/{columnNameFr}/{columnNameSc}/{columnNameThr}/{columnNameFour}', 'ReportMisController@dynamicQuerySave');
    ...
    Route::get('/configration/list-database-table', 'SettingController@listDBConfig');

    Route::get('/configuration/update-column', 'SettingController@updateColumn');
    ...
    Route::get('/Trips/pending-outward-trip-status', 'DashboardController@PendingOutwordTrip');
   ...
   Route::get('/report/logistic/trip-planning/daily-trip-plan-report', 'ReportLogisticsController@dailyTripReport');

    Route::get('/get-data-daily-trip-planning-report', 'ReportLogisticsController@getdailyTripPlanReport');
    ...
    Route::get('/get-data-stock-ledger-report', 'ReportMisController@getStockLedgerReport');

    Route::get('/get-data-grn-inward-report', 'ReportMisController@getGrnInwardReport');
    
    Route::get('/get-data-rake-do-summary', 'ReportMisController@getRakeDoSummReport');

    Route::get('/get-data-rake-party-summary', 'ReportMisController@getRakeStockPartyReport');

    Route::get('/get-data-dispatch-outward-report', 'ReportMisController@getDispatchOutwardReport');
    ...
    Route::get('/report/c_and_f/get-rake-stock-summary','ReportMisController@ProceedRackStockReportData');
  ...
  /* ---------- End Purchase Pending Routes ------------*/
   ...
   /* ---------- Start Unit Master ------------*/
Route::get('Master/Infrastructure/Add-Unit-Type','DevControllerOne@AddUnitTypeInfra');

    Route::post('Master/Infrastructure/Add-Unit-Save','DevControllerOne@SaveUnitTypeInfra');

    Route::get('Master/Infrastructure/View-unit-type','DevControllerOne@ViewUnitTypeInfra');

    Route::get('/Master/Infrastructure/Edit-Unit-Type/{id}', 'DevControllerOne@EditUnitTypeInfra');

    Route::post('/Master/Infrastructure/Unit-Type-Update','DevControllerOne@UpdateUnitTypeInfra');

     Route::get('/Master/Infrastructure/add-unit-master','DevControllerOne@AddUnitMasterInfra');

     Route::post('/Master/Infrastructure/save-unit-master','DevControllerOne@SaveUnitMasterInfra');

     Route::get('/Master/Infrastructure/view-unit-master','DevControllerOne@ViewUnitMasterInfra');

     Route::get('/Master/Infrastructure/edit-unit-master/{id}', 'DevControllerOne@editUnitMasterInfra');

      Route::post('/Master/Infrastructure/update-unit-master','DevControllerOne@updateUnitMasterInfra');

      Route::post('/Master/Infrastructure/Delete-Unit-master','DevControllerOne@deleteUnitMasterInfra');

       Route::get('/Master/Infrastructure/add-unit-wbs-master','DevControllerOne@AddUnitWbs');

       Route::post('/Master/Infrastructure/save-unit-wbs-master','DevControllerOne@saveUnitWbs');

        Route::get('/Master/Infrastructure/view-unit-wbs-master','DevControllerOne@viewUnitWbs');
        

         Route::get('/Master/Infrastructure/edit-unit-wbs-master/{id}', 'DevControllerOne@editUnitWbs');

         Route::post('/Master/Infrastructure/update-unit-wbs-master','DevControllerOne@updateUnitWbs');



   /* ---------- END Unit Master ------------*/

   /* ---------- Start Project Master ------------*/


    Route::get('/Master/Infrastructure/Add-Project-Master','InfrastructureMasterController@AddProjectInfra');

    Route::post('/Master/Infrastructure/Save-Project-Master','InfrastructureMasterController@SaveProjectInfra');
    
    Route::get('/Master/Infrastructure/View-Project-Master','InfrastructureMasterController@ViewProjectMasterInfra');

    Route::get('/Master/Infrastructure/Edit-Project-Master/{id}','InfrastructureMasterController@EditProjectInfra');

    Route::post('/Master/Infrastructure/Editdata-Project-Master','InfrastructureMasterController@EditdataProjectInfra');

    Route::post('/Master/Infrastructure/Update-Project-Master','InfrastructureMasterController@updatedataProjectInfra');
   
    Route::post('/Master/Infrastructure/Delete-Project-Master','InfrastructureMasterController@DeleteProjectInfra');

   // ----End Project Master---------
  
   /* ---------- Start Project Details Master ------------*/

    Route::get('/Master/Infrastructure/Add-Project-Detail-Master','MasterController@AddProjectDetails');

    Route::get('/Master/Infrastructure/View-Project-Detail-Master', 'MasterController@ViewProjectDetails');

    Route::get('/Master/Infrastructure/Edit-Project-Detail/{id}', 'MasterController@EditProjectDetails');

    Route::post('/Master/Infrastructure/Save-Project-Detail-Master', 'MasterController@SaveProjectDetails');

    Route::post('/Master/Infrastructure/Update-Project-Detail-Master', 'MasterController@UpdateProjectDetails');

    Route::post('/Master/Infrastructure/Delete-Project-Detail-Master', 'MasterController@DeleteProjectDetails');

   /* ---------- END Project Details Master ------------*/

   /*----- Start  Milestone Master------------*/

    Route::get('Master/Infrastructure/Add-Milestone','DevControllerTwo@AddMileStone');

    Route::post('Master/Infrastructure/Add-Milestone','DevControllerTwo@SaveMilestone');

    Route::get('Master/Infrastructure/View-Milestone','DevControllerTwo@ViewMilestoneMaster');

    Route::get('Master/Infrastructure/Edit-Milestone-Master/{id}','DevControllerTwo@EditMilestoneMaster');
    
    Route::post('Master/Infrastructure/update-Milestone-Master','DevControllerTwo@updateMilestone');

    Route::post('Master/Infrastructure/Delete-Milestone-Master','DevControllerTwo@DeleteMilestone');
   
   /*----- End  Milestone Master------------*/


    /* ------Start Project Wbs Master---------*/

    Route::get('Master/Infrastructure/Add-Project-Wbs-Master','DevControllerTwo@AddProjectWbs');

    Route::post('Master/Infrastructure/Save-Project-Wbs-Master','DevControllerTwo@SaveProjectWbs');

    Route::get('Master/Infrastructure/View-Project-Wbs-Master','DevControllerTwo@ViewProjectWbs');

    Route::get('get-data-project-wbs-master','DevControllerTwo@ViewProjectWbsMaster');

    Route::get('Master/Infrastructure/Edit-Project-Wbs-Master/{id}','DevControllerTwo@EditProjectWbsMaster');

    Route::post('Master/Infrastructure/update-Project-Wbs-Master','DevControllerTwo@updateProjectWbs');

    Route::post('Master/Infrastructure/Delete-Project-Wbs-Master','DevControllerTwo@DeleteProjectWbs');

    /* ----End  Project Wbs Master------------*/

    /*------ Start Unit Sale Tran------------*/

    Route::get('Transaction/Infrastructure/Add-Unit-Sale-Tran','DevControllerTwo@AddUnitSaleTran');

    Route::post('Transaction/Infrastructure/getdata-Unit-Sale-Tran','DevControllerTwo@getdataunitmaster');
    Route::post('Transaction/Infrastructure/Save-Unit-Sale-Tran','DevControllerTwo@SaveUnitSaleTran');

    Route::get('Transaction/Infrastructure/View-Unit-Sale-Tran','DevControllerTwo@ViewUnitTran');

    Route::get('get-data-unit-sale-tran','DevControllerTwo@ViewUnitSaleTran');

    Route::get('Transaction/Infrastructure/Edit-Unit-Sale-Tran/{id}','DevControllerTwo@EditUnitSaleTran');

    Route::post('Transaction/Infrastructure/Update-Unit-Sale-Tran','DevControllerTwo@updateUnitSaleTran');

   /*------ End Unit Sale Tran------------*/

   /*------ LOAN & HUNDI TRAN ------ */

    Route::get('Transaction/LoanAndHundi/Add-loan-hundi-Tran','LoanNhundiController@AddLoanHundi');
    
    Route::post('get-simulation-for-add-loan-n-hundi','LoanNhundiController@SimulationForLoanHundi');

    Route::post('Transaction/LoanAndHundi/save-loan-hundi-Tran','LoanNhundiController@SaveLoanHundi');
    
    Route::get('LoanAndHundi/save-loan-hundi-Tran-msg/{savedata}','LoanNhundiController@loanHundiSaveMsg');

    Route::get('Transaction/LoanAndHundi/view-loan-hundi-Tran','LoanNhundiController@ViewLoanNHundi');

    Route::get('Transaction/LoanAndHundi/create-interest-schedule','LoanNhundiController@CreateInterestSch');

     Route::post('Transaction/LoanHundi/donwload-loan-hundi-Pdf','LoanNhundiController@DonwloandfOnViewPageLoanHundi');
    
    Route::post('transaction/loan-hundi/get-loan-no','LoanNhundiController@getLoanNoAgainstAcc');

   /*------ LOAN & HUNDI TRAN ------ */

   /*------- FREIGHT SALE QUOTATION ----------------- */

   Route::get('/Transaction/Logistic/Freight-Sale-Quatation', 'FinanaceLogisticController@AddFreightSaleQuatation');

  Route::post('/Transaction/Logistic/save-freight-sale-Quatation', 'FinanaceLogisticController@SaveFreightSaleQuatation');

  Route::get('/Transaction/Logistic/view-freight-sale-Quatation', 'FinanaceLogisticController@viewFreightSaleQuatation');

  Route::post('/Transaction/Logistic/view-freight-sale-Quatation-chield-row-data', 'FinanaceLogisticController@viewChildFreightSaleQuatation');

  
  Route::post('/Transaction/Logistic/get-freight-loading-quatation-offline-pdf','FinanaceLogisticController@offlineFSQLsPDF');

  Route::get('/Transaction/Logistic/View-fsq-Plan-msg/{savedata}', 'FinanaceLogisticController@freight_fsq_msg');

   /*------- FREIGHT SALE QUOTATION ----------------- */


/* ---------- START : STORE AJAX METHOD ------------ */
  
    Route::post('/Transaction/Store/get-item-details-for-store','FinanaceStoreController@getDataForitemStore');
    Route::post('/get-item-details-from-store-table-against-store-no','FinanaceStoreController@GeStoreTranItemDetailsAginstNo');
    Route::post('/get-batch-no-against-item-from-item-bal','FinanaceStoreController@GetBatchNoAgainstItem');

/* ---------- END : STORE AJAX METHOD ------------ */

/* -------- TDS REPORT ----------- */
  
    Route::get('/report/account/indirect-tax/tds-report','ReportMisController@tdsReport');
    Route::post('/account/report/tds-report-data','ReportMisController@TdsReportData');

/* -------- TDS REPORT ----------- */

/* ------------ CHANGE CONSINEE --------------*/
    Route::get('/logistic/Change-Consinee', 'LogisticController@deliveryOrderChangeConsinee');
    Route::post('/transaction/update-delivery-Change-Consinee', 'LogisticController@UpdatedeliveryOrderChangeConsinee');
    Route::post('/get-do-No-by-change-Consinee', 'LogisticController@getDoNoChangeConsinee');

/* ------------ CHANGE CONSINEE --------------*/

/* ------ START : ADD PROJECT BUDGET TRAN --------- */
  
  Route::get('Transaction/Infrastructure/Add-project-budget-tranasction','InfrastructureTranController@AddProjectBudgetTran');
  Route::post('/get-all-projectwbs-against-project','InfrastructureTranController@GetAllProjectWbsForProject');

  Route::post('/Transaction/Infrastructure/Save-project-budget-transaction','InfrastructureTranController@SaveProjectBudget');
  Route::get('/Transaction/Infrastructure/save-Trans-Success-Msg/{savedata}/{pageName}', 'InfrastructureTranController@SaveInfraDataMsg');
  Route::get('/Transaction/Infrastructure/view-project-budget-tranasction', 'InfrastructureTranController@ViewrojectBudgetTran');
  Route::post('/Transaction/Infrastructure/Delete-project-budget-tranasction', 'DevControllerOne@DeleteprojectBudgetTran');

/* ------ END : ADD PROJECT BUDGET TRAN --------- */

/* ------ START : ADD PROJECT EXPENSE TRAN --------- */
  
  Route::get('Transaction/Infrastructure/Add-project-expense-tranasction','InfrastructureTranController@AddProjectExpenseTran');

  Route::post('/Transaction/Infrastructure/get-vrno-and-alloc-amt-for-expense-gl', 'InfrastructureTranController@GetvrnoAlocAmtForExpenseGl');
  
  Route::post('/get-budget-amount-of-project-wbs', 'InfrastructureTranController@GetBudgetAmtOfProjectWBS');

  Route::post('/Transaction/Infrastructure/save-project-expense-transaction', 'InfrastructureTranController@SaveProjectExpense');


  Route::get('Transaction/Infrastructure/view-project-expense-tranasction','InfrastructureTranController@viewProjectExpense');
  
  Route::get('report/infrastructure/project-budget-report','InfrastructureTranController@projectBudgetReport');

/* ------ END : ADD PROJECT EXPENSE TRAN --------- */

Route::post('/report/account/acc-ledger-sub-button-data','ReportMisController@ReportAccSubLegder');
Route::post('/report/account/pending-bill-alloc-sub-data','ReportMisController@ReportAccSubLegderbillAloc');

/* --------- START : E-INVOICE ------ */
  
   Route::get('/transaction/logistics/e-invoice-report', 'DashboardController@eInvoiceReport');
   Route::post('/get-acc-list-for-e-invoice','DashboardController@accListForEInvoice');
   Route::post('/e-invoice-data-show-report','DashboardController@eInvoicegetData');
